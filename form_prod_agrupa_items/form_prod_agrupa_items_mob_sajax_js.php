  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_agrupa_items_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_agrupa_items_mob_form();
	}
...
?>
  ...
  // ---------- Validate nombre_agrupador
  function do_ajax_form_prod_agrupa_items_mob_validate_nombre_agrupador()
  {
    var nomeCampo_nombre_agrupador = "nombre_agrupador";
    var var_nombre_agrupador = scAjaxGetFieldText(nomeCampo_nombre_agrupador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_agrupa_items_mob_validate_nombre_agrupador(var_nombre_agrupador, var_script_case_init, do_ajax_form_prod_agrupa_items_mob_validate_nombre_agrupador_cb);
  } // do_ajax_form_prod_agrupa_items_mob_validate_nombre_agrupador

  function do_ajax_form_prod_agrupa_items_mob_validate_nombre_agrupador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_agrupador";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_agrupa_items_mob_validate_nombre_agrupador_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_agrupa_items_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_agrupa_items_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre_agrupador = scAjaxGetFieldText("nombre_agrupador");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_agrupa_items_mob_submit_form(var_nombre_agrupador, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_agrupa_items_mob_submit_form_cb);
  } // do_ajax_form_prod_agrupa_items_mob_submit_form

  function do_ajax_form_prod_agrupa_items_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_agrupa_items_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_agrupa_items_mob_submit_form_cb
  function do_ajax_form_prod_agrupa_items_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_agrupa_items_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_agrupa_items_mob_navigate_form()
  {
    perform_ajax_form_prod_agrupa_items_mob_navigate_form();
  }

  function perform_ajax_form_prod_agrupa_items_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_agrupa_items_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_agrupa_items_mob_navigate_form_cb);
  } // do_ajax_form_prod_agrupa_items_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_agrupa_items_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_agrupa_items_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_agrupa_items_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_agrupa_items_mob_navigate_form_cb
  function do_ajax_form_prod_agrupa_items_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_agrupa_items_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_agrupa_items_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_agrupa_items_mob_form()
  {
  ...
  ajax_field_list[0] = "nombre_agrupador";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "nombre_agrupador": {"label": "Nombre Agrupador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "nombre_agrupador": new Array()
  };
  ajax_field_mult["nombre_agrupador"][1] = "nombre_agrupador";

  var ajax_field_id = {
    "nombre_agrupador": new Array("hidden_field_label_nombre_agrupador", "hidden_field_data_nombre_agrupador")
  };

  var ajax_read_only = {
    "nombre_agrupador": "off"
  };
