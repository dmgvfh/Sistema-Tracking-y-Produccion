<?php
@session_start() ;
$_SESSION['scriptcase']['chart_appointments_count']['sc_process_barr'] = true;
require_once('../chart_appointments_count/index.php');
unset($_SESSION['scriptcase']['chart_appointments_count']['sc_process_barr']);
$ExportCtrl = new chart_appointments_count_export_control;
$ExportCtrl->Export_barr();

class chart_appointments_count_export_control
{
