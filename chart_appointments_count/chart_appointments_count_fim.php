...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____chart_appointments_count"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____chart_appointments_count"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_appointments_count</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['embutida_filho'] as $ind => $sc_init)
          {
