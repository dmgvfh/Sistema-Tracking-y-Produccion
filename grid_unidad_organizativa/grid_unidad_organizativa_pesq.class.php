...
class grid_unidad_organizativa_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_unidad_organizativa_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_unidad_organizativa_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_unidad_organizativa_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombre_unidad')
      {
          $nombre_unidad = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombre_unidad($nombre_unidad);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_nombre_unidad($nombre_unidad)
   {
      $nombre_unidad = substr($this->Db->qstr($nombre_unidad), 1, -1);
            $nombre_unidad_look = (is_string($nombre_unidad) ? substr($this->Db->qstr($nombre_unidad), 1, -1) : $nombre_unidad); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre_unidad from " . $this->Ini->nm_tabela . " where  nombre_unidad like '%" . $nombre_unidad . "%' order by nombre_unidad"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      else
      {
         ...
         $nome_sum = "unidad_organizativa.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> unidad_organizativa</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_unidad_organizativa/grid_unidad_organizativa_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_unidad_organizativa_ajax_search.js"></script>
 <script type="text/javascript" src="grid_unidad_organizativa_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_unidad_organizativa_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_compania_cond#NMF#' + search_get_sel_txt('SC_id_compania_cond') + '@NMF@';
  str_out += 'SC_id_compania#NMF#' + search_get_text('SC_id_compania') + '@NMF@';
  str_out += 'SC_nombre_unidad_cond#NMF#' + search_get_sel_txt('SC_nombre_unidad_cond') + '@NMF@';
  str_out += 'SC_nombre_unidad#NMF#' + search_get_text('SC_nombre_unidad') + '@NMF@';
  str_out += 'id_ac_nombre_unidad#NMF#' + search_get_text('id_ac_nombre_unidad') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nombre_unidad").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nombre_unidad").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombre_unidad",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nombre_unidad").val(ui.item.value);
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> unidad_organizativa</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             $id_cond, $id,
             $id_compania_cond, $id_compania,
             $nombre_unidad_cond, $nombre_unidad, $nombre_unidad_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['id_cond']; 
          $id_compania = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['id_compania']; 
          $id_compania_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['id_compania_cond']; 
          $nombre_unidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['nombre_unidad']; 
          $nombre_unidad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['nombre_unidad_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($id_compania_cond) != "II" && strtoupper($id_compania_cond) != "QP" && strtoupper($id_compania_cond) != "NP" && strtoupper($id_compania_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_compania, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_compania_cond) || empty($id_compania_cond))
      {
         $id_compania_cond = "gt";
      }
      if (!isset($nombre_unidad_cond) || empty($nombre_unidad_cond))
      {
         $nombre_unidad_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_compania = (in_array($id_compania_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre_unidad = (in_array($nombre_unidad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($id_compania) || $id_compania == "")
      {
          $id_compania = "";
      }
      if (isset($id_compania) && !empty($id_compania))
      {
         $tmp_pos = (is_string($id_compania)) ? strpos($id_compania, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_compania = substr($id_compania, 0, $tmp_pos);
         }
      }
      ...
      if (isset($nombre_unidad) && !empty($nombre_unidad))
      {
         $tmp_pos = (is_string($nombre_unidad)) ? strpos($nombre_unidad, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $nombre_unidad = substr($nombre_unidad, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_id_compania_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_compania'])) ? $this->New_label['id_compania'] : "Compania"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_compania_cond" name="id_compania_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_compania'), this, 'id_compania')">
       <OPTION value="gt" <?php if ("gt" == $id_compania_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_compania_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_compania_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_compania" <?php echo $str_hide_id_compania?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_compania'])) ? $this->New_label['id_compania'] : "Compania";
 $nmgp_tab_label .= "id_compania?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_compania" name="id_compania" value="<?php echo NM_encode_input($id_compania) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_nombre_unidad_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nombre_unidad'])) ? $this->New_label['nombre_unidad'] : "Nombre Unidad"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nombre_unidad_cond" name="nombre_unidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_unidad'), this, 'nombre_unidad')">
       <OPTION value="qp" <?php if ("qp" == $nombre_unidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombre_unidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombre_unidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombre_unidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_unidad" <?php echo $str_hide_nombre_unidad?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nombre_unidad'])) ? $this->New_label['nombre_unidad'] : "Nombre Unidad";
 $nmgp_tab_label .= "nombre_unidad?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $nombre_unidad_look = (is_string($nombre_unidad) ? substr($this->Db->qstr($nombre_unidad), 1, -1) : $nombre_unidad); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre_unidad from " . $this->Ini->nm_tabela . " where nombre_unidad = '$nombre_unidad_look' order by nombre_unidad"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$nombre_unidad]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nombre_unidad];
      }
      else
      {
          $sAutocompValue = $nombre_unidad;
      }
?>
<INPUT  type="text" id="SC_nombre_unidad" name="nombre_unidad" value="<?php echo NM_encode_input($nombre_unidad) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nombre_unidad" name="nombre_unidad_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_unidad_organizativa_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_unidad_organizativa']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_unidad_organizativa']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_compania_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_compania'), document.F1.id_compania_cond, 'id_compania');
   document.F1.id_compania.value = "";
   document.F1.nombre_unidad_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nombre_unidad'), document.F1.nombre_unidad_cond, 'nombre_unidad');
   document.F1.nombre_unidad.value = "";
   document.F1.nombre_unidad_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_unidad_organizativa";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_unidad_organizativa/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_compania_cond'] = 'cond';
      $tp_fields['SC_id_compania'] = 'text';
      $tp_fields['SC_nombre_unidad_cond'] = 'cond';
      $tp_fields['SC_nombre_unidad'] = 'text_aut';
      $tp_fields['id_ac_nombre_unidad'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $id_cond, $id,
             $id_compania_cond, $id_compania,
             $nombre_unidad_cond, $nombre_unidad, $nombre_unidad_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($nombre_unidad_autocomp) && empty($nombre_unidad))
      {
          $nombre_unidad = $nombre_unidad_autocomp;
      }
      ...
      $id_compania_cond_salva = $id_compania_cond; 
      if (!isset($id_compania_input_2) || $id_compania_input_2 == "")
      {
          $id_compania_input_2 = $id_compania;
      }
      $nombre_unidad_cond_salva = $nombre_unidad_cond; 
      if (!isset($nombre_unidad_input_2) || $nombre_unidad_input_2 == "")
      {
          $nombre_unidad_input_2 = $nombre_unidad;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_compania_cond != "in")
      {
          nm_limpa_numero($id_compania, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['id_compania'] = $id_compania; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['id_compania_cond'] = $id_compania_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['nombre_unidad'] = $nombre_unidad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['nombre_unidad_cond'] = $nombre_unidad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $id_compania;
      if (strtoupper($id_compania_cond) != "II" && strtoupper($id_compania_cond) != "QP" && strtoupper($id_compania_cond) != "NP" && strtoupper($id_compania_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['id_compania'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nombre_unidad != '') {
      $nombre_unidad_look = (is_string($nombre_unidad) ? substr($this->Db->qstr($nombre_unidad), 1, -1) : $nombre_unidad); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombre_unidad'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nombre_unidad'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombre_unidad'] = $nombre_unidad;
      }
      ...
      //----- $id_compania
      $this->Date_part = false;
      if (isset($id_compania) || $id_compania_cond == "nu" || $id_compania_cond == "nn" || $id_compania_cond == "ep" || $id_compania_cond == "ne")
      {
         $this->monta_condicao("id_compania", $id_compania_cond, $id_compania, "", "id_compania", "INT", false);
      }

      //----- $nombre_unidad
      $this->Date_part = false;
      if (isset($nombre_unidad) || $nombre_unidad_cond == "nu" || $nombre_unidad_cond == "nn" || $nombre_unidad_cond == "ep" || $nombre_unidad_cond == "ne")
      {
         $this->monta_condicao("nombre_unidad", $nombre_unidad_cond, $nombre_unidad, "", "nombre_unidad", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unidad_organizativa']['cond_pesq'] .= $this->NM_operador;
