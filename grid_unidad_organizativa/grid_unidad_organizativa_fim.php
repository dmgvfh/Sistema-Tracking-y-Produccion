...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_unidad_organizativa"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_unidad_organizativa"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_unidad_organizativa'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_unidad_organizativa']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_unidad_organizativa']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_unidad_organizativa']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_unidad_organizativa']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_unidad_organizativa']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_unidad_organizativa</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_unidad_organizativa']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_unidad_organizativa']['embutida_filho'] as $ind => $sc_init)
          {
