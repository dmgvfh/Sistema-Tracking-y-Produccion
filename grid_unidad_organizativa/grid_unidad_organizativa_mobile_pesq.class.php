...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "id_compania";$Nm_numeric[] = "id";$Nm_numeric[] = "id_compania";
...
<HTML>
<HEAD>
 <TITLE> unidad_organizativa</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_compania_cond" name="id_compania_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_compania'), this, 'id_compania')">
      ...
      <br><span id="id_hide_id_compania"  <?php echo $str_hide_id_compania?>><INPUT  type="text" id="SC_id_compania" name="id_compania" value="<?php echo NM_encode_input($id_compania) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nombre_unidad_cond" name="nombre_unidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_unidad'), this, 'nombre_unidad')">
      ...
      <br><span id="id_hide_nombre_unidad"  <?php echo $str_hide_nombre_unidad?>><?php
      if ($nombre_unidad != "")
      {
      $nombre_unidad_look = (is_string($nombre_unidad) ? substr($this->Db->qstr($nombre_unidad), 1, -1) : $nombre_unidad); 
      $nmgp_def_dados = array(); 
