  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_actividades" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipo_actividades_form();
	}
...
?>
  ...
  function do_ajax_form_tipo_actividades_validate_nombre_actividad()
  {
    ...
    x_ajax_form_tipo_actividades_validate_nombre_actividad(var_nombre_actividad, var_script_case_init, do_ajax_form_tipo_actividades_validate_nombre_actividad_cb);
  } // do_ajax_form_tipo_actividades_validate_nombre_actividad

  function do_ajax_form_tipo_actividades_validate_nombre_actividad_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_actividades_validate_nombre_actividad_cb

  // ---------- Validate descripcion_actividad
  function do_ajax_form_tipo_actividades_validate_descripcion_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_actividades_validate_descripcion_actividad(var_descripcion_actividad, var_script_case_init, do_ajax_form_tipo_actividades_validate_descripcion_actividad_cb);
  } // do_ajax_form_tipo_actividades_validate_descripcion_actividad

  function do_ajax_form_tipo_actividades_validate_descripcion_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_actividades_validate_descripcion_actividad_cb

  // ---------- Validate id_unidad_organizativa
  function do_ajax_form_tipo_actividades_validate_id_unidad_organizativa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_actividades_validate_id_unidad_organizativa(var_id_unidad_organizativa, var_script_case_init, do_ajax_form_tipo_actividades_validate_id_unidad_organizativa_cb);
  } // do_ajax_form_tipo_actividades_validate_id_unidad_organizativa

  function do_ajax_form_tipo_actividades_validate_id_unidad_organizativa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_actividades_validate_id_unidad_organizativa_cb

  // ---------- Validate habilitado
  function do_ajax_form_tipo_actividades_validate_habilitado()
  {
    var nomeCampo_habilitado = "habilitado";
    var var_habilitado = scAjaxGetFieldSelect(nomeCampo_habilitado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_actividades_validate_habilitado(var_habilitado, var_script_case_init, do_ajax_form_tipo_actividades_validate_habilitado_cb);
  } // do_ajax_form_tipo_actividades_validate_habilitado

  function do_ajax_form_tipo_actividades_validate_habilitado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_actividades_validate_habilitado_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_tipo_actividades_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipo_actividades_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_actividades_submit_form(var_nombre_actividad, var_descripcion_actividad, var_id_unidad_organizativa, var_habilitado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_actividades_submit_form_cb);
  } // do_ajax_form_tipo_actividades_submit_form

  function do_ajax_form_tipo_actividades_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tipo_actividades_submit_form_cb_after_alert);
  } // do_ajax_form_tipo_actividades_submit_form_cb
  function do_ajax_form_tipo_actividades_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipo_actividades_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipo_actividades_navigate_form()
  {
    perform_ajax_form_tipo_actividades_navigate_form();
  }

  function perform_ajax_form_tipo_actividades_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_actividades_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_actividades_navigate_form_cb);
  } // do_ajax_form_tipo_actividades_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_actividades']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_actividades_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipo_actividades_navigate_form_cb_after_alert);
  } // do_ajax_form_tipo_actividades_navigate_form_cb
  function do_ajax_form_tipo_actividades_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tipo_actividades_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipo_actividades_navigate_form_cb_after_alert

  function sc_hide_form_tipo_actividades_form()
  {
