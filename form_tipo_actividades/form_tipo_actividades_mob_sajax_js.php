  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_actividades_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipo_actividades_mob_form();
	}
...
?>
  ...
  // ---------- Validate nombre_actividad
  function do_ajax_form_tipo_actividades_mob_validate_nombre_actividad()
  {
    var nomeCampo_nombre_actividad = "nombre_actividad";
    var var_nombre_actividad = scAjaxGetFieldText(nomeCampo_nombre_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_actividades_mob_validate_nombre_actividad(var_nombre_actividad, var_script_case_init, do_ajax_form_tipo_actividades_mob_validate_nombre_actividad_cb);
  } // do_ajax_form_tipo_actividades_mob_validate_nombre_actividad

  function do_ajax_form_tipo_actividades_mob_validate_nombre_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_actividad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_actividades_mob_validate_nombre_actividad_cb

  // ---------- Validate descripcion_actividad
  function do_ajax_form_tipo_actividades_mob_validate_descripcion_actividad()
  {
    var nomeCampo_descripcion_actividad = "descripcion_actividad";
    var var_descripcion_actividad = scAjaxGetFieldText(nomeCampo_descripcion_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_actividades_mob_validate_descripcion_actividad(var_descripcion_actividad, var_script_case_init, do_ajax_form_tipo_actividades_mob_validate_descripcion_actividad_cb);
  } // do_ajax_form_tipo_actividades_mob_validate_descripcion_actividad

  function do_ajax_form_tipo_actividades_mob_validate_descripcion_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descripcion_actividad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_actividades_mob_validate_descripcion_actividad_cb

  // ---------- Validate id_unidad_organizativa
  function do_ajax_form_tipo_actividades_mob_validate_id_unidad_organizativa()
  {
    var nomeCampo_id_unidad_organizativa = "id_unidad_organizativa";
    var var_id_unidad_organizativa = scAjaxGetFieldSelect(nomeCampo_id_unidad_organizativa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_actividades_mob_validate_id_unidad_organizativa(var_id_unidad_organizativa, var_script_case_init, do_ajax_form_tipo_actividades_mob_validate_id_unidad_organizativa_cb);
  } // do_ajax_form_tipo_actividades_mob_validate_id_unidad_organizativa

  function do_ajax_form_tipo_actividades_mob_validate_id_unidad_organizativa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_unidad_organizativa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_actividades_mob_validate_id_unidad_organizativa_cb

  // ---------- Validate habilitado
  function do_ajax_form_tipo_actividades_mob_validate_habilitado()
  {
    var nomeCampo_habilitado = "habilitado";
    var var_habilitado = scAjaxGetFieldSelect(nomeCampo_habilitado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_actividades_mob_validate_habilitado(var_habilitado, var_script_case_init, do_ajax_form_tipo_actividades_mob_validate_habilitado_cb);
  } // do_ajax_form_tipo_actividades_mob_validate_habilitado

  function do_ajax_form_tipo_actividades_mob_validate_habilitado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_actividades_mob_validate_habilitado_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_tipo_actividades_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipo_actividades_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre_actividad = scAjaxGetFieldText("nombre_actividad");
    var var_descripcion_actividad = scAjaxGetFieldText("descripcion_actividad");
    var var_id_unidad_organizativa = scAjaxGetFieldSelect("id_unidad_organizativa");
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_actividades_mob_submit_form(var_nombre_actividad, var_descripcion_actividad, var_id_unidad_organizativa, var_habilitado, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_actividades_mob_submit_form_cb);
  } // do_ajax_form_tipo_actividades_mob_submit_form

  function do_ajax_form_tipo_actividades_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nombre_actividad");
      scAjaxHideErrorDisplay("descripcion_actividad");
      scAjaxHideErrorDisplay("id_unidad_organizativa");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tipo_actividades_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tipo_actividades_mob_submit_form_cb
  function do_ajax_form_tipo_actividades_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipo_actividades_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipo_actividades_mob_navigate_form()
  {
    perform_ajax_form_tipo_actividades_mob_navigate_form();
  }

  function perform_ajax_form_tipo_actividades_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_actividades_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_actividades_mob_navigate_form_cb);
  } // do_ajax_form_tipo_actividades_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_actividades_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_actividades_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipo_actividades_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tipo_actividades_mob_navigate_form_cb
  function do_ajax_form_tipo_actividades_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tipo_actividades_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipo_actividades_mob_navigate_form_cb_after_alert

  function sc_hide_form_tipo_actividades_mob_form()
  {
  ...
  ajax_field_list[0] = "nombre_actividad";
  ajax_field_list[1] = "descripcion_actividad";
  ajax_field_list[2] = "id_unidad_organizativa";
  ajax_field_list[3] = "habilitado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "nombre_actividad": {"label": "Nombre Actividad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "descripcion_actividad": {"label": "Descripcion Actividad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_unidad_organizativa": {"label": "Unidad Organizativa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    "nombre_actividad": new Array(),
    "descripcion_actividad": new Array(),
    "id_unidad_organizativa": new Array(),
    "habilitado": new Array()
  };
  ajax_field_mult["nombre_actividad"][1] = "nombre_actividad";
  ajax_field_mult["descripcion_actividad"][1] = "descripcion_actividad";
  ajax_field_mult["id_unidad_organizativa"][1] = "id_unidad_organizativa";
  ajax_field_mult["habilitado"][1] = "habilitado";

  var ajax_field_id = {
    "nombre_actividad": new Array("hidden_field_label_nombre_actividad", "hidden_field_data_nombre_actividad"),
    "descripcion_actividad": new Array("hidden_field_label_descripcion_actividad", "hidden_field_data_descripcion_actividad"),
    "id_unidad_organizativa": new Array("hidden_field_label_id_unidad_organizativa", "hidden_field_data_id_unidad_organizativa"),
    "habilitado": new Array("hidden_field_label_habilitado", "hidden_field_data_habilitado")
  };

  var ajax_read_only = {
    "nombre_actividad": "off",
    "descripcion_actividad": "off",
    "id_unidad_organizativa": "off",
    "habilitado": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("descripcion_actividad" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("id_unidad_organizativa" == sIndex)
    {
