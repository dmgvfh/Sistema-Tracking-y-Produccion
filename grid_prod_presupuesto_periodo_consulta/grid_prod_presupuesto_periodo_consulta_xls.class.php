...
class grid_prod_presupuesto_periodo_consulta_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_prod_presupuesto_periodo_consulta" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_prod_presupuesto_periodo_consulta_total.class.php"); 
      ...
      {
          $this->sum_monto_uf = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['tot_geral'][2];
          $this->sum_reajuste = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['tot_geral'][3];
          $this->sum_retencion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['tot_geral'][4];
          $this->sum_avance_informado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['tot_geral'][5];
          $this->sum_produccion_total_final = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['tot_geral'][6];
      }
   }
   //---- 
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_prod_presupuesto_periodo_consulta']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['embutida'])
      { 
   ...
   function NM_export_produccion_total_final()
   {
         ...
         if (is_numeric($this->produccion_total_final))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->produccion_total_final);
         $this->Xls_col++;
   }
   //----- facturado
   function NM_export_facturado()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_facturado, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_facturado, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- factura
   ...
   function NM_export_vigente()
   {
         ...
         if (is_numeric($this->vigente))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->vigente);
         $this->Xls_col++;
   }
   //----- id_partida
   ...
   //----- produccion_total_final
   function NM_sub_cons_produccion_total_final()
   {
         $this->produccion_total_final = NM_charset_to_utf8($this->produccion_total_final);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->produccion_total_final;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.0";
         $this->Xls_col++;
   ...
   //----- vigente
   function NM_sub_cons_vigente()
   {
         $this->vigente = NM_charset_to_utf8($this->vigente);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->vigente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['nolabel'])
       {
