...
class grid_prod_presupuesto_periodo_consulta_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_prod_presupuesto_periodo_consulta.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_prod_presupuesto_periodo_consulta']['contr_erro'] = 'off'; 
   ...
   function NM_export_produccion_total_final()
   {
         ...
         $this->produccion_total_final = NM_charset_to_utf8($this->produccion_total_final);
         $this->produccion_total_final = str_replace('<', '&lt;', $this->produccion_total_final);
         $this->produccion_total_final = str_replace('>', '&gt;', $this->produccion_total_final);
         $this->Texto_tag .= "<td>" . $this->produccion_total_final . "</td>\r\n";
   }
   //----- facturado
   ...
   function NM_export_vigente()
   {
         ...
         $this->vigente = NM_charset_to_utf8($this->vigente);
         $this->vigente = str_replace('<', '&lt;', $this->vigente);
         $this->vigente = str_replace('>', '&gt;', $this->vigente);
         $this->Texto_tag .= "<td>" . $this->vigente . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
