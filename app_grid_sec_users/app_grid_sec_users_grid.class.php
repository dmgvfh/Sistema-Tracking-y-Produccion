...
class app_grid_sec_users_grid
{
   ...
   var $progress_res;
   var $progress_graf;
   var $array_perfil = array();
   var $array_proyectos = array();
   var $count_ger;
   var $perfil;
   var $proyectos;
   var $login;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['grid_pesq'] = array();
   }
   ...
   { 
       ...
       if (!$this->Proc_link_res && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf' && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['proc_pdf'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print')
       { 
       $nm_saida->saida("     <TR>\r\n");
       $nm_saida->saida("      <TD id=\"div_refin_search\" class=\"scGridRefinedSearchPadding\" valign='top'>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ajax_nav'])
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['refresh_interativ']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['refresh_interativ'] == "S") {
                   $this->Ini->Arr_result['setValue'][] = array('field' => 'div_refin_search', 'value' => NM_charset_to_utf8($_SESSION['scriptcase']['saida_html']));
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['refresh_interativ']);
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['save_grid']))
       {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['SC_Ind_Groupby'] != "sc_free_total")
       { 
...
//
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] || $this->Ini->Embutida_iframe)
   {
   ...
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['mostra_edit'] = "N";
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
   ...
   $this->Cmps_ord_def['is_active'] = " asc";
   ...
   $this->New_label['priv_admin'] = "" . $this->Ini->Nm_lang['lang_sec_users_fld_priv_admin'] . "";
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   ...
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['qt_lin_grid'] = 25;
   }   
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['SC_Ind_Groupby'] == "sc_free_total") 
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ordem_quebra'] = array(); 
       } 
   }
...
// 
   ...
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT login, name, email, id_empresa, is_active, id from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT login, name, email, id_empresa, is_active, id from " . $this->Ini->nm_tabela; 
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['SC_Ind_Groupby'], $campo);
   ...
   { 
       ...
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ordem_desc']; 
   } 
   ...
   { 
       ...
       $this->id_empresa = $this->rs_grid->fields[3] ;  
       $this->id_empresa = (string)$this->id_empresa;
       $this->is_active = $this->rs_grid->fields[4] ;  
       $this->id = $this->rs_grid->fields[5] ;  
       $this->id = (string)$this->id;
       $GLOBALS["id_empresa"] = $this->rs_grid->fields[3] ;  
       $GLOBALS["id_empresa"] = (string)$GLOBALS["id_empresa"] ;
       $GLOBALS["id"] = $this->rs_grid->fields[5] ;  
       $GLOBALS["id"] = (string)$GLOBALS["id"] ;
       $this->look_is_active = $this->is_active; 
       $this->Lookup->lookup_is_active($this->look_is_active); 
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $this->Lookup->lookup_perfil($this->perfil, $this->login, $this->array_perfil); 
       $this->Lookup->lookup_proyectos($this->proyectos, $this->id, $this->array_proyectos); 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['initialize']) ? true : false;
...
<HEAD>
 <TITLE>Registro de Usuarios :: PDF</TITLE>
...
<?php
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Registro de Usuarios</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $this->NM_opcao != "pdf") {
       ...
       { 
           ...
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"app_grid_sec_users_jquery-3.6.0.min.js\"></script>\r\n");
 ...
 { 
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".app_grid_sec_users_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .app_grid_sec_users_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
   ...
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   $this->css_is_active_label = $compl_css_emb . "css_is_active_label";
   $this->css_is_active_grid_line = $compl_css_emb . "css_is_active_grid_line";
   $this->css_perfil_label = $compl_css_emb . "css_perfil_label";
   $this->css_perfil_grid_line = $compl_css_emb . "css_perfil_grid_line";
   $this->css_proyectos_label = $compl_css_emb . "css_proyectos_label";
   $this->css_proyectos_grid_line = $compl_css_emb . "css_proyectos_grid_line";
 }  
 function cabecalho()
 {
...
//----- 
 function cabecalho_normal()
 {
   ...
   $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">Registro de Usuarios</div>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_proyectos_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " sc-col-actionbar-left \"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_proyectos_label'] . "\" ><style>\r\n");
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['name'])) ? $this->New_label['name'] : "Nombre";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['email'])) ? $this->New_label['email'] : "Dirección de email";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 function NM_label_is_active()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['is_active'])) ? $this->New_label['is_active'] : "Activo";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['is_active']) || $this->NM_cmp_hidden['is_active'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_is_active_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_is_active_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $fieldSortRule = $this->scGetColumnOrderRule('is_active');
        $fieldSortIcon = $this->scGetColumnOrderIcon('is_active', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_is_active_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "\<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_is_active_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('is_active')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_perfil()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['perfil'])) ? $this->New_label['perfil'] : "Perfil Acceso";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['perfil']) || $this->NM_cmp_hidden['perfil'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_perfil_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_perfil_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = 'left';
 ...
 function NM_label_proyectos()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['proyectos'])) ? $this->New_label['proyectos'] : "Proyectos Asociados Activos";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['proyectos']) || $this->NM_cmp_hidden['proyectos'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_proyectos_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_proyectos_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ordem_cmp'] == $fieldName) {
...
// 
   $SC_Label = (isset($this->New_label['login'])) ? $this->New_label['login'] : "Login";
   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels']['login'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['name'])) ? $this->New_label['name'] : "Nombre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels']['name'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['email'])) ? $this->New_label['email'] : "Dirección de email";
   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels']['email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_empresa'])) ? $this->New_label['id_empresa'] : "Empresa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels']['id_empresa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['is_active'])) ? $this->New_label['is_active'] : "Activo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels']['is_active'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['perfil'])) ? $this->New_label['perfil'] : "Perfil Acceso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels']['perfil'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['proyectos'])) ? $this->New_label['proyectos'] : "Proyectos Asociados Activos";
   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['labels']['proyectos'] = $SC_Label; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_refresh'] = false;
   }
...
// 
   ...
   {  
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_psq'])
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_proyectos_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['mostra_edit'] != "N"){ 
              ...
              {
                  $Parms_Edt  = "login*scin" . str_replace('"', "@aspasd@", $this->login) . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scoutnmgp_opcao*scinigual*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout";
              ...
              {
                  $Md5_Edt  = "login*scin" . str_replace('"', "@aspasd@", $this->login) . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scoutnmgp_opcao*scinigual*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_app_form_edit_users . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'app_form_edit_users', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_app_form_edit_users . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'app_form_edit_users', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['mostra_edit'] == "N"){ 
   ...
   { 
       ...
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida_grid'])
 ...
 function NM_grid_login()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['login']) || $this->NM_cmp_hidden['login'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_login_grid_line . "\"  style=\"" . $this->Css_Cmp['css_login_grid_line'] . "\"  align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_login_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_name()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_name_grid_line . "\"  style=\"" . $this->Css_Cmp['css_name_grid_line'] . "\"  align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_name_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_is_active()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['is_active']) || $this->NM_cmp_hidden['is_active'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->look_is_active));
              $conteudo_original = NM_encode_input(sc_strip_script($this->look_is_active));
          }
          else {
              $conteudo = trim(sc_strip_script($this->look_is_active)); 
              $conteudo_original = trim(sc_strip_script($this->look_is_active)); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_is_active_grid_line . "\"  style=\"" . $this->Css_Cmp['css_is_active_grid_line'] . "\"  align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_is_active_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_perfil()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['perfil']) || $this->NM_cmp_hidden['perfil'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->perfil));
              $conteudo_original = NM_encode_input(sc_strip_script($this->perfil));
          }
          else {
              $conteudo = sc_strip_script($this->perfil); 
              $conteudo_original = sc_strip_script($this->perfil); 
          }
          $conteudo = trim($this->perfil); 
          $str_tem_display = $conteudo;
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
              $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
          }
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_perfil_grid_line . "\"  style=\"" . $this->Css_Cmp['css_perfil_grid_line'] . "\"  align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_perfil_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_proyectos()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['proyectos']) || $this->NM_cmp_hidden['proyectos'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->proyectos));
              $conteudo_original = NM_encode_input(sc_strip_script($this->proyectos));
          }
          else {
              $conteudo = sc_strip_script($this->proyectos); 
              $conteudo_original = sc_strip_script($this->proyectos); 
          }
          $conteudo = trim($this->proyectos); 
          $str_tem_display = $conteudo;
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
              $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
          }
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_proyectos_grid_line . "\"  style=\"" . $this->Css_Cmp['css_proyectos_grid_line'] . "\"  align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_proyectos_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "", "", "selcmp_top", "", "VER PROYECTOS ASOCIADOS", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "app_grid_sec_users/app_grid_sec_users_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "app_grid_sec_users/app_grid_sec_users_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "app_grid_sec_users/app_grid_sec_users_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "VER PROYECTOS ASOCIADOS", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
           ...
           $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
           if (isset($this->Ini->sc_lig_md5["app_form_edit_users"]) && $this->Ini->sc_lig_md5["app_form_edit_users"] == "S") {
               $Parms_Lig  = "NM_cancel_insert_new*scin1*scoutNM_cancel_return_new*scin1*scoutnmgp_opcao*scinnovo*scoutNM_btn_insert*scinS*scoutNM_btn_new*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scout";
               ...
               $Md5_Lig  = "NM_cancel_insert_new*scin1*scoutNM_cancel_return_new*scin1*scoutnmgp_opcao*scinnovo*scoutNM_btn_insert*scinS*scoutNM_btn_new*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scout";
           }
         $this->nm_btn_exist['new'][] = "sc_b_new_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "nm_gp_submit1('" .  $this->Ini->link_app_form_edit_users . "', '$this->nm_location', '$Md5_Lig', '_self', 'app_form_edit_users'); return false;;", "nm_gp_submit1('" .  $this->Ini->link_app_form_edit_users . "', '$this->nm_location', '$Md5_Lig', '_self', 'app_form_edit_users'); return false;;", "sc_b_new_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
         $NM_btn = true;
        }
          $nm_saida->saida("         </td> \r\n");
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_interativ_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_dados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_dados'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_sql']   = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['is_active'] = (isset($this->New_label['is_active'])) ? $this->New_label['is_active'] : 'Activo';
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_sql']['is_active']   = "is_active";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['id_empresa'] = (isset($this->New_label['id_empresa'])) ? $this->New_label['id_empresa'] : 'Empresa';
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_sql']['id_empresa']   = "id_empresa";
       ...
       $lin_obj = $this->interativ_search_is_active($bol_refin_use_modal);
   ...
   function interativ_search_is_active($bol_refin_use_modal)
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']["is_active"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']["is_active"])) ? "none" : "";
       $displ_open= false;
       $lin_obj  = "    <div id=\"div_int_is_active\">";
       $lin_obj .= "    <table width='100%' cellspacing=0 cellpadding=0>";
       $lin_obj .= "     <tr>";
       $lin_obj .= "      <td nowrap class='scGridRefinedSearchLabel' onclick=\"nm_toggle_int_search('is_active')\">";
       $lin_obj .= "        <table width='100%' cellspacing=0 cellpadding=0>";
       $lin_obj .= "         <tr>";
       $lin_obj .= "          <td nowrap>";
       $lin_obj .= "              <span id=\"id_expand_is_active\" style=\"display: " .  $exp_disp . ";\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer; padding:0px 2px 0px 0px;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_show . "\" BORDER=\"0\" />   </span>";
       $lin_obj .= "              <span id=\"id_retract_is_active\" style=\"display: none;\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_hide . "\" BORDER=\"0\" />   </span>";
       $lin_obj .= "              <span class=\"dn-expand-button\" style=\"cursor: pointer;\">";
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['is_active'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       $lin_obj .= "              <span id=\"id_clear_is_active\" style=\"display: " .  $cle_disp . ";\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_close . "\" BORDER=\"0\" onclick=\"event.stopPropagation(); nm_proc_int_search('clear','','','is_active', '', 'is_active', '', 'S')\"/>   </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "         </tr>";
       $lin_obj .= "        </table>";
       $lin_obj .= "     </td></tr>";
       $Cmps_where = "";
       $nm_comando = "select is_active, COUNT(*) AS countTest from " . $this->Ini->nm_tabela;
       $tmp_where = "";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq']))
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq'];
       }
       $nm_comando .= " " . $tmp_where;
       $nm_comando .= " GROUP BY is_active". $Cmps_where;
       $nm_comando .= " order by is_active ASC";
       $result = array();
       $range_max = false;
       $range_min = false;
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']['is_active'])) ? "" : "none";
       $lin_obj  .= "   <tr><td><div class='scGridRefinedSearchMolduraResult' id=\"id_tab_is_active_link\" style=\"display: " . $disp_link . ";\">";
        $check_uncheck  = "
            <span id='id_check_is_active' class='multipleis_active' style='display:" . (($displ_open)?'':'none') . ";'>
                <input class='scAppDivToolbarInput' style='margin:0px' type='checkbox' checked='checked' onclick=\"refinedSearchCheckUncheckAll('is_active', true); this.checked=true;\" \>
                <input class='scAppDivToolbarInput' style='margin:0px' type='checkbox'                   onclick=\"refinedSearchCheckUncheckAll('is_active', false); this.checked=false;\" \>
            </span>";
       $qtd_see_more  = 0;
       ...
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_dados']['is_active'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           $formatado = $dados;
           $this->Lookup->lookup_is_active($formatado);
           $formatado_exib  = $formatado;
           $dados = (string)$dados;
           if($bol_refin_use_modal && $bol_populate_modal_values)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_dados']['is_active'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
           ...
           {
               $lin_obj  .= "   <div id='id_see_more_list_is_active' style='display:none'>";
           ...
           $lin_obj  .= "   <tr>";
           $lin_obj  .= "   <td>";
           $lin_obj  .= "   <span class='simpleis_active' style='display:" . (($displ_open)?'none':'') . ";'>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']['is_active']))
           {
               $lin_obj  .= "        <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear_opc', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['is_active']) . "','is_active','id_int_search_is_active','is_active', '" . NM_encode_input($dados . "##@@" . $formatado) . "', 'S');\"/>";
           }
           $lin_obj  .= "        <a href=\"javascript:nm_proc_int_search('link','tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['is_active']) . "','is_active','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'is_active', '', 'N');\" class='scGridRefinedSearchCampoFont'>";
           ...
           $lin_obj  .= "        </a>";
           $lin_obj  .= "    </span>";
           $lin_obj  .= "    <span class='multipleis_active' style='display:"  . (($displ_open)?'':'none') .  ";'>";
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']['is_active']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']['is_active']['val_sel'])) ? " checked" : "";
           $checked = " checked";
           $lin_obj  .= "        <INPUT class='" . $this->css_scAppDivToolbarInput . "' style='margin:0px' type=\"checkbox\"  id=\"id_int_search_is_active_" . md5($dados) . "\" name=\"int_search_is_active[]\" value=\"" . NM_encode_input($dados . "##@@" . $formatado) . "\" $checked><span class='scGridRefinedSearchCampoFont'> <label for=\"id_int_search_is_active_". md5($dados) ."\" for=\"id_int_search_is_active_". md5($dados) ."\">" . $formatado_exib . "</label></span>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= " <span class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</span>";
           }
           ...
           $lin_obj  .= "   <div id='id_see_more_is_active' class='scGridRefinedSearchVejaMais'>";
           $lin_obj  .= "       " . $check_uncheck;
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'app_grid_sec_users_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=is_active&tp_obj=tx&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
               $lin_obj  .= "       <a style='display:" . (($displ_see_more)?'':'none') . ";'  href=\"javascript:toggleSeeMore('is_active');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           $lin_obj  .= "   </div>";
           $lin_obj  .= "   <div id='id_see_less_is_active' class='scGridRefinedSearchVejaMais' style='display:none;'>";
           $lin_obj  .= "   " . $check_uncheck;
           $lin_obj  .= "    <a href=\"javascript:toggleSeeMore('is_active');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_less'] ."</a>";
           $lin_obj  .= "   </div>";
           $lin_obj  .= "<SCRIPT>";
           $lin_obj  .= "$( document ).ready(function() {";
           $lin_obj  .= "    nm_expand_int_search('is_active');";
           $lin_obj  .= "});";
           $lin_obj  .= "</SCRIPT>";
           $lin_obj  .= "   </div></td></tr>";
           $lin_obj .= "    <tr class='toolbarFields'>";
           $lin_obj .= "    <td style='display:'>";
           $lin_obj .= "    <div class='scGridRefinedSearchToolbar' id=\"id_toolbar_is_active\" style='display:none'>";
           $disp_show_multi_btn = '';
           if (count($result) < 2)
           {
               $disp_show_multi_btn = 'none';
           }
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bmultiselect", "nm_mult_int_search('is_active', false);", "nm_mult_int_search('is_active', false);", "mult_int_search_is_active", "", "", "display: $disp_show_multi_btn;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "multiselect", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $disp_multi_btn = 'none';
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['is_active']) . "','is_active','id_int_search_is_active','is_active', '', 'N');", "nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['is_active']) . "','is_active','id_int_search_is_active','is_active', '', 'N');", "app_int_search_is_active", "", "", "display: $disp_multi_btn ;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_cancel", "nm_single_int_search('is_active');", "nm_single_int_search('is_active');", "single_int_search_is_active", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $lin_obj .= "    </div>";
       $lin_obj .= "    </td>";
       $lin_obj .= "    </tr>";
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']["id_empresa"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']["id_empresa"])) ? "none" : "";
       $displ_open= false;
       ...
       $lin_obj .= "              <span class=\"dn-expand-button\" style=\"cursor: pointer;\">";
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['id_empresa'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']['id_empresa'])) ? "" : "none";
       ...
       if($bol_refin_use_modal)
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_dados']['id_empresa'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           $formatado = $dados;
           ...
           if($bol_refin_use_modal && $bol_populate_modal_values)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_dados']['id_empresa'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
               $formatado_exib = "" . $this->Ini->Nm_lang['lang_refine_search_empty'] . "";
           ...
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']['id_empresa']))
           {
               $lin_obj  .= "        <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear_opc', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['id_empresa']) . "','id_empresa','id_int_search_id_empresa','id_empresa', '" . NM_encode_input($dados . "##@@" . $formatado) . "', 'S');\"/>";
           }
           $lin_obj  .= "        <a href=\"javascript:nm_proc_int_search('link','nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['id_empresa']) . "','id_empresa','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'id_empresa', '', 'N');\" class='scGridRefinedSearchCampoFont'>";
           $lin_obj  .= $formatado_exib;
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "            <span class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</span>";
           ...
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']['id_empresa']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['interativ_search']['id_empresa']['val_sel'])) ? " checked" : "";
           $checked = " checked";
           ...
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'app_grid_sec_users_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=id_empresa&tp_obj=nn&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
           ...
           $lin_obj .= $Cod_Btn; 
           $disp_multi_btn = 'none';
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['id_empresa']) . "','id_empresa','id_int_search_id_empresa','id_empresa', '', 'N');", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['int_search_label']['id_empresa']) . "','id_empresa','id_int_search_id_empresa','id_empresa', '', 'N');", "app_int_search_id_empresa", "", "", "display: $disp_multi_btn ;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   function JS_interativ_search()
   {
       ...
       $nm_saida->saida("     if($( \"#id_slider_is_active\").length > 0)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("         $('#app_int_search_range_is_active').click();\r\n");
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida("     else if($( \"input[name='int_search_is_active[]']:checked\" ).length > 0)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("         $('#app_int_search_is_active').click();\r\n");
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida("     else\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("         nm_proc_int_search('clear','','','is_active', '', 'is_active', '', 'S');\r\n");
       $nm_saida->saida("     }\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"app_grid_sec_users_iframe.php\";\r\n");
