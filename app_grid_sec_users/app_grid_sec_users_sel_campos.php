<?php
   ...
   if(!$bol_sel_campos_include)
   {
     ...
     if (!isset($_SESSION['sc_session']))
     {
       ...
       if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      $tab_ger_campos['is_active'] = "on";
      $tab_blk_campos[] = "is_active";
      $tab_ger_campos['perfil'] = "on";
      $tab_blk_campos[] = "perfil";
      $tab_ger_campos['proyectos'] = "on";
