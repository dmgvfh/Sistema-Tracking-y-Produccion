...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function NM_export_is_active()
   {
         ...
         $this->look_is_active = str_replace('<', '&lt;', $this->look_is_active);
         $this->look_is_active = str_replace('>', '&gt;', $this->look_is_active);
         $this->Texto_tag .= "<td>" . $this->look_is_active . "</td>\r\n";
   }
   //----- perfil
   function NM_export_perfil()
   {
         $this->perfil = NM_charset_to_utf8($this->perfil);
         $this->perfil = str_replace('<', '&lt;', $this->perfil);
         $this->perfil = str_replace('>', '&gt;', $this->perfil);
         $this->Texto_tag .= "<td>" . $this->perfil . "</td>\r\n";
   }
   //----- proyectos
   function NM_export_proyectos()
   {
         $this->proyectos = NM_charset_to_utf8($this->proyectos);
         $this->proyectos = str_replace('<', '&lt;', $this->proyectos);
         $this->proyectos = str_replace('>', '&gt;', $this->proyectos);
         $this->Texto_tag .= "<td>" . $this->proyectos . "</td>\r\n";
   }
...
<HEAD>
 <TITLE>Registro de Usuarios :: RTF</TITLE>
