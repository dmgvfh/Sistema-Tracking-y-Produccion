...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_retrieve_pswd']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['app_retrieve_pswd']['opc_ant'] = "inicio";
      }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_retrieve_pswd']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_retrieve_pswd']['label'] = "" . $this->Ini->Nm_lang['lang_retrieve_pswd'] . "";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['opc_ant'] : "";
      } 
...
if($this->rs === FALSE || count($this->rs) == 0)
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_app_retrieve_pswd';
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['ordem_ord'] == " desc") {
