...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>calendar_appointments_adm/calendar_appointments_adm_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("calendar_appointments_adm_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('calendar_appointments_adm_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['calendar_appointments_adm']['error_buffer']) && '' != $_SESSION['scriptcase']['calendar_appointments_adm']['error_buffer'])
{
    echo $_SESSION['scriptcase']['calendar_appointments_adm']['error_buffer'];
}
...
<?php
 include_once("calendar_appointments_adm_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="calendar_appointments_adm_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['calendar_appointments_adm_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendar_appointments_adm_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['btn_customer']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['btn_customer']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['btn_customer']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['btn_customer']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['btn_customer'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['btn_service_details']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['btn_service_details']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['btn_service_details']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['btn_service_details']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['btn_service_details'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_usuario_line" id="hidden_field_data_id_usuario" style="<?php echo $sStyleHidden_id_usuario; ?>"> <span class="scFormLabelOddFormat css_id_usuario_label" style=""><span id="id_label_id_usuario"><?php echo $this->nm_new_label['id_usuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['php_cmp_required']['id_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['php_cmp_required']['id_usuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_appointment_start_date_line" id="hidden_field_data_appointment_start_date" style="<?php echo $sStyleHidden_appointment_start_date; ?>"> <span class="scFormLabelOddFormat css_appointment_start_date_label" style=""><span id="id_label_appointment_start_date"><?php echo $this->nm_new_label['appointment_start_date']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['php_cmp_required']['appointment_start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['php_cmp_required']['appointment_start_date'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_appointment_end_date_line" id="hidden_field_data_appointment_end_date" style="<?php echo $sStyleHidden_appointment_end_date; ?>"> <span class="scFormLabelOddFormat css_appointment_end_date_label" style=""><span id="id_label_appointment_end_date"><?php echo $this->nm_new_label['appointment_end_date']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_appointment_period_line" id="hidden_field_data_appointment_period" style="<?php echo $sStyleHidden_appointment_period; ?>"> <span class="scFormLabelOddFormat css_appointment_period_label" style=""><span id="id_label_appointment_period"><?php echo $this->nm_new_label['appointment_period']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_period'][] = 'D'; ?>
 <option  value="W" <?php  if ($this->appointment_period == "W") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_weekly']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_period'][] = 'W'; ?>
 <option  value="A" <?php  if ($this->appointment_period == "A") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_annual']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_period'][] = 'A'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_appointment_recurrent_line" id="hidden_field_data_appointment_recurrent" style="<?php echo $sStyleHidden_appointment_recurrent; ?>"> <span class="scFormLabelOddFormat css_appointment_recurrent_label" style=""><span id="id_label_appointment_recurrent"><?php echo $this->nm_new_label['appointment_recurrent']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_recurrent'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_recurrent'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("calendar_appointments_adm_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("calendar_appointments_adm_mob");
 parent.scAjaxDetailHeight("calendar_appointments_adm_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
