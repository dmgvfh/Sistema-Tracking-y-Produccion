  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_appointments_adm" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_appointments_adm_form();
	}
...
?>
  ...
  // ---------- Validate id_usuario
  function do_ajax_calendar_appointments_adm_validate_id_usuario()
  {
    var nomeCampo_id_usuario = "id_usuario";
    var var_id_usuario = scAjaxGetFieldSelect(nomeCampo_id_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_id_usuario(var_id_usuario, var_script_case_init, do_ajax_calendar_appointments_adm_validate_id_usuario_cb);
  } // do_ajax_calendar_appointments_adm_validate_id_usuario

  function do_ajax_calendar_appointments_adm_validate_id_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_id_usuario_cb

  // ---------- Validate current_status_id
  function do_ajax_calendar_appointments_adm_validate_current_status_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_current_status_id(var_current_status_id, var_script_case_init, do_ajax_calendar_appointments_adm_validate_current_status_id_cb);
  } // do_ajax_calendar_appointments_adm_validate_current_status_id

  function do_ajax_calendar_appointments_adm_validate_current_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_current_status_id_cb

  // ---------- Validate id_proyecto
  function do_ajax_calendar_appointments_adm_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_calendar_appointments_adm_validate_id_proyecto_cb);
  } // do_ajax_calendar_appointments_adm_validate_id_proyecto

  function do_ajax_calendar_appointments_adm_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_id_proyecto_cb

  // ---------- Validate id_actividad
  function do_ajax_calendar_appointments_adm_validate_id_actividad()
  {
    var nomeCampo_id_actividad = "id_actividad";
    var var_id_actividad = scAjaxGetFieldSelect(nomeCampo_id_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_id_actividad(var_id_actividad, var_script_case_init, do_ajax_calendar_appointments_adm_validate_id_actividad_cb);
  } // do_ajax_calendar_appointments_adm_validate_id_actividad

  function do_ajax_calendar_appointments_adm_validate_id_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_id_actividad_cb

  // ---------- Validate appointment_start_date
  function do_ajax_calendar_appointments_adm_validate_appointment_start_date()
  {
    ...
    setTimeout(function() {
      var var_appointment_start_date = scAjaxGetFieldText(nomeCampo_appointment_start_date);
      x_ajax_calendar_appointments_adm_validate_appointment_start_date(var_appointment_start_date, var_script_case_init, do_ajax_calendar_appointments_adm_validate_appointment_start_date_cb);
    }, 200);
  } // do_ajax_calendar_appointments_adm_validate_appointment_start_date

  function do_ajax_calendar_appointments_adm_validate_appointment_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_appointment_start_date_cb

  // ---------- Validate appointment_start_time
  function do_ajax_calendar_appointments_adm_validate_appointment_start_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_appointment_start_time(var_appointment_start_time, var_script_case_init, do_ajax_calendar_appointments_adm_validate_appointment_start_time_cb);
  } // do_ajax_calendar_appointments_adm_validate_appointment_start_time

  function do_ajax_calendar_appointments_adm_validate_appointment_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_appointment_start_time_cb

  // ---------- Validate appointment_end_date
  function do_ajax_calendar_appointments_adm_validate_appointment_end_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_appointment_end_date(var_appointment_end_date, var_script_case_init, do_ajax_calendar_appointments_adm_validate_appointment_end_date_cb);
  } // do_ajax_calendar_appointments_adm_validate_appointment_end_date

  function do_ajax_calendar_appointments_adm_validate_appointment_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_appointment_end_date_cb

  // ---------- Validate appointment_end_time
  function do_ajax_calendar_appointments_adm_validate_appointment_end_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_appointment_end_time(var_appointment_end_time, var_script_case_init, do_ajax_calendar_appointments_adm_validate_appointment_end_time_cb);
  } // do_ajax_calendar_appointments_adm_validate_appointment_end_time

  function do_ajax_calendar_appointments_adm_validate_appointment_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_appointment_end_time_cb

  // ---------- Validate appointment_period
  function do_ajax_calendar_appointments_adm_validate_appointment_period()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_appointment_period(var_appointment_period, var_script_case_init, do_ajax_calendar_appointments_adm_validate_appointment_period_cb);
  } // do_ajax_calendar_appointments_adm_validate_appointment_period

  function do_ajax_calendar_appointments_adm_validate_appointment_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_appointment_period_cb

  // ---------- Validate appointment_recurrent
  function do_ajax_calendar_appointments_adm_validate_appointment_recurrent()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_appointment_recurrent(var_appointment_recurrent, var_script_case_init, do_ajax_calendar_appointments_adm_validate_appointment_recurrent_cb);
  } // do_ajax_calendar_appointments_adm_validate_appointment_recurrent

  function do_ajax_calendar_appointments_adm_validate_appointment_recurrent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_appointment_recurrent_cb

  // ---------- Validate intervalo
  function do_ajax_calendar_appointments_adm_validate_intervalo()
  {
    var nomeCampo_intervalo = "intervalo";
    var var_intervalo = scAjaxGetFieldText(nomeCampo_intervalo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_validate_intervalo(var_intervalo, var_script_case_init, do_ajax_calendar_appointments_adm_validate_intervalo_cb);
  } // do_ajax_calendar_appointments_adm_validate_intervalo

  function do_ajax_calendar_appointments_adm_validate_intervalo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_validate_intervalo_cb

  // ---------- Event onchange additional_charges
  function do_ajax_calendar_appointments_adm_event_additional_charges_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_appointments_adm_event_additional_charges_onchange(var_script_case_init, do_ajax_calendar_appointments_adm_event_additional_charges_onchange_cb);
  } // do_ajax_calendar_appointments_adm_event_additional_charges_onchange

  function do_ajax_calendar_appointments_adm_event_additional_charges_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendar_appointments_adm_event_additional_charges_onchange_cb_after_alert);
  } // do_ajax_calendar_appointments_adm_event_additional_charges_onchange_cb
  function do_ajax_calendar_appointments_adm_event_additional_charges_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendar_appointments_adm_event_additional_charges_onchange_cb_after_alert

  // ---------- Event onchange discount
  function do_ajax_calendar_appointments_adm_event_discount_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_appointments_adm_event_discount_onchange(var_script_case_init, do_ajax_calendar_appointments_adm_event_discount_onchange_cb);
  } // do_ajax_calendar_appointments_adm_event_discount_onchange

  function do_ajax_calendar_appointments_adm_event_discount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendar_appointments_adm_event_discount_onchange_cb_after_alert);
  } // do_ajax_calendar_appointments_adm_event_discount_onchange_cb
  function do_ajax_calendar_appointments_adm_event_discount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendar_appointments_adm_event_discount_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_calendar_appointments_adm_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_appointments_adm_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_calendar_appointments_adm_submit_form(var_id_usuario, var_current_status_id, var_id_proyecto, var_id_actividad, var_appointment_start_date, var_appointment_start_time, var_appointment_end_date, var_appointment_end_time, var_appointment_period, var_appointment_recurrent, var_intervalo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_appointments_adm_submit_form_cb);
  } // do_ajax_calendar_appointments_adm_submit_form

  function do_ajax_calendar_appointments_adm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_appointments_adm_submit_form_cb_after_alert);
  } // do_ajax_calendar_appointments_adm_submit_form_cb
  function do_ajax_calendar_appointments_adm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_appointments_adm_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_appointments_adm_navigate_form()
  {
    perform_ajax_calendar_appointments_adm_navigate_form();
  }

  function perform_ajax_calendar_appointments_adm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_calendar_appointments_adm_navigate_form(var_appointments_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_appointments_adm_navigate_form_cb);
  } // do_ajax_calendar_appointments_adm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_appointments_adm_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_appointments_adm_navigate_form_cb_after_alert);
  } // do_ajax_calendar_appointments_adm_navigate_form_cb
  function do_ajax_calendar_appointments_adm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_appointments_adm_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_appointments_adm_navigate_form_cb_after_alert

  function sc_hide_calendar_appointments_adm_form()
  {
