<?php
//
class calendar_appointments_adm_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      {
          if (isset($this->NM_ajax_info['param']['appointment_end_date']))
          {
              $this->appointment_end_date = $this->NM_ajax_info['param']['appointment_end_date'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['appointment_period']))
          {
              $this->appointment_period = $this->NM_ajax_info['param']['appointment_period'];
          }
          if (isset($this->NM_ajax_info['param']['appointment_recurrent']))
          {
              $this->appointment_recurrent = $this->NM_ajax_info['param']['appointment_recurrent'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_calendar_appointments_adm_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->id_proyecto)) 
          {
              $_SESSION['id_proyecto'] = $this->id_proyecto;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_appointments_adm_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['calendar_appointments_adm_mob']['upload_field_info'] = array();

      $this->Ini->Init_apl_lig = array();
      $this->List_apl_lig = array('grid_customers_address'=>array('type'=>'cons', 'lab'=>'grid_customers_address', 'hint'=>'', 'img_on'=>'', 'img_off'=>''),'tabs_appointments'=>array('type'=>'aba', 'lab'=>'tabs_appointments', 'hint'=>'', 'img_on'=>'', 'img_off'=>''));
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_modal']))
      {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_appointments_adm_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_appointments_adm_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_appointments_adm_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_appointments_adm_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_appointments_adm_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_appointments_adm_mob']['label'] = "" . $this->Ini->Nm_lang['lang_appointment_info'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "calendar_appointments_adm_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (in_array($this->nmgp_opcao, array('calendar', 'calendar_fetch', 'calendar_drop', 'calendar_resize', 'calendar_print')))
      {
          $this->Db->debug = false;
      }
      ...
      $this->arr_buttons['btn_customer']['hint']             = "";
      $this->arr_buttons['btn_customer']['type']             = "button";
      $this->arr_buttons['btn_customer']['value']            = "" . $this->Ini->Nm_lang['lang_customer_info'] . "";
      $this->arr_buttons['btn_customer']['display']          = "only_text";
      $this->arr_buttons['btn_customer']['display_position'] = "text_right";
      $this->arr_buttons['btn_customer']['style']            = "default";
      $this->arr_buttons['btn_customer']['image']            = "";

      $this->arr_buttons['btn_service_details']['hint']             = "";
      $this->arr_buttons['btn_service_details']['type']             = "button";
      $this->arr_buttons['btn_service_details']['value']            = "" . $this->Ini->Nm_lang['lang_appointment_info'] . "";
      $this->arr_buttons['btn_service_details']['display']          = "only_text";
      $this->arr_buttons['btn_service_details']['display_position'] = "text_right";
      $this->arr_buttons['btn_service_details']['style']            = "default";
      $this->arr_buttons['btn_service_details']['image']            = "";


      $_SESSION['scriptcase']['error_icon']['calendar_appointments_adm_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_appointments_adm_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['btn_customer'] = "on";
      $this->nmgp_botoes['btn_service_details'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_orig'] = " where (( appointments.current_status_id=1 or appointments.current_status_id=2) and id_proyecto in (" . $_SESSION['id_proyecto'] . "))";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_pesq'] = " where (( appointments.current_status_id=1 or appointments.current_status_id=2) and id_proyecto in (" . $_SESSION['id_proyecto'] . "))";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_adm_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_appointments_adm_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_appointments_adm_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dados_form'];
          if (!isset($this->appointments_id)){$this->appointments_id = $this->nmgp_dados_form['appointments_id'];} 
          if (!isset($this->staff_id)){$this->staff_id = $this->nmgp_dados_form['staff_id'];} 
          if (!isset($this->customers_id)){$this->customers_id = $this->nmgp_dados_form['customers_id'];} 
          if (!isset($this->price)){$this->price = $this->nmgp_dados_form['price'];} 
          if (!isset($this->additional_charges)){$this->additional_charges = $this->nmgp_dados_form['additional_charges'];} 
          if (!isset($this->discount)){$this->discount = $this->nmgp_dados_form['discount'];} 
          if (!isset($this->total_price)){$this->total_price = $this->nmgp_dados_form['total_price'];} 
          if (!isset($this->appointment_rating)){$this->appointment_rating = $this->nmgp_dados_form['appointment_rating'];} 
          if (!isset($this->intervalo_seg)){$this->intervalo_seg = $this->nmgp_dados_form['intervalo_seg'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_appointments_adm_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_appointments_adm/calendar_appointments_adm_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_appointments_adm_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_appointments_adm_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_appointments_adm_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_appointments_adm/calendar_appointments_adm_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_appointments_adm_mob_erro.class.php"); 
      }
      $this->Erro      = new calendar_appointments_adm_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_adm_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['btn_customer'] = "off";
          $this->nmgp_botoes['btn_service_details'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['btn_customer'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['botoes']['btn_customer'];
          $this->nmgp_botoes['btn_service_details'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['botoes']['btn_service_details'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      {
          $_SESSION['scriptcase']['calendar_appointments_adm_mob']['contr_erro'] = 'on';
if (!isset($this->sc_temp_id_proyecto)) {$this->sc_temp_id_proyecto = (isset($_SESSION['id_proyecto'])) ? $_SESSION['id_proyecto'] : "";}
  $this->sc_temp_id_proyecto=str_replace(";",",",$this->sc_temp_id_proyecto);
...
window.addEventListener('DOMContentLoaded', function () {
    $('#calendar').fullCalendar({
      ...
      views: {
		...
		week: {titleFormat: 'MMM D YYYY', columnFormat: 'dddd', timeFormat: 'H:mm',slotLabelFormat: ['ddd M/D','H:mm'],},
...
$_SESSION['scriptcase']['calendar_appointments_adm_mob']['contr_erro'] = 'off'; 
      }
      ...
      if (isset($this->appointment_recurrent)) { $this->nm_limpa_alfa($this->appointment_recurrent); }
      if (isset($this->appointment_period)) { $this->nm_limpa_alfa($this->appointment_period); }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- additional_charges
      $this->field_config['additional_charges']               = array();
      $this->field_config['additional_charges']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['additional_charges']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['additional_charges']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['additional_charges']['symbol_mon'] = '';
      $this->field_config['additional_charges']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['additional_charges']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- discount
      ...
      //-- total_price
      $this->field_config['total_price']               = array();
      $this->field_config['total_price']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['total_price']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['total_price']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['total_price']['symbol_mon'] = '';
      $this->field_config['total_price']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['total_price']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- appointment_rating
      $this->field_config['appointment_rating']               = array();
      $this->field_config['appointment_rating']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['appointment_rating']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['appointment_rating']['symbol_dec'] = '';
      $this->field_config['appointment_rating']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['appointment_rating']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- intervalo_seg
      $this->field_config['intervalo_seg']               = array();
      $this->field_config['intervalo_seg']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['intervalo_seg']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['intervalo_seg']['symbol_dec'] = '';
      $this->field_config['intervalo_seg']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['intervalo_seg']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_appointment_end_date' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'appointment_end_date');
          }
          ...
          if ('validate_appointment_period' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'appointment_period');
          }
          if ('validate_appointment_recurrent' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'appointment_recurrent');
          }
          if ('validate_intervalo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'intervalo');
          }
          calendar_appointments_adm_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_additional_charges_onchange' == $this->NM_ajax_opcao)
          {
              $this->additional_charges_onChange();
          }
          if ('event_discount_onchange' == $this->NM_ajax_opcao)
          {
              $this->discount_onChange();
          }
          calendar_appointments_adm_mob_pack_ajax_response();
          exit;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dados_select']['current_status_id']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dados_select']['current_status_id'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_appointments_adm_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="calendar_appointments_adm_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_appointments_adm_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="calendar_appointments_adm_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'appointments_id':
               ...
               break;
           case 'staff_id':
               return "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . "";
               break;
           case 'customers_id':
               return "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . "";
               break;
           case 'price':
               return "" . $this->Ini->Nm_lang['lang_appointments_fld_price'] . "";
               break;
           case 'additional_charges':
               return "" . $this->Ini->Nm_lang['lang_appointments_fld_additional_charges'] . "";
               break;
           case 'discount':
               return "" . $this->Ini->Nm_lang['lang_appointments_fld_discount'] . "";
               break;
           case 'total_price':
               return "" . $this->Ini->Nm_lang['lang_appointments_fld_total_price'] . "";
               break;
           case 'appointment_rating':
               return "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_rating'] . "";
               break;
           case 'intervalo_seg':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_appointments_adm_mob']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_appointments_adm_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_appointments_adm_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_appointments_adm_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['bypass_required_time']['appointment_start_time'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['bypass_required_time']['appointment_end_time'] = true;
      }
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "id_usuario";
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'appointment_end_date' == $filtro)) || (is_array($filtro) && in_array('appointment_end_date', $filtro)))
        $this->ValidateField_appointment_end_date($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "appointment_end_date";
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'appointment_period' == $filtro)) || (is_array($filtro) && in_array('appointment_period', $filtro)))
        $this->ValidateField_appointment_period($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "appointment_period";

      if ((!is_array($filtro) && ('' == $filtro || 'appointment_recurrent' == $filtro)) || (is_array($filtro) && in_array('appointment_recurrent', $filtro)))
        $this->ValidateField_appointment_recurrent($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "appointment_recurrent";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['bypass_required_time']['appointment_start_time'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['bypass_required_time']['appointment_end_time'] = false;
...
//---
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->id_usuario == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['php_cmp_required']['id_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['php_cmp_required']['id_usuario'] == "on"))
      {
          $hasError = true;
          ...
          $Campos_Erros['id_usuario'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['id_usuario'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->id_usuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_usuario']) && !in_array($this->id_usuario, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_usuario']))
          {
              $hasError = true;
    ...
    function ValidateField_current_status_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->current_status_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_current_status_id']) && !in_array($this->current_status_id, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_current_status_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_proyecto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_proyecto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_proyecto']) && !in_array($this->id_proyecto, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_proyecto']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_actividad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_actividad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_actividad']) && !in_array($this->id_actividad, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_actividad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_appointment_start_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['php_cmp_required']['appointment_start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['php_cmp_required']['appointment_start_date'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_appointment_end_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          $guarda_datahora = $this->field_config['appointment_end_date']['date_format']; 
          if (false !== strpos($guarda_datahora, ';')) $this->field_config['appointment_end_date']['date_format'] = substr($guarda_datahora, 0, strpos($guarda_datahora, ';'));
          $Format_Data = $this->field_config['appointment_end_date']['date_format']; 
          nm_limpa_data($Format_Data, $this->field_config['appointment_end_date']['date_sep']) ; 
          if (trim($this->appointment_end_date) != "")  
          { 
              if ($teste_validade->Data($this->appointment_end_date, $Format_Data, $trab_dt_min, $trab_dt_max) == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Fecha Término; " ; 
                  if (!isset($Campos_Erros['appointment_end_date']))
                  {
                      $Campos_Erros['appointment_end_date'] = array();
                  }
                  $Campos_Erros['appointment_end_date'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['appointment_end_date']) || !is_array($this->NM_ajax_info['errList']['appointment_end_date']))
                  {
                      $this->NM_ajax_info['errList']['appointment_end_date'] = array();
                  }
                  $this->NM_ajax_info['errList']['appointment_end_date'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
          $this->field_config['appointment_end_date']['date_format'] = $guarda_datahora; 
       } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'appointment_end_date';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_appointment_end_date
    ...
    function ValidateField_appointment_period(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->appointment_period == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'appointment_period';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_appointment_period

    function ValidateField_appointment_recurrent(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->appointment_recurrent == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'appointment_recurrent';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_appointment_recurrent
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['appointment_end_date'] = (strlen(trim($this->appointment_end_date)) > 19) ? str_replace(".", ":", $this->appointment_end_date) : trim($this->appointment_end_date);
    ...
    $this->nmgp_dados_form['staff_id'] = $this->staff_id;
    $this->nmgp_dados_form['customers_id'] = $this->customers_id;
    $this->nmgp_dados_form['price'] = $this->price;
    $this->nmgp_dados_form['additional_charges'] = $this->additional_charges;
    $this->nmgp_dados_form['discount'] = $this->discount;
    $this->nmgp_dados_form['total_price'] = $this->total_price;
    $this->nmgp_dados_form['appointment_rating'] = $this->appointment_rating;
    $this->nmgp_dados_form['intervalo_seg'] = $this->intervalo_seg;
    $this->nmgp_dados_form['__calend_all_day__'] = $this->__calend_all_day__;
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['price'] = $this->price;
      ...
      $this->Before_unformat['additional_charges'] = $this->additional_charges;
      if (!empty($this->field_config['additional_charges']['symbol_dec']))
      {
         $this->sc_remove_currency($this->additional_charges, $this->field_config['additional_charges']['symbol_dec'], $this->field_config['additional_charges']['symbol_grp'], $this->field_config['additional_charges']['symbol_mon']);
         nm_limpa_valor($this->additional_charges, $this->field_config['additional_charges']['symbol_dec'], $this->field_config['additional_charges']['symbol_grp']);
      }
      ...
      $this->Before_unformat['total_price'] = $this->total_price;
      if (!empty($this->field_config['total_price']['symbol_dec']))
      {
         $this->sc_remove_currency($this->total_price, $this->field_config['total_price']['symbol_dec'], $this->field_config['total_price']['symbol_grp'], $this->field_config['total_price']['symbol_mon']);
         nm_limpa_valor($this->total_price, $this->field_config['total_price']['symbol_dec'], $this->field_config['total_price']['symbol_grp']);
      }
      $this->Before_unformat['appointment_rating'] = $this->appointment_rating;
      nm_limpa_numero($this->appointment_rating, $this->field_config['appointment_rating']['symbol_grp']) ; 
      $this->Before_unformat['intervalo_seg'] = $this->intervalo_seg;
      nm_limpa_numero($this->intervalo_seg, $this->field_config['intervalo_seg']['symbol_grp']) ; 
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "additional_charges")
      {
          if (!empty($this->field_config['additional_charges']['symbol_dec']))
          {
             $this->sc_remove_currency($this->additional_charges, $this->field_config['additional_charges']['symbol_dec'], $this->field_config['additional_charges']['symbol_grp'], $this->field_config['additional_charges']['symbol_mon']);
      ...
      if ($Nome_Campo == "appointment_rating")
      {
          nm_limpa_numero($this->appointment_rating, $this->field_config['appointment_rating']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "intervalo_seg")
      {
          nm_limpa_numero($this->intervalo_seg, $this->field_config['intervalo_seg']['symbol_grp']) ; 
      }
   }
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ((!empty($this->appointment_end_date) && 'null' != $this->appointment_end_date) || (!empty($format_fields) && isset($format_fields['appointment_end_date'])))
      {
          nm_volta_data($this->appointment_end_date, $this->field_config['appointment_end_date']['date_format']) ; 
          nmgp_Form_Datas($this->appointment_end_date, $this->field_config['appointment_end_date']['date_format'], $this->field_config['appointment_end_date']['date_sep']) ;  
      }
      elseif ('null' == $this->appointment_end_date || '' == $this->appointment_end_date)
      {
...
//-- 
   function nm_converte_datas($use_null = true, $bForce = false)
   {
      ...
      $guarda_format_hora = $this->field_config['appointment_end_date']['date_format'];
      if ($this->appointment_end_date != "")  
      { 
          nm_conv_data($this->appointment_end_date, $this->field_config['appointment_end_date']['date_format']) ; 
          $this->appointment_end_date_hora = "00:00:00:000" ; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->appointment_end_date_hora = substr($this->appointment_end_date_hora, 0, -4);
          }
      } 
      if ($this->appointment_end_date == "" && $use_null)  
      { 
          $this->appointment_end_date = "null" ; 
      } 
      $this->field_config['appointment_end_date']['date_format'] = $guarda_format_hora;
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_appointment_end_date();
          $this->ajax_return_values_appointment_end_time();
          $this->ajax_return_values_appointment_period();
          $this->ajax_return_values_appointment_recurrent();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['appointments_id']['keyVal'] = calendar_appointments_adm_mob_pack_protect_string($this->nmgp_dados_form['appointments_id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_usuario']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_usuario'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_usuario']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_usuario'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(calendar_appointments_adm_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_appointments_adm_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_usuario'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_usuario']['valList'][$i] = calendar_appointments_adm_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_current_status_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_current_status_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_current_status_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_current_status_id'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_current_status_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['current_status_id']['valList'][$i] = calendar_appointments_adm_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_proyecto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_proyecto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_proyecto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_proyecto'] = array(); 
}
$aLookup[] = array(calendar_appointments_adm_mob_pack_protect_string('') => str_replace('<', '&lt;',calendar_appointments_adm_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_proyecto'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   $nm_comando = "SELECT    proyectos.id, proyectos.nombre_proyecto FROM   usuarios_proyectos   INNER JOIN proyectos ON (usuarios_proyectos.id_proyecto = proyectos.id) WHERE   usuarios_proyectos.id_usuario=" . $_SESSION['glo_staff_id'] . "";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_proyecto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_proyecto']['valList'][$i] = calendar_appointments_adm_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_actividad']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_actividad'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_actividad']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_actividad'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   $nm_comando = "SELECT id, nombre_actividad, id  FROM tipo_actividades  ORDER BY nombre_actividad";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_id_actividad'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_actividad']['valList'][$i] = calendar_appointments_adm_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_appointment_start_time($bForce = false)
   {
          ...
          //----- appointment_end_date
   function ajax_return_values_appointment_end_date($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("appointment_end_date", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->appointment_end_date);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['appointment_end_date'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_appointment_end_time($bForce = false)
   {
          ...
          //----- appointment_period
   function ajax_return_values_appointment_period($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("appointment_period", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->appointment_period);
              $aLookup = array();
              $this->_tmp_lookup_appointment_period = $this->appointment_period;

$aLookup[] = array(calendar_appointments_adm_mob_pack_protect_string('D') => str_replace('<', '&lt;',calendar_appointments_adm_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_daily'] . "")));
$aLookup[] = array(calendar_appointments_adm_mob_pack_protect_string('W') => str_replace('<', '&lt;',calendar_appointments_adm_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_weekly'] . "")));
$aLookup[] = array(calendar_appointments_adm_mob_pack_protect_string('A') => str_replace('<', '&lt;',calendar_appointments_adm_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_annual'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_period'][] = 'D';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_period'][] = 'W';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_period'][] = 'A';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"appointment_period\"";
          if (isset($this->NM_ajax_info['select_html']['appointment_period']) && !empty($this->NM_ajax_info['select_html']['appointment_period']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['appointment_period']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->appointment_period == $sValue)
                  {
                      $this->_tmp_lookup_appointment_period = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['appointment_period'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['appointment_period']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['appointment_period']['valList'][$i] = calendar_appointments_adm_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['appointment_period']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['appointment_period']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['appointment_period']['labList'] = $aLabel;
          }
   }

          //----- appointment_recurrent
   function ajax_return_values_appointment_recurrent($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("appointment_recurrent", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->appointment_recurrent);
              $aLookup = array();
              $this->_tmp_lookup_appointment_recurrent = $this->appointment_recurrent;

$aLookup[] = array(calendar_appointments_adm_mob_pack_protect_string('Y') => str_replace('<', '&lt;',calendar_appointments_adm_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_yes'] . "")));
$aLookup[] = array(calendar_appointments_adm_mob_pack_protect_string('N') => str_replace('<', '&lt;',calendar_appointments_adm_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_no'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_recurrent'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['Lookup_appointment_recurrent'][] = 'N';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"appointment_recurrent\"";
          if (isset($this->NM_ajax_info['select_html']['appointment_recurrent']) && !empty($this->NM_ajax_info['select_html']['appointment_recurrent']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['appointment_recurrent']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->appointment_recurrent == $sValue)
                  {
                      $this->_tmp_lookup_appointment_recurrent = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['appointment_recurrent'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['appointment_recurrent']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['appointment_recurrent']['valList'][$i] = calendar_appointments_adm_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['appointment_recurrent']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['appointment_recurrent']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['appointment_recurrent']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_appointments_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_btn_customer_var_customer_id'] = $this->form_encode_input($this->nmgp_dados_form['customers_id']);
       $this->NM_ajax_info['btnVars']['var_btn_btn_service_details_var_appointment_id'] = $this->form_encode_input($this->nmgp_dados_form['appointments_id']);
       $this->NM_ajax_info['btnVars']['var_btn_btn_service_details_var_cur_status'] = $this->form_encode_input($this->nmgp_dados_form['current_status_id']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
if($this->current_status_id  == 1 or $this->current_status_id  == 4){
...
//
   ...
   { 
      ...
      $this->additional_charges = str_replace($sc_parm1, $sc_parm2, $this->additional_charges); 
      $this->discount = str_replace($sc_parm1, $sc_parm2, $this->discount); 
      $this->total_price = str_replace($sc_parm1, $sc_parm2, $this->total_price); 
   } 
   function nm_poe_aspas_decimal() 
   { 
      $this->intervalo = "'" . $this->intervalo . "'";
      $this->price = "'" . $this->price . "'";
      $this->additional_charges = "'" . $this->additional_charges . "'";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  $differences =$this->nm_data->Dif_Horas($this->appointment_end_time , "hh:ii:ss", $this->appointment_start_time , "hh:ii:ss");

$this->intervalo_seg =$differences[0]*3600 + $differences[1]*60 +$differences[2];
$this->intervalo =($this->intervalo_seg /3600);
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
...
$_SESSION['scriptcase']['calendar_appointments_adm_mob']['contr_erro'] = 'off'; 
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_calendar_appointments_adm_mob';
...
$_SESSION['scriptcase']['calendar_appointments_adm_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['staff_id'] = $this->staff_id;
      $NM_val_form['customers_id'] = $this->customers_id;
      $NM_val_form['price'] = $this->price;
      $NM_val_form['additional_charges'] = $this->additional_charges;
      $NM_val_form['discount'] = $this->discount;
      $NM_val_form['total_price'] = $this->total_price;
      $NM_val_form['appointment_rating'] = $this->appointment_rating;
      $NM_val_form['intervalo_seg'] = $this->intervalo_seg;
      ...
      if ($this->staff_id === "" || is_null($this->staff_id))  
      { 
          $this->staff_id = 0;
          $this->sc_force_zero[] = 'staff_id';
      } 
      if ($this->customers_id === "" || is_null($this->customers_id))  
      { 
          $this->customers_id = 0;
          $this->sc_force_zero[] = 'customers_id';
      } 
      if ($this->price === "" || is_null($this->price))  
      { 
          $this->price = 0;
          $this->sc_force_zero[] = 'price';
      } 
      if ($this->additional_charges === "" || is_null($this->additional_charges))  
      { 
          $this->additional_charges = 0;
          $this->sc_force_zero[] = 'additional_charges';
      } 
      ...
      if ($this->total_price === "" || is_null($this->total_price))  
      { 
          $this->total_price = 0;
          $this->sc_force_zero[] = 'total_price';
      } 
      ...
      if ($this->appointment_rating === "" || is_null($this->appointment_rating))  
      { 
          $this->appointment_rating = 0;
          $this->sc_force_zero[] = 'appointment_rating';
      } 
      if ($this->intervalo === "" || is_null($this->intervalo))  
      { 
          $this->intervalo = 0;
      ...
      if ($this->intervalo_seg === "" || is_null($this->intervalo_seg))  
      { 
          $this->intervalo_seg = 0;
          $this->sc_force_zero[] = 'intervalo_seg';
      } 
      $nm_bases_lob_geral = array_merge($this->Ini->nm_bases_mysql, $this->Ini->nm_bases_sqlite);
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "id_proyecto = $this->id_proyecto, id_actividad = $this->id_actividad, appointment_start_date = " . $this->Ini->date_delim . $this->appointment_start_date . $this->Ini->date_delim1 . ", appointment_start_time = " . $this->Ini->date_delim . $this->appointment_start_time . $this->Ini->date_delim1 . ", appointment_end_date = " . $this->Ini->date_delim . $this->appointment_end_date . $this->Ini->date_delim1 . ", appointment_end_time = " . $this->Ini->date_delim . $this->appointment_end_time . $this->Ini->date_delim1 . ", current_status_id = $this->current_status_id, appointment_recurrent = '$this->appointment_recurrent', appointment_period = '$this->appointment_period'"; 
              } 
              else 
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['staff_id']) && $NM_val_form['staff_id'] != $this->nmgp_dados_select['staff_id']) 
              { 
                  $SC_fields_update[] = "staff_id = $this->staff_id"; 
              } 
              if (isset($NM_val_form['customers_id']) && $NM_val_form['customers_id'] != $this->nmgp_dados_select['customers_id']) 
              { 
                  $SC_fields_update[] = "customers_id = $this->customers_id"; 
              } 
              if (isset($NM_val_form['price']) && $NM_val_form['price'] != $this->nmgp_dados_select['price']) 
              { 
                  $SC_fields_update[] = "price = $this->price"; 
              } 
              if (isset($NM_val_form['additional_charges']) && $NM_val_form['additional_charges'] != $this->nmgp_dados_select['additional_charges']) 
              { 
                  $SC_fields_update[] = "additional_charges = $this->additional_charges"; 
              } 
              if (isset($NM_val_form['discount']) && $NM_val_form['discount'] != $this->nmgp_dados_select['discount']) 
              { 
                  $SC_fields_update[] = "discount = $this->discount"; 
              } 
              if (isset($NM_val_form['total_price']) && $NM_val_form['total_price'] != $this->nmgp_dados_select['total_price']) 
              { 
                  $SC_fields_update[] = "total_price = $this->total_price"; 
              } 
              if (isset($NM_val_form['appointment_rating']) && $NM_val_form['appointment_rating'] != $this->nmgp_dados_select['appointment_rating']) 
              { 
                  $SC_fields_update[] = "appointment_rating = $this->appointment_rating"; 
              } 
              ...
              if (isset($NM_val_form['intervalo_seg']) && $NM_val_form['intervalo_seg'] != $this->nmgp_dados_select['intervalo_seg']) 
              { 
                  $SC_fields_update[] = "intervalo_seg = $this->intervalo_seg"; 
              } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['appointment_recurrent'])) { $this->appointment_recurrent = $NM_val_form['appointment_recurrent']; }
              elseif (isset($this->appointment_recurrent)) { $this->nm_limpa_alfa($this->appointment_recurrent); }
              if     (isset($NM_val_form) && isset($NM_val_form['appointment_period'])) { $this->appointment_period = $NM_val_form['appointment_period']; }
              elseif (isset($this->appointment_period)) { $this->nm_limpa_alfa($this->appointment_period); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('id_usuario', 'current_status_id', 'id_proyecto', 'id_actividad', 'appointment_start_date', 'appointment_start_time', 'appointment_end_date', 'appointment_end_time', 'appointment_period', 'appointment_recurrent', 'intervalo'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "id_proyecto, id_usuario, id_actividad, staff_id, customers_id, price, additional_charges, discount, total_price, appointment_start_date, appointment_start_time, appointment_end_date, appointment_end_time, current_status_id, appointment_recurrent, appointment_period, appointment_rating, intervalo, intervalo_seg) VALUES (" . $NM_seq_auto . "$this->id_proyecto, $this->id_usuario, $this->id_actividad, $this->staff_id, $this->customers_id, $this->price, $this->additional_charges, $this->discount, $this->total_price, " . $this->Ini->date_delim . $this->appointment_start_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->appointment_start_time . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->appointment_end_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->appointment_end_time . $this->Ini->date_delim1 . ", $this->current_status_id, '$this->appointment_recurrent', '$this->appointment_period', $this->appointment_rating, $this->intervalo, $this->intervalo_seg)"; 
              }
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['calendar_appointments_adm_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['parms'] = "appointments_id?#?$this->appointments_id?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['parms'] = ""; 
          $nmgp_select = "SELECT appointments_id, id_proyecto, id_usuario, id_actividad, staff_id, customers_id, price, additional_charges, discount, total_price, appointment_start_date, appointment_start_time, appointment_end_date, appointment_end_time, current_status_id, appointment_recurrent, appointment_period, appointment_rating, intervalo, intervalo_seg from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = "(( appointments.current_status_id=1 or appointments.current_status_id=2) and id_proyecto in (" . $_SESSION['id_proyecto'] . "))";
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['btn_customer'] = $this->nmgp_botoes['btn_customer'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['btn_service_details'] = $this->nmgp_botoes['btn_service_details'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->staff_id = $rs->fields[4] ; 
              $this->nmgp_dados_select['staff_id'] = $this->staff_id;
              $this->customers_id = $rs->fields[5] ; 
              $this->nmgp_dados_select['customers_id'] = $this->customers_id;
              $this->price = $rs->fields[6] ; 
              $this->nmgp_dados_select['price'] = $this->price;
              $this->additional_charges = $rs->fields[7] ; 
              $this->nmgp_dados_select['additional_charges'] = $this->additional_charges;
              $this->discount = $rs->fields[8] ; 
              $this->nmgp_dados_select['discount'] = $this->discount;
              $this->total_price = $rs->fields[9] ; 
              $this->nmgp_dados_select['total_price'] = $this->total_price;
              $this->appointment_start_date = $rs->fields[10] ; 
              $this->nmgp_dados_select['appointment_start_date'] = $this->appointment_start_date;
              $this->appointment_start_time = $rs->fields[11] ; 
              $this->nmgp_dados_select['appointment_start_time'] = $this->appointment_start_time;
              $this->appointment_end_date = $rs->fields[12] ; 
              $this->nmgp_dados_select['appointment_end_date'] = $this->appointment_end_date;
              $this->appointment_end_time = $rs->fields[13] ; 
              $this->nmgp_dados_select['appointment_end_time'] = $this->appointment_end_time;
              $this->current_status_id = $rs->fields[14] ; 
              $this->nmgp_dados_select['current_status_id'] = $this->current_status_id;
              $this->appointment_recurrent = $rs->fields[15] ; 
              $this->nmgp_dados_select['appointment_recurrent'] = $this->appointment_recurrent;
              $this->appointment_period = $rs->fields[16] ; 
              $this->nmgp_dados_select['appointment_period'] = $this->appointment_period;
              $this->appointment_rating = $rs->fields[17] ; 
              $this->nmgp_dados_select['appointment_rating'] = $this->appointment_rating;
              $this->intervalo = $rs->fields[18] ; 
              $this->nmgp_dados_select['intervalo'] = $this->intervalo;
              $this->intervalo_seg = $rs->fields[19] ; 
              $this->nmgp_dados_select['intervalo_seg'] = $this->intervalo_seg;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              ...
              $this->appointment_rating = (string)$this->appointment_rating; 
              $this->intervalo = (string)$this->intervalo; 
              $this->intervalo_seg = (string)$this->intervalo_seg; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['parms'] = "appointments_id?#?$this->appointments_id?@?";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['reg_start'] < $qt_geral_reg_calendar_appointments_adm_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
function additional_charges_onChange()
{
$_SESSION['scriptcase']['calendar_appointments_adm_mob']['contr_erro'] = 'on';
...
$this->nm_formatar_campos();
$this->NM_ajax_info['event_field'] = 'additional';
calendar_appointments_adm_mob_pack_ajax_response();
exit;
...
$this->nm_formatar_campos();
$this->NM_ajax_info['event_field'] = 'discount';
calendar_appointments_adm_mob_pack_ajax_response();
exit;
...
$this->total_price  = $this->price  + $this->additional_charges  - $this->discount ;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("calendar_appointments_adm_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_outra_jan'] != 'calendar_appointments_adm_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
<head>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <title>calendar_appointments_adm_mob</title>
<?php
...
{
    $.ajax({
        url: "calendar_appointments_adm_mob.php",
        type: "GET",
        dataType: "json",
        data: {
...
{
    $('#calendar').fullCalendar('removeEventSource', 'calendar_appointments_adm_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
    setCategory();
    $('#calendar').fullCalendar('addEventSource', 'calendar_appointments_adm_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
}
...
{
    tb_show('', 'calendar_appointments_adm_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
function editEvent_desktop(sEventId)
{
    tb_show('', 'calendar_appointments_adm_mob.php?nmgp_opcao=igual_calendar&appointments_id=' + sEventId + '&__orig_appointments_id=' + sEventId + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
<?php
...
?>
        events: 'calendar_appointments_adm_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
        eventRender: function (event, element, view) {
            if (event.hasOwnProperty('description') && event.description != '') {
                element.find('.fc-title').append('<div class="hr-line-solid-no-margin"></div><span style="font-size: 80%;">' + event.description + '</span></div>');
            }
...
?>
        ...
        eventResize: function(event, delta, revertFunc) {
            $.post(
                'calendar_appointments_adm_mob.php',
                {
                    'script_case_init': '<?php echo $this->Ini->sc_page ?>',
...
<?php
    ...
    {
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard']) {
?>
<style type="text/css">
...
<?php
    ...
    function calendarOutput_formMobile()
    {
        if (isset($_SESSION['scriptcase']['device_mobile']) && $_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
?>
<form name="F1" id="sc-ui-form" method="post" action="calendar_appointments_adm.php" target="_self">
...
<?php
       ...
       while ($oRs && !$oRs->EOF)
       {
           ...
           foreach ($aSelect as $sFldName => $sFldSql)
           {
               if ('title' == $sFldName || 'description' == $sFldName)
               {
                   ...
                   $this->id_actividad = $aEvent['title'];
                   $this->ajax_return_values_id_actividad(true);
                   $aEvent['title'] = $this->_tmp_lookup_id_actividad;
               }
               else
               {
   ...
   function calendarFetchSelect($googleInfo = false)
   {
       ...
       $aSelect['title'] = "id_actividad";

       $aSelect['description'] = "id_proyecto";
   ...
   function calendarWhere($sId, $bRecur = false, $bPrintCalendar = false, $filter = null)
   {
       ...
       $cWhere[] = "(( appointments.current_status_id=1 or appointments.current_status_id=2) and id_proyecto in (" . $_SESSION['id_proyecto'] . "))";
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_appointment_period()
   {
       $nmgp_def_dados  = "";
   ...
   function Form_lookup_appointment_recurrent()
   {
       $nmgp_def_dados  = "";
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter_form'] . " and ((( appointments.current_status_id=1 or appointments.current_status_id=2) and id_proyecto in (" . $_SESSION['id_proyecto'] . "))) and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where (( appointments.current_status_id=1 or appointments.current_status_id=2) and id_proyecto in (" . $_SESSION['id_proyecto'] . ")) and (" . $comando . ")";
      }
      ...
      $qt_geral_reg_calendar_appointments_adm_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['total'] = $qt_geral_reg_calendar_appointments_adm_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_appointments_adm_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "appointments_id";$nm_numeric[] = "id_proyecto";$nm_numeric[] = "id_usuario";$nm_numeric[] = "id_actividad";$nm_numeric[] = "staff_id";$nm_numeric[] = "customers_id";$nm_numeric[] = "price";$nm_numeric[] = "additional_charges";$nm_numeric[] = "discount";$nm_numeric[] = "total_price";$nm_numeric[] = "current_status_id";$nm_numeric[] = "appointment_rating";$nm_numeric[] = "intervalo";$nm_numeric[] = "intervalo_seg";
      ...
      $Nm_datas["appointment_start_date"] = "date";$Nm_datas["appointment_start_time"] = "time";$Nm_datas["appointment_end_date"] = "date";$Nm_datas["appointment_end_time"] = "time";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_appointments_adm_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_appointments_adm_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['ordem_ord'] == " desc") {
