  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_appointments_adm_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_appointments_adm_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_usuario
  function do_ajax_calendar_appointments_adm_mob_validate_id_usuario()
  {
    var nomeCampo_id_usuario = "id_usuario";
    var var_id_usuario = scAjaxGetFieldSelect(nomeCampo_id_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_id_usuario(var_id_usuario, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_id_usuario_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_id_usuario

  function do_ajax_calendar_appointments_adm_mob_validate_id_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_id_usuario_cb

  // ---------- Validate current_status_id
  function do_ajax_calendar_appointments_adm_mob_validate_current_status_id()
  {
    var nomeCampo_current_status_id = "current_status_id";
    var var_current_status_id = scAjaxGetFieldSelect(nomeCampo_current_status_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_current_status_id(var_current_status_id, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_current_status_id_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_current_status_id

  function do_ajax_calendar_appointments_adm_mob_validate_current_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "current_status_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_current_status_id_cb

  // ---------- Validate id_proyecto
  function do_ajax_calendar_appointments_adm_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_id_proyecto_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_id_proyecto

  function do_ajax_calendar_appointments_adm_mob_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_id_proyecto_cb

  // ---------- Validate id_actividad
  function do_ajax_calendar_appointments_adm_mob_validate_id_actividad()
  {
    var nomeCampo_id_actividad = "id_actividad";
    var var_id_actividad = scAjaxGetFieldSelect(nomeCampo_id_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_id_actividad(var_id_actividad, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_id_actividad_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_id_actividad

  function do_ajax_calendar_appointments_adm_mob_validate_id_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_id_actividad_cb

  // ---------- Validate appointment_start_date
  function do_ajax_calendar_appointments_adm_mob_validate_appointment_start_date()
  {
    var nomeCampo_appointment_start_date = "appointment_start_date";
    var var_appointment_start_date = scAjaxGetFieldText(nomeCampo_appointment_start_date);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_appointment_start_date = scAjaxGetFieldText(nomeCampo_appointment_start_date);
      x_ajax_calendar_appointments_adm_mob_validate_appointment_start_date(var_appointment_start_date, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_appointment_start_date_cb);
    }, 200);
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_start_date

  function do_ajax_calendar_appointments_adm_mob_validate_appointment_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "appointment_start_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_start_date_cb

  // ---------- Validate appointment_start_time
  function do_ajax_calendar_appointments_adm_mob_validate_appointment_start_time()
  {
    var nomeCampo_appointment_start_time = "appointment_start_time";
    var var_appointment_start_time = scAjaxGetFieldText(nomeCampo_appointment_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_appointment_start_time(var_appointment_start_time, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_appointment_start_time_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_start_time

  function do_ajax_calendar_appointments_adm_mob_validate_appointment_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "appointment_start_time";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_start_time_cb

  // ---------- Validate appointment_end_date
  function do_ajax_calendar_appointments_adm_mob_validate_appointment_end_date()
  {
    var nomeCampo_appointment_end_date = "appointment_end_date";
    var var_appointment_end_date = scAjaxGetFieldText(nomeCampo_appointment_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_appointment_end_date(var_appointment_end_date, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_appointment_end_date_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_end_date

  function do_ajax_calendar_appointments_adm_mob_validate_appointment_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "appointment_end_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_end_date_cb

  // ---------- Validate appointment_end_time
  function do_ajax_calendar_appointments_adm_mob_validate_appointment_end_time()
  {
    var nomeCampo_appointment_end_time = "appointment_end_time";
    var var_appointment_end_time = scAjaxGetFieldText(nomeCampo_appointment_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_appointment_end_time(var_appointment_end_time, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_appointment_end_time_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_end_time

  function do_ajax_calendar_appointments_adm_mob_validate_appointment_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "appointment_end_time";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_end_time_cb

  // ---------- Validate appointment_period
  function do_ajax_calendar_appointments_adm_mob_validate_appointment_period()
  {
    var nomeCampo_appointment_period = "appointment_period";
    var var_appointment_period = scAjaxGetFieldSelect(nomeCampo_appointment_period);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_appointment_period(var_appointment_period, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_appointment_period_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_period

  function do_ajax_calendar_appointments_adm_mob_validate_appointment_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "appointment_period";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_period_cb

  // ---------- Validate appointment_recurrent
  function do_ajax_calendar_appointments_adm_mob_validate_appointment_recurrent()
  {
    var nomeCampo_appointment_recurrent = "appointment_recurrent";
    var var_appointment_recurrent = scAjaxGetFieldSelect(nomeCampo_appointment_recurrent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_appointment_recurrent(var_appointment_recurrent, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_appointment_recurrent_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_recurrent

  function do_ajax_calendar_appointments_adm_mob_validate_appointment_recurrent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "appointment_recurrent";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_appointment_recurrent_cb

  // ---------- Validate intervalo
  function do_ajax_calendar_appointments_adm_mob_validate_intervalo()
  {
    var nomeCampo_intervalo = "intervalo";
    var var_intervalo = scAjaxGetFieldText(nomeCampo_intervalo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_adm_mob_validate_intervalo(var_intervalo, var_script_case_init, do_ajax_calendar_appointments_adm_mob_validate_intervalo_cb);
  } // do_ajax_calendar_appointments_adm_mob_validate_intervalo

  function do_ajax_calendar_appointments_adm_mob_validate_intervalo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "intervalo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_adm_mob_validate_intervalo_cb

  // ---------- Event onchange additional_charges
  function do_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange(var_script_case_init, do_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange_cb);
  } // do_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange

  function do_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "additional_charges";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange_cb_after_alert);
  } // do_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange_cb
  function do_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendar_appointments_adm_mob_event_additional_charges_onchange_cb_after_alert

  // ---------- Event onchange discount
  function do_ajax_calendar_appointments_adm_mob_event_discount_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_appointments_adm_mob_event_discount_onchange(var_script_case_init, do_ajax_calendar_appointments_adm_mob_event_discount_onchange_cb);
  } // do_ajax_calendar_appointments_adm_mob_event_discount_onchange

  function do_ajax_calendar_appointments_adm_mob_event_discount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendar_appointments_adm_mob_event_discount_onchange_cb_after_alert);
  } // do_ajax_calendar_appointments_adm_mob_event_discount_onchange_cb
  function do_ajax_calendar_appointments_adm_mob_event_discount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendar_appointments_adm_mob_event_discount_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_calendar_appointments_adm_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_appointments_adm_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_usuario = scAjaxGetFieldSelect("id_usuario");
    var var_current_status_id = scAjaxGetFieldSelect("current_status_id");
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_id_actividad = scAjaxGetFieldSelect("id_actividad");
    var var_appointment_start_date = scAjaxGetFieldText("appointment_start_date");
    var var_appointment_start_time = scAjaxGetFieldText("appointment_start_time");
    var var_appointment_end_date = scAjaxGetFieldText("appointment_end_date");
    var var_appointment_end_time = scAjaxGetFieldText("appointment_end_time");
    var var_appointment_period = scAjaxGetFieldSelect("appointment_period");
    var var_appointment_recurrent = scAjaxGetFieldSelect("appointment_recurrent");
    var var_intervalo = scAjaxGetFieldText("intervalo");
    var var_appointments_id = scAjaxGetFieldText("appointments_id");
    ...
    scAjaxProcOn();
    x_ajax_calendar_appointments_adm_mob_submit_form(var_id_usuario, var_current_status_id, var_id_proyecto, var_id_actividad, var_appointment_start_date, var_appointment_start_time, var_appointment_end_date, var_appointment_end_time, var_appointment_period, var_appointment_recurrent, var_intervalo, var_appointments_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_appointments_adm_mob_submit_form_cb);
  } // do_ajax_calendar_appointments_adm_mob_submit_form

  function do_ajax_calendar_appointments_adm_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_appointments_adm_mob_submit_form_cb_after_alert);
  } // do_ajax_calendar_appointments_adm_mob_submit_form_cb
  function do_ajax_calendar_appointments_adm_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_appointments_adm_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_appointments_adm_mob_navigate_form()
  {
    perform_ajax_calendar_appointments_adm_mob_navigate_form();
  }

  function perform_ajax_calendar_appointments_adm_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_appointments_id = document.F2.appointments_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_calendar_appointments_adm_mob_navigate_form(var_appointments_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_appointments_adm_mob_navigate_form_cb);
  } // do_ajax_calendar_appointments_adm_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_appointments_adm_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.appointments_id.value = scAjaxGetKeyValue("appointments_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_appointments_adm_mob_navigate_form_cb_after_alert);
  } // do_ajax_calendar_appointments_adm_mob_navigate_form_cb
  function do_ajax_calendar_appointments_adm_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_appointments_adm_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_appointments_adm_mob_navigate_form_cb_after_alert

  function sc_hide_calendar_appointments_adm_mob_form()
  {
  ...
  ajax_field_list[0] = "id_usuario";
  ajax_field_list[1] = "current_status_id";
  ajax_field_list[2] = "id_proyecto";
  ajax_field_list[3] = "id_actividad";
  ajax_field_list[4] = "appointment_start_date";
  ajax_field_list[5] = "appointment_start_time";
  ajax_field_list[6] = "appointment_end_date";
  ajax_field_list[7] = "appointment_end_time";
  ajax_field_list[8] = "appointment_period";
  ajax_field_list[9] = "appointment_recurrent";
  ajax_field_list[10] = "intervalo";
  ...
  var ajax_error_list = {
    "id_usuario": {"label": "Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "current_status_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_proyecto": {"label": "Proyecto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_actividad": {"label": "Actividad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_start_date": {"label": "Fecha Inicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_start_time": {"label": "Hora Inicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_end_date": {"label": "Fecha Término", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_end_time": {"label": "Hora Término", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_period": {"label": "Período de Horas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_recurrent": {"label": "Recurrencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "intervalo": {"label": "Intervalo (horas)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "current_status_id": new Array(),
    "id_proyecto": new Array(),
    "id_actividad": new Array(),
    "appointment_start_date": new Array(),
    "appointment_start_time": new Array(),
    "appointment_end_date": new Array(),
    "appointment_end_time": new Array(),
    "appointment_period": new Array(),
    "appointment_recurrent": new Array(),
    "intervalo": new Array()
  };
  ajax_field_mult["id_usuario"][1] = "id_usuario";
  ajax_field_mult["current_status_id"][1] = "current_status_id";
  ajax_field_mult["id_proyecto"][1] = "id_proyecto";
  ajax_field_mult["id_actividad"][1] = "id_actividad";
  ajax_field_mult["appointment_start_date"][1] = "appointment_start_date";
  ajax_field_mult["appointment_start_time"][1] = "appointment_start_time";
  ajax_field_mult["appointment_end_date"][1] = "appointment_end_date";
  ajax_field_mult["appointment_end_time"][1] = "appointment_end_time";
  ajax_field_mult["appointment_period"][1] = "appointment_period";
  ajax_field_mult["appointment_recurrent"][1] = "appointment_recurrent";
  ajax_field_mult["intervalo"][1] = "intervalo";

  var ajax_field_id = {
    "id_usuario": new Array("hidden_field_label_id_usuario", "hidden_field_data_id_usuario"),
    "current_status_id": new Array("hidden_field_label_current_status_id", "hidden_field_data_current_status_id"),
    ...
    "appointment_start_date": new Array("hidden_field_label_appointment_start_date", "hidden_field_data_appointment_start_date"),
    "appointment_start_time": new Array("hidden_field_label_appointment_start_time", "hidden_field_data_appointment_start_time"),
    "appointment_end_date": new Array("hidden_field_label_appointment_end_date", "hidden_field_data_appointment_end_date"),
    "appointment_end_time": new Array("hidden_field_label_appointment_end_time", "hidden_field_data_appointment_end_time"),
    "appointment_period": new Array("hidden_field_label_appointment_period", "hidden_field_data_appointment_period"),
    "appointment_recurrent": new Array("hidden_field_label_appointment_recurrent", "hidden_field_data_appointment_recurrent"),
    "intervalo": new Array("hidden_field_label_intervalo", "hidden_field_data_intervalo")
  };

  var ajax_read_only = {
    "id_usuario": "on",
    "current_status_id": "off",
    "id_proyecto": "off",
    "id_actividad": "off",
    "appointment_start_date": "off",
    "appointment_start_time": "off",
    "appointment_end_date": "off",
    "appointment_end_time": "off",
    "appointment_period": "off",
    "appointment_recurrent": "off",
    "intervalo": "on"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("appointment_start_date" == sIndex)
    {
    ...
    if ("appointment_start_time" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("appointment_end_date" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("appointment_end_time" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("appointment_recurrent" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
