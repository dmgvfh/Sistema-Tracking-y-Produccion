...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>calendar_appointments_adm/calendar_appointments_adm_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("calendar_appointments_adm_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('calendar_appointments_adm_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['link_info']['remove_border']) {
...
<?php
 include_once("calendar_appointments_adm_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['calendar_appointments_adm'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendar_appointments_adm'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['btn_customer']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['btn_customer']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['btn_customer']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['btn_customer']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['btn_customer'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "btn_customer", "sc_btn_btn_customer()", "sc_btn_btn_customer()", "sc_btn_customer_top", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['btn_service_details']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['btn_service_details']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['btn_service_details']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['btn_service_details']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['btn_service_details'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "btn_service_details", "sc_btn_btn_service_details()", "sc_btn_btn_service_details()", "sc_btn_service_details_top", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_usuario_label" id="hidden_field_label_id_usuario" style="<?php echo $sStyleHidden_id_usuario; ?>"><span id="id_label_id_usuario"><?php echo $this->nm_new_label['id_usuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['php_cmp_required']['id_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['php_cmp_required']['id_usuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_id_usuario_line" id="hidden_field_data_id_usuario" style="<?php echo $sStyleHidden_id_usuario; ?>">
...
$(function() {
        ...
        $(".sc-cal-categ-item-current_status_id").on("click", function() {
                ...
                if (oldValue != $(this).data("value")) {
                        do_ajax_calendar_appointments_adm_event_current_status_id_onchange();
                }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_actividad_label" id="hidden_field_label_id_actividad" style="<?php echo $sStyleHidden_id_actividad; ?>"><span id="id_label_id_actividad"><?php echo $this->nm_new_label['id_actividad']; ?></span></TD>
    <TD class="scFormDataOdd css_id_actividad_line" id="hidden_field_data_id_actividad" style="<?php echo $sStyleHidden_id_actividad; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_appointment_start_date_label" id="hidden_field_label_appointment_start_date" style="<?php echo $sStyleHidden_appointment_start_date; ?>"><span id="id_label_appointment_start_date"><?php echo $this->nm_new_label['appointment_start_date']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['php_cmp_required']['appointment_start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['php_cmp_required']['appointment_start_date'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['appointment_end_date'] = "Fecha Término";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_appointment_end_date_label" id="hidden_field_label_appointment_end_date" style="<?php echo $sStyleHidden_appointment_end_date; ?>"><span id="id_label_appointment_end_date"><?php echo $this->nm_new_label['appointment_end_date']; ?></span></TD>
    <TD class="scFormDataOdd css_appointment_end_date_line" id="hidden_field_data_appointment_end_date" style="<?php echo $sStyleHidden_appointment_end_date; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_appointment_end_time_label" id="hidden_field_label_appointment_end_time" style="<?php echo $sStyleHidden_appointment_end_time; ?>"><span id="id_label_appointment_end_time"><?php echo $this->nm_new_label['appointment_end_time']; ?></span></TD>
    <TD class="scFormDataOdd css_appointment_end_time_line" id="hidden_field_data_appointment_end_time" style="<?php echo $sStyleHidden_appointment_end_time; ?>">
...
?>
   ...
   <?php
   if (!isset($this->nm_new_label['appointment_period']))
   {
       $this->nm_new_label['appointment_period'] = "Período de Horas";
   }
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $appointment_period = $this->appointment_period;
   $sStyleHidden_appointment_period = '';
   if (isset($this->nmgp_cmp_hidden['appointment_period']) && $this->nmgp_cmp_hidden['appointment_period'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['appointment_period']);
       $sStyleHidden_appointment_period = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_appointment_period = 'display: none;';
   $sStyleReadInp_appointment_period = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['appointment_period']) && $this->nmgp_cmp_readonly['appointment_period'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['appointment_period']);
       $sStyleReadLab_appointment_period = '';
       $sStyleReadInp_appointment_period = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['appointment_period']) && $this->nmgp_cmp_hidden['appointment_period'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="appointment_period" value="<?php echo $this->form_encode_input($this->appointment_period) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_appointment_period_label" id="hidden_field_label_appointment_period" style="<?php echo $sStyleHidden_appointment_period; ?>"><span id="id_label_appointment_period"><?php echo $this->nm_new_label['appointment_period']; ?></span></TD>
    <TD class="scFormDataOdd css_appointment_period_line" id="hidden_field_data_appointment_period" style="<?php echo $sStyleHidden_appointment_period; ?>">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["appointment_period"]) &&  $this->nmgp_cmp_readonly["appointment_period"] == "on") { 

$appointment_period_look = "";
 if ($this->appointment_period == "D") { $appointment_period_look .= "" . $this->Ini->Nm_lang['lang_recu_daily'] . "" ;} 
 if ($this->appointment_period == "W") { $appointment_period_look .= "" . $this->Ini->Nm_lang['lang_recu_weekly'] . "" ;} 
 if ($this->appointment_period == "A") { $appointment_period_look .= "" . $this->Ini->Nm_lang['lang_recu_annual'] . "" ;} 
 if (empty($appointment_period_look)) { $appointment_period_look = $this->appointment_period; }
?>
<input type="hidden" name="appointment_period" value="<?php echo $this->form_encode_input($appointment_period) . "\">" . $appointment_period_look . ""; ?>
<?php } else { ?>
<?php
...
$appointment_period_look = "";
 ...
 if (empty($appointment_period_look)) { $appointment_period_look = $this->appointment_period; }
?>
<span id="id_read_on_appointment_period" class="css_appointment_period_line"  style="<?php echo $sStyleReadLab_appointment_period; ?>"><?php echo $this->form_format_readonly("appointment_period", $this->form_encode_input($appointment_period_look)); ?></span><span id="id_read_off_appointment_period" class="css_read_off_appointment_period<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap; <?php echo $sStyleReadInp_appointment_period; ?>">
 <span id="idAjaxSelect_appointment_period" class="<?php echo $this->classes_100perc_fields['span_select'] ?>"><select class="sc-js-input scFormObjectOdd css_appointment_period_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_appointment_period" name="appointment_period" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="D" <?php  if ($this->appointment_period == "D") { echo " selected" ;} ?><?php  if (empty($this->appointment_period)) { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_daily']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['Lookup_appointment_period'][] = 'D'; ?>
 <option  value="W" <?php  if ($this->appointment_period == "W") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_weekly']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['Lookup_appointment_period'][] = 'W'; ?>
 <option  value="A" <?php  if ($this->appointment_period == "A") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_annual']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['Lookup_appointment_period'][] = 'A'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
   ...
   <?php
   if (!isset($this->nm_new_label['appointment_recurrent']))
   {
       $this->nm_new_label['appointment_recurrent'] = "Recurrencia";
   }
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $appointment_recurrent = $this->appointment_recurrent;
   $sStyleHidden_appointment_recurrent = '';
   if (isset($this->nmgp_cmp_hidden['appointment_recurrent']) && $this->nmgp_cmp_hidden['appointment_recurrent'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['appointment_recurrent']);
       $sStyleHidden_appointment_recurrent = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_appointment_recurrent = 'display: none;';
   $sStyleReadInp_appointment_recurrent = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['appointment_recurrent']) && $this->nmgp_cmp_readonly['appointment_recurrent'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['appointment_recurrent']);
       $sStyleReadLab_appointment_recurrent = '';
       $sStyleReadInp_appointment_recurrent = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['appointment_recurrent']) && $this->nmgp_cmp_hidden['appointment_recurrent'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="appointment_recurrent" value="<?php echo $this->form_encode_input($this->appointment_recurrent) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_appointment_recurrent_label" id="hidden_field_label_appointment_recurrent" style="<?php echo $sStyleHidden_appointment_recurrent; ?>"><span id="id_label_appointment_recurrent"><?php echo $this->nm_new_label['appointment_recurrent']; ?></span></TD>
    <TD class="scFormDataOdd css_appointment_recurrent_line" id="hidden_field_data_appointment_recurrent" style="<?php echo $sStyleHidden_appointment_recurrent; ?>">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["appointment_recurrent"]) &&  $this->nmgp_cmp_readonly["appointment_recurrent"] == "on") { 

$appointment_recurrent_look = "";
 if ($this->appointment_recurrent == "Y") { $appointment_recurrent_look .= "" . $this->Ini->Nm_lang['lang_peri_yes'] . "" ;} 
 if ($this->appointment_recurrent == "N") { $appointment_recurrent_look .= "" . $this->Ini->Nm_lang['lang_peri_no'] . "" ;} 
 if (empty($appointment_recurrent_look)) { $appointment_recurrent_look = $this->appointment_recurrent; }
?>
<input type="hidden" name="appointment_recurrent" value="<?php echo $this->form_encode_input($appointment_recurrent) . "\">" . $appointment_recurrent_look . ""; ?>
<?php } else { ?>
<?php
...
$appointment_recurrent_look = "";
 ...
 if (empty($appointment_recurrent_look)) { $appointment_recurrent_look = $this->appointment_recurrent; }
?>
<span id="id_read_on_appointment_recurrent" class="css_appointment_recurrent_line"  style="<?php echo $sStyleReadLab_appointment_recurrent; ?>"><?php echo $this->form_format_readonly("appointment_recurrent", $this->form_encode_input($appointment_recurrent_look)); ?></span><span id="id_read_off_appointment_recurrent" class="css_read_off_appointment_recurrent<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap; <?php echo $sStyleReadInp_appointment_recurrent; ?>">
 <span id="idAjaxSelect_appointment_recurrent" class="<?php echo $this->classes_100perc_fields['span_select'] ?>"><select class="sc-js-input scFormObjectOdd css_appointment_recurrent_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_appointment_recurrent" name="appointment_recurrent" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="Y" <?php  if ($this->appointment_recurrent == "Y") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_peri_yes']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['Lookup_appointment_recurrent'][] = 'Y'; ?>
 <option  value="N" <?php  if ($this->appointment_recurrent == "N") { echo " selected" ;} ?><?php  if (empty($this->appointment_recurrent)) { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_peri_no']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['Lookup_appointment_recurrent'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_intervalo_label" id="hidden_field_label_intervalo" style="<?php echo $sStyleHidden_intervalo; ?>"><span id="id_label_intervalo"><?php echo $this->nm_new_label['intervalo']; ?></span></TD>
    <TD class="scFormDataOdd css_intervalo_line" id="hidden_field_data_intervalo" style="<?php echo $sStyleHidden_intervalo; ?>">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("calendar_appointments_adm");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("calendar_appointments_adm");
 parent.scAjaxDetailHeight("calendar_appointments_adm", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_adm']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
