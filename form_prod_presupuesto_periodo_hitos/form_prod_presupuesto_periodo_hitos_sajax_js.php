  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_presupuesto_periodo_hitos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_presupuesto_periodo_hitos_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_validate_id(var_id, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_id

  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_cb

  // ---------- Validate id_presupuesto_periodo
  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_presupuesto_periodo()
  {
    var nomeCampo_id_presupuesto_periodo = "id_presupuesto_periodo";
    var var_id_presupuesto_periodo = scAjaxGetFieldText(nomeCampo_id_presupuesto_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_validate_id_presupuesto_periodo(var_id_presupuesto_periodo, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_presupuesto_periodo_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_presupuesto_periodo

  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_presupuesto_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_presupuesto_periodo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_presupuesto_periodo_cb

  // ---------- Validate id_hito
  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_hito()
  {
    var nomeCampo_id_hito = "id_hito";
    var var_id_hito = scAjaxGetFieldText(nomeCampo_id_hito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_validate_id_hito(var_id_hito, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_hito_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_hito

  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_hito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_hito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_id_hito_cb

  // ---------- Validate estado
  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_validate_estado(var_estado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_validate_estado_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_estado

  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_estado_cb

  // ---------- Validate fecha_hito
  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_fecha_hito()
  {
    var nomeCampo_fecha_hito = "fecha_hito";
    var var_fecha_hito = scAjaxGetFieldText(nomeCampo_fecha_hito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_validate_fecha_hito(var_fecha_hito, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_validate_fecha_hito_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_fecha_hito

  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_fecha_hito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_hito";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_fecha_hito_cb

  // ---------- Validate adjunto
  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_adjunto()
  {
    var nomeCampo_adjunto = "adjunto";
    var var_adjunto = scAjaxGetFieldText(nomeCampo_adjunto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_validate_adjunto(var_adjunto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_validate_adjunto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_adjunto

  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_adjunto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adjunto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_adjunto_cb

  // ---------- Validate link_externo
  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_link_externo()
  {
    var nomeCampo_link_externo = "link_externo";
    var var_link_externo = scAjaxGetFieldText(nomeCampo_link_externo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_validate_link_externo(var_link_externo, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_validate_link_externo_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_link_externo

  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_link_externo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "link_externo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_link_externo_cb

  // ---------- Validate hitos_asociados
  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_hitos_asociados()
  {
    var nomeCampo_hitos_asociados = "hitos_asociados";
    nm_pack(nomeCampo_hitos_asociados + '_dest', nomeCampo_hitos_asociados);
    var var_hitos_asociados = scAjaxGetFieldText(nomeCampo_hitos_asociados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_validate_hitos_asociados(var_hitos_asociados, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_validate_hitos_asociados_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_hitos_asociados

  function do_ajax_form_prod_presupuesto_periodo_hitos_validate_hitos_asociados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hitos_asociados";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_validate_hitos_asociados_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_presupuesto_periodo_hitos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_presupuesto_periodo_hitos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_presupuesto_periodo = scAjaxGetFieldText("id_presupuesto_periodo");
    var var_id_hito = scAjaxGetFieldText("id_hito");
    var var_estado = scAjaxGetFieldText("estado");
    var var_fecha_hito = scAjaxGetFieldText("fecha_hito");
    var var_adjunto = scAjaxGetFieldText("adjunto");
    var var_link_externo = scAjaxGetFieldText("link_externo");
    nm_pack("hitos_asociados_dest", "hitos_asociados");
    var var_hitos_asociados = scAjaxGetFieldText("hitos_asociados", "@?@");
    var var_adjunto_ul_name = scAjaxSpecCharProtect(document.F1.adjunto_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_adjunto_ul_type = document.F1.adjunto_ul_type.value;
    var var_adjunto_salva = scAjaxSpecCharProtect(document.F1.adjunto_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_adjunto_limpa = document.F1.adjunto_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_hitos_submit_form(var_id, var_id_presupuesto_periodo, var_id_hito, var_estado, var_fecha_hito, var_adjunto, var_link_externo, var_hitos_asociados, var_adjunto_ul_name, var_adjunto_ul_type, var_adjunto_salva, var_adjunto_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_presupuesto_periodo_hitos_submit_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_submit_form

  function do_ajax_form_prod_presupuesto_periodo_hitos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.adjunto_limpa && document.F1.adjunto_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("adjunto", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_adjunto") && "" != document.getElementById("id_ajax_doc_adjunto").innerHTML)
      {
        document.getElementById("id_ajax_doc_adjunto").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_hitos_submit_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_submit_form_cb
  function do_ajax_form_prod_presupuesto_periodo_hitos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_presupuesto_periodo_hitos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_presupuesto_periodo_hitos_navigate_form()
  {
    perform_ajax_form_prod_presupuesto_periodo_hitos_navigate_form();
  }

  function perform_ajax_form_prod_presupuesto_periodo_hitos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_presupuesto_periodo = document.F2.id_presupuesto_periodo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_hitos_navigate_form(var_id_presupuesto_periodo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_navigate_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_hitos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_presupuesto_periodo_hitos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_presupuesto_periodo.value = scAjaxGetKeyValue("id_presupuesto_periodo");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_hitos_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_navigate_form_cb
  function do_ajax_form_prod_presupuesto_periodo_hitos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_presupuesto_periodo_hitos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_presupuesto_periodo_hitos_navigate_form_cb_after_alert

  function sc_hide_form_prod_presupuesto_periodo_hitos_form()
  {
  ...
  ajax_field_list[1] = "id_presupuesto_periodo";
  ajax_field_list[2] = "id_hito";
  ajax_field_list[3] = "estado";
  ajax_field_list[4] = "fecha_hito";
  ajax_field_list[5] = "adjunto";
  ajax_field_list[6] = "link_externo";
  ajax_field_list[7] = "hitos_asociados";
  ...
  var ajax_error_list = {
    ...
    "id_presupuesto_periodo": {"label": "Id Presupuesto Periodo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_hito": {"label": "Id Hito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "estado": {"label": "Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fecha_hito": {"label": "Fecha Hito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "adjunto": {"label": "Adjunto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "link_externo": {"label": "Link Externo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "hitos_asociados": {"label": "Hitos Asociados Al Período", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "id_presupuesto_periodo": new Array(),
    "id_hito": new Array(),
    "estado": new Array(),
    "fecha_hito": new Array(),
    "adjunto": new Array(),
    "link_externo": new Array(),
    "hitos_asociados": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["id_presupuesto_periodo"][1] = "id_presupuesto_periodo";
  ajax_field_mult["id_hito"][1] = "id_hito";
  ajax_field_mult["estado"][1] = "estado";
  ajax_field_mult["fecha_hito"][1] = "fecha_hito";
  ajax_field_mult["adjunto"][1] = "adjunto";
  ajax_field_mult["link_externo"][1] = "link_externo";
  ajax_field_mult["hitos_asociados"][1] = "hitos_asociados";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "id_presupuesto_periodo": new Array("hidden_field_label_id_presupuesto_periodo", "hidden_field_data_id_presupuesto_periodo"),
    "id_hito": new Array("hidden_field_label_id_hito", "hidden_field_data_id_hito"),
    "estado": new Array("hidden_field_label_estado", "hidden_field_data_estado"),
    "fecha_hito": new Array("hidden_field_label_fecha_hito", "hidden_field_data_fecha_hito"),
    "adjunto": new Array("hidden_field_label_adjunto", "hidden_field_data_adjunto"),
    "link_externo": new Array("hidden_field_label_link_externo", "hidden_field_data_link_externo"),
    "hitos_asociados": new Array("hidden_field_label_hitos_asociados", "hidden_field_data_hitos_asociados")
  };

  var ajax_read_only = {
    "id": "on",
    "id_presupuesto_periodo": "on",
    "id_hito": "off",
    "estado": "off",
    "fecha_hito": "off",
    "adjunto": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("id_presupuesto_periodo" == sIndex)
    {
