  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_programar_proyecto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_programar_proyecto_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_form_programar_proyecto_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_proyecto_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_programar_proyecto_validate_id__cb);
  } // do_ajax_form_programar_proyecto_validate_id_

  function do_ajax_form_programar_proyecto_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_proyecto_validate_id__cb

  // ---------- Validate id_proyecto_
  function do_ajax_form_programar_proyecto_validate_id_proyecto_(iNumLinha)
  {
    var nomeCampo_id_proyecto_ = "id_proyecto_" + iNumLinha;
    var var_id_proyecto_ = scAjaxGetFieldSelect(nomeCampo_id_proyecto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_proyecto_validate_id_proyecto_(var_id_proyecto_, iNumLinha, var_script_case_init, do_ajax_form_programar_proyecto_validate_id_proyecto__cb);
  } // do_ajax_form_programar_proyecto_validate_id_proyecto_

  function do_ajax_form_programar_proyecto_validate_id_proyecto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_proyecto_validate_id_proyecto__cb

  // ---------- Validate fecha_
  function do_ajax_form_programar_proyecto_validate_fecha_(iNumLinha)
  {
    var nomeCampo_fecha_ = "fecha_" + iNumLinha;
    var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_proyecto_validate_fecha_(var_fecha_, iNumLinha, var_script_case_init, do_ajax_form_programar_proyecto_validate_fecha__cb);
  } // do_ajax_form_programar_proyecto_validate_fecha_

  function do_ajax_form_programar_proyecto_validate_fecha__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_proyecto_validate_fecha__cb

  // ---------- Validate correlativo_mes_
  function do_ajax_form_programar_proyecto_validate_correlativo_mes_(iNumLinha)
  {
    var nomeCampo_correlativo_mes_ = "correlativo_mes_" + iNumLinha;
    var var_correlativo_mes_ = scAjaxGetFieldText(nomeCampo_correlativo_mes_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_proyecto_validate_correlativo_mes_(var_correlativo_mes_, iNumLinha, var_script_case_init, do_ajax_form_programar_proyecto_validate_correlativo_mes__cb);
  } // do_ajax_form_programar_proyecto_validate_correlativo_mes_

  function do_ajax_form_programar_proyecto_validate_correlativo_mes__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "correlativo_mes_" + iLineNumber;
    }
    else
    {
      sFieldValid = "correlativo_mes_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "correlativo_mes_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "correlativo_mes_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_proyecto_validate_correlativo_mes__cb

  // ---------- Validate valor_uf_presupuesto_
  function do_ajax_form_programar_proyecto_validate_valor_uf_presupuesto_(iNumLinha)
  {
    var nomeCampo_valor_uf_presupuesto_ = "valor_uf_presupuesto_" + iNumLinha;
    var var_valor_uf_presupuesto_ = scAjaxGetFieldText(nomeCampo_valor_uf_presupuesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_proyecto_validate_valor_uf_presupuesto_(var_valor_uf_presupuesto_, iNumLinha, var_script_case_init, do_ajax_form_programar_proyecto_validate_valor_uf_presupuesto__cb);
  } // do_ajax_form_programar_proyecto_validate_valor_uf_presupuesto_

  function do_ajax_form_programar_proyecto_validate_valor_uf_presupuesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valor_uf_presupuesto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valor_uf_presupuesto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valor_uf_presupuesto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valor_uf_presupuesto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_proyecto_validate_valor_uf_presupuesto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_programar_proyecto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_programar_proyecto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_programar_proyecto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_programar_proyecto_add_new_line_cb);
  } // do_ajax_form_programar_proyecto_add_new_line

  function do_ajax_form_programar_proyecto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_programar_proyecto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_programar_proyecto_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_proyecto_backup_line(var_id_, var_id_proyecto_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_programar_proyecto_backup_line_cb);
  } // do_ajax_form_programar_proyecto_backup_line

  function do_ajax_form_programar_proyecto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_programar_proyecto_backup_line_cb

  function do_ajax_form_programar_proyecto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_programar_proyecto_cancel_insert

  function do_ajax_form_programar_proyecto_cancel_update(iSeqVert)
  {
    do_ajax_form_programar_proyecto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_programar_proyecto_cancel_update

  function do_ajax_form_programar_proyecto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_programar_proyecto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_programar_proyecto_table_refresh()
  {
    var var_id_ = document.F2.id_.value;
    var var_id_proyecto_ = document.F2.id_proyecto_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_programar_proyecto_table_refresh(var_id_, var_id_proyecto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_programar_proyecto_table_refresh_cb);
  } //  do_ajax_form_programar_proyecto_table_refresh

  function do_ajax_form_programar_proyecto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_proyecto_.value = scAjaxGetKeyValue("id_proyecto_");
    ...
    scAjaxAlert(do_ajax_form_programar_proyecto_table_refresh_cb_after_alert);
  } // do_ajax_form_programar_proyecto_table_refresh_cb
  function do_ajax_form_programar_proyecto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_programar_proyecto_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_programar_proyecto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_programar_proyecto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_correlativo_mes_ = scAjaxGetFieldText("correlativo_mes_" + iNumLinha);
    var var_valor_uf_presupuesto_ = scAjaxGetFieldText("valor_uf_presupuesto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_programar_proyecto_submit_form(var_id_, var_id_proyecto_, var_fecha_, var_correlativo_mes_, var_valor_uf_presupuesto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_programar_proyecto_submit_form_cb);
  } // do_ajax_form_programar_proyecto_submit_form

  function do_ajax_form_programar_proyecto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("correlativo_mes_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valor_uf_presupuesto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_programar_proyecto_submit_form_cb_after_alert);
  } // do_ajax_form_programar_proyecto_submit_form_cb
  function do_ajax_form_programar_proyecto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_programar_proyecto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_programar_proyecto_navigate_form()
  {
    perform_ajax_form_programar_proyecto_navigate_form();
  }

  function perform_ajax_form_programar_proyecto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_programar_proyecto_cancel_insert(sc_form_programar_proyecto_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("correlativo_mes_" + iNavForm);
      scAjaxHideErrorDisplay("valor_uf_presupuesto_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_id_proyecto_ = document.F2.id_proyecto_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_programar_proyecto_navigate_form(var_id_, var_id_proyecto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_programar_proyecto_navigate_form_cb);
  } // do_ajax_form_programar_proyecto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_programar_proyecto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_programar_proyecto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_proyecto_.value = scAjaxGetKeyValue("id_proyecto_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_programar_proyecto_navigate_form_cb_after_alert);
  } // do_ajax_form_programar_proyecto_navigate_form_cb
  function do_ajax_form_programar_proyecto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_programar_proyecto_navigate_form_cb_after_alert

    function sc_form_programar_proyecto_get_last_line_number()
    {
    ...
    } //sc_form_programar_proyecto_get_last_line_number

  function sc_hide_form_programar_proyecto_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "correlativo_mes_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_uf_presupuesto_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["fecha_" + iNumLinha] = {"label": "Mes / Año Partida Facturación<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["correlativo_mes_" + iNumLinha] = {"label": "Correlativo Mes<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["valor_uf_presupuesto_" + iNumLinha] = {"label": "Valor Moneda Período<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_field_mult["correlativo_mes_"][iNumLinha] = "correlativo_mes_" + iNumLinha;
    ajax_field_mult["valor_uf_presupuesto_"][iNumLinha] = "valor_uf_presupuesto_" + iNumLinha;
    ...
    ajax_field_id["correlativo_mes_" + iNumLinha] = new Array("hidden_field_label_correlativo_mes_", "hidden_field_data_correlativo_mes_" + iNumLinha);
    ajax_field_id["valor_uf_presupuesto_" + iNumLinha] = new Array("hidden_field_label_valor_uf_presupuesto_", "hidden_field_data_valor_uf_presupuesto_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["id_proyecto_" + iNumLinha] = "off";
    ajax_error_count["fecha_" + iNumLinha] = "off";
    ajax_error_count["correlativo_mes_" + iNumLinha] = "off";
    ajax_error_count["valor_uf_presupuesto_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["correlativo_mes_" + iNumLinha] = "off";
    ajax_read_only["valor_uf_presupuesto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["correlativo_mes_" + iNumLinha] = "on";
    ajax_read_only["valor_uf_presupuesto_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["correlativo_mes_" + iNumLinha] = null;
    ajax_error_list["valor_uf_presupuesto_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "fecha_": new Array(),
    "correlativo_mes_": new Array(),
    "valor_uf_presupuesto_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["correlativo_mes_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["correlativo_mes_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["correlativo_mes_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["correlativo_mes_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["correlativo_mes_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["valor_uf_presupuesto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valor_uf_presupuesto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valor_uf_presupuesto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valor_uf_presupuesto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valor_uf_presupuesto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['correlativo_mes_'])) ? $this->nmgp_cmp_readonly['correlativo_mes_'] : 'off';
?>
    scAjaxFieldRead("correlativo_mes_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valor_uf_presupuesto_'])) ? $this->nmgp_cmp_readonly['valor_uf_presupuesto_'] : 'off';
?>
    scAjaxFieldRead("valor_uf_presupuesto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("correlativo_mes_" + iSeq, "on");
    scAjaxFieldRead("valor_uf_presupuesto_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["id_proyecto_" + iRow] || "on" == ajax_error_count["fecha_" + iRow] || "on" == ajax_error_count["correlativo_mes_" + iRow] || "on" == ajax_error_count["valor_uf_presupuesto_" + iRow]))
    {
      ...
      $("#hidden_field_data_correlativo_mes_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_uf_presupuesto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["id_proyecto_" + iRow] && "off" == ajax_error_count["fecha_" + iRow] && "off" == ajax_error_count["correlativo_mes_" + iRow] && "off" == ajax_error_count["valor_uf_presupuesto_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["correlativo_mes_" + iRow] = "off";
        ajax_error_count["valor_uf_presupuesto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_correlativo_mes_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_uf_presupuesto_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("valor_uf_presupuesto_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
