...
<input type="hidden" name="id_proyecto_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_proyecto_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_programar_proyecto"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_programar_proyecto_submit_form(y, z);
