...
class grid_prod_produccion_proyecto_mod_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $id_proyecto;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['contr_total_geral'] = "OK";
   } 
