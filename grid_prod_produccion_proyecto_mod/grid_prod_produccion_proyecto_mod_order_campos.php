<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_prod_produccion_proyecto_mod']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_prod_produccion_proyecto_mod_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_produccion_proyecto_mod_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['nombre_proyecto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nombre_proyecto'] = "nombre_proyecto";
   }
   else
   {
       $tab_def_campos['nombre_proyecto'] = "proyectos.nombre_proyecto";
   }
   $tab_labels["nombre_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["nombre_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["nombre_proyecto"] : "Proyecto";
   ...
   {
       $tab_def_campos['presupuesto'] = "SELECT presupuesto 
FROM proyectos 
WHERE id = '{id_proyecto}' 
ORDER BY presupuesto";
   }
   $tab_labels["presupuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["presupuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["presupuesto"] : "Presupuesto Proyecto";
   ...
   {
       $tab_def_campos['correlativo_mes'] = "prod_produccion_proyecto.correlativo_mes";
   }
   $tab_labels["correlativo_mes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["correlativo_mes"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["correlativo_mes"] : "Correlativo Mes";
   ...
   {
       $tab_def_campos['modificacion_contrato'] = "prod_produccion_proyecto.modificacion_contrato";
   }
   $tab_labels["modificacion_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["modificacion_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["modificacion_contrato"] : "Modificación Contrato";
   ...
   {
       $tab_def_campos['fecha'] = "prod_produccion_proyecto.fecha";
   }
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["fecha"] : "Mes / Año";
   ...
   {
       $tab_def_campos['avance'] = "prod_produccion_proyecto.avance";
   }
   $tab_labels["avance"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["avance"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["avance"] : "Avance (Producción)";
   ...
   {
       $tab_def_campos['facturacion'] = "prod_produccion_proyecto.facturacion";
   }
   $tab_labels["facturacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["facturacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["facturacion"] : "Facturación";
   $tab_ger_campos['saldo_ur'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['saldo_ur'] = "saldo_ur";
   }
   else
   {
       $tab_def_campos['saldo_ur'] = "prod_produccion_proyecto.saldo_ur";
   }
   $tab_labels["saldo_ur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["saldo_ur"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["saldo_ur"] : "Saldo Ur";
   ...
   {
       $tab_def_campos['ur_real'] = "prod_produccion_proyecto.ur_real";
   }
   $tab_labels["ur_real"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["ur_real"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["ur_real"] : "Facturación Proyectada";
   ...
   {
       $tab_def_campos['backlog_p'] = "prod_produccion_proyecto.backlog_p";
   }
   $tab_labels["backlog_p"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["backlog_p"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["backlog_p"] : "Backlog P";
   ...
   {
       $tab_def_campos['backlog_f'] = "prod_produccion_proyecto.backlog_f";
   }
   $tab_labels["backlog_f"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["backlog_f"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['labels']["backlog_f"] : "Backlog F";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_produccion_proyecto_mod_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_mod']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
