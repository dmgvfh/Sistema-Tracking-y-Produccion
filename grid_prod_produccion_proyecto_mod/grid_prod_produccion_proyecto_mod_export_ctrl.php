<?php
@session_start() ;
$_SESSION['scriptcase']['grid_prod_produccion_proyecto_mod']['sc_process_barr'] = true;
require_once('../grid_prod_produccion_proyecto_mod/index.php');
unset($_SESSION['scriptcase']['grid_prod_produccion_proyecto_mod']['sc_process_barr']);
$ExportCtrl = new grid_prod_produccion_proyecto_mod_export_control;
$ExportCtrl->Export_barr();

class grid_prod_produccion_proyecto_mod_export_control
{
