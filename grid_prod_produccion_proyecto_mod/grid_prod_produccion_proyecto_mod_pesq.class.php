...
class grid_prod_produccion_proyecto_mod_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_prod_produccion_proyecto_mod_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_prod_produccion_proyecto_mod_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_prod_produccion_proyecto_mod_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "prod_produccion_proyecto_id";$Nm_numeric[] = "prod_produccion_proyecto_id_proyecto";$Nm_numeric[] = "prod_produccion_proyecto_avance";$Nm_numeric[] = "prod_produccion_proyecto_facturacion";$Nm_numeric[] = "prod_produccion_proyecto_costos";$Nm_numeric[] = "prod_produccion_proyecto_saldo_ur";$Nm_numeric[] = "prod_produccion_proyecto_backlog_p";$Nm_numeric[] = "prod_produccion_proyecto_backlog_f";$Nm_numeric[] = "prod_produccion_proyecto_ur_real";$Nm_numeric[] = "prod_produccion_proyecto_correlativo_mes";$Nm_numeric[] = "prod_produccion_proyecto_modificacion_contrato";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "prod_produccion_proyecto.fecha";$Nm_datas[] = "prod_produccion_proyecto_fecha";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_prod_produccion_proyecto_mod/grid_prod_produccion_proyecto_mod_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_prod_produccion_proyecto_mod_ajax_search.js"></script>
 <script type="text/javascript" src="grid_prod_produccion_proyecto_mod_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_prod_produccion_proyecto_mod_message.js"></script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_proyecto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']['id_proyecto']; 
          $id_proyecto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']['id_proyecto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']['NM_operador']; 
      } 
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['psq_check_ret']['id_proyecto'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['psq_check_ret']['id_proyecto'][] = trim($rs->fields[0]);
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_id_proyecto_orig" name="id_proyecto_orig" size=7 multiple onDblClick="nm_add_sel('id_proyecto_orig', 'id_proyecto_dest', 'N' , '')">
<?php
...
?>
   ...
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_id_proyecto_dest" name="id_proyecto_dest" size=7 multiple  onDblClick="nm_del_sel('id_proyecto_dest', 'id_proyecto_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
<?php
   if (is_file("grid_prod_produccion_proyecto_mod_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_prod_produccion_proyecto_mod";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_prod_produccion_proyecto_mod/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $id_proyecto_cond, $id_proyecto, $nmgp_tab_label;
      ...
      if (is_array($id_proyecto)) {
          foreach ($id_proyecto as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['psq_check_ret']['id_proyecto'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']['id_proyecto'] = $id_proyecto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']['id_proyecto_cond'] = $id_proyecto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['id_proyecto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']['id_proyecto'];
      ...
      if (is_array($id_proyecto) && count($id_proyecto) != 0)
      {
         ...
         {
             $this->comando        .= " prod_produccion_proyecto.id_proyecto not in (";
             $this->comando_sum    .= " prod_produccion_proyecto.prod_produccion_proyecto.id_proyecto not in (";
             $this->comando_filtro .= " prod_produccion_proyecto.id_proyecto not in (";
         }
         else
         {
             $this->comando        .= " prod_produccion_proyecto.id_proyecto in (";
             $this->comando_sum    .= " prod_produccion_proyecto.prod_produccion_proyecto.id_proyecto in (";
             $this->comando_filtro .= " prod_produccion_proyecto.id_proyecto in (";
         }
         $x                     = count($id_proyecto);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $nmgp_tab_label['id_proyecto'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($id_proyecto) && ($id_proyecto_cond == "nu" || $id_proyecto_cond == "nn" || $id_proyecto_cond == "ep" || $id_proyecto_cond == "ne"))
      {
         $this->monta_condicao("prod_produccion_proyecto.id_proyecto", $id_proyecto_cond, "", "", "id_proyecto", "INT", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_mod']['cond_pesq'] .= $this->NM_operador;
