...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_portafolio"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_portafolio"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_portafolio'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_portafolio']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_portafolio']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_portafolio']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_portafolio']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_portafolio']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_portafolio']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_portafolio']['embutida_filho'] as $ind => $sc_init)
          {
