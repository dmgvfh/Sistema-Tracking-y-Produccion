...
<HTML>
<HEAD>
 <TITLE> portafolio (Centro de Negocio)</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nombre_portafolio_cond" name="nombre_portafolio_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_portafolio'), this, 'nombre_portafolio')">
      ...
      <br><span id="id_hide_nombre_portafolio"  <?php echo $str_hide_nombre_portafolio?>><?php
