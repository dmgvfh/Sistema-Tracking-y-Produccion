<?php
@session_start() ;
$_SESSION['scriptcase']['grid_portafolio']['sc_process_barr'] = true;
require_once('../grid_portafolio/index.php');
unset($_SESSION['scriptcase']['grid_portafolio']['sc_process_barr']);
$ExportCtrl = new grid_portafolio_export_control;
$ExportCtrl->Export_barr();

class grid_portafolio_export_control
{
