...
//
   ...
   $_SESSION['scriptcase']['app_Login']['glo_nm_perfil']          = "conn_example";
...
//
   function init()
   {
      ...
      $this->nm_dt_criacao   = "20171211"; 
      $this->nm_hr_criacao   = "155804"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20231220"; 
      $this->nm_hr_ult_alt   = "100102"; 
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'carga_horas', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_carga_horas'])) {
                $_SESSION['scriptcase']['app_Login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_carga_horas'];
            }
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['app_Login']['session_timeout']['redir']))
    {
        ...
        if ('ajax_app_Login_submit_form' == $_POST['rs'])
        {
            ...
            $bok = NM_utf8_urldecode($_POST['rsargs'][10]);
        }
    ...
    { 
        ...
        if (isset($glo_customer_id)) 
        {
            $_SESSION['glo_customer_id'] = $glo_customer_id;
        }
        if (isset($group_name)) 
        {
    ...
    else
    {
        ...
        if (isset($_POST["usr_group"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['usr_group']);
        }
        ...
        if (isset($_POST["glo_staff_id"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['glo_staff_id']);
        }
        ...
        if (isset($_POST["glo_customer_id"])) 
        {
            $_SESSION['glo_customer_id'] = $_POST["glo_customer_id"];
            nm_limpa_str_app_Login($_SESSION['glo_customer_id']);
        }
        if (isset($_GET["glo_customer_id"])) 
        {
            $_SESSION['glo_customer_id'] = $_GET["glo_customer_id"];
            nm_limpa_str_app_Login($_SESSION['glo_customer_id']);
        }
        if (isset($_POST["group_name"])) 
        {
            $_SESSION['group_name'] = $_POST["group_name"];
            nm_limpa_str_app_Login($_SESSION['group_name']);
        }
        ...
        if (isset($_POST["id_proyecto"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['id_proyecto']);
        }
        ...
        if (isset($_POST["id_partida"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['id_partida']);
        }
...
//
    ...
    function ajax_app_Login_submit_form($login, $pswd, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token, $bok)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
