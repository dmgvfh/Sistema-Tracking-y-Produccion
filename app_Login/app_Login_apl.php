...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->glo_customer_id) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['glo_customer_id'] = $this->glo_customer_id;
      }
      ...
      if (isset($_POST["glo_customer_id"]) && isset($this->glo_customer_id)) 
      {
          $_SESSION['glo_customer_id'] = $this->glo_customer_id;
      }
      ...
      if (isset($_GET["glo_customer_id"]) && isset($this->glo_customer_id)) 
      {
          $_SESSION['glo_customer_id'] = $this->glo_customer_id;
      }
...
$_SESSION['scriptcase']['app_Login']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_Login']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_Login']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['app_Login']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
//
      ...
      {
      $_SESSION['scriptcase']['app_Login']['contr_erro'] = 'on';
if (!isset($this->sc_temp_id_partida)) {$this->sc_temp_id_partida = (isset($_SESSION['id_partida'])) ? $_SESSION['id_partida'] : "";}
...
if (!isset($this->sc_temp_glo_customer_id)) {$this->sc_temp_glo_customer_id = (isset($_SESSION['glo_customer_id'])) ? $_SESSION['glo_customer_id'] : "";}
...
if (!isset($this->sc_temp_usr_login)) {$this->sc_temp_usr_login = (isset($_SESSION['usr_login'])) ? $_SESSION['usr_login'] : "";}
 ...
 unset($_SESSION['usr_group']);
 unset($this->sc_temp_usr_group);
 unset($_SESSION['glo_staff_id']);
 unset($this->sc_temp_glo_staff_id);
 unset($_SESSION['glo_customer_id']);
 unset($this->sc_temp_glo_customer_id);
 unset($_SESSION['group_name']);
 unset($this->sc_temp_group_name);
 unset($_SESSION['id_proyecto']);
 unset($this->sc_temp_id_proyecto);
 unset($_SESSION['id_partida']);
 unset($this->sc_temp_id_partida);
;
...
$year = sprintf( $this->Ini->Nm_lang['lang_page_copyright'] , date('Y'));
 $this->Ini->Nm_lang['lang_page_copyright']  = $year;
...
if (isset($this->sc_temp_glo_customer_id)) { $_SESSION['glo_customer_id'] = $this->sc_temp_glo_customer_id;}
...
if (isset($this->sc_temp_id_partida)) { $_SESSION['id_partida'] = $this->sc_temp_id_partida;}
$_SESSION['scriptcase']['app_Login']['contr_erro'] = 'off'; 
      }
      $Campos_Crit       = "";
      $Campos_erro       = "";
...
WHERE
  sec_users.login = sec_users_groups.login 
...
else if($this->rs[0][1] == 'Y')
{
	...
	$usr_group		= $this->rs[0][4];
	$usr_name		= $this->rs[0][2];
	$group_name=$this->rs[0][5];
	$glo_staff_id   = $this->rs[0][6];
...
;
	 if (isset($usr_group)) {$this->sc_temp_usr_group = $usr_group;}
;
	 if (isset($group_name)) {$this->sc_temp_group_name = $group_name;}
;
	 if (isset($glo_staff_id)) {$this->sc_temp_glo_staff_id = $glo_staff_id;}
;
}
else
{
