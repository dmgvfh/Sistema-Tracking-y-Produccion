...
$old_error_handler = set_error_handler("rechazar_horas_mob_scriptcase_error_handler");

function rechazar_horas_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['rechazar_horas_mob']['contr_erro']) && $_SESSION['scriptcase']['rechazar_horas_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_rechazar_horas_mob->contr_rechazar_horas_mob->Apl_com_erro = true;
            if ($inicial_rechazar_horas_mob->contr_rechazar_horas_mob->NM_ajax_flag)
            {
                $inicial_rechazar_horas_mob->contr_rechazar_horas_mob->NM_ajax_info['errList']['geral_rechazar_horas_mob'][] = $msg;
                return;
            }
            rechazar_horas_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function rechazar_horas_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['rechazar_horas_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['rechazar_horas_mob'])  ? $_SESSION['scriptcase']['error_icon']['rechazar_horas_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['rechazar_horas_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['rechazar_horas_mob']) ? $_SESSION['scriptcase']['error_span_title']['rechazar_horas_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['rechazar_horas_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['rechazar_horas_mob']) ? $_SESSION['scriptcase']['error_icon_title']['rechazar_horas_mob'] : '';
?>
