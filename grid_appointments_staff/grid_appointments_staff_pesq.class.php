...
class grid_appointments_staff_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_appointments_staff_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_appointments_staff_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_appointments_staff_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_refresh'] = true;
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_res'])) 
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_res'] = false; 
    }
?>
...
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_appointments_staff').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_appointments_staff').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_appointments_staff').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<HEAD>
 <TITLE>Ingrese Período De Fechas De Actividades - Bitácora Personal</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_appointments_staff/grid_appointments_staff_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_appointments_staff_ajax_search.js"></script>
 <script type="text/javascript" src="grid_appointments_staff_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_appointments_staff_message.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_appointment_start_date_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_appointment_start_date_dia').value + '/';
          var_dt_ini += document.getElementById('SC_appointment_start_date_mes').value + '/';
          var_dt_ini += document.getElementById('SC_appointment_start_date_ano').value;
          document.getElementById('sc_appointment_start_date_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_appointment_start_date_dia').value = aParts[0];
          document.getElementById('SC_appointment_start_date_mes').value = aParts[1];
          document.getElementById('SC_appointment_start_date_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_appointment_start_date_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_appointment_start_date_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_appointment_start_date_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_appointment_start_date_input_2_ano').value;
          document.getElementById('sc_appointment_start_date_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_appointment_start_date_input_2_dia').value = aParts[0];
          document.getElementById('SC_appointment_start_date_input_2_mes').value = aParts[1];
          document.getElementById('SC_appointment_start_date_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Ingrese Período De Fechas De Actividades - Bitácora Personal</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $appointment_start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_dia']; 
          $appointment_start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_mes']; 
          $appointment_start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_ano']; 
          $appointment_start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_input_2_dia']; 
          $appointment_start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_input_2_mes']; 
          $appointment_start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_input_2_ano']; 
          $appointment_start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['NM_operador']; 
      } 
...
?>
<?php
   if (is_file("grid_appointments_staff_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_modal'])
       {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_appointment_start_date_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : "Fecha Actividad"; ?></TD>
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_appointment_start_date" <?php echo $str_hide_appointment_start_date?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : "Fecha Actividad";
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_appointment_start_date_dia" name="appointment_start_date_dia" value="<?php echo NM_encode_input($appointment_start_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_appointment_start_date_mes" name="appointment_start_date_mes" value="<?php echo NM_encode_input($appointment_start_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_appointment_start_date_ano" name="appointment_start_date_ano" value="<?php echo NM_encode_input($appointment_start_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_appointment_start_date_jq">
</span>
...
?>
        <SPAN id="id_vis_appointment_start_date"  <?php echo $str_display_appointment_start_date; ?> class="scFilterFieldFontOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_appointment_start_date_input_2_dia" name="appointment_start_date_input_2_dia" value="<?php echo NM_encode_input($appointment_start_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_appointment_start_date_input_2_mes" name="appointment_start_date_input_2_mes" value="<?php echo NM_encode_input($appointment_start_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_appointment_start_date_input_2_ano" name="appointment_start_date_input_2_ano" value="<?php echo NM_encode_input($appointment_start_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_appointment_start_date_jq2">
</span>
...
{
?>
<iframe id="nmsc_iframe_grid_appointments_staff" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_appointments_staff" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_appointments_staff_pesq"  name="nm_iframe_grid_appointments_staff_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_appointments_staff_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_appointments_staff').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
 ...
 {
    $('#SC_appointment_start_date_dia').bind('change', function() {sc_grid_appointments_staff_valida_dia(this)});
    $('#SC_appointment_start_date_input_2_dia').bind('change', function() {sc_grid_appointments_staff_valida_dia(this)});
    $('#SC_appointment_start_date_input_2_mes').bind('change', function() {sc_grid_appointments_staff_valida_mes(this)});
    $('#SC_appointment_start_date_mes').bind('change', function() {sc_grid_appointments_staff_valida_mes(this)});
 }
 function sc_grid_appointments_staff_valida_dia(obj)
 {
 ...
 function sc_grid_appointments_staff_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_appointments_staff";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_appointments_staff/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $appointment_start_date_cond, $appointment_start_date, $appointment_start_date_dia, $appointment_start_date_mes, $appointment_start_date_ano, $appointment_start_date_input_2_dia, $appointment_start_date_input_2_mes, $appointment_start_date_input_2_ano, $nmgp_tab_label;
      ...
      $I_Dyn = 0;
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_dia'] = $appointment_start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_mes'] = $appointment_start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_ano'] = $appointment_start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_input_2_dia'] = $appointment_start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_input_2_mes'] = $appointment_start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_input_2_ano'] = $appointment_start_date_input_2_ano; 
      ...
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][$I_Dyn]['val'][0][] = "D:" . $appointment_start_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][$I_Dyn]['val'][0][] = "M:" . $appointment_start_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][$I_Dyn]['val'][0][] = "Y:" . $appointment_start_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][$I_Dyn]['val'][1][] = "D:" . $appointment_start_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][$I_Dyn]['val'][1][] = "M:" . $appointment_start_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][$I_Dyn]['val'][1][] = "Y:" . $appointment_start_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_cond'] = $appointment_start_date_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][$I_Dyn]['cmp'] = "appointment_start_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][$I_Dyn]['opc'] = $appointment_start_date_cond_salva; 
          $I_Dyn++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($appointment_start_date_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date'] = $val[0];
          ...
          if ($appointment_start_date_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']['appointment_start_date_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_dados'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] .= $this->NM_operador;
