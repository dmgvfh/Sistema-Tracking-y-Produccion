<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_appointments_staff_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointments_staff_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["appointment_start_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["appointment_start_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["appointment_start_date"] : "Fecha Actividad";
   $tab_ger_campos['appointment_start_time'] = "on";
   $tab_def_campos['appointment_start_time'] = "appointment_start_time";
   $tab_labels["appointment_start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["appointment_start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["appointment_start_time"] : "Hora Inicio";
   $tab_ger_campos['appointment_end_time'] = "on";
   $tab_def_campos['appointment_end_time'] = "appointment_end_time";
   $tab_labels["appointment_end_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["appointment_end_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["appointment_end_time"] : "Hora Término";
   $tab_ger_campos['intervalo'] = "on";
   $tab_def_campos['intervalo'] = "intervalo";
   $tab_labels["intervalo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["intervalo"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["intervalo"] : "Duración (horas)";
   $tab_ger_campos['id_proyecto'] = "on";
   $tab_def_campos['id_proyecto'] = "id_proyecto";
   $tab_labels["id_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["id_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["id_proyecto"] : "Proyecto";
   $tab_ger_campos['id_actividad'] = "on";
   $tab_def_campos['id_actividad'] = "id_actividad";
   $tab_labels["id_actividad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["id_actividad"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["id_actividad"] : "Tipo Actividad";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["nombre"] : "Nombre Actividad";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['current_status_id'] = "on";
   $tab_def_campos['current_status_id'] = "current_status_id";
   $tab_labels["current_status_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["current_status_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['labels']["current_status_id"] : "" . $this->Nm_lang['lang_appointments_fld_current_status_id'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>Resumen de Horas De  Actividades - Bitácora Personal</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointments_staff_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointments_staff']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
