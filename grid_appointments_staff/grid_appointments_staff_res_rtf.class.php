...
class grid_appointments_staff_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['arr_export']['data'];
   ...
   function formatValue($group, $valor_campo)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
           if ($group == 0)
           {
               nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']);
