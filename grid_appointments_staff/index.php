<?php
   include_once('grid_appointments_staff_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_perfil']          = "conn_example";
   $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class grid_appointments_staff_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "grid_appointments_staff"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_appointments_staff']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_appointments_staff']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_appointments_staff']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_appointments_staff';
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_appointments_staff']['actual_lang']) || $_SESSION['scriptcase']['grid_appointments_staff']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_appointments_staff']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("grid_appointments_staff_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_Link_View'] = true;
          }
      }
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dyn_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dyn_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      ...
      $this->sc_lig_target["C_@scinf_historia"] = '_self';
      $this->sc_lig_target["C_@scinf_historia_@scinf_grid_appointments_history"] = '_self';
      $Tmp_apl_lig = "grid_appointments_history";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/grid_appointments_history_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/grid_appointments_history_ini.txt");
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_appointments_staff"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_appointments_staff"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['link_info']['remove_border'] = true;
        }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_appointments_staff_erro.class.php"); 
      $this->Erro = new grid_appointments_staff_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_appointments_staff'); 
// 
      ...
      $this->arr_buttons_usr['enviar']['hint']             = "Con esta opción Ud. puede enviar a revisión las horas seleccionadas. Se omitirán la que ya se encuentren en estado Pendiente.";
      $this->arr_buttons_usr['enviar']['type']             = "button";
      $this->arr_buttons_usr['enviar']['value']            = "<font color=red><b>ENVIAR REGISTROS PARA APROBACIÓN</b></font>";
      $this->arr_buttons_usr['enviar']['display']          = "only_text";
      $this->arr_buttons_usr['enviar']['display_position'] = "text_right";
      $this->arr_buttons_usr['enviar']['style']            = "default";
      $this->arr_buttons_usr['enviar']['image']            = "";
      ...
      if (isset($_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['emb_linha']))
      {
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['emb_linha'] = 0;
      }
   }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_appointments_staff']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_appointments_staff']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['embutida_init']) 
      {
          if (!isset($_SESSION['glo_staff_id'])) 
          {
              $this->nm_falta_var .= "glo_staff_id; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao'], $this->root . $this->path_prod, 'carga_horas', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           $delim  = "'";
           $delim1 = "'";
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_appointments_staff']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class grid_appointments_staff_sub_css
{
   function __construct()
   {
      ...
      if (!$this->Ini) 
      { 
          $this->Ini = new grid_appointments_staff_ini(); 
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_appointments_staff']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_appointments_staff'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_appointments_staff_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_appointments_staff']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_appointments_staff'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida'] || $Parms_form_pdf)
      { 
          ...
          if (isset($total_chked)) 
          {
              ...
              nm_limpa_str_grid_appointments_staff($_SESSION["total_chked"]);
          }
          if (isset($glo_staff_id)) 
          {
              $_SESSION['glo_staff_id'] = $glo_staff_id;
              nm_limpa_str_grid_appointments_staff($_SESSION["glo_staff_id"]);
          }
          if (isset($i)) 
          {
              $_SESSION['i'] = $i;
              nm_limpa_str_grid_appointments_staff($_SESSION["i"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_pai'] = "";
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "";
      }
       if ($nmgp_opcao == "link_res")  
       { 
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           {
                $cadapar  = explode("?#?", $param);
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status")
                { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_appointments_staff']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_appointments_staff'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_appointments_staff']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_appointments_staff']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_appointments_staff') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_appointments_staff']['label'] = "Resumen de Horas De  Actividades - Bitácora Personal";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "grid_appointments_staff")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_appointments_staff_erro.class.php"); 
      } 
      $this->Erro      = new grid_appointments_staff_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_appointments_staff_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_appointments_staff_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_appointments_staff_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pivot_tabular']);
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_prefix_date_format']['status']['appointment_start_date'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYMM'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_date_format']['status']['appointment_start_date'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_date_format']['status']['appointment_start_date'] = 'YYYYMM';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_def_sql']['status']['appointment_start_date'] = 'appointment_start_date';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_All_Groupby'] = array('status' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", "Fecha Actividad");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Labels_GB'][] = "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['status']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['status'][2] = array('label' => "Total Horas (Suma)", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_order']['status'][] = 2;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_control']['status']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_control']['status'] = array(
               array(
                   'cmp_res' => "intervalo",
                   'label' => "Total Horas (Suma)",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_appointments_staff_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_appointments_staff_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_appointments_staff_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_appointments_staff_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['conf_chart_level'] = "N";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_exibe_val']    = '0';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf']      = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "appointment_start_date";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "appointment_start_time";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "appointment_end_time";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "intervalo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "id_proyecto";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "id_actividad";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "nombre";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "observaciones";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "current_status_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['use_pass_pdf'] = "";
      ...
      if (strpos($NM_orig, "/grid_appointments_staff") === false)
      {
          $nmgp_opcao = "busca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "busca";  
      }
      if (strpos($NM_orig, "/grid_appointments_history_fim.php") !== false || strpos($NM_orig, "/grid_appointments_history.php") !== false)
      {
          $nmgp_opcao = "igual";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "igual";  
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status") 
      {
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_select']))  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_select'] = array(); 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_select']['appointment_start_date'] = 'DESC'; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_select']['appointment_start_time'] = 'DESC'; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_select']; 
          } 
      }
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'])) && !isset($_POST['reload_comb_chart']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "busca";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf")
      { 
          $this->Ini->path_img_modelo = $this->Ini->path_img_modelo;
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['contr_array_resumo'] = "NAO";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['contr_total_geral']  = "NAO";
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral']);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['orig_pesq'] = 'grid';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_refresh'] = true;
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "dyn_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "dyn_search_clear")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "dyn_search_clear")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_clear'] = true;
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "interativ_search")
      { 
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = 'inicio';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_refresh'] = true;
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search']        = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_dyn_search']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_ant'];  
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_appointments_staff_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_appointments_staff.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_appointments_staff_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_appointments_staff_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_appointments_staff_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_xls.class.php"); 
          } 
          $this->xls  = new grid_appointments_staff_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_res_xls.class.php"); 
          } 
          $this->xls  = new grid_appointments_staff_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_xml.class.php"); 
          } 
          $this->xml  = new grid_appointments_staff_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_res_xml.class.php"); 
          } 
          $this->xml  = new grid_appointments_staff_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_csv.class.php"); 
          } 
          $this->csv  = new grid_appointments_staff_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_res_csv.class.php"); 
          } 
          $this->csv  = new grid_appointments_staff_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_rtf.class.php"); 
          } 
          $this->rtf  = new grid_appointments_staff_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_appointments_staff_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_appointments_staff . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new grid_appointments_staff_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_appointments_staff_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grid_appointments_staff_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_appointments_staff_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_grid.class.php"); 
          } 
          $this->grid  = new grid_appointments_staff_grid();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "ajax_detalhe")  
             {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_appointments_staff_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_name']);
            }
            ...
            $str_cmd_qpdf = "";
            $str_zip      = "";
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_appointments_staff_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_appointments_staff_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<HEAD>
 <TITLE>Resumen de Horas De  Actividades - Bitácora Personal :: PDF</TITLE>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_appointments_staff.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_sql_btn_run']))
{
    foreach ($NM_index_reg as $Run_register)
    {
       if (!is_numeric($Run_register)) { continue; }
       $Temp_fields = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_sql_btn_run'][$Run_register];
       $this->appointment_start_date = $Temp_fields[0] ;  
       $this->appointment_start_time = $Temp_fields[1] ;  
       $this->appointment_end_time = $Temp_fields[2] ;  
       $this->intervalo = $Temp_fields[3] ;  
       $this->intervalo = (string)$this->intervalo;
       $this->id_proyecto = $Temp_fields[4] ;  
       $this->id_proyecto = (string)$this->id_proyecto;
       $this->id_actividad = $Temp_fields[5] ;  
       $this->id_actividad = (string)$this->id_actividad;
       $this->nombre = $Temp_fields[6] ;  
       $this->observaciones = $Temp_fields[7] ;  
       $this->current_status_id = $Temp_fields[8] ;  
      ...
      $_SESSION['scriptcase']['grid_appointments_staff']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_appointments_staff']['contr_erro'] = 'off'; 
    }  
    $_SESSION['scriptcase']['grid_appointments_staff']['contr_erro'] = 'on';
if (!isset($_SESSION['total_chked'])) {$_SESSION['total_chked'] = "";}
if (!isset($this->sc_temp_total_chked)) {$this->sc_temp_total_chked = (isset($_SESSION['total_chked'])) ? $_SESSION['total_chked'] : "";}
...
for($x=0;$x<$tot;$x++)
{
$updateficha = "update appointments set appointments.current_status_id=1 where (appointments.current_status_id=4) and appointments.appointments_id=".$this->sc_temp_total_chked[$x];
...
$updateficha = "update appointments set appointments.current_status_id=5 where (appointments.current_status_id=6) and appointments.appointments_id=".$this->sc_temp_total_chked[$x];
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_filtro'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_dyn'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_dyn'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_dyn'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search']);
          return;
      }
      $comando = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig']; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'] . ")";
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_dyn'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_dyn'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date']))
      {
          $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date'];
          $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date1'];
      }
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_refresh'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'][] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val' => $val_sv);
           if (!isset($busca[$dats[0]]))
           {
               ...
               if ($dats[0] == "appointment_start_date")
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'][$dats[0] . '_' . $tp] = $vl;
                   }
                   ...
                   if (!empty($val))
                   {
                       foreach ($val as $tp => $vl)
                       {
                          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'][$dats[0] . '_input_2_' . $tp] = $vl;
                       }
                   }
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
                   }
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
       }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca'][$ind] = $dados;
      }
       $this->NM_case_insensitive = false;
       ...
       foreach ($fields as $ind => $dados)
       {
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_label']['appointment_start_date'];
               if ($dados['cond'] != "BI_TP")
               {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_out_cmd']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_out_cmd']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_out_cmd'] as $cada_out)
           {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_out_cond']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_out_cond']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_out_cond'] as $cada_out)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_dyn_search'] .= $cada_out . "##*@@";
           }
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_dyn'] = $this->Cmd_Dyn_Search;
       if (empty($this->Cmd_Dyn_Search)) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_filtro'] = "";
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campos_busca']      = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_dyn_search']   = "";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'] . ")";
               }
           }
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'];
               }
           }
           return;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_filtro'] = "( " . $this->Cmd_Dyn_Search . " )";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'])) 
       {
           $this->Cmd_Dyn_Search = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'] . " and (" . $this->Cmd_Dyn_Search . ")"; 
       }
       else
       {
           $this->Cmd_Dyn_Search = " where " . $this->Cmd_Dyn_Search; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] = $this->Cmd_Dyn_Search;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_dyn_search'] . $this->Dyn_Serarch_and_or;
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'])) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'] . ")";
       }
       ...
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'] = sc_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
   }
   function SC_proc_dyn_search_lookup($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       ...
       if (!empty($nm_cmd))
       {
           ...
           if ($cond == "DF" || $cond == "NP")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $nm_cond . "##*@@";
           }
           else
           {
               $this->Cmd_Dyn_Search .= "(" . $sql . " in (" . $nm_cmd . "))";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
           }
       }
   }
   function SC_proc_dyn_search_all($cond, $vls, $sql, $tp, $tsql, $lab, $tp_unaccent=false)
   {
       $nm_aspas  = "'";
       $nm_aspas1 = "'";
       if ($tp == "N" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['decimal_db'] == ".")
       {
           $nm_aspas  = "";
           $nm_aspas1 = "";
       }
       ...
       {
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date']))
           {
               $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date'];
               $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date1'];
           }
       ...
       $dados   = $vls[0];
           ...
           if (!empty($nm_cmd))
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_dyn_search'] .= $nm_cond;
           }
   }
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'] = array();
       }
       else {
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
               {
                   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date']))
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           ...
           $this->Cmd_dth = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]['val'] = $this->Cmd_dth;
           }
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
       }
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'])) 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_fast'] . ")";
          }
      }
      ...
      { 
          if (empty($tmp_where)) 
          { 
              $tmp_cmd = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_resumo']; 
          } 
          else
          { 
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_resumo'] . ")"; 
          } 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['word_file']);
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Resumen de Horas De  Actividades - Bitácora Personal :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
?>
 <link rel="shortcut icon" href="../_lib/img/scriptcase__NM__ico__NM__favicon.ico">
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_appointments_staff']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_appointments_staff($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_grid_appointments_staff($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_appointments_staff") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_carga_horas'])) {
               $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_carga_horas'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_appointments_staff']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_appointments_staff']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_appointments_staff']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']);
               $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_appointments_staff']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_appointments_staff']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_appointments_staff']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_appointments_staff']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_appointments_staff']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_appointments_staff']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_appointments_staff";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_appointments_staff' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   $_SESSION['sc_session']['grid_appointments_staff']['show_skip_charts_option'] = true;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_appointments_staff/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "es";
   if (isset($_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "tracking/tracking";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_appointments_staff')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_appointments_staff_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida'] && $nmgp_opcao != "formphp")
   { 
       if (empty($nmgp_opcao) && !isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao']))
       { 
           $nmgp_opcao = "busca";
       } 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (isset($_POST["glo_staff_id"])) 
       {
           $_SESSION["glo_staff_id"] = $_POST["glo_staff_id"];
           nm_limpa_str_grid_appointments_staff($_SESSION["glo_staff_id"]);
       }
       if (isset($_GET["glo_staff_id"])) 
       {
           $_SESSION["glo_staff_id"] = $_GET["glo_staff_id"];
           nm_limpa_str_grid_appointments_staff($_SESSION["glo_staff_id"]);
       }
       if (!isset($_SESSION["glo_staff_id"])) 
       {
           $_SESSION["glo_staff_id"] = "";
       }
       if (isset($_POST["i"])) 
       {
           $_SESSION["i"] = $_POST["i"];
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
      if (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao']) || empty($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao']) || !isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['where_orig']))  
      { 
          $nmgp_opcao = "busca" ;  
      }   
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_appointments_staff_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] != "pdf"  && $nmgp_opcao == "busca") 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_appointments_staff_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] != "pdf"  && $nmgp_opcao == "busca") 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['mostra_edit'] = "N";   
           } 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("grid_appointments_staff", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
...
<?php
       ...
       $contr_grid_appointments_staff = new grid_appointments_staff_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] = "busca";
          $contr_grid_appointments_staff->NM_ajax_flag = true;
          $contr_grid_appointments_staff->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] = "busca";
          $contr_grid_appointments_staff->NM_ajax_flag = true;
          $contr_grid_appointments_staff->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] = "busca";
          $contr_grid_appointments_staff->NM_ajax_flag = true;
          $contr_grid_appointments_staff->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] = "busca";
          $contr_grid_appointments_staff->NM_ajax_flag = true;
          $contr_grid_appointments_staff->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_grid_appointments_staff->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_appointments_staff(&$str)
   {
   }
   function nm_protect_num_grid_appointments_staff($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function grid_appointments_staff_pack_protect_string($sString)
   {
    ...
    function grid_appointments_staff_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
