...
class grid_appointments_staff_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_appointments_staff" . $this->Xls_tp;
          $this->Tit_doc    = "grid_appointments_staff" . $this->Xls_tp;
      ...
      {
          $this->sum_intervalo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][2];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status")
      {
          $this->sum_intervalo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][2];
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_appointments_staff']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      $this->NM_cmp_hidden['historia'] = "off";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->Xls_row++;
         $this->appointment_start_date = $rs->fields[0] ;  
         $this->appointment_start_time = $rs->fields[1] ;  
         $this->appointment_end_time = $rs->fields[2] ;  
         $this->intervalo = $rs->fields[3] ;  
         $this->intervalo = (string)$this->intervalo;
         $this->id_proyecto = $rs->fields[4] ;  
         ...
         $this->arg_sum_current_status_id = ($this->current_status_id == "") ? " is null " : " = " . $this->current_status_id;
          ...
          if ($Cmp_tst != $this->appointment_start_date_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status") 
          {  
              if (isset($this->current_status_id_Old) && !$prim_gb)
              {
                 $this->quebra_current_status_id_status_bot() ; 
              }
              if (isset($this->appointment_start_date_Old) && !$prim_gb)
              {
                 $this->quebra_appointment_start_date_status_bot() ; 
              }
              $this->current_status_id_Old = $this->current_status_id ; 
              $this->quebra_current_status_id_status($this->appointment_start_date, $this->current_status_id) ; 
              $Format_tst = $this->Ini->Get_Gb_date_format('status', 'appointment_start_date');
              $TP_Time = (in_array('appointment_start_date', $this->Ini->Cmp_Sql_Time)) ? "0000-00-00 " : "";
          ...
          if ($this->current_status_id !== $this->current_status_id_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status") 
          {  
              if (isset($this->current_status_id_Old) && !$prim_gb)
              {
                 $this->quebra_current_status_id_status_bot() ; 
...
$_SESSION['scriptcase']['grid_appointments_staff']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      { 
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['historia'])) ? $this->New_label['historia'] : "Historia"; 
          if ((!isset($this->NM_cmp_hidden['historia']) || $this->NM_cmp_hidden['historia'] != "off") && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->arr_span['historia'] = $this->count_span;
              $this->Emb_label_cols_historia = 0;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_historia += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_historia += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_historia++;
                         }
                     }
                  }
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      { 
          if (!isset($this->NM_cmp_hidden[$historia]) || $this->NM_cmp_hidden[$historia] != "off")
          {
              while ($this->count_span < $this->Emb_label_cols_historia)
              {
   ...
   //----- historia
   function NM_sub_cons_historia()
   {
         $this->Rows_sub_historia = array();
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         ...
         if (method_exists($this->grid_appointments_history, "controle"))
         {
             ...
             {
                 $this->row_sub = 1;
             $this->Rows_sub_historia = $_SESSION['scriptcase']['export_return'];
             return;
             }
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'] = false;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['nolabel'])
       {
 ...
 function quebra_current_status_id_status($appointment_start_date, $current_status_id) 
 {
   global $tot_current_status_id;
   $this->sc_proc_quebra_appointment_start_date = false;
   $this->sc_proc_quebra_current_status_id = true; 
   $this->Tot->quebra_current_status_id_status($appointment_start_date, $current_status_id, $this->arg_sum_appointment_start_date, $this->arg_sum_current_status_id);
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Resumen de Horas De  Actividades - Bitácora Personal :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
