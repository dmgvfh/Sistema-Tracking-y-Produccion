<?php
class grid_appointments_staff_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['grid_pesq'])) {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['charts_html'] = '';
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_appointments_staff/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_appointments_staff_resumo();
       $this->Res->Db     = $this->Db;
       ...
       if (!$this->Proc_link_res && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != 'pdf' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != 'print')
       { 
       $nm_saida->saida("     <TR>\r\n");
       $nm_saida->saida("      <TD id=\"div_refin_search\" class=\"scGridRefinedSearchPadding\" valign='top'>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'])
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['refresh_interativ']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['refresh_interativ'] == "S") {
                   $this->Ini->Arr_result['setValue'][] = array('field' => 'div_refin_search', 'value' => NM_charset_to_utf8($_SESSION['scriptcase']['saida_html']));
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['refresh_interativ']);
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       $nm_saida->saida("      <TD class=\"scGridRefinedSearchMolduraResult\" valign='top'>\r\n");
       $nm_saida->saida("       <table width='100%' cellspacing=0 cellpadding=0>\r\n");
       } 
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_appointments_staff'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if (!$this->Proc_link_res && $nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != 'print')
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_refresh'] = array();
           $this->html_dynamic_search();
       } 
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['save_grid']))
       {
           $this->refresh_interativ_search();
       }
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['graf_pdf'] == "S")
       { 
           ...
           elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" && $Gera_graf)
           { 
               $this->grafico_pdf();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "grid";
           } 
       ...
       { 
           ...
           if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf")
           { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'];
 }
...
//
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_pdf']['all_label'] : "N";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_add']))
   {
       $NM_func_dyn_add = "dynamic_search_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_add']['cmp'];
       $Lin_dyn_add = $this->$NM_func_dyn_add($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_add']['seq'], 'S');
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_add']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['force_toolbar']);
   } 
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['mostra_edit'] = "N";
   }
   $this->NM_cont_emb_linha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['emb_linha'];
   ...
   $this->Cmps_ord_def['appointment_start_date'] = " desc";
   $this->Cmps_ord_def['appointment_start_time'] = " desc";
   $this->Cmps_ord_def['appointment_end_time'] = " desc";
   ...
   $this->Cmps_ord_def['current_status_id'] = " desc";
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   $NM_opc_rec = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "muda_qt_linhas";
   } 
...
$_SESSION['scriptcase']['grid_appointments_staff']['contr_erro'] = 'off'; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_sql_btn_run'] = array(); 
   $this->NM_btn_run_show = ($this->Ini->SC_Link_View || $this->grid_emb_form || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida']) ? false : true;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq']) 
   { 
      $this->nmgp_botoes['enviar'] = "off";
   } 
   if ($this->nmgp_botoes['enviar'] != "on") 
   { 
      $this->NM_btn_run_show = false;
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "print" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf") 
   { 
      $this->NM_btn_run_show = false;
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_appointments_staff_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid']; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_quebra']['appointment_start_date']["appointment_start_date"] = "DESC"; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_quebra']['current_status_id']["current_status_id"] = "asc"; 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['prim_cons'] || !empty($nmgp_parms))  
   { 
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']       = "igual" ; 
...
// 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][1] ;  
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['contr_array_resumo']))  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'];
   }
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_desc']; 
   } 
   ...
   {
       $nmgp_order_by = " order by appointment_start_date";
   }
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->appointment_start_date = $this->rs_grid->fields[0] ;  
       $this->appointment_start_time = $this->rs_grid->fields[1] ;  
       $this->appointment_end_time = $this->rs_grid->fields[2] ;  
       $this->intervalo = $this->rs_grid->fields[3] ;  
       $this->intervalo = (string)$this->intervalo;
       $this->id_proyecto = $this->rs_grid->fields[4] ;  
       $this->id_proyecto = (string)$this->id_proyecto;
       $this->id_actividad = $this->rs_grid->fields[5] ;  
       $this->id_actividad = (string)$this->id_actividad;
       $this->nombre = $this->rs_grid->fields[6] ;  
       $this->observaciones = $this->rs_grid->fields[7] ;  
       $this->current_status_id = $this->rs_grid->fields[8] ;  
       ...
       $GLOBALS["id_proyecto"] = $this->rs_grid->fields[4] ;  
       $GLOBALS["id_proyecto"] = (string)$GLOBALS["id_proyecto"] ;
       $GLOBALS["id_actividad"] = $this->rs_grid->fields[5] ;  
       $GLOBALS["id_actividad"] = (string)$GLOBALS["id_actividad"] ;
       $GLOBALS["current_status_id"] = $this->rs_grid->fields[8] ;  
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'];
...
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
   { 
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_appointments_staff_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_appointments_staff_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_appointments_staff_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_appointments_staff_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_appointments_staff_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/scriptcase__NM__ico__NM__favicon.ico\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid']) . ";\r\n");
           }
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
       ...
       $write_css = true;
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_appointments_staff_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_appointments_staff_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_appointments_staff_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_appointments_staff_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_appointments_staff_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_appointments_staff_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf_vert'])
   {
   }
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != "print") 
       { 
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_appointments_staff\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_appointments_staff\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
       }
           $nm_saida->saida("    <TR>\r\n");
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_appointments_staff\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_appointments_staff\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_appointments_staff\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_appointments_staff\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida']) ? "grid_appointments_staff_" : "";
   $this->css_sep = " ";
   ...
   $this->css_historia_label = $compl_css_emb . "css_historia_label";
   $this->css_historia_grid_line = $compl_css_emb . "css_historia_grid_line";
 }  
 function cabecalho()
 {
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_label'])
   { 
       $this->New_label['current_status_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . "";
       $this->New_label['appointments_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointments_id'] . "";
       $this->New_label['appointment_recurrent'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_recurrent'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_appointments_staff__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_appointments_staff-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_current_status_id_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_current_status_id_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($this->NM_btn_run_show) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_current_status_id_label'] . "\" ><input type=checkbox id=\"NM_ck_run0\" name=\"NM_ck_grid[]\" value=\"0\" style=\"display:" . $this->SC_contr_ck_grid . "\" onClick=\"nm_marca_check_grid(this)\"></TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] != "pdf") {
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " sc-col-actionbar-left \"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_current_status_id_label'] . "\" ><style>\r\n");
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_appointments_staff_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_appointment_start_date()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_appointment_start_date_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_appointment_start_date_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != 'pdf') {
        ...
        $fieldSortRule = $this->scGetColumnOrderRule('appointment_start_date');
        $fieldSortIcon = $this->scGetColumnOrderIcon('appointment_start_date', $fieldSortRule);
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_appointment_start_date_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
            ...
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_appointment_start_date_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('appointment_start_date')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
 ...
 function NM_label_appointment_start_time()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_appointment_start_time_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_appointment_start_time_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $fieldSortRule = $this->scGetColumnOrderRule('appointment_start_time');
        $fieldSortIcon = $this->scGetColumnOrderIcon('appointment_start_time', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_appointment_start_time_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "\<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_appointment_start_time_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('appointment_start_time')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_appointment_end_time()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_appointment_end_time_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_appointment_end_time_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $fieldSortRule = $this->scGetColumnOrderRule('appointment_end_time');
        $fieldSortIcon = $this->scGetColumnOrderIcon('appointment_end_time', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_appointment_end_time_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "\<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_appointment_end_time_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('appointment_end_time')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_current_status_id()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_current_status_id_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_current_status_id_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: center';
        $fieldSortRule = $this->scGetColumnOrderRule('current_status_id');
        $fieldSortIcon = $this->scGetColumnOrderIcon('current_status_id', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_current_status_id_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "\<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_current_status_id_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('current_status_id')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : "Fecha Actividad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_start_date'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['appointment_start_time'])) ? $this->New_label['appointment_start_time'] : "Hora Inicio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_start_time'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['appointment_end_time'])) ? $this->New_label['appointment_end_time'] : "Hora Término";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_end_time'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['intervalo'])) ? $this->New_label['intervalo'] : "Duración (horas)";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['intervalo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_proyecto'])) ? $this->New_label['id_proyecto'] : "Proyecto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['id_proyecto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_actividad'])) ? $this->New_label['id_actividad'] : "Tipo Actividad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['id_actividad'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nombre'])) ? $this->New_label['nombre'] : "Nombre Actividad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['observaciones'])) ? $this->New_label['observaciones'] : "Observaciones";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['observaciones'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['current_status_id'])) ? $this->New_label['current_status_id'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['current_status_id'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['lig_edit'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_refresh'] = false;
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_appointments_staff#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cab_embutida'] != "S")
               {
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_appointments_staff\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_appointments_staff\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_appointments_staff', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_appointments_staff', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_appointments_staff', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" &&
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_appointments_staff\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_appointments_staff\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               if (!$_SESSION['scriptcase']['proc_mobile']) {
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_appointments_staff\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_appointments_staff\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               }
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_appointments_staff\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_appointments_staff\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_appointments_staff#?#1\"";
   } 
   $TD_padding = "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf_vert'])
{
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-ce1cc278\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Page_break_PDF'] = array();
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final'] == 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status") 
   { 
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          $this->NM_cont_emb_linha++;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['emb_linha']++;
          if ($this->Ini->qual_linha == "impar")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['ini_cor_grid'] = "impar";
          }
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_appointments_staff_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          {
              $this->SC_seq_btn_run++;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_sql_btn_run'][$this->SC_seq_btn_run] = $this->rs_grid->fields;
          }
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final'] + 1; 
          ...
          {  
              ...
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby']]['appointment_start_date'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Page_break_PDF']['appointment_start_date'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->current_status_id_Old = $this->current_status_id ; 
          ...
          {  
              ...
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby']]['current_status_id'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Page_break_PDF']['current_status_id'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->current_status_id_Old = $this->current_status_id ; 
...
$_SESSION['scriptcase']['grid_appointments_staff']['contr_erro'] = 'off';
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_historia_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"  >&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_historia_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\" >\r\n");
 ...
 if ($this->NM_btn_run_show){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_historia_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\" > <input type=\"checkbox\" id=\"NM_ck_run" . $this->SC_seq_btn_run . "\" class=\"sc-ui-check-run\" name=\"NM_ck_grid[]\" value=\"" . NM_encode_input($this->SC_seq_btn_run) . "\" style=\"align:left;vertical-align:middle;font-weight:bold;\" /></TD>\r\n");
 } 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['mostra_edit'] != "N"){ 
          ...
          $nm_saida->saida("<td style=\"padding: 0px\"><img id=\"b_open_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_close_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">\r\n");
          $nm_saida->saida("<img id=\"b_close_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_open_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">\r\n");
          $nm_saida->saida("</td>\r\n");
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] != "pdf"){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  NOWRAP align=\"center\" valign=\"top\" WIDTH=\"1px\" ><img id=\"b_open_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_close_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">\r\n");
          $nm_saida->saida("<img id=\"b_close_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_open_emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">\r\n");
          $nm_saida->saida("</TD>\r\n");
 } 
          ...
          { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] != "pdf")
              { 
                  $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:none\">\r\n");
              } 
              else 
              { 
                  $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_grid_appointments_staff_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:''\">\r\n");
              } 
              $nm_saida->saida("<TD class=\"" . $this->css_line_fonf . "\" colspan=\"" . $this->NM_colspan . "\"><TABLE align=\"center\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\" width=\"100%\"><TR>\r\n");
              $this->NM_grid_historia();
              $nm_saida->saida("</TR></TABLE></TD>\r\n");
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   if ($this->rs_grid->EOF) 
   { 
       if (isset($this->current_status_id_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status")
       {
           $this->quebra_current_status_id_status_bot() ; 
       }
       if (isset($this->appointment_start_date_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status")
       {
           $this->quebra_appointment_start_date_status_bot() ; 
       }
  
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
 ...
 function NM_grid_nombre()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nombre']) || $this->NM_cmp_hidden['nombre'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function NM_grid_historia()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_historia_grid_line . "\"  style=\"" . $this->Css_Cmp['css_historia_grid_line'] . "\"  align=\"\" valign=\"top\"  >\r\n");
          if (!$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] != "pdf")
          { 
              $link_div = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida_opcao'] = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['doc_word']) ? "doc_word" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'];
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
              { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['emb_lig_aba'] = array_merge($this->Ini->Init_apl_lig, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['emb_lig_aba']);
              }
              else 
              { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] != "pdf")
          { 
 ...
 {
   $this->NM_colspan  = 12;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] || $this->NM_btn_run_show)
   {
       $this->NM_colspan++;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_pdf'] == "pdf")
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 { global
   ...
   { 
       ...
       if ($this->SC_tab_quebra > 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_grid'])
       {
 ...
 { global 
          $appointment_start_date_ant_desc, 
          $nm_saida, $tot_appointment_start_date;
   $NM_cmp_tot['intervalo']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . '');
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['rows_emb']++;
   $appointment_start_date_ant_desc = $this->campos_quebra_appointment_start_date[0]['cmp'];
   ...
   $prim_lin_tit = true;
   $tit_lin_sumariza = "Total Horas Mes";
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "intervalo" && (!isset($this->NM_cmp_hidden['intervalo']) || $this->NM_cmp_hidden['intervalo'] != "off"))
    {
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['intervalo'][$Tipo_Sum]))
      {
          $conteudo =  $tot_appointment_start_date[$NM_cmp_tot['intervalo'][$Tipo_Sum]]; 
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_intervalo_S_sub_tot";} 
 ...
 { global
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" && !$this->Print_All)
   {
       $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H3 style=\"font-size:0;padding:1px\">" .  $this->campos_quebra_current_status_id[0]['cmp'] ;
 ...
 { global 
   ...
   $prim_lin_tit = true;
   $tit_lin_sumariza = "Total Horas Estado";
   $tit_lin_sumariza_orig = $tit_lin_sumariza;
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   if (!$prim_lin_tit)
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "intervalo" && (!isset($this->NM_cmp_hidden['intervalo']) || $this->NM_cmp_hidden['intervalo'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['intervalo'][$Tipo_Sum]))
      {
          $conteudo =  $tot_current_status_id[$NM_cmp_tot['intervalo'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
 ...
 function quebra_geral_status_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][1] . ")";
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "intervalo" && (!isset($this->NM_cmp_hidden['intervalo']) || $this->NM_cmp_hidden['intervalo'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['intervalo'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][$NM_cmp_tot['intervalo'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "S") {$NM_css_field = " css_intervalo_S_tot_ger";} 
...
$nm_saida->saida("    </style>\r\n");
      ...
      { 
          $this->nm_btn_exist['enviar'][] = "sc_enviar_top";
          $Cod_Btn = nmButtonOutput($this->arr_buttons, "enviar", "sc_btn_enviar();", "sc_btn_enviar();", "sc_enviar_top", "", "<font color=red><b>ENVIAR REGISTROS PARA APROBACIÓN</b></font>", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida("          $Cod_Btn \r\n");
          $NM_btn = true;
      } 
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Xls_mod_export = "grid";
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['print'][] = "print_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=PC&nm_cor=PB&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
          ...
          if (is_file("grid_appointments_staff_help.txt") && !$this->grid_emb_form)
          {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['qt_lin_grid'] == '50') ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $Cod_Btn = nmButtonGroupTableOutput($this->arr_buttons, "group_group_1", 'group_1', 'top', 'app', 'ini');
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      $Tem_gb_pdf  = "s";
      $Tem_pdf_res = "n";
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          $Xml_mod_export = "grid";
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          $Csv_mod_export = "grid";
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
          $UseAlias =  "S";
          $nm_saida->saida("            <div id=\"div_ordcmp_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['sort_col'][] = "ordcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_dynamic_search()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq']))
       {
           $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['cond_pesq'];
           $pos = strrpos($tmp, "##*@@");
           if ($pos !== false)
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'])
       {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['save_grid']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_clear']))
           {
               return;
           }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_label'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_label']['appointment_start_date'] = (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : "Fecha Actividad";
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search'] as $IX => $def)
           {
               $cmp = $def['cmp'];
       ...
       $Cod_Btn = nmButtonOutput($this->arr_buttons, "bapply_appdiv", "ajax_add_dyn_search('appointment_start_date', 'grid'); return false;", "ajax_add_dyn_search('appointment_start_date', 'grid'); return false;", "id_dyn_search_fields", "", "" . $this->Ini->Nm_lang['lang_othr_dynamicsearch_fields'] . "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "" . $this->Ini->Nm_lang['lang_othr_dynamicsearch_fields_hint'] . "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
       $nm_saida->saida("      $Cod_Btn \r\n");
       $nm_saida->saida("      &nbsp;&nbsp;&nbsp;\r\n");
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           $this->Ini->Arr_result['setValue'][] = array('field' => 'id_dyn_search_cmd_str', 'value' => NM_charset_to_utf8(trim($this->Dyn_search_str)));
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_clear']))
           { 
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_clear']);
               return;
           } 
       } 
       $nm_saida->saida("   </tr>\r\n");
   ...
   function dynamic_search_appointment_start_date($ind, $ajax, $opc="", $val=array())
   {
       ...
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dyn_search_label']['appointment_start_date'] . "</td>";
       ...
       $lin_obj .= "     <input type=\"hidden\" id=\"sc_appointment_start_date_jq_" . $ind . "\">";
       $lin_obj .= "       </span>";
       if ($opc == "bw")
       {
           $display_in_2 = "''";
       ...
       $lin_obj .= "     <input type=\"hidden\" id=\"sc_appointment_start_date_v2__jq_" . $ind . "\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "      </td>";
   ...
   function JS_dynamic_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_appointments_staff_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_appointments_staff_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['appointment_start_date_mes'] =  'sc_grid_appointments_staff_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['appointment_start_date_dia'] =  'sc_grid_appointments_staff_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['appointment_start_date_v2__mes'] =  'sc_grid_appointments_staff_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['appointment_start_date_v2__dia'] =  'sc_grid_appointments_staff_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['appointment_start_date_mes']", 'value' => 'sc_grid_appointments_staff_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['appointment_start_date_dia']", 'value' => 'sc_grid_appointments_staff_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['appointment_start_date_v2__mes']", 'value' => 'sc_grid_appointments_staff_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['appointment_start_date_v2__dia']", 'value' => 'sc_grid_appointments_staff_valida_dia(this)');
       } 
       ...
       $nm_saida->saida("                     $('#sc_appointment_start_date_jq_' + i).datepicker({\r\n");
       $nm_saida->saida("                        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("                          var_dt_ini  = document.getElementById('dyn_search_appointment_start_date_dia_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('dyn_search_appointment_start_date_mes_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('dyn_search_appointment_start_date_ano_val_' + i_calendar).value;\r\n");
       $nm_saida->saida("                          document.getElementById('sc_appointment_start_date_jq_' + i_calendar).value = var_dt_ini;\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("                          aParts  = dateText.split(\"/\");\r\n");
       $nm_saida->saida("                          document.getElementById('dyn_search_appointment_start_date_dia_val_' + i_calendar).value = aParts[0];\r\n");
       $nm_saida->saida("                          document.getElementById('dyn_search_appointment_start_date_mes_val_' + i_calendar).value = aParts[1];\r\n");
       $nm_saida->saida("                          document.getElementById('dyn_search_appointment_start_date_ano_val_' + i_calendar).value = aParts[2];\r\n");
       $nm_saida->saida("                        },\r\n");
       ...
       $nm_saida->saida("                     });\r\n");
       $nm_saida->saida("                     var i_calendar = i;\r\n");
       $nm_saida->saida("                     $('#sc_appointment_start_date_v2__jq_' + i).datepicker({\r\n");
       $nm_saida->saida("                        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("                          var_dt_ini  = document.getElementById('dyn_search_appointment_start_date_v2__dia_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('dyn_search_appointment_start_date_v2__mes_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('dyn_search_appointment_start_date_v2__ano_val_' + i_calendar).value;\r\n");
       $nm_saida->saida("                          document.getElementById('sc_appointment_start_date_v2__jq_' + i_calendar).value = var_dt_ini;\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("                          aParts  = dateText.split(\"/\");\r\n");
       $nm_saida->saida("                          document.getElementById('dyn_search_appointment_start_date_v2__dia_val_' + i_calendar).value = aParts[0];\r\n");
       $nm_saida->saida("                          document.getElementById('dyn_search_appointment_start_date_v2__mes_val_' + i_calendar).value = aParts[1];\r\n");
       $nm_saida->saida("                          document.getElementById('dyn_search_appointment_start_date_v2__ano_val_' + i_calendar).value = aParts[2];\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        showWeek: true,\r\n");
       $nm_saida->saida("                        numberOfMonths: 1,\r\n");
       $nm_saida->saida("                        changeMonth: true,\r\n");
   ...
   function html_interativ_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_dados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_dados'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_sql']   = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['appointment_start_date'] = (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : 'Fecha Actividad';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_sql']['appointment_start_date']   = "appointment_start_date";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['current_status_id'] = (isset($this->New_label['current_status_id'])) ? $this->New_label['current_status_id'] : '' . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . '';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_sql']['current_status_id']   = "current_status_id";
       ...
       $nm_saida->saida("        <div id='id_div_interativ_search_content' class='scGridRefinedSearchMoldura' style='min-width:180px;'>\r\n");
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']["appointment_start_date"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']["appointment_start_date"])) ? "none" : "";
       $displ_open= false;
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['appointment_start_date'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq']))
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_pesq'];
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_resumo'])) 
       { 
           if (empty($tmp_where)) 
           { 
               $tmp_where = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_resumo']; 
           } 
           else
           { 
               $tmp_where .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_resumo'] . ")"; 
           } 
       } 
       ...
       krsort($result);
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']['appointment_start_date'])) ? "" : "none";
       ...
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_dados']['appointment_start_date'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_dados']['appointment_start_date'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
           ...
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']['appointment_start_date']))
           {
               $lin_obj  .= "        <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear_opc', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['appointment_start_date']) . "','appointment_start_date','id_int_search_appointment_start_date','appointment_start_date', '" . NM_encode_input($dados . "##@@" . $formatado) . "', 'S');\"/>";
           }
           $lin_obj  .= "        <a href=\"javascript:nm_proc_int_search('link','dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['appointment_start_date']) . "','appointment_start_date','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'appointment_start_date', '', 'N');\" class='scGridRefinedSearchCampoFont'>";
           ...
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']['appointment_start_date']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']['appointment_start_date']['val_sel'])) ? " checked" : "";
           $checked = " checked";
           ...
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'grid_appointments_staff_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=appointment_start_date&tp_obj=dt&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
           ...
           $lin_obj .= $Cod_Btn; 
           $disp_multi_btn = 'none';
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['appointment_start_date']) . "','appointment_start_date','id_int_search_appointment_start_date','appointment_start_date', '', 'N');", "nm_proc_int_search('chbx', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['appointment_start_date']) . "','appointment_start_date','id_int_search_appointment_start_date','appointment_start_date', '', 'N');", "app_int_search_appointment_start_date", "", "", "display: $disp_multi_btn ;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']["current_status_id"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']["current_status_id"])) ? "none" : "";
       $displ_open= false;
       ...
       $lin_obj .= "              <span class=\"dn-expand-button\" style=\"cursor: pointer;\">";
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['current_status_id'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']['current_status_id'])) ? "" : "none";
       ...
       if($bol_refin_use_modal)
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_dados']['current_status_id'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           $formatado = $dados;
           ...
           if($bol_refin_use_modal && $bol_populate_modal_values)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_dados']['current_status_id'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
               $formatado_exib = "" . $this->Ini->Nm_lang['lang_refine_search_empty'] . "";
           ...
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']['current_status_id']))
           {
               $lin_obj  .= "        <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear_opc', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['current_status_id']) . "','current_status_id','id_int_search_current_status_id','current_status_id', '" . NM_encode_input($dados . "##@@" . $formatado) . "', 'S');\"/>";
           }
           $lin_obj  .= "        <a href=\"javascript:nm_proc_int_search('link','nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['current_status_id']) . "','current_status_id','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'current_status_id', '', 'N');\" class='scGridRefinedSearchCampoFont'>";
           $lin_obj  .= $formatado_exib;
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "            <span class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</span>";
           ...
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']['current_status_id']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search']['current_status_id']['val_sel'])) ? " checked" : "";
           $checked = " checked";
           ...
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'grid_appointments_staff_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=current_status_id&tp_obj=nn&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
           ...
           $lin_obj .= $Cod_Btn; 
           $disp_multi_btn = 'none';
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['current_status_id']) . "','current_status_id','id_int_search_current_status_id','current_status_id', '', 'N');", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['int_search_label']['current_status_id']) . "','current_status_id','id_int_search_current_status_id','current_status_id', '', 'N');", "app_int_search_current_status_id", "", "", "display: $disp_multi_btn ;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
...
//--- 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_appointments_staff\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_appointments_staff\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   ...
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'])
               {
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav'])
               {
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_appointments_staff', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_appointments_staff\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_appointments_staff_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("       scJs_confirm('¿ Está Seguro De Enviar Registros Seleccionados ?', sc_btn_enviar_ok, sc_btn_enviar_cancel)\r\n");
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   function sc_btn_enviar_ok()\r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       document.FBtn_Run.nm_call_php.value = \"enviar\";\r\n");
   $nm_saida->saida("       document.FBtn_Run.submit();\r\n");
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   function sc_btn_enviar_cancel()\r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       return;\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_modal']) || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['dashboard_info']['under_dashboard'])) {
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_appointments_staff';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_appointments_staff');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_appointments_staff');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_appointments_staff');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_appointments_staff');} \r\n");
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_appointments_staff_iframe.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret']) )
   {
      ...
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent.parent;\r\n");
             $nm_saida->saida("          if (parent.parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = parent.opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = parent.opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = parent.opener;\r\n");
          $nm_saida->saida("          if (parent.opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = parent.opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_appointments_staff_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_appointments_staff')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_appointments_staff', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
