  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_produccion_proyecto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_produccion_proyecto_mob_form();
	}
...
?>
  ...
  function do_ajax_form_prod_produccion_proyecto_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_id_proyecto_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_id_proyecto

  function do_ajax_form_prod_produccion_proyecto_mob_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_id_proyecto_cb

  // ---------- Validate duracion_contrato
  function do_ajax_form_prod_produccion_proyecto_mob_validate_duracion_contrato()
  {
    var nomeCampo_duracion_contrato = "duracion_contrato";
    var var_duracion_contrato = scAjaxGetFieldText(nomeCampo_duracion_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_duracion_contrato(var_duracion_contrato, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_duracion_contrato_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_duracion_contrato

  function do_ajax_form_prod_produccion_proyecto_mob_validate_duracion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "duracion_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_duracion_contrato_cb

  // ---------- Validate correlativo_mes
  function do_ajax_form_prod_produccion_proyecto_mob_validate_correlativo_mes()
  {
    var nomeCampo_correlativo_mes = "correlativo_mes";
    var var_correlativo_mes = scAjaxGetFieldText(nomeCampo_correlativo_mes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_correlativo_mes(var_correlativo_mes, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_correlativo_mes_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_correlativo_mes

  function do_ajax_form_prod_produccion_proyecto_mob_validate_correlativo_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correlativo_mes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_correlativo_mes_cb

  // ---------- Validate monto_proyecto
  function do_ajax_form_prod_produccion_proyecto_mob_validate_monto_proyecto()
  {
    var nomeCampo_monto_proyecto = "monto_proyecto";
    var var_monto_proyecto = scAjaxGetFieldText(nomeCampo_monto_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_monto_proyecto(var_monto_proyecto, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_monto_proyecto_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_monto_proyecto

  function do_ajax_form_prod_produccion_proyecto_mob_validate_monto_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto_proyecto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_monto_proyecto_cb

  // ---------- Validate modificacion_contrato
  function do_ajax_form_prod_produccion_proyecto_mob_validate_modificacion_contrato()
  {
    var nomeCampo_modificacion_contrato = "modificacion_contrato";
    var var_modificacion_contrato = scAjaxGetFieldText(nomeCampo_modificacion_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_modificacion_contrato(var_modificacion_contrato, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_modificacion_contrato_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_modificacion_contrato

  function do_ajax_form_prod_produccion_proyecto_mob_validate_modificacion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modificacion_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_modificacion_contrato_cb

  // ---------- Validate reajuste
  function do_ajax_form_prod_produccion_proyecto_mob_validate_reajuste()
  {
    var nomeCampo_reajuste = "reajuste";
    var var_reajuste = scAjaxGetFieldText(nomeCampo_reajuste);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_reajuste(var_reajuste, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_reajuste_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_reajuste

  function do_ajax_form_prod_produccion_proyecto_mob_validate_reajuste_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "reajuste";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_reajuste_cb

  // ---------- Validate retencion
  function do_ajax_form_prod_produccion_proyecto_mob_validate_retencion()
  {
    var nomeCampo_retencion = "retencion";
    var var_retencion = scAjaxGetFieldText(nomeCampo_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_retencion(var_retencion, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_retencion_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_retencion

  function do_ajax_form_prod_produccion_proyecto_mob_validate_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_retencion_cb

  // ---------- Validate multa
  function do_ajax_form_prod_produccion_proyecto_mob_validate_multa()
  {
    var nomeCampo_multa = "multa";
    var var_multa = scAjaxGetFieldText(nomeCampo_multa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_multa(var_multa, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_multa_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_multa

  function do_ajax_form_prod_produccion_proyecto_mob_validate_multa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "multa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_multa_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_produccion_proyecto_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_prod_produccion_proyecto_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_fecha

  function do_ajax_form_prod_produccion_proyecto_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_fecha_cb

  // ---------- Validate avance
  function do_ajax_form_prod_produccion_proyecto_mob_validate_avance()
  {
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_avance

  function do_ajax_form_prod_produccion_proyecto_mob_validate_avance_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avance";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_avance_cb

  // ---------- Validate facturacion
  function do_ajax_form_prod_produccion_proyecto_mob_validate_facturacion()
  {
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_facturacion

  function do_ajax_form_prod_produccion_proyecto_mob_validate_facturacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "facturacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_facturacion_cb

  // ---------- Validate costos
  function do_ajax_form_prod_produccion_proyecto_mob_validate_costos()
  {
    var nomeCampo_costos = "costos";
    var var_costos = scAjaxGetFieldText(nomeCampo_costos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_mob_validate_costos(var_costos, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_validate_costos_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_costos

  function do_ajax_form_prod_produccion_proyecto_mob_validate_costos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "costos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_costos_cb

  // ---------- Validate backlog_f
  function do_ajax_form_prod_produccion_proyecto_mob_validate_backlog_f()
  {
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_backlog_f

  function do_ajax_form_prod_produccion_proyecto_mob_validate_backlog_f_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "backlog_f";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_backlog_f_cb

  // ---------- Validate backlog_p
  function do_ajax_form_prod_produccion_proyecto_mob_validate_backlog_p()
  {
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_backlog_p

  function do_ajax_form_prod_produccion_proyecto_mob_validate_backlog_p_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "backlog_p";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_mob_validate_backlog_p_cb

  // ---------- Event onchange facturacion
  function do_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange()
  {
    var var_backlog_p = scAjaxGetFieldHidden("backlog_p");
    var var_backlog_f = scAjaxGetFieldHidden("backlog_f");
    var var_monto_proyecto = scAjaxGetFieldText("monto_proyecto");
    var var_modificacion_contrato = scAjaxGetFieldText("modificacion_contrato");
    var var_facturacion = scAjaxGetFieldHidden("facturacion");
    var var_avance = scAjaxGetFieldHidden("avance");
    var var_duracion_contrato = scAjaxGetFieldText("duracion_contrato");
    var var_retencion = scAjaxGetFieldText("retencion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange(var_backlog_p, var_backlog_f, var_monto_proyecto, var_modificacion_contrato, var_facturacion, var_avance, var_duracion_contrato, var_retencion, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange

  function do_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "facturacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange_cb
  function do_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_produccion_proyecto_mob_event_facturacion_onchange_cb_after_alert

  // ---------- Event onchange modificacion_contrato
  function do_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange()
  {
    var var_backlog_f = scAjaxGetFieldHidden("backlog_f");
    var var_monto_proyecto = scAjaxGetFieldText("monto_proyecto");
    var var_modificacion_contrato = scAjaxGetFieldText("modificacion_contrato");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange(var_backlog_f, var_monto_proyecto, var_modificacion_contrato, var_facturacion, var_backlog_p, var_avance, var_duracion_contrato, var_retencion, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange

  function do_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "modificacion_contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange_cb
  function do_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_produccion_proyecto_mob_event_modificacion_contrato_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_produccion_proyecto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_produccion_proyecto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_duracion_contrato = scAjaxGetFieldText("duracion_contrato");
    var var_correlativo_mes = scAjaxGetFieldText("correlativo_mes");
    var var_monto_proyecto = scAjaxGetFieldText("monto_proyecto");
    var var_modificacion_contrato = scAjaxGetFieldText("modificacion_contrato");
    var var_reajuste = scAjaxGetFieldText("reajuste");
    var var_retencion = scAjaxGetFieldText("retencion");
    var var_multa = scAjaxGetFieldText("multa");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_avance = scAjaxGetFieldHidden("avance");
    var var_facturacion = scAjaxGetFieldHidden("facturacion");
    var var_costos = scAjaxGetFieldText("costos");
    var var_backlog_f = scAjaxGetFieldHidden("backlog_f");
    var var_backlog_p = scAjaxGetFieldHidden("backlog_p");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_produccion_proyecto_mob_submit_form(var_id_proyecto, var_duracion_contrato, var_correlativo_mes, var_monto_proyecto, var_modificacion_contrato, var_reajuste, var_retencion, var_multa, var_fecha, var_avance, var_facturacion, var_costos, var_backlog_f, var_backlog_p, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_produccion_proyecto_mob_submit_form_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_submit_form

  function do_ajax_form_prod_produccion_proyecto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_mob_submit_form_cb
  function do_ajax_form_prod_produccion_proyecto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_produccion_proyecto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_produccion_proyecto_mob_navigate_form()
  {
    perform_ajax_form_prod_produccion_proyecto_mob_navigate_form();
  }

  function perform_ajax_form_prod_produccion_proyecto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_prod_produccion_proyecto_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_produccion_proyecto_mob_navigate_form_cb);
  } // do_ajax_form_prod_produccion_proyecto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_produccion_proyecto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_produccion_proyecto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_mob_navigate_form_cb
  function do_ajax_form_prod_produccion_proyecto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_produccion_proyecto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_produccion_proyecto_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_produccion_proyecto_mob_form()
  {
  ...
  ajax_field_list[0] = "id_proyecto";
  ajax_field_list[1] = "duracion_contrato";
  ajax_field_list[2] = "correlativo_mes";
  ajax_field_list[3] = "monto_proyecto";
  ajax_field_list[4] = "modificacion_contrato";
  ajax_field_list[5] = "reajuste";
  ajax_field_list[6] = "retencion";
  ajax_field_list[7] = "multa";
  ajax_field_list[8] = "fecha";
  ajax_field_list[9] = "avance";
  ajax_field_list[10] = "facturacion";
  ajax_field_list[11] = "costos";
  ajax_field_list[12] = "backlog_f";
  ajax_field_list[13] = "backlog_p";
  ...
  var ajax_error_list = {
    ...
    "duracion_contrato": {"label": "Duración Contrato (Meses)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "correlativo_mes": {"label": "Correlativo Mes", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "monto_proyecto": {"label": "Monto Contrato (UF)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "modificacion_contrato": {"label": "Modificacion Contrato (UF)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "reajuste": {"label": "Reajuste", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "retencion": {"label": "Retención", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "multa": {"label": "Multa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "avance": {"label": "Avance", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "facturacion": {"label": "Facturación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "costos": {"label": "Costos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "backlog_f": {"label": "Backlog Facturación (F)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "backlog_p": {"label": "Backlog Producción (P)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "duracion_contrato": new Array(),
    "correlativo_mes": new Array(),
    "monto_proyecto": new Array(),
    "modificacion_contrato": new Array(),
    "reajuste": new Array(),
    "retencion": new Array(),
    "multa": new Array(),
    "fecha": new Array(),
    "avance": new Array(),
    "facturacion": new Array(),
    "costos": new Array(),
    "backlog_f": new Array(),
    "backlog_p": new Array()
  };
  ajax_field_mult["id_proyecto"][1] = "id_proyecto";
  ajax_field_mult["duracion_contrato"][1] = "duracion_contrato";
  ajax_field_mult["correlativo_mes"][1] = "correlativo_mes";
  ajax_field_mult["monto_proyecto"][1] = "monto_proyecto";
  ajax_field_mult["modificacion_contrato"][1] = "modificacion_contrato";
  ajax_field_mult["reajuste"][1] = "reajuste";
  ajax_field_mult["retencion"][1] = "retencion";
  ajax_field_mult["multa"][1] = "multa";
  ajax_field_mult["fecha"][1] = "fecha";
  ajax_field_mult["avance"][1] = "avance";
  ajax_field_mult["facturacion"][1] = "facturacion";
  ajax_field_mult["costos"][1] = "costos";
  ajax_field_mult["backlog_f"][1] = "backlog_f";
  ajax_field_mult["backlog_p"][1] = "backlog_p";

  var ajax_field_id = {
    "id_proyecto": new Array("hidden_field_label_id_proyecto", "hidden_field_data_id_proyecto"),
    "duracion_contrato": new Array("hidden_field_label_duracion_contrato", "hidden_field_data_duracion_contrato"),
    "correlativo_mes": new Array("hidden_field_label_correlativo_mes", "hidden_field_data_correlativo_mes"),
    "monto_proyecto": new Array("hidden_field_label_monto_proyecto", "hidden_field_data_monto_proyecto"),
    "modificacion_contrato": new Array("hidden_field_label_modificacion_contrato", "hidden_field_data_modificacion_contrato"),
    "reajuste": new Array("hidden_field_label_reajuste", "hidden_field_data_reajuste"),
    ...
    "avance": new Array("hidden_field_label_avance", "hidden_field_data_avance"),
    "facturacion": new Array("hidden_field_label_facturacion", "hidden_field_data_facturacion"),
    "costos": new Array("hidden_field_label_costos", "hidden_field_data_costos"),
    "backlog_f": new Array("hidden_field_label_backlog_f", "hidden_field_data_backlog_f"),
    "backlog_p": new Array("hidden_field_label_backlog_p", "hidden_field_data_backlog_p")
  };

  var ajax_read_only = {
    "id_proyecto": "off",
    "duracion_contrato": "on",
    "correlativo_mes": "off",
    "monto_proyecto": "on",
    "modificacion_contrato": "off",
    "reajuste": "on",
    "retencion": "on",
    "multa": "off",
    "fecha": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("modificacion_contrato" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
