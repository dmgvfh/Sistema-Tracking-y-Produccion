  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_produccion_proyecto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_produccion_proyecto_form();
	}
...
?>
  ...
  function do_ajax_form_prod_produccion_proyecto_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_id_proyecto_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_id_proyecto

  function do_ajax_form_prod_produccion_proyecto_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_id_proyecto_cb

  // ---------- Validate duracion_contrato
  function do_ajax_form_prod_produccion_proyecto_validate_duracion_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_duracion_contrato(var_duracion_contrato, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_duracion_contrato_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_duracion_contrato

  function do_ajax_form_prod_produccion_proyecto_validate_duracion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_duracion_contrato_cb

  // ---------- Validate correlativo_mes
  function do_ajax_form_prod_produccion_proyecto_validate_correlativo_mes()
  {
    var nomeCampo_correlativo_mes = "correlativo_mes";
    var var_correlativo_mes = scAjaxGetFieldText(nomeCampo_correlativo_mes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_correlativo_mes(var_correlativo_mes, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_correlativo_mes_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_correlativo_mes

  function do_ajax_form_prod_produccion_proyecto_validate_correlativo_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_correlativo_mes_cb

  // ---------- Validate monto_proyecto
  function do_ajax_form_prod_produccion_proyecto_validate_monto_proyecto()
  {
    var nomeCampo_monto_proyecto = "monto_proyecto";
    var var_monto_proyecto = scAjaxGetFieldText(nomeCampo_monto_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_monto_proyecto(var_monto_proyecto, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_monto_proyecto_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_monto_proyecto

  function do_ajax_form_prod_produccion_proyecto_validate_monto_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_monto_proyecto_cb

  // ---------- Validate modificacion_contrato
  function do_ajax_form_prod_produccion_proyecto_validate_modificacion_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_modificacion_contrato(var_modificacion_contrato, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_modificacion_contrato_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_modificacion_contrato

  function do_ajax_form_prod_produccion_proyecto_validate_modificacion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_modificacion_contrato_cb

  // ---------- Validate reajuste
  function do_ajax_form_prod_produccion_proyecto_validate_reajuste()
  {
    var nomeCampo_reajuste = "reajuste";
    var var_reajuste = scAjaxGetFieldText(nomeCampo_reajuste);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_reajuste(var_reajuste, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_reajuste_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_reajuste

  function do_ajax_form_prod_produccion_proyecto_validate_reajuste_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_reajuste_cb

  // ---------- Validate retencion
  function do_ajax_form_prod_produccion_proyecto_validate_retencion()
  {
    var nomeCampo_retencion = "retencion";
    var var_retencion = scAjaxGetFieldText(nomeCampo_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_retencion(var_retencion, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_retencion_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_retencion

  function do_ajax_form_prod_produccion_proyecto_validate_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_retencion_cb

  // ---------- Validate multa
  function do_ajax_form_prod_produccion_proyecto_validate_multa()
  {
    var nomeCampo_multa = "multa";
    var var_multa = scAjaxGetFieldText(nomeCampo_multa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_multa(var_multa, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_multa_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_multa

  function do_ajax_form_prod_produccion_proyecto_validate_multa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "multa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_multa_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_produccion_proyecto_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_prod_produccion_proyecto_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_prod_produccion_proyecto_validate_fecha

  function do_ajax_form_prod_produccion_proyecto_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_fecha_cb

  // ---------- Validate avance
  function do_ajax_form_prod_produccion_proyecto_validate_avance()
  {
  } // do_ajax_form_prod_produccion_proyecto_validate_avance

  function do_ajax_form_prod_produccion_proyecto_validate_avance_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avance";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_avance_cb

  // ---------- Validate facturacion
  function do_ajax_form_prod_produccion_proyecto_validate_facturacion()
  {
  } // do_ajax_form_prod_produccion_proyecto_validate_facturacion

  function do_ajax_form_prod_produccion_proyecto_validate_facturacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_facturacion_cb

  // ---------- Validate costos
  function do_ajax_form_prod_produccion_proyecto_validate_costos()
  {
    var nomeCampo_costos = "costos";
    var var_costos = scAjaxGetFieldText(nomeCampo_costos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_validate_costos(var_costos, var_script_case_init, do_ajax_form_prod_produccion_proyecto_validate_costos_cb);
  } // do_ajax_form_prod_produccion_proyecto_validate_costos

  function do_ajax_form_prod_produccion_proyecto_validate_costos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "costos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_costos_cb

  // ---------- Validate backlog_f
  function do_ajax_form_prod_produccion_proyecto_validate_backlog_f()
  {
  } // do_ajax_form_prod_produccion_proyecto_validate_backlog_f

  function do_ajax_form_prod_produccion_proyecto_validate_backlog_f_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_backlog_f_cb

  // ---------- Validate backlog_p
  function do_ajax_form_prod_produccion_proyecto_validate_backlog_p()
  {
  } // do_ajax_form_prod_produccion_proyecto_validate_backlog_p

  function do_ajax_form_prod_produccion_proyecto_validate_backlog_p_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_validate_backlog_p_cb

  // ---------- Event onchange facturacion
  function do_ajax_form_prod_produccion_proyecto_event_facturacion_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_prod_produccion_proyecto_event_facturacion_onchange(var_backlog_p, var_backlog_f, var_monto_proyecto, var_modificacion_contrato, var_facturacion, var_avance, var_duracion_contrato, var_retencion, var_script_case_init, do_ajax_form_prod_produccion_proyecto_event_facturacion_onchange_cb);
  } // do_ajax_form_prod_produccion_proyecto_event_facturacion_onchange

  function do_ajax_form_prod_produccion_proyecto_event_facturacion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "facturacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_event_facturacion_onchange_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_event_facturacion_onchange_cb
  function do_ajax_form_prod_produccion_proyecto_event_facturacion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_produccion_proyecto_event_facturacion_onchange_cb_after_alert

  // ---------- Event onchange modificacion_contrato
  function do_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange()
  {
    var var_backlog_f = scAjaxGetFieldHidden("backlog_f");
    var var_monto_proyecto = scAjaxGetFieldText("monto_proyecto");
    var var_modificacion_contrato = scAjaxGetFieldText("modificacion_contrato");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange(var_backlog_f, var_monto_proyecto, var_modificacion_contrato, var_facturacion, var_backlog_p, var_avance, var_duracion_contrato, var_retencion, var_script_case_init, do_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange_cb);
  } // do_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange

  function do_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "modificacion_contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange_cb
  function do_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_produccion_proyecto_event_modificacion_contrato_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_produccion_proyecto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_produccion_proyecto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_prod_produccion_proyecto_submit_form(var_id_proyecto, var_duracion_contrato, var_correlativo_mes, var_monto_proyecto, var_modificacion_contrato, var_reajuste, var_retencion, var_multa, var_fecha, var_avance, var_facturacion, var_costos, var_backlog_f, var_backlog_p, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_produccion_proyecto_submit_form_cb);
  } // do_ajax_form_prod_produccion_proyecto_submit_form

  function do_ajax_form_prod_produccion_proyecto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_submit_form_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_submit_form_cb
  function do_ajax_form_prod_produccion_proyecto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_produccion_proyecto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_produccion_proyecto_navigate_form()
  {
    perform_ajax_form_prod_produccion_proyecto_navigate_form();
  }

  function perform_ajax_form_prod_produccion_proyecto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_prod_produccion_proyecto_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_produccion_proyecto_navigate_form_cb);
  } // do_ajax_form_prod_produccion_proyecto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_produccion_proyecto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_produccion_proyecto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_navigate_form_cb
  function do_ajax_form_prod_produccion_proyecto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_produccion_proyecto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_produccion_proyecto_navigate_form_cb_after_alert

  function sc_hide_form_prod_produccion_proyecto_form()
  {
