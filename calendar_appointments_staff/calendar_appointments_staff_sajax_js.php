  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_appointments_staff" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_appointments_staff_form();
	}
...
?>
  ...
  function do_ajax_calendar_appointments_staff_validate_current_status_id()
  {
    ...
    x_ajax_calendar_appointments_staff_validate_current_status_id(var_current_status_id, var_script_case_init, do_ajax_calendar_appointments_staff_validate_current_status_id_cb);
  } // do_ajax_calendar_appointments_staff_validate_current_status_id

  function do_ajax_calendar_appointments_staff_validate_current_status_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_current_status_id_cb

  // ---------- Validate nombre
  function do_ajax_calendar_appointments_staff_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_nombre(var_nombre, var_script_case_init, do_ajax_calendar_appointments_staff_validate_nombre_cb);
  } // do_ajax_calendar_appointments_staff_validate_nombre

  function do_ajax_calendar_appointments_staff_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_nombre_cb

  // ---------- Validate id_actividad
  function do_ajax_calendar_appointments_staff_validate_id_actividad()
  {
    var nomeCampo_id_actividad = "id_actividad";
    var var_id_actividad = scAjaxGetFieldSelect(nomeCampo_id_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_id_actividad(var_id_actividad, var_script_case_init, do_ajax_calendar_appointments_staff_validate_id_actividad_cb);
  } // do_ajax_calendar_appointments_staff_validate_id_actividad

  function do_ajax_calendar_appointments_staff_validate_id_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_id_actividad_cb

  // ---------- Validate busca_proyecto
  function do_ajax_calendar_appointments_staff_validate_busca_proyecto()
  {
    var nomeCampo_busca_proyecto = "busca_proyecto";
    var var_busca_proyecto = scAjaxGetFieldText(nomeCampo_busca_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_busca_proyecto(var_busca_proyecto, var_script_case_init, do_ajax_calendar_appointments_staff_validate_busca_proyecto_cb);
  } // do_ajax_calendar_appointments_staff_validate_busca_proyecto

  function do_ajax_calendar_appointments_staff_validate_busca_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_busca_proyecto_cb

  // ---------- Validate id_proyecto
  function do_ajax_calendar_appointments_staff_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_calendar_appointments_staff_validate_id_proyecto_cb);
  } // do_ajax_calendar_appointments_staff_validate_id_proyecto

  function do_ajax_calendar_appointments_staff_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_id_proyecto_cb

  // ---------- Validate appointment_start_date
  function do_ajax_calendar_appointments_staff_validate_appointment_start_date()
  {
    ...
    setTimeout(function() {
      var var_appointment_start_date = scAjaxGetFieldText(nomeCampo_appointment_start_date);
      x_ajax_calendar_appointments_staff_validate_appointment_start_date(var_appointment_start_date, var_script_case_init, do_ajax_calendar_appointments_staff_validate_appointment_start_date_cb);
    }, 200);
  } // do_ajax_calendar_appointments_staff_validate_appointment_start_date

  function do_ajax_calendar_appointments_staff_validate_appointment_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_appointment_start_date_cb

  // ---------- Validate appointment_start_time
  function do_ajax_calendar_appointments_staff_validate_appointment_start_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_appointment_start_time(var_appointment_start_time, var_script_case_init, do_ajax_calendar_appointments_staff_validate_appointment_start_time_cb);
  } // do_ajax_calendar_appointments_staff_validate_appointment_start_time

  function do_ajax_calendar_appointments_staff_validate_appointment_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_appointment_start_time_cb

  // ---------- Validate appointment_end_time
  function do_ajax_calendar_appointments_staff_validate_appointment_end_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_appointment_end_time(var_appointment_end_time, var_script_case_init, do_ajax_calendar_appointments_staff_validate_appointment_end_time_cb);
  } // do_ajax_calendar_appointments_staff_validate_appointment_end_time

  function do_ajax_calendar_appointments_staff_validate_appointment_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_appointment_end_time_cb

  // ---------- Validate intervalo
  function do_ajax_calendar_appointments_staff_validate_intervalo()
  {
    var nomeCampo_intervalo = "intervalo";
    var var_intervalo = scAjaxGetFieldText(nomeCampo_intervalo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_intervalo(var_intervalo, var_script_case_init, do_ajax_calendar_appointments_staff_validate_intervalo_cb);
  } // do_ajax_calendar_appointments_staff_validate_intervalo

  function do_ajax_calendar_appointments_staff_validate_intervalo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_intervalo_cb

  // ---------- Validate estado
  function do_ajax_calendar_appointments_staff_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_estado(var_estado, var_script_case_init, do_ajax_calendar_appointments_staff_validate_estado_cb);
  } // do_ajax_calendar_appointments_staff_validate_estado

  function do_ajax_calendar_appointments_staff_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_estado_cb

  // ---------- Validate observaciones
  function do_ajax_calendar_appointments_staff_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_calendar_appointments_staff_validate_observaciones_cb);
  } // do_ajax_calendar_appointments_staff_validate_observaciones

  function do_ajax_calendar_appointments_staff_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_validate_observaciones_cb

  // ---------- Refresh busca_proyecto
  function do_ajax_calendar_appointments_staff_refresh_busca_proyecto()
  {
    var var_busca_proyecto = scAjaxGetFieldText("busca_proyecto");
    var var_nmgp_refresh_fields = "id_proyecto";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_appointments_staff_refresh_busca_proyecto(var_busca_proyecto, var_nmgp_refresh_fields, var_script_case_init, do_ajax_calendar_appointments_staff_refresh_busca_proyecto_cb);
  } // do_ajax_calendar_appointments_staff_refresh_busca_proyecto

  function do_ajax_calendar_appointments_staff_refresh_busca_proyecto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_refresh_busca_proyecto_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_calendar_appointments_staff_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_appointments_staff_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_calendar_appointments_staff_submit_form(var_current_status_id, var_nombre, var_id_actividad, var_busca_proyecto, var_id_proyecto, var_appointment_start_date, var_appointment_start_time, var_appointment_end_time, var_intervalo, var_estado, var_observaciones, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_appointments_staff_submit_form_cb);
  } // do_ajax_calendar_appointments_staff_submit_form

  function do_ajax_calendar_appointments_staff_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_appointments_staff_submit_form_cb_after_alert);
  } // do_ajax_calendar_appointments_staff_submit_form_cb
  function do_ajax_calendar_appointments_staff_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_appointments_staff_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_appointments_staff_navigate_form()
  {
    perform_ajax_calendar_appointments_staff_navigate_form();
  }

  function perform_ajax_calendar_appointments_staff_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_calendar_appointments_staff_navigate_form(var_appointments_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_appointments_staff_navigate_form_cb);
  } // do_ajax_calendar_appointments_staff_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_appointments_staff_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_appointments_staff_navigate_form_cb_after_alert);
  } // do_ajax_calendar_appointments_staff_navigate_form_cb
  function do_ajax_calendar_appointments_staff_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_appointments_staff_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_appointments_staff_navigate_form_cb_after_alert

  function sc_hide_calendar_appointments_staff_form()
  {
