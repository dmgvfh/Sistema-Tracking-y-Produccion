<?php
//
class calendar_appointments_staff_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->glo_staff_id)) 
          {
              $_SESSION['glo_staff_id'] = $this->glo_staff_id;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_appointments_staff_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['calendar_appointments_staff_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_appointments_staff_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_appointments_staff_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_appointments_staff_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_appointments_staff_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_appointments_staff_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_appointments_staff_mob']['label'] = "" . $this->Ini->Nm_lang['lang_appointment_info'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "calendar_appointments_staff_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_appointments_staff_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_appointments_staff_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_orig'] = " where (id_usuario = " . $_SESSION['glo_staff_id'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_pesq'] = " where (id_usuario = " . $_SESSION['glo_staff_id'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_appointments_staff_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_appointments_staff_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_appointments_staff_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_appointments_staff/calendar_appointments_staff_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_appointments_staff_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_appointments_staff_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_appointments_staff_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_appointments_staff/calendar_appointments_staff_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_appointments_staff_mob_erro.class.php"); 
      }
      $this->Erro      = new calendar_appointments_staff_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_appointments_staff_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      {
          $_SESSION['scriptcase']['calendar_appointments_staff_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['calendar_appointments_staff_mob']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['current_status_id']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['current_status_id'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_appointments_staff_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="calendar_appointments_staff_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_appointments_staff_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="calendar_appointments_staff_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_appointments_staff_mob']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_appointments_staff_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_appointments_staff_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_appointments_staff_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['bypass_required_time']['appointment_start_time'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['bypass_required_time']['appointment_end_time'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['bypass_required_time']['appointment_start_time'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['bypass_required_time']['appointment_end_time'] = false;
...
if (($this->sc_evento == "excluir" || $this->sc_evento == "delete")==0)
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_calendar_appointments_staff_mob';
...
$_SESSION['scriptcase']['calendar_appointments_staff_mob']['contr_erro'] = 'off'; 
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->current_status_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_current_status_id']) && !in_array($this->current_status_id, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_current_status_id']))
               {
                   $hasError = true;
    ...
    function ValidateField_id_actividad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_actividad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_actividad']) && !in_array($this->id_actividad, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_actividad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_proyecto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_proyecto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_proyecto']) && !in_array($this->id_proyecto, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_proyecto']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_appointment_start_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['php_cmp_required']['appointment_start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['php_cmp_required']['appointment_start_date'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_appointment_start_time(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->appointment_start_time == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['php_cmp_required']['appointment_start_time']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['php_cmp_required']['appointment_start_time'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->appointment_start_time) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_start_time']) && !in_array($this->appointment_start_time, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_start_time']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['appointment_start_time']))
 ...
 nm_limpa_hora($this->appointment_start_time, $this->field_config['appointment_start_time']['time_sep']) ; 
    ...
    function ValidateField_appointment_end_time(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->appointment_end_time == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['php_cmp_required']['appointment_end_time']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['php_cmp_required']['appointment_end_time'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->appointment_end_time) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_end_time']) && !in_array($this->appointment_end_time, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_end_time']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['appointment_end_time']))
 ...
 nm_limpa_hora($this->appointment_end_time, $this->field_config['appointment_end_time']['time_sep']) ; 
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->estado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_estado']) && !in_array($this->estado, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_estado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['appointments_id']['keyVal'] = calendar_appointments_staff_mob_pack_protect_string($this->nmgp_dados_form['appointments_id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_current_status_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_current_status_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_current_status_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_current_status_id'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(calendar_appointments_staff_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_appointments_staff_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_current_status_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['current_status_id']['valList'][$i] = calendar_appointments_staff_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_actividad']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_actividad'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_actividad']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_actividad'] = array(); 
}
$aLookup[] = array(calendar_appointments_staff_mob_pack_protect_string('') => str_replace('<', '&lt;',calendar_appointments_staff_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_actividad'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_actividad'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_actividad']['valList'][$i] = calendar_appointments_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_proyecto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_proyecto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_proyecto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_proyecto'] = array(); 
}
$aLookup[] = array(calendar_appointments_staff_mob_pack_protect_string('') => str_replace('<', '&lt;',calendar_appointments_staff_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_proyecto'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_id_proyecto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_proyecto']['valList'][$i] = calendar_appointments_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_start_time']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_start_time'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_start_time']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_start_time'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_start_time'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['appointment_start_time']['valList'][$i] = calendar_appointments_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_end_time']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_end_time'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_end_time']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_end_time'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_appointment_end_time'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['appointment_end_time']['valList'][$i] = calendar_appointments_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_estado']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_estado'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_estado']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_estado'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_estado'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['estado']['valList'][$i] = calendar_appointments_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_appointments_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
$_SESSION['scriptcase']['calendar_appointments_staff_mob']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['calendar_appointments_staff_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['parms'] = "appointments_id?#?$this->appointments_id?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['parms'] = ""; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['reg_start'] < $qt_geral_reg_calendar_appointments_staff_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("calendar_appointments_staff_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_outra_jan'] != 'calendar_appointments_staff_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
<head>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <title>calendar_appointments_staff_mob</title>
<?php
...
{
    $.ajax({
        url: "calendar_appointments_staff_mob.php",
        type: "GET",
        dataType: "json",
        data: {
...
{
    $('#calendar').fullCalendar('removeEventSource', 'calendar_appointments_staff_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
    setCategory();
    $('#calendar').fullCalendar('addEventSource', 'calendar_appointments_staff_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
}
...
{
    tb_show('', 'calendar_appointments_staff_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
function editEvent_desktop(sEventId)
{
    tb_show('', 'calendar_appointments_staff_mob.php?nmgp_opcao=igual_calendar&appointments_id=' + sEventId + '&__orig_appointments_id=' + sEventId + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
<?php
...
?>
        events: 'calendar_appointments_staff_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
        eventRender: function (event, element, view) {
            if (event.hasOwnProperty('description') && event.description != '') {
                element.find('.fc-title').append('<div class="hr-line-solid-no-margin"></div><span style="font-size: 80%;">' + event.description + '</span></div>');
            }
...
?>
        ...
        eventResize: function(event, delta, revertFunc) {
            $.post(
                'calendar_appointments_staff_mob.php',
                {
                    'script_case_init': '<?php echo $this->Ini->sc_page ?>',
...
<?php
    ...
    {
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['under_dashboard']) {
?>
<style type="text/css">
...
<?php
    ...
    function calendarOutput_formMobile()
    {
        if (isset($_SESSION['scriptcase']['device_mobile']) && $_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
?>
<form name="F1" id="sc-ui-form" method="post" action="calendar_appointments_staff.php" target="_self">
...
<?php
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form'] . " and ((id_usuario = " . $_SESSION['glo_staff_id'] . ")) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_calendar_appointments_staff_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['total'] = $qt_geral_reg_calendar_appointments_staff_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_appointments_staff_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas["appointment_start_date"] = "date";$Nm_datas["appointment_start_time"] = "time";$Nm_datas["appointment_end_date"] = "date";$Nm_datas["appointment_end_time"] = "time";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_appointments_staff_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_appointments_staff_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['ordem_ord'] == " desc") {
