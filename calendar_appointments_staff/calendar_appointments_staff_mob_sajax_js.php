  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_appointments_staff_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_appointments_staff_mob_form();
	}
...
?>
  ...
  function do_ajax_calendar_appointments_staff_mob_validate_current_status_id()
  {
    ...
    x_ajax_calendar_appointments_staff_mob_validate_current_status_id(var_current_status_id, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_current_status_id_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_current_status_id

  function do_ajax_calendar_appointments_staff_mob_validate_current_status_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_current_status_id_cb

  // ---------- Validate nombre
  function do_ajax_calendar_appointments_staff_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_nombre_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_nombre

  function do_ajax_calendar_appointments_staff_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_nombre_cb

  // ---------- Validate id_actividad
  function do_ajax_calendar_appointments_staff_mob_validate_id_actividad()
  {
    var nomeCampo_id_actividad = "id_actividad";
    var var_id_actividad = scAjaxGetFieldSelect(nomeCampo_id_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_id_actividad(var_id_actividad, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_id_actividad_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_id_actividad

  function do_ajax_calendar_appointments_staff_mob_validate_id_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_id_actividad_cb

  // ---------- Validate busca_proyecto
  function do_ajax_calendar_appointments_staff_mob_validate_busca_proyecto()
  {
    var nomeCampo_busca_proyecto = "busca_proyecto";
    var var_busca_proyecto = scAjaxGetFieldText(nomeCampo_busca_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_busca_proyecto(var_busca_proyecto, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_busca_proyecto_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_busca_proyecto

  function do_ajax_calendar_appointments_staff_mob_validate_busca_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "busca_proyecto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_busca_proyecto_cb

  // ---------- Validate id_proyecto
  function do_ajax_calendar_appointments_staff_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_id_proyecto_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_id_proyecto

  function do_ajax_calendar_appointments_staff_mob_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_id_proyecto_cb

  // ---------- Validate appointment_start_date
  function do_ajax_calendar_appointments_staff_mob_validate_appointment_start_date()
  {
    ...
    setTimeout(function() {
      var var_appointment_start_date = scAjaxGetFieldText(nomeCampo_appointment_start_date);
      x_ajax_calendar_appointments_staff_mob_validate_appointment_start_date(var_appointment_start_date, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_appointment_start_date_cb);
    }, 200);
  } // do_ajax_calendar_appointments_staff_mob_validate_appointment_start_date

  function do_ajax_calendar_appointments_staff_mob_validate_appointment_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_appointment_start_date_cb

  // ---------- Validate appointment_start_time
  function do_ajax_calendar_appointments_staff_mob_validate_appointment_start_time()
  {
    var nomeCampo_appointment_start_time = "appointment_start_time";
    var var_appointment_start_time = scAjaxGetFieldSelect(nomeCampo_appointment_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_appointment_start_time(var_appointment_start_time, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_appointment_start_time_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_appointment_start_time

  function do_ajax_calendar_appointments_staff_mob_validate_appointment_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_appointment_start_time_cb

  // ---------- Validate appointment_end_time
  function do_ajax_calendar_appointments_staff_mob_validate_appointment_end_time()
  {
    var nomeCampo_appointment_end_time = "appointment_end_time";
    var var_appointment_end_time = scAjaxGetFieldSelect(nomeCampo_appointment_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_appointment_end_time(var_appointment_end_time, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_appointment_end_time_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_appointment_end_time

  function do_ajax_calendar_appointments_staff_mob_validate_appointment_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_appointment_end_time_cb

  // ---------- Validate intervalo
  function do_ajax_calendar_appointments_staff_mob_validate_intervalo()
  {
    var nomeCampo_intervalo = "intervalo";
    var var_intervalo = scAjaxGetFieldText(nomeCampo_intervalo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_intervalo(var_intervalo, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_intervalo_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_intervalo

  function do_ajax_calendar_appointments_staff_mob_validate_intervalo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_intervalo_cb

  // ---------- Validate estado
  function do_ajax_calendar_appointments_staff_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_estado(var_estado, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_estado_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_estado

  function do_ajax_calendar_appointments_staff_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_estado_cb

  // ---------- Validate observaciones
  function do_ajax_calendar_appointments_staff_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_observaciones_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_observaciones

  function do_ajax_calendar_appointments_staff_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_observaciones_cb

  // ---------- Refresh busca_proyecto
  function do_ajax_calendar_appointments_staff_mob_refresh_busca_proyecto()
  {
    var var_busca_proyecto = scAjaxGetFieldText("busca_proyecto");
    var var_nmgp_refresh_fields = "id_proyecto";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_appointments_staff_mob_refresh_busca_proyecto(var_busca_proyecto, var_nmgp_refresh_fields, var_script_case_init, do_ajax_calendar_appointments_staff_mob_refresh_busca_proyecto_cb);
  } // do_ajax_calendar_appointments_staff_mob_refresh_busca_proyecto

  function do_ajax_calendar_appointments_staff_mob_refresh_busca_proyecto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_refresh_busca_proyecto_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_calendar_appointments_staff_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_appointments_staff_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_appointment_start_time = scAjaxGetFieldSelect("appointment_start_time");
    var var_appointment_end_time = scAjaxGetFieldSelect("appointment_end_time");
    ...
    scAjaxProcOn();
    x_ajax_calendar_appointments_staff_mob_submit_form(var_current_status_id, var_nombre, var_id_actividad, var_busca_proyecto, var_id_proyecto, var_appointment_start_date, var_appointment_start_time, var_appointment_end_time, var_intervalo, var_estado, var_observaciones, var_appointments_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_appointments_staff_mob_submit_form_cb);
  } // do_ajax_calendar_appointments_staff_mob_submit_form

  function do_ajax_calendar_appointments_staff_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_appointments_staff_mob_submit_form_cb_after_alert);
  } // do_ajax_calendar_appointments_staff_mob_submit_form_cb
  function do_ajax_calendar_appointments_staff_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_appointments_staff_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_appointments_staff_mob_navigate_form()
  {
    perform_ajax_calendar_appointments_staff_mob_navigate_form();
  }

  function perform_ajax_calendar_appointments_staff_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_calendar_appointments_staff_mob_navigate_form(var_appointments_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_appointments_staff_mob_navigate_form_cb);
  } // do_ajax_calendar_appointments_staff_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_appointments_staff_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_appointments_staff_mob_navigate_form_cb_after_alert);
  } // do_ajax_calendar_appointments_staff_mob_navigate_form_cb
  function do_ajax_calendar_appointments_staff_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_appointments_staff_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_appointments_staff_mob_navigate_form_cb_after_alert

  function sc_hide_calendar_appointments_staff_mob_form()
  {
  ...
  ajax_field_list[0] = "current_status_id";
  ajax_field_list[1] = "nombre";
  ajax_field_list[2] = "id_actividad";
  ajax_field_list[3] = "busca_proyecto";
  ajax_field_list[4] = "id_proyecto";
  ajax_field_list[5] = "appointment_start_date";
  ajax_field_list[6] = "appointment_start_time";
  ajax_field_list[7] = "appointment_end_time";
  ajax_field_list[8] = "intervalo";
  ajax_field_list[9] = "estado";
  ...
  var ajax_error_list = {
    ...
    "nombre": {"label": "Nombre Actividad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_actividad": {"label": "Tipo Actividad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "busca_proyecto": {"label": "Buscar Proyecto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["busca_proyecto"][1] = "busca_proyecto";
  ...
  var ajax_field_id = {
    ...
    "busca_proyecto": new Array("hidden_field_label_busca_proyecto", "hidden_field_data_busca_proyecto"),
