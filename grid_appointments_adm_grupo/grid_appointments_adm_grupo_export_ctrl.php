<?php
@session_start() ;
$_SESSION['scriptcase']['grid_appointments_adm_grupo']['sc_process_barr'] = true;
require_once('../grid_appointments_adm_grupo/index.php');
unset($_SESSION['scriptcase']['grid_appointments_adm_grupo']['sc_process_barr']);
$ExportCtrl = new grid_appointments_adm_grupo_export_control;
$ExportCtrl->Export_barr();

class grid_appointments_adm_grupo_export_control
{
