...
class grid_appointments_adm_grupo_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_appointments_adm_grupo" . $this->Xls_tp;
          $this->Tit_doc    = "grid_appointments_adm_grupo" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_appointments_adm_grupo_total.class.php"); 
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_appointments_adm_grupo']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_appointments_adm_grupo']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['embutida'])
      { 
   ...
   function NM_export_horas_pendientes()
   {
         ...
         if (is_numeric($this->horas_pendientes))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,###.##';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->horas_pendientes);
         $this->Xls_col++;
   }
   ...
   function NM_export_horas_pendientes_corregidas()
   {
         ...
         if (is_numeric($this->horas_pendientes_corregidas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->horas_pendientes_corregidas);
         $this->Xls_col++;
   }
   //----- horas_rechazadas
   ...
   //----- horas_pendientes
   function NM_sub_cons_horas_pendientes()
   {
         $this->horas_pendientes = NM_charset_to_utf8($this->horas_pendientes);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->horas_pendientes;
   ...
   //----- horas_pendientes_corregidas
   function NM_sub_cons_horas_pendientes_corregidas()
   {
         $this->horas_pendientes_corregidas = NM_charset_to_utf8($this->horas_pendientes_corregidas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->horas_pendientes_corregidas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['nolabel'])
       {
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Resumen De Horas Registradas En Período :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
