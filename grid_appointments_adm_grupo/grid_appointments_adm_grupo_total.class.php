...
class grid_appointments_adm_grupo_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_adm_grupo']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_appointments_adm_grupo']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_total($res_limit=false, $res_export=false)
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $nm_comando = "select DISTINCT    sec_users.id as id from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['where_pesq']; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['tot_geral'] = array() ;  
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['tot_geral'][0] = "Total Horas"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo']['contr_total_geral'] = "OK";
   } 
