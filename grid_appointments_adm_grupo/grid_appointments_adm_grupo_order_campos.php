<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_appointments_adm_grupo']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_appointments_adm_grupo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointments_adm_grupo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['validar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['validar'] = "validar";
   }
   else
   {
       $tab_def_campos['validar'] = "";
   }
   $tab_labels["validar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["validar"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["validar"] : "Validar";
   ...
   {
       $tab_def_campos['id'] = "sec_users.id";
   }
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["id"] : "Usuario";
   $tab_ger_campos['horas_pendientes'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['horas_pendientes'] = "horas_pendientes";
   }
   else
   {
       $tab_def_campos['horas_pendientes'] = "";
   }
   $tab_labels["horas_pendientes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_pendientes"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_pendientes"] : "Horas Pendientes de Envío";
   $tab_ger_campos['horas_pendientes_corregidas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['horas_pendientes_corregidas'] = "horas_pendientes_corregidas";
   }
   else
   {
       $tab_def_campos['horas_pendientes_corregidas'] = "";
   }
   $tab_labels["horas_pendientes_corregidas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_pendientes_corregidas"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_pendientes_corregidas"] : "Horas Pendientes Corregidas";
   $tab_ger_campos['horas_rechazadas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['horas_rechazadas'] = "horas_rechazadas";
   }
   else
   {
       $tab_def_campos['horas_rechazadas'] = "";
   }
   $tab_labels["horas_rechazadas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_rechazadas"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_rechazadas"] : "Horas Rechazadas";
   $tab_ger_campos['horas_enviadas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['horas_enviadas'] = "horas_enviadas";
   }
   else
   {
       $tab_def_campos['horas_enviadas'] = "";
   }
   $tab_labels["horas_enviadas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_enviadas"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_enviadas"] : "Horas Enviadas";
   $tab_ger_campos['horas_corregidas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['horas_corregidas'] = "horas_corregidas";
   }
   else
   {
       $tab_def_campos['horas_corregidas'] = "";
   }
   $tab_labels["horas_corregidas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_corregidas"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_corregidas"] : "Horas Corregidas (Enviadas)";
   $tab_ger_campos['horas_aprobadas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['horas_aprobadas'] = "horas_aprobadas";
   }
   else
   {
       $tab_def_campos['horas_aprobadas'] = "";
   }
   $tab_labels["horas_aprobadas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_aprobadas"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_aprobadas"] : "Horas Aprobadas";
   $tab_ger_campos['horas_totales'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['horas_totales'] = "horas_totales";
   }
   else
   {
       $tab_def_campos['horas_totales'] = "";
   }
   $tab_labels["horas_totales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_totales"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['labels']["horas_totales"] : "Total Horas Registradas";
   $tab_ger_campos['validar'] = "none";
   $tab_ger_campos['horas_pendientes'] = "none";
   $tab_ger_campos['horas_pendientes_corregidas'] = "none";
   $tab_ger_campos['horas_rechazadas'] = "none";
   $tab_ger_campos['horas_enviadas'] = "none";
   $tab_ger_campos['horas_corregidas'] = "none";
   $tab_ger_campos['horas_aprobadas'] = "none";
   $tab_ger_campos['horas_totales'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointments_adm_grupo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_grupo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
