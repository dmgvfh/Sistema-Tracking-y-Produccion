...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha2";$Nm_numeric[] = "id";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_fecha2"  <?php echo $str_hide_fecha2?>>
<?php
  $date_format_show = 'dd/mm/aaaa';
  $date_format_show = str_replace("dd",   $this->Ini->Nm_lang['lang_othr_date_days'], $date_format_show);
  $date_format_show = str_replace("mm",   $this->Ini->Nm_lang['lang_othr_date_mnth'], $date_format_show);
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha2_dia" name="fecha2_dia" value="<?php echo NM_encode_input($fecha2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
<span id='id_date_part_fecha2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha2_mes" name="fecha2_mes" value="<?php echo NM_encode_input($fecha2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
<span id='id_date_part_fecha2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha2_ano" name="fecha2_ano" value="<?php echo NM_encode_input($fecha2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fecha2_jq">
</span>
        <SPAN id="id_css_fecha2"  class="scFilterFieldFontEven">
 <br><?php echo $date_format_show ?>         </SPAN>
          </TD>
