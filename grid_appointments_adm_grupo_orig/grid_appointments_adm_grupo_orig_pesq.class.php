...
class grid_appointments_adm_grupo_orig_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_appointments_adm_grupo_orig_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_appointments_adm_grupo_orig_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_appointments_adm_grupo_orig_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha2";
      if (in_array($campo_join, $Nm_datas))
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['proc_res'])) 
    {
...
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_appointments_adm_grupo_orig').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_appointments_adm_grupo_orig').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_appointments_adm_grupo_orig').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<HEAD>
 <TITLE>BÚSQUEDA POR FECHAS DE ACTIVIDADES</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_appointments_adm_grupo_orig/grid_appointments_adm_grupo_orig_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_appointments_adm_grupo_orig_ajax_search.js"></script>
 <script type="text/javascript" src="grid_appointments_adm_grupo_orig_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_appointments_adm_grupo_orig_message.js"></script>
...
function scJQCalendarAdd() {
  ...
  $("#sc_fecha2_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fecha2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fecha2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fecha2_ano').value;
          document.getElementById('sc_fecha2_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fecha2_dia').value = aParts[0];
          document.getElementById('SC_fecha2_mes').value = aParts[1];
          document.getElementById('SC_fecha2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_fecha2_cond#NMF#' + search_get_sel_txt('SC_fecha2_cond') + '@NMF@';
  str_out += 'SC_fecha2_dia#NMF#' + search_get_sel_txt('SC_fecha2_dia') + '@NMF@';
  str_out += 'SC_fecha2_mes#NMF#' + search_get_sel_txt('SC_fecha2_mes') + '@NMF@';
  str_out += 'SC_fecha2_ano#NMF#' + search_get_sel_txt('SC_fecha2_ano') + '@NMF@';
  str_out += 'SC_fecha2_input_2_dia#NMF#' + search_get_sel_txt('SC_fecha2_input_2_dia') + '@NMF@';
  str_out += 'SC_fecha2_input_2_mes#NMF#' + search_get_sel_txt('SC_fecha2_input_2_mes') + '@NMF@';
  str_out += 'SC_fecha2_input_2_ano#NMF#' + search_get_sel_txt('SC_fecha2_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">BÚSQUEDA POR FECHAS DE ACTIVIDADES</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $fecha2_cond, $fecha2, $fecha2_dia, $fecha2_mes, $fecha2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_cond']; 
          $fecha2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_dia']; 
          $fecha2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_mes']; 
          $fecha2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_ano']; 
          $fecha2_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fecha_cond) || empty($fecha_cond))
      {
         $fecha_cond = "eq";
      }
      if (!isset($fecha2_cond) || empty($fecha2_cond))
      {
         $fecha2_cond = "eq";
      }
      ...
      $str_hide_fecha2 = (in_array($fecha2_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($fecha)) ? strpos($fecha, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      if (!isset($fecha2) || $fecha2 == "")
      {
          $fecha2 = "";
      }
      if (isset($fecha2) && !empty($fecha2))
      {
         $tmp_pos = (is_string($fecha2)) ? strpos($fecha2, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $fecha2 = substr($fecha2, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_appointments_adm_grupo_orig_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['opc_psq'])
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_fecha_cond" name="fecha_cond" value="eq">
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fecha" <?php echo $str_hide_fecha?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha Inicio";
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_ano" name="fecha_ano" value="<?php echo NM_encode_input($fecha_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <INPUT type="hidden" id="SC_fecha2_cond" name="fecha2_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fecha2" <?php echo $str_hide_fecha2?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fecha2'])) ? $this->New_label['fecha2'] : "Fecha Término";
 $nmgp_tab_label .= "fecha2?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
         ...
         <span id='id_date_part_fecha2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha2_dia" name="fecha2_dia" value="<?php echo NM_encode_input($fecha2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
<span id='id_date_part_fecha2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha2_mes" name="fecha2_mes" value="<?php echo NM_encode_input($fecha2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
<span id='id_date_part_fecha2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha2_ano" name="fecha2_ano" value="<?php echo NM_encode_input($fecha2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fecha2_jq">
</span>
        <SPAN id="id_css_fecha2"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
...
{
?>
<iframe id="nmsc_iframe_grid_appointments_adm_grupo_orig" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_appointments_adm_grupo_orig" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_appointments_adm_grupo_orig_pesq"  name="nm_iframe_grid_appointments_adm_grupo_orig_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_appointments_adm_grupo_orig_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_appointments_adm_grupo_orig').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.fecha2_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fecha2'), document.F1.fecha2_cond, 'fecha2');
   document.F1.fecha2_dia.value = "";
   document.F1.fecha2_mes.value = "";
   document.F1.fecha2_ano.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fecha2_dia').bind('change', function() {sc_grid_appointments_adm_grupo_orig_valida_dia(this)});
    $('#SC_fecha2_mes').bind('change', function() {sc_grid_appointments_adm_grupo_orig_valida_mes(this)});
    $('#SC_fecha_dia').bind('change', function() {sc_grid_appointments_adm_grupo_orig_valida_dia(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_appointments_adm_grupo_orig_valida_mes(this)});
 }
 function sc_grid_appointments_adm_grupo_orig_valida_dia(obj)
 {
 ...
 function sc_grid_appointments_adm_grupo_orig_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_appointments_adm_grupo_orig";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_appointments_adm_grupo_orig/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fecha2_cond'] = 'cond';
      $tp_fields['SC_fecha2_dia'] = 'text';
      $tp_fields['SC_fecha2_mes'] = 'text';
      $tp_fields['SC_fecha2_ano'] = 'text';
      $tp_fields['SC_fecha2_input_2_dia'] = 'text';
      $tp_fields['SC_fecha2_input_2_mes'] = 'text';
      $tp_fields['SC_fecha2_input_2_ano'] = 'text';
   ...
   {
      global $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano,
             $fecha2_cond, $fecha2, $fecha2_dia, $fecha2_mes, $fecha2_ano, $nmgp_tab_label;
      ...
      $fecha2_cond_salva = $fecha2_cond; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca'];
      }
      if (!$this->NM_ajax_flag || $this->NM_ajax_opcao != "ajax_grid_search")
      {
          if ($fecha_cond != "nu" && $fecha_cond != "nn" && $fecha_cond != "ep" && $fecha_cond != "ne")
          {
              if ($fecha_dia == "" && $fecha_mes == "" && $fecha_ano == "")
              {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Fecha Inicio : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
              }
          }
      }
      if (!$this->NM_ajax_flag || $this->NM_ajax_opcao != "ajax_grid_search")
      {
          if ($fecha2_cond != "nu" && $fecha2_cond != "nn" && $fecha2_cond != "ep" && $fecha2_cond != "ne")
          {
              if ($fecha2_dia == "" && $fecha2_mes == "" && $fecha2_ano == "")
              {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Fecha Término : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_dia'] = $fecha2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_mes'] = $fecha2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_ano'] = $fecha2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_cond'] = $fecha2_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca'];
      }
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fecha'], "YYYY-MM-DD");
          $this->cmp_formatado['fecha'] = $this->nm_data->FormataSaida("d/m/Y");
          if ($fecha_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fecha_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fecha_input_2'] = $this->nm_data->FormataSaida("d/m/Y");
          }
      }

      //----- $fecha2
      $this->Date_part = false;
      if ($fecha2_cond != "bi_TP")
      {
          $fecha2_cond = strtoupper($fecha2_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fecha2_ano;
          $Dtxt .= $fecha2_mes;
          $Dtxt .= $fecha2_dia;
          $val[0]['ano'] = $fecha2_ano;
          $val[0]['mes'] = $fecha2_mes;
          $val[0]['dia'] = $fecha2_dia;
          if ($fecha2_cond == "BW")
          {
              $val[1]['ano'] = $fecha2_input_2_ano;
              $val[1]['mes'] = $fecha2_input_2_mes;
              $val[1]['dia'] = $fecha2_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $fecha2_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fecha2 = $val[0];
          $this->cmp_formatado['fecha2'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fecha2'], "YYYY-MM-DD");
          $this->cmp_formatado['fecha2'] = $this->nm_data->FormataSaida("d/m/Y");
          if ($fecha2_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fecha2_input_2     = $val[1];
              $this->cmp_formatado['fecha2_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']['fecha2_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fecha2_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fecha2_input_2'] = $this->nm_data->FormataSaida("d/m/Y");
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_grupo_orig']['where_pesq'];
