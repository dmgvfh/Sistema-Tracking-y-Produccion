...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_form_sec_groups_apps']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['app_form_sec_groups_apps']['opc_ant'] = "inicio";
      }
...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off';
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['opc_ant'] : "";
      } 
...
//--------------------------------------------------------------------------------------
   ...
   function Recupera_Nome_Campo($campo) 
   {
       ...
       {
           case 'app_name_':
               return "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_app_name'] . "";
               break;
           case 'priv_access_':
               return "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_access'] . "";
               break;
           case 'priv_insert_':
               return "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_insert'] . "";
               break;
           case 'priv_delete_':
               return "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_delete'] . "";
               break;
           case 'priv_update_':
               return "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_update'] . "";
               break;
           case 'priv_export_':
               return "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_export'] . "";
               break;
           case 'priv_print_':
               return "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_print'] . "";
               break;
           case 'group_id_':
               return "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_group_id'] . "";
               break;
       }
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['link_info']['compact_mode']) {
            return;
        }
?>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    ...
    <div class="scFormHeaderFont" style="float: right;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . ""; } ?></div>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == $fieldName) {
