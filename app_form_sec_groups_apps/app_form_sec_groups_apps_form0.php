...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['last'] : 'off'); ?>";
...
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    ...
    $remove_margin = '';
    $remove_border = '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['link_info']['remove_border']) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['first'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "binicio", "nm_move ('inicio');", "nm_move ('inicio');", "sc_b_ini_t", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['back'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bretorna", "nm_move ('retorna');", "nm_move ('retorna');", "sc_b_ret_t", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['forward'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bavanca", "nm_move ('avanca');", "nm_move ('avanca');", "sc_b_avc_t", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['last'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bfinal", "nm_move ('final');", "nm_move ('final');", "sc_b_fim_t", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['app_name_']) || $this->nmgp_cmp_hidden['app_name_'] == 'on') {
        if (!isset($this->nm_new_label['app_name_'])) {
            $this->nm_new_label['app_name_'] = "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_app_name'] . "";
        }
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_access_']) || $this->nmgp_cmp_hidden['priv_access_'] == 'on') {
        if (!isset($this->nm_new_label['priv_access_'])) {
            $this->nm_new_label['priv_access_'] = "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_access'] . "";
        }
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_insert_']) || $this->nmgp_cmp_hidden['priv_insert_'] == 'on') {
        if (!isset($this->nm_new_label['priv_insert_'])) {
            $this->nm_new_label['priv_insert_'] = "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_insert'] . "";
        }
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_delete_']) || $this->nmgp_cmp_hidden['priv_delete_'] == 'on') {
        if (!isset($this->nm_new_label['priv_delete_'])) {
            $this->nm_new_label['priv_delete_'] = "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_delete'] . "";
        }
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_update_']) || $this->nmgp_cmp_hidden['priv_update_'] == 'on') {
        if (!isset($this->nm_new_label['priv_update_'])) {
            $this->nm_new_label['priv_update_'] = "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_update'] . "";
        }
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_export_']) || $this->nmgp_cmp_hidden['priv_export_'] == 'on') {
        if (!isset($this->nm_new_label['priv_export_'])) {
            $this->nm_new_label['priv_export_'] = "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_export'] . "";
        }
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_print_']) || $this->nmgp_cmp_hidden['priv_print_'] == 'on') {
        if (!isset($this->nm_new_label['priv_print_'])) {
            $this->nm_new_label['priv_print_'] = "" . $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_print'] . "";
        }
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['balterarsel']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['balterarsel']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['balterarsel']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['balterarsel']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['balterarsel'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "balterarsel", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_b", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['btn_label']['exit'];
        }
?>
