...
//
   ...
   $_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_perfil']          = "conn_example";
...
// 
      ...
      $this->str_lang        = (isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_lang']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_lang'])) ? $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_lang'] : "es";
      $this->str_conf_reg    = (isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_conf_reg']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_conf_reg'])) ? $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_conf_reg'] : "es_es";
      $this->str_schema_all  = (isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_schema_all']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_schema_all'])) ? $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_schema_all'] : "tracking/tracking";
...
';
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['iframe_menu'])) {
          $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['iframe_menu'] = "";
      }
      if (!isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['run_iframe'])) {
          $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['run_iframe'] = "";
      }
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info']['remove_border'] = true;
        }
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'carga_horas', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_carga_horas'])) {
                $_SESSION['scriptcase']['app_sync_apps']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_carga_horas'];
            }
        }
    }
    ...
    $STR_lang    = (isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_lang']) && !empty($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_lang'])) ? $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_lang'] : "es";
    if (isset($_SESSION['scriptcase']['app_sync_apps_mob']['session_timeout']['lang'])) {
        $STR_lang = $_SESSION['scriptcase']['app_sync_apps_mob']['session_timeout']['lang'];
    }
      $STR_schema_all = (isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all']) && !empty($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all'])) ? $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all'] : "tracking/tracking";
    ...
    if (!empty($nmgp_opcao) && ($nmgp_opcao == "change_lang_t" || $nmgp_opcao == "change_lang_b" || $nmgp_opcao == "change_lang_f" || $nmgp_opcao == "force_lang"))  
    {
        ...
        { 
            $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_lang'] = $Temp_lang[0];
        } 
        if (isset($Temp_lang[1]) && !empty($Temp_lang[1])) 
        { 
            $_SESSION['scriptcase']['change_regional_old'] = (isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_conf_reg']) && !empty($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_conf_reg'])) ? $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_conf_reg'] : "es_es";
            $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_conf_reg']        = $Temp_lang[1];
            $_SESSION['scriptcase']['change_regional_new'] = $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_conf_reg'];
        } 
    ...
    if (!empty($nmgp_opcao) && ($nmgp_opcao == "change_schema_t" || $nmgp_opcao == "change_schema_b" || $nmgp_opcao == "change_schema_f"))  
    {
        ...
        $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all'] = $nmgp_schema;
        $nmgp_opcao = "recarga";  
    } 
    ...
    else
    {
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['run_iframe'] != "R")
        {
            ...
            $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['volta_dep'] = (isset($nm_apl_dependente)) ? $nm_apl_dependente : "";
        ...
        $nm_url_saida      = (isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['volta_php'])) ? $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['volta_php'] : "";
        $nm_apl_dependente = (isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['volta_dep'])) ? $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['volta_dep'] : "";
        $nm_saida_global   = $nm_url_saida;
    ...
    if (!isset($_SESSION['scriptcase']['app_sync_apps_mob']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || $_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps'] != "on"))
    { 
      ...
      $str_schema_app = (isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all']) && !empty($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all'])) ? $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all'] : "tracking/tracking";
...
<?php
    ...
    if (isset($_POST['wizard_action']) && 'change_step' == $_POST['wizard_action']) {
        $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['param']['buffer_output'] = true;
        ob_start();
    }
...
//
   ...
   function app_sync_apps_mob_pack_ajax_response()
   {
      ...
      if (isset($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['wizard']))
      {
          $aResp['wizard'] = $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['wizard'];
      }
...
//-----
      {
         ...
         if (isset($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['btnDisabled']) && '' != $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['btnDisabled'])
         {
            app_sync_apps_mob_pack_btn_disabled($aResp);
         }
         if (isset($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['btnLabel']) && '' != $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['btnLabel'])
         {
            app_sync_apps_mob_pack_btn_label($aResp);
         }
         ...
         {
/* mantis 0021191 */            $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['buttonDisplay'] = $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->nmgp_botoes;
   ...
   function app_sync_apps_mob_pack_btn_disabled(&$aResp)
   {
      global $inicial_app_sync_apps_mob;
      $aResp['btnDisabled'] = array();
      foreach ($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['btnDisabled'] as $btnName => $btnStatus) {
        $aResp['btnDisabled'][$btnName] = $btnStatus;
      }
   } // app_sync_apps_mob_pack_ajax_alert

   function app_sync_apps_mob_pack_btn_label(&$aResp)
   {
      global $inicial_app_sync_apps_mob;
      $aResp['btnLabel'] = array();
      foreach ($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['btnLabel'] as $btnName => $btnLabel) {
   ...
   function app_sync_apps_mob_pack_ajax_alert(&$aResp)
   {
      global $inicial_app_sync_apps_mob;
// PHP 8.0
      if (!isset($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['ajaxAlert']['message'])) {
          $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['ajaxAlert']['message'] = '';
      }
      if (!isset($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['ajaxAlert']['params'])) {
          $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['ajaxAlert']['params'] = '';
      }
//---
   ...
   function app_sync_apps_mob_pack_ajax_message(&$aResp)
   {
      global $inicial_app_sync_apps_mob;
// PHP 8.0
      if (!isset($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['ajaxMessage']['message'])) {
          $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['ajaxMessage']['message'] = '';
      }
      if (!isset($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['ajaxMessage']['title'])) {
          $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['ajaxMessage']['title'] = '';
      }
//---
