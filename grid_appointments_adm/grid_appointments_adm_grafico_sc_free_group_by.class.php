...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $prep_label['appointments_id_proyecto'] = "Id Proyecto";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
