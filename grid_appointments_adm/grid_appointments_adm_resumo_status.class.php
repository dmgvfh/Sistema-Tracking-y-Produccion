...
$_SESSION['scriptcase']['grid_appointments_adm']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_appointments_current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['appointments_current_status_id'];
          $this->array_total_appointments_appointment_start_date = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['appointments_appointment_start_date'];
          $this->array_total_appointments_id_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['appointments_id_usuario'];
      }
      else
      {
          $this->array_total_appointments_current_status_id = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['appointments_id_usuario'] = $this->array_total_appointments_id_usuario;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointments_id_usuario'] = $Lab_appointments_id_usuario; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_order']['status']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_order']['status'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_order']['status'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'] as $i_sum => $d_sum)
           {
