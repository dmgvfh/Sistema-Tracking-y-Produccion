...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_appointments_id_proyecto"  <?php echo $str_hide_appointments_id_proyecto?>>
<?php
...
?>
   <span id="idAjaxSelect_appointments_id_proyecto">
      <SELECT class="scFilterObjectOdd" id="SC_appointments_id_proyecto" name="appointments_id_proyecto[]"  size="7" multiple>
<?php
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($appointments_id_proyecto) && !empty($appointments_id_proyecto))
            {
               ...
               foreach ($appointments_id_proyecto as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $appointments_id_proyecto_sel = "selected";
                       break;
                   }
               }
            }
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'appointments_id_proyecto[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "appointments_id_proyecto" : return ('class="scFilterObjectOdd"'); break;
