...
<?php
   ...
   $Ord_Cmp = new grid_appointments_adm_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointments_adm_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["codigo_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["codigo_proyecto"] : "Código Proyecto";
   ...
   $tab_labels["nombre_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["nombre_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["nombre_usuario"] : "Nombre Usuario";
   ...
   $tab_labels["appointments_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_nombre"] : "Nombre Actividad";
   ...
   $tab_labels["appointments_current_status_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_current_status_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_current_status_id"] : "Estado";
   ...
   $tab_labels["appointments_appointment_start_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_appointment_start_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_appointment_start_date"] : "Fecha Actividad";
   ...
   $tab_labels["appointments_appointment_start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_appointment_start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_appointment_start_time"] : "Hora Inicio";
   ...
   $tab_labels["appointments_appointment_end_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_appointment_end_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_appointment_end_time"] : "Hora Término";
   ...
   $tab_labels["appointments_intervalo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_intervalo"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointments_intervalo"] : "Duración (horas)";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointments_adm_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
