...
class grid_prod_produccion_proyecto_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_prod_produccion_proyecto" . $this->Xls_tp;
          $this->Tit_doc    = "grid_prod_produccion_proyecto" . $this->Xls_tp;
      ...
      if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['SC_Ind_Groupby'], $this->GB_tot_php))
      {
          $Tot_Gb = "totaliza_php_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['SC_Ind_Groupby'];
          $this->$Tot_Gb();
      }
      else
      {
          require_once($this->Ini->path_aplicacao . "grid_prod_produccion_proyecto_total.class.php"); 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['SC_Ind_Groupby'] == "sc_free_total")
      {
          $this->sum_facturacion_acumulada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['tot_geral'][2];
          $this->sum_ur_real = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['tot_geral'][3];
          $this->sum_backlog_p = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['tot_geral'][4];
          $this->sum_backlog_f = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['tot_geral'][5];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_prod_produccion_proyecto']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_prod_produccion_proyecto']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['embutida'])
      { 
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "Detalles"; 
          if ((!isset($this->NM_cmp_hidden['sc_field_0']) || $this->NM_cmp_hidden['sc_field_0'] != "off") && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->arr_span['sc_field_0'] = $this->count_span;
              $this->Emb_label_cols_sc_field_0 = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_produccion_proyecto']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_produccion_proyecto']['embutida_label'] = true;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_sc_field_0 += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_sc_field_0 += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_sc_field_0++;
                         }
                     }
                  }
              }
      ...
      { 
          ...
          {
              while ($this->count_span < $this->Emb_label_cols_sc_field_0)
              {
   ...
   function NM_export_facturacion_acumulada()
   {
         ...
         if (is_numeric($this->facturacion_acumulada))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->facturacion_acumulada);
         $this->Xls_col++;
   }
   //----- reajuste_acumulado
   function NM_export_reajuste_acumulado()
   {
         ...
         if (is_numeric($this->reajuste_acumulado))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->reajuste_acumulado);
         $this->Xls_col++;
   }
   //----- retencion_acumulada
   function NM_export_retencion_acumulada()
   {
         ...
         if (is_numeric($this->retencion_acumulada))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->retencion_acumulada);
         $this->Xls_col++;
   }
   //----- multa_acumulada
   function NM_export_multa_acumulada()
   {
         ...
         if (is_numeric($this->multa_acumulada))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->multa_acumulada);
         $this->Xls_col++;
   }
   //----- avance
   ...
   //----- facturacion_acumulada
   function NM_sub_cons_facturacion_acumulada()
   {
         $this->facturacion_acumulada = NM_charset_to_utf8($this->facturacion_acumulada);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->facturacion_acumulada;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- reajuste_acumulado
   function NM_sub_cons_reajuste_acumulado()
   {
         $this->reajuste_acumulado = NM_charset_to_utf8($this->reajuste_acumulado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->reajuste_acumulado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- retencion_acumulada
   function NM_sub_cons_retencion_acumulada()
   {
         $this->retencion_acumulada = NM_charset_to_utf8($this->retencion_acumulada);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->retencion_acumulada;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- multa_acumulada
   function NM_sub_cons_multa_acumulada()
   {
         $this->multa_acumulada = NM_charset_to_utf8($this->multa_acumulada);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->multa_acumulada;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
         $this->Rows_sub_sc_field_0 = array();
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?id_proyecto?#?" . str_replace("'", "@aspass@", $this->Orig_id_proyecto) . "?@?fecha_corte?#?" . str_replace("'", "@aspass@", $this->Orig_fecha) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_produccion_proyecto']['embutida'] = true;
         if (method_exists($this->detalle_produccion_proyecto, "controle"))
         {
             $this->detalle_produccion_proyecto->controle();
             ...
             {
                 $this->row_sub = 1;
             $this->Rows_sub_sc_field_0 = $_SESSION['scriptcase']['export_return'];
             return;
             }
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_produccion_proyecto']['embutida'] = false;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['nolabel'])
       {
...
$_SESSION['scriptcase']['grid_prod_produccion_proyecto']['contr_erro'] = 'off';
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
