<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_prod_produccion_proyecto']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_prod_produccion_proyecto_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_produccion_proyecto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['empresa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa'] = "empresa";
   }
   else
   {
       $tab_def_campos['empresa'] = "SELECT 
  companias.razon_social
FROM
  proyectos
  INNER JOIN companias ON (proyectos.id_empresa = companias.id)
WHERE
  proyectos.id ={id_proyecto}";
   }
   $tab_labels["empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["empresa"] : "Empresa";
   $tab_ger_campos['id_proyecto'] = "on";
   $tab_def_campos['id_proyecto'] = "id_proyecto";
   $tab_labels["id_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["id_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["id_proyecto"] : "Proyecto";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["fecha"] : "Período";
   ...
   $tab_labels["tipo_moneda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["tipo_moneda"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["tipo_moneda"] : "Tipo Moneda";
   $tab_ger_campos['valor_uf_presupuesto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['valor_uf_presupuesto'] = "sc_def_col_1";
   }
   else
   {
       $tab_def_campos['valor_uf_presupuesto'] = "`valor_uf_presupuesto`";
   }
   $tab_labels["valor_uf_presupuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["valor_uf_presupuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["valor_uf_presupuesto"] : "Valor Moneda<br>Perído ($)";
   ...
   $tab_labels["presupuesto_acumulado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["presupuesto_acumulado"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["presupuesto_acumulado"] : "Presupuesto<br>Actualizado";
   $tab_ger_campos['facturacion_acumulada'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['facturacion_acumulada'] = "facturacion_acumulada";
   }
   else
   {
       $tab_def_campos['facturacion_acumulada'] = "";
   }
   $tab_labels["facturacion_acumulada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["facturacion_acumulada"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["facturacion_acumulada"] : "Facturación";
   $tab_ger_campos['reajuste_acumulado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['reajuste_acumulado'] = "reajuste_acumulado";
   }
   else
   {
       $tab_def_campos['reajuste_acumulado'] = "";
   }
   $tab_labels["reajuste_acumulado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["reajuste_acumulado"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["reajuste_acumulado"] : "Reajuste";
   $tab_ger_campos['retencion_acumulada'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['retencion_acumulada'] = "retencion_acumulada";
   }
   else
   {
       $tab_def_campos['retencion_acumulada'] = "";
   }
   $tab_labels["retencion_acumulada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["retencion_acumulada"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["retencion_acumulada"] : "Retención";
   $tab_ger_campos['multa_acumulada'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['multa_acumulada'] = "multa_acumulada";
   }
   else
   {
       $tab_def_campos['multa_acumulada'] = "";
   }
   $tab_labels["multa_acumulada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["multa_acumulada"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["multa_acumulada"] : "Multas";
   $tab_ger_campos['avance'] = "on";
   $tab_def_campos['avance'] = "avance";
   $tab_labels["avance"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["avance"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["avance"] : "Avance Periodo";
   ...
   $tab_labels["porcentaje_avance"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["porcentaje_avance"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["porcentaje_avance"] : "Avance Acumulado";
   ...
   $tab_labels["porcentaje_avance2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["porcentaje_avance2"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["porcentaje_avance2"] : "% Avance";
   $tab_ger_campos['ur_real'] = "on";
   $tab_def_campos['ur_real'] = "ur_real";
   $tab_labels["ur_real"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["ur_real"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["ur_real"] : "UR Acumulado";
   $tab_ger_campos['backlog_p'] = "on";
   $tab_def_campos['backlog_p'] = "backlog_p";
   $tab_labels["backlog_p"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["backlog_p"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["backlog_p"] : "Backlog P";
   $tab_ger_campos['backlog_f'] = "on";
   $tab_def_campos['backlog_f'] = "backlog_f";
   $tab_labels["backlog_f"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["backlog_f"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['labels']["backlog_f"] : "Backlog F";
   $tab_ger_campos['empresa'] = "none";
   $tab_ger_campos['tipo_moneda'] = "none";
   $tab_ger_campos['presupuesto_acumulado'] = "none";
   $tab_ger_campos['facturacion_acumulada'] = "none";
   $tab_ger_campos['reajuste_acumulado'] = "none";
   $tab_ger_campos['retencion_acumulada'] = "none";
   $tab_ger_campos['multa_acumulada'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_produccion_proyecto_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
