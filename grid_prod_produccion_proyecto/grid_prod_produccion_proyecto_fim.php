...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_produccion_proyecto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_produccion_proyecto"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_produccion_proyecto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_produccion_proyecto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_produccion_proyecto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_produccion_proyecto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_prod_produccion_proyecto']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_prod_produccion_proyecto</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_prod_produccion_proyecto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_prod_produccion_proyecto']['embutida_filho'] as $ind => $sc_init)
          {
