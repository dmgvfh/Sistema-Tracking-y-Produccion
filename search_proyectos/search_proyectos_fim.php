...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____search_proyectos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____search_proyectos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['search_proyectos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['search_proyectos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['search_proyectos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['search_proyectos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['search_proyectos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['search_proyectos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['search_proyectos']['embutida_filho'] as $ind => $sc_init)
          {
