...
class grid_prod_items_base_tipo_proyectos_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_prod_items_base_tipo_proyectos" . $this->Xls_tp;
          $this->Tit_doc    = "grid_prod_items_base_tipo_proyectos" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_prod_items_base_tipo_proyectos_total.class.php"); 
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['embutida'])
      { 
   ...
   function NM_export_companias_razon_social()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->companias_razon_social, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->companias_razon_social, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_prod_items_base_agrupador1()
   {
         ...
         if (is_numeric($this->prod_items_base_agrupador1))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->prod_items_base_agrupador1);
         $this->Xls_col++;
   }
   //----- companias_nombre
   function NM_export_companias_nombre()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->companias_nombre, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->companias_nombre, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- companias_razon_social
   function NM_sub_cons_companias_razon_social()
   {
         $this->companias_razon_social = html_entity_decode($this->companias_razon_social, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->companias_razon_social = strip_tags($this->companias_razon_social);
         $this->companias_razon_social = NM_charset_to_utf8($this->companias_razon_social);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->companias_razon_social;
   ...
   //----- prod_items_base_agrupador1
   function NM_sub_cons_prod_items_base_agrupador1()
   {
         $this->prod_items_base_agrupador1 = NM_charset_to_utf8($this->prod_items_base_agrupador1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->prod_items_base_agrupador1;
   ...
   //----- companias_nombre
   function NM_sub_cons_companias_nombre()
   {
         $this->companias_nombre = html_entity_decode($this->companias_nombre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->companias_nombre = strip_tags($this->companias_nombre);
         $this->companias_nombre = NM_charset_to_utf8($this->companias_nombre);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->companias_nombre;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['nolabel'])
       {
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>ITEMS ASOCIADOS SEGÚN TIPO DE PROYECTO :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base_tipo_proyectos']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
