  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_documentos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_documentos_form();
	}
...
?>
  ...
  function do_ajax_form_prod_documentos_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_documentos_validate_id_proyecto_cb);
  } // do_ajax_form_prod_documentos_validate_id_proyecto

  function do_ajax_form_prod_documentos_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_validate_id_proyecto_cb

  // ---------- Validate id_carpeta
  function do_ajax_form_prod_documentos_validate_id_carpeta()
  {
    var nomeCampo_id_carpeta = "id_carpeta";
    var var_id_carpeta = scAjaxGetFieldSelect(nomeCampo_id_carpeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_validate_id_carpeta(var_id_carpeta, var_script_case_init, do_ajax_form_prod_documentos_validate_id_carpeta_cb);
  } // do_ajax_form_prod_documentos_validate_id_carpeta

  function do_ajax_form_prod_documentos_validate_id_carpeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_carpeta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_validate_id_carpeta_cb

  // ---------- Validate id_tipo_doc
  function do_ajax_form_prod_documentos_validate_id_tipo_doc()
  {
    var nomeCampo_id_tipo_doc = "id_tipo_doc";
    var var_id_tipo_doc = scAjaxGetFieldSelect(nomeCampo_id_tipo_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_validate_id_tipo_doc(var_id_tipo_doc, var_script_case_init, do_ajax_form_prod_documentos_validate_id_tipo_doc_cb);
  } // do_ajax_form_prod_documentos_validate_id_tipo_doc

  function do_ajax_form_prod_documentos_validate_id_tipo_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_tipo_doc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_validate_id_tipo_doc_cb

  // ---------- Validate nombre_documento
  function do_ajax_form_prod_documentos_validate_nombre_documento()
  {
    var nomeCampo_nombre_documento = "nombre_documento";
    var var_nombre_documento = scAjaxGetFieldText(nomeCampo_nombre_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_validate_nombre_documento(var_nombre_documento, var_script_case_init, do_ajax_form_prod_documentos_validate_nombre_documento_cb);
  } // do_ajax_form_prod_documentos_validate_nombre_documento

  function do_ajax_form_prod_documentos_validate_nombre_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_documento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_validate_nombre_documento_cb

  // ---------- Validate descripcion
  function do_ajax_form_prod_documentos_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_prod_documentos_validate_descripcion_cb);
  } // do_ajax_form_prod_documentos_validate_descripcion

  function do_ajax_form_prod_documentos_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_validate_descripcion_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_documentos_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_prod_documentos_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_documentos_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_prod_documentos_validate_fecha

  function do_ajax_form_prod_documentos_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_validate_fecha_cb

  // ---------- Refresh id_carpeta
  function do_ajax_form_prod_documentos_refresh_id_carpeta()
  {
    var var_id_carpeta = scAjaxGetFieldSelect("id_carpeta");
    var var_nmgp_refresh_fields = "id_tipo_doc";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_documentos_refresh_id_carpeta(var_id_carpeta, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_prod_documentos_refresh_id_carpeta_cb);
  } // do_ajax_form_prod_documentos_refresh_id_carpeta

  function do_ajax_form_prod_documentos_refresh_id_carpeta_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_refresh_id_carpeta_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_documentos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_documentos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_id_carpeta = scAjaxGetFieldSelect("id_carpeta");
    var var_id_tipo_doc = scAjaxGetFieldSelect("id_tipo_doc");
    var var_nombre_documento = scAjaxGetFieldText("nombre_documento");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_nombre_documento_ul_name = scAjaxSpecCharProtect(document.F1.nombre_documento_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_nombre_documento_ul_type = document.F1.nombre_documento_ul_type.value;
    var var_nombre_documento_salva = scAjaxSpecCharProtect(document.F1.nombre_documento_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_nombre_documento_limpa = document.F1.nombre_documento_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_prod_documentos_submit_form(var_id_proyecto, var_id_carpeta, var_id_tipo_doc, var_nombre_documento, var_descripcion, var_fecha, var_nombre_documento_ul_name, var_nombre_documento_ul_type, var_nombre_documento_salva, var_nombre_documento_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_documentos_submit_form_cb);
  } // do_ajax_form_prod_documentos_submit_form

  function do_ajax_form_prod_documentos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.nombre_documento_limpa && document.F1.nombre_documento_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("nombre_documento", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_nombre_documento") && "" != document.getElementById("id_ajax_doc_nombre_documento").innerHTML)
      {
        document.getElementById("id_ajax_doc_nombre_documento").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_documentos_submit_form_cb_after_alert);
  } // do_ajax_form_prod_documentos_submit_form_cb
  function do_ajax_form_prod_documentos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_documentos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_documentos_navigate_form()
  {
    perform_ajax_form_prod_documentos_navigate_form();
  }

  function perform_ajax_form_prod_documentos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_prod_documentos_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_documentos_navigate_form_cb);
  } // do_ajax_form_prod_documentos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_documentos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_documentos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_documentos_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_documentos_navigate_form_cb
  function do_ajax_form_prod_documentos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_documentos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_documentos_navigate_form_cb_after_alert

  function sc_hide_form_prod_documentos_form()
  {
  ...
  ajax_field_list[1] = "id_carpeta";
  ajax_field_list[2] = "id_tipo_doc";
  ajax_field_list[3] = "nombre_documento";
  ajax_field_list[4] = "descripcion";
  ajax_field_list[5] = "fecha";
  ...
  var ajax_error_list = {
    ...
    "id_carpeta": {"label": "Carpeta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_tipo_doc": {"label": "Tipo Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nombre_documento": {"label": "Nombre Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    ...
    "id_carpeta": new Array(),
    "id_tipo_doc": new Array(),
    "nombre_documento": new Array(),
    "descripcion": new Array(),
    "fecha": new Array()
  };
  ajax_field_mult["id_proyecto"][1] = "id_proyecto";
  ajax_field_mult["id_carpeta"][1] = "id_carpeta";
  ajax_field_mult["id_tipo_doc"][1] = "id_tipo_doc";
  ajax_field_mult["nombre_documento"][1] = "nombre_documento";
  ...
  var ajax_field_id = {
    ...
    "id_carpeta": new Array("hidden_field_label_id_carpeta", "hidden_field_data_id_carpeta"),
    "id_tipo_doc": new Array("hidden_field_label_id_tipo_doc", "hidden_field_data_id_tipo_doc"),
    "nombre_documento": new Array("hidden_field_label_nombre_documento", "hidden_field_data_nombre_documento"),
