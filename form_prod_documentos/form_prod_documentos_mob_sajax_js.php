  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_documentos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_documentos_mob_form();
	}
...
?>
  ...
  function do_ajax_form_prod_documentos_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_documentos_mob_validate_id_proyecto_cb);
  } // do_ajax_form_prod_documentos_mob_validate_id_proyecto

  function do_ajax_form_prod_documentos_mob_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_mob_validate_id_proyecto_cb

  // ---------- Validate id_carpeta
  function do_ajax_form_prod_documentos_mob_validate_id_carpeta()
  {
    var nomeCampo_id_carpeta = "id_carpeta";
    var var_id_carpeta = scAjaxGetFieldSelect(nomeCampo_id_carpeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_mob_validate_id_carpeta(var_id_carpeta, var_script_case_init, do_ajax_form_prod_documentos_mob_validate_id_carpeta_cb);
  } // do_ajax_form_prod_documentos_mob_validate_id_carpeta

  function do_ajax_form_prod_documentos_mob_validate_id_carpeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_mob_validate_id_carpeta_cb

  // ---------- Validate id_tipo_doc
  function do_ajax_form_prod_documentos_mob_validate_id_tipo_doc()
  {
    var nomeCampo_id_tipo_doc = "id_tipo_doc";
    var var_id_tipo_doc = scAjaxGetFieldSelect(nomeCampo_id_tipo_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_mob_validate_id_tipo_doc(var_id_tipo_doc, var_script_case_init, do_ajax_form_prod_documentos_mob_validate_id_tipo_doc_cb);
  } // do_ajax_form_prod_documentos_mob_validate_id_tipo_doc

  function do_ajax_form_prod_documentos_mob_validate_id_tipo_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_mob_validate_id_tipo_doc_cb

  // ---------- Validate nombre_documento
  function do_ajax_form_prod_documentos_mob_validate_nombre_documento()
  {
    var nomeCampo_nombre_documento = "nombre_documento";
    var var_nombre_documento = scAjaxGetFieldText(nomeCampo_nombre_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_mob_validate_nombre_documento(var_nombre_documento, var_script_case_init, do_ajax_form_prod_documentos_mob_validate_nombre_documento_cb);
  } // do_ajax_form_prod_documentos_mob_validate_nombre_documento

  function do_ajax_form_prod_documentos_mob_validate_nombre_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_mob_validate_nombre_documento_cb

  // ---------- Validate descripcion
  function do_ajax_form_prod_documentos_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_documentos_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_prod_documentos_mob_validate_descripcion_cb);
  } // do_ajax_form_prod_documentos_mob_validate_descripcion

  function do_ajax_form_prod_documentos_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_mob_validate_descripcion_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_documentos_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_prod_documentos_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_documentos_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_prod_documentos_mob_validate_fecha

  function do_ajax_form_prod_documentos_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_mob_validate_fecha_cb

  // ---------- Refresh id_carpeta
  function do_ajax_form_prod_documentos_mob_refresh_id_carpeta()
  {
    var var_id_carpeta = scAjaxGetFieldSelect("id_carpeta");
    var var_nmgp_refresh_fields = "id_tipo_doc";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_documentos_mob_refresh_id_carpeta(var_id_carpeta, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_prod_documentos_mob_refresh_id_carpeta_cb);
  } // do_ajax_form_prod_documentos_mob_refresh_id_carpeta

  function do_ajax_form_prod_documentos_mob_refresh_id_carpeta_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_documentos_mob_refresh_id_carpeta_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_documentos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_documentos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_prod_documentos_mob_submit_form(var_id_proyecto, var_id_carpeta, var_id_tipo_doc, var_nombre_documento, var_descripcion, var_fecha, var_id, var_nombre_documento_ul_name, var_nombre_documento_ul_type, var_nombre_documento_salva, var_nombre_documento_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_documentos_mob_submit_form_cb);
  } // do_ajax_form_prod_documentos_mob_submit_form

  function do_ajax_form_prod_documentos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_documentos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_documentos_mob_submit_form_cb
  function do_ajax_form_prod_documentos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_documentos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_documentos_mob_navigate_form()
  {
    perform_ajax_form_prod_documentos_mob_navigate_form();
  }

  function perform_ajax_form_prod_documentos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_prod_documentos_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_documentos_mob_navigate_form_cb);
  } // do_ajax_form_prod_documentos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_documentos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_documentos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_documentos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_documentos_mob_navigate_form_cb
  function do_ajax_form_prod_documentos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_documentos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_documentos_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_documentos_mob_form()
  {
