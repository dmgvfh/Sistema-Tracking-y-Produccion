...
?>
   <span id="idAjaxSelect_id_proyecto">
      <SELECT class="scFilterObjectEven" id="SC_id_proyecto" name="id_proyecto[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'id_proyecto[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "id_proyecto" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
