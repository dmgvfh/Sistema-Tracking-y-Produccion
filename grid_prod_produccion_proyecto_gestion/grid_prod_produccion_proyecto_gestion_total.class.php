...
class grid_prod_produccion_proyecto_gestion_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']))
      { 
