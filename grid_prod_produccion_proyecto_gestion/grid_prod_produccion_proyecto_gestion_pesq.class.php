...
class grid_prod_produccion_proyecto_gestion_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_prod_produccion_proyecto_gestion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_prod_produccion_proyecto_gestion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_prod_produccion_proyecto_gestion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      else
      {
         ...
         $nome_sum = "prod_produccion_proyecto.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Producción de Proyectos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_prod_produccion_proyecto_gestion/grid_prod_produccion_proyecto_gestion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_prod_produccion_proyecto_gestion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_prod_produccion_proyecto_gestion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_prod_produccion_proyecto_gestion_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_empresa_cond#NMF#' + search_get_sel_txt('SC_id_empresa_cond') + '@NMF@';
  str_out += 'SC_id_empresa#NMF#' + search_get_select('SC_id_empresa') + '@NMF@';
  str_out += 'SC_id_proyecto_cond#NMF#' + search_get_sel_txt('SC_id_proyecto_cond') + '@NMF@';
  str_out += 'SC_id_proyecto#NMF#' + search_get_Dselelect('SC_id_proyecto_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> Producción de Proyectos</div>
...
<?php
   ...
   {
      global 
             $id_empresa_cond, $id_empresa,
             $id_proyecto_cond, $id_proyecto,
      ...
      if (isset($bprocessa) && ($bprocessa == "recarga" || $bprocessa == "save_form" || $bprocessa == "filter_delete"))
      {
          ...
          {
              $id_proyecto = explode("@?@", $id_proyecto);
          }
          else
          {
              $id_proyecto = array();
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_empresa']; 
          $id_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_empresa_cond']; 
          $id_proyecto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_proyecto']; 
          $id_proyecto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_proyecto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['NM_operador']; 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_id_empresa = (in_array($id_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_proyecto = (in_array($id_proyecto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      // id_proyecto
      if (is_array($id_proyecto) && !empty($id_proyecto))
      {
         $tmp_array = array();
         $id_proyecto_val_str = "";
         foreach ($id_proyecto as $tmp_val_cmp)
         {
            if ("" != $id_proyecto_val_str)
            {
               $id_proyecto_val_str .= ",";
            }
            ...
            $id_proyecto_val_str .= "'$tmp_val_cmp'";
         }
         $id_proyecto = $tmp_array;
      }
      else
      {
         $id_proyecto_val_str = "";
      ...
      {
         $tmp_pos = (is_string($id_empresa)) ? strpos($id_empresa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_empresa = substr($id_empresa, 0, $tmp_pos);
         }
      }
      if (!isset($id_proyecto) || $id_proyecto == "")
      {
          $id_proyecto = array();
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_empresa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_empresa'])) ? $this->New_label['id_empresa'] : "Empresa"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_empresa_cond" name="id_empresa_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_empresa" <?php echo $str_hide_id_empresa?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_empresa'])) ? $this->New_label['id_empresa'] : "Empresa";
 $nmgp_tab_label .= "id_empresa?#?" . $SC_Label . "?@?";
...
<?php
      $id_empresa_look = (is_string($id_empresa) ? substr($this->Db->qstr($id_empresa), 1, -1) : $id_empresa); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT id, razon_social  FROM companias  ORDER BY nombre"; 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['psq_check_ret']['id_empresa'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['psq_check_ret']['id_empresa'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_id_empresa">
      <SELECT class="scFilterObjectOdd" id="SC_id_empresa" name="id_empresa"  size="1">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_empresa)
            {
                    $id_empresa_sel = ($nm_opc_cod === $id_empresa) ? "selected" : "";
            }
            else
            {
               $id_empresa_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $id_empresa_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_id_proyecto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_proyecto'])) ? $this->New_label['id_proyecto'] : "Código Proyecto"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_proyecto_cond" name="id_proyecto_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_proyecto" <?php echo $str_hide_id_proyecto?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_proyecto'])) ? $this->New_label['id_proyecto'] : "Código Proyecto";
 $nmgp_tab_label .= "id_proyecto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $id_proyecto_look = (is_string($id_proyecto) ? substr($this->Db->qstr($id_proyecto), 1, -1) : $id_proyecto); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT id, nombre_proyecto  FROM proyectos where habilitado=1  ORDER BY codigo"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['psq_check_ret']['id_proyecto'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['psq_check_ret']['id_proyecto'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_id_proyecto_orig" name="id_proyecto_orig" size=7 multiple onDblClick="nm_add_sel('id_proyecto_orig', 'id_proyecto_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $id_proyecto_sel = "";
               foreach ($id_proyecto as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $id_proyecto_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
            ...
            {
               $id_proyecto_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $id_proyecto_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('id_proyecto_orig', 'id_proyecto_dest', 'N', '');", "nm_add_all('id_proyecto_orig', 'id_proyecto_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('id_proyecto_orig', 'id_proyecto_dest', 'N', '');", "nm_add_sel('id_proyecto_orig', 'id_proyecto_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('id_proyecto_dest', 'id_proyecto_orig', 'N', '');", "nm_del_sel('id_proyecto_dest', 'id_proyecto_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('id_proyecto_dest', 'id_proyecto_orig', 'N', '');", "nm_del_all('id_proyecto_dest', 'id_proyecto_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_id_proyecto_dest" name="id_proyecto_dest" size=7 multiple  onDblClick="nm_del_sel('id_proyecto_dest', 'id_proyecto_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_id_proyecto" name="id_proyecto" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.id_proyecto_dest.selectedIndex = -1;</script>
<?php
?>
...
?>
<?php
   if (is_file("grid_prod_produccion_proyecto_gestion_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('id_proyecto_dest', 'id_proyecto');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_empresa'), document.F1.id_empresa_cond, 'id_empresa');
   document.F1.id_empresa.value = "";
   nm_campos_between(document.getElementById('id_vis_id_proyecto'), document.F1.id_proyecto_cond, 'id_proyecto');
   nm_del_all('id_proyecto_dest', 'id_proyecto_orig', 'N', '');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_prod_produccion_proyecto_gestion";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_prod_produccion_proyecto_gestion/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_empresa_cond'] = 'cond';
      $tp_fields['SC_id_empresa'] = 'select';
      $tp_fields['SC_id_proyecto_cond'] = 'cond';
      $tp_fields['SC_id_proyecto'] = 'dselect';
   ...
   {
      global $id_empresa_cond, $id_empresa,
             $id_proyecto_cond, $id_proyecto, $nmgp_tab_label;
      ...
      $id_empresa_cond_salva = $id_empresa_cond; 
      if (!isset($id_empresa_input_2) || $id_empresa_input_2 == "")
      {
          $id_empresa_input_2 = $id_empresa;
      }
      $id_proyecto_cond_salva = $id_proyecto_cond; 
      if (!isset($id_proyecto_input_2) || $id_proyecto_input_2 == "")
      {
          $id_proyecto_input_2 = $id_proyecto;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca'];
      }
      $tmp_pos = (is_string($id_empresa)) ? strpos($id_empresa, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $id_empresa;
          ...
          $L_lookup = substr($id_empresa, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['psq_check_ret']['id_empresa'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Empresa : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (is_array($id_proyecto)) {
          foreach ($id_proyecto as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['psq_check_ret']['id_proyecto'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Código Proyecto : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_empresa'] = $id_empresa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_empresa_cond'] = $id_empresa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_proyecto'] = $id_proyecto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_proyecto_cond'] = $id_proyecto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['id_empresa'] = $Conteudo;
      $this->cmp_formatado['id_proyecto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']['id_proyecto'];
      $this->cmp_formatado['id_proyecto_input_2'] = $id_proyecto_input_2;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca'];
      }
      ...
      $nm_aspas = "";
      if ($id_proyecto_cond == "nu" || $id_proyecto_cond == "nn" || $id_proyecto_cond == "ep" || $id_proyecto_cond == "ne")
      {
          $id_proyecto = array();
      }
      if (is_array($id_proyecto) && count($id_proyecto) != 0)
      {
         foreach ($id_proyecto as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($id_proyecto_cond == "df" || $id_proyecto_cond == "np")
         {
             $this->comando        .= " id_proyecto not in (";
             $this->comando_sum    .= " prod_produccion_proyecto.id_proyecto not in (";
             $this->comando_filtro .= " id_proyecto not in (";
         }
         else
         {
             $this->comando        .= " id_proyecto in (";
             $this->comando_sum    .= " prod_produccion_proyecto.id_proyecto in (";
             $this->comando_filtro .= " id_proyecto in (";
         }
         $x                     = count($id_proyecto);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$id_proyecto_cond]) ? $Lang_descr[$id_proyecto_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $nmgp_tab_label['id_proyecto'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($id_proyecto) && ($id_proyecto_cond == "nu" || $id_proyecto_cond == "nn" || $id_proyecto_cond == "ep" || $id_proyecto_cond == "ne"))
      {
         $this->monta_condicao("id_proyecto", $id_proyecto_cond, "", "", "id_proyecto", "INT", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_produccion_proyecto_gestion']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "id_empresa" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
