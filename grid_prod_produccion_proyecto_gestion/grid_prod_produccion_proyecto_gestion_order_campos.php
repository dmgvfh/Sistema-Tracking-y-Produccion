<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_prod_produccion_proyecto_gestion']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_prod_produccion_proyecto_gestion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_produccion_proyecto_gestion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["id_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["id_proyecto"] : "Código Proyecto";
...
WHERE
  ...
  prod_presupuesto.id_proyecto = {id_proyecto}";
   ...
   $tab_labels["presupuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["presupuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["presupuesto"] : "Presupuesto Base<br>Proyecto";
   ...
   {
       $tab_def_campos['modificacion_contrato'] = "SUM(modificacion_contrato)";
   }
   $tab_labels["modificacion_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["modificacion_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["modificacion_contrato"] : "Modificacion Contrato";
   ...
   {
       $tab_def_campos['facturacion'] = "sum(facturacion)";
   }
   $tab_labels["facturacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["facturacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["facturacion"] : "Facturacion Total Neto";
   ...
   {
       $tab_def_campos['reajuste'] = "SUM(reajuste)";
   }
   $tab_labels["reajuste"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["reajuste"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["reajuste"] : "Reajuste Total Neto";
   ...
   {
       $tab_def_campos['retencion'] = "SUM(retencion)";
   }
   $tab_labels["retencion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["retencion"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["retencion"] : "Retención Total Neto";
   ...
   {
       $tab_def_campos['multa'] = "SUM(multa)";
   }
   $tab_labels["multa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["multa"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["multa"] : "Multas Total Neto";
   ...
   {
       $tab_def_campos['avance'] = "sum(avance)";
   }
   $tab_labels["avance"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["avance"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["avance"] : "Producción Total Neto";
   $tab_ger_campos['ur_real'] = "on";
   $tab_def_campos['ur_real'] = "ur_real";
   $tab_labels["ur_real"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["ur_real"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["ur_real"] : "UR Acumulado<br>Mes";
   $tab_ger_campos['backlog_p'] = "on";
   $tab_def_campos['backlog_p'] = "backlog_p";
   $tab_labels["backlog_p"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["backlog_p"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["backlog_p"] : "Backlog P";
   $tab_ger_campos['backlog_f'] = "on";
   $tab_def_campos['backlog_f'] = "backlog_f";
   $tab_labels["backlog_f"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["backlog_f"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['labels']["backlog_f"] : "Backlog F";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_produccion_proyecto_gestion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_produccion_proyecto_gestion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
