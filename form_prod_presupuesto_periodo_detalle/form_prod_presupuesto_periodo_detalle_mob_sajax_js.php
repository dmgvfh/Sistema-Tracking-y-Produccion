  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_presupuesto_periodo_detalle_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_presupuesto_periodo_detalle_mob_form();
	}
...
?>
  ...
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_proyecto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_proyecto

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_proyecto_cb

  // ---------- Validate id_item
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_item()
  {
    var nomeCampo_id_item = "id_item";
    var var_id_item = scAjaxGetFieldSelect(nomeCampo_id_item);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_item(var_id_item, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_item_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_item

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_item_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_item";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_item_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_fecha_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_fecha

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_fecha_cb

  // ---------- Validate monto_disponible
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_disponible()
  {
    var nomeCampo_monto_disponible = "monto_disponible";
    var var_monto_disponible = scAjaxGetFieldText(nomeCampo_monto_disponible);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_disponible(var_monto_disponible, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_disponible_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_disponible

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_disponible_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto_disponible";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_disponible_cb

  // ---------- Validate monto_uf
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_uf()
  {
    var nomeCampo_monto_uf = "monto_uf";
    var var_monto_uf = scAjaxGetFieldText(nomeCampo_monto_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_uf(var_monto_uf, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_uf_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_uf

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_monto_uf_cb

  // ---------- Validate observaciones
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_observaciones_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_observaciones

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_observaciones_cb

  // ---------- Validate avance_proyecto
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_avance_proyecto()
  {
    var nomeCampo_avance_proyecto = "avance_proyecto";
    var var_avance_proyecto = scAjaxGetFieldText(nomeCampo_avance_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_avance_proyecto(var_avance_proyecto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_avance_proyecto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_avance_proyecto

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_avance_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avance_proyecto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_avance_proyecto_cb

  // ---------- Validate id_partida
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_partida()
  {
    var nomeCampo_id_partida = "id_partida";
    var var_id_partida = scAjaxGetFieldText(nomeCampo_id_partida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_partida(var_id_partida, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_partida_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_partida

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_partida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_validate_id_partida_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_id_item = scAjaxGetFieldSelect("id_item");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_monto_disponible = scAjaxGetFieldText("monto_disponible");
    var var_monto_uf = scAjaxGetFieldText("monto_uf");
    var var_observaciones = scAjaxGetFieldText("observaciones");
    var var_id_partida = scAjaxGetFieldText("id_partida");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form(var_id_proyecto, var_id_item, var_fecha, var_monto_disponible, var_monto_uf, var_observaciones, var_id_partida, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form_cb
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_prod_presupuesto_periodo_mob"] = "off";

  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form()
  {
    perform_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form();
  }

  function perform_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_prod_presupuesto_periodo_mob"] = "on";
    x_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_detalle_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_prod_presupuesto_periodo_mob"] && "nmsc_iframe_liga_form_prod_presupuesto_periodo_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_prod_presupuesto_periodo_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_prod_presupuesto_periodo_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_prod_presupuesto_periodo_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_prod_presupuesto_periodo_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_prod_presupuesto_periodo_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form_cb
  function do_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_presupuesto_periodo_detalle_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_presupuesto_periodo_detalle_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_presupuesto_periodo_detalle_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_prod_presupuesto_periodo_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "id_item";
  ajax_field_list[2] = "fecha";
  ajax_field_list[3] = "monto_disponible";
  ajax_field_list[4] = "monto_uf";
  ajax_field_list[5] = "observaciones";
  ajax_field_list[6] = "avance_proyecto";
  ajax_field_list[7] = "id_partida";
  ...
  var ajax_error_list = {
    ...
    "id_item": {"label": "Item", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fecha": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "monto_disponible": {"label": "Monto Disponible", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "monto_uf": {"label": "Monto Uf", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "avance_proyecto": {"label": "Avance Proyecto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_partida": {"label": "Id Partida", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_id = {
    ...
    "id_item": new Array("hidden_field_label_id_item", "hidden_field_data_id_item"),
    "fecha": new Array("hidden_field_label_fecha", "hidden_field_data_fecha"),
    "monto_disponible": new Array("hidden_field_label_monto_disponible", "hidden_field_data_monto_disponible"),
    ...
    "avance_proyecto": new Array("hidden_field_label_avance_proyecto", "hidden_field_data_avance_proyecto"),
