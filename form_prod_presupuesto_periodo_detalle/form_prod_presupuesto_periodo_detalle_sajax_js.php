  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_presupuesto_periodo_detalle" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_presupuesto_periodo_detalle_form();
	}
...
?>
  ...
  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_proyecto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_proyecto

  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_proyecto_cb

  // ---------- Validate id_item
  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_item()
  {
    var nomeCampo_id_item = "id_item";
    var var_id_item = scAjaxGetFieldSelect(nomeCampo_id_item);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_validate_id_item(var_id_item, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_item_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_item

  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_item_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_item";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_item_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_validate_fecha_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_fecha

  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_fecha_cb

  // ---------- Validate monto_disponible
  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_disponible()
  {
    var nomeCampo_monto_disponible = "monto_disponible";
    var var_monto_disponible = scAjaxGetFieldText(nomeCampo_monto_disponible);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_disponible(var_monto_disponible, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_disponible_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_disponible

  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_disponible_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_disponible_cb

  // ---------- Validate monto_uf
  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_uf()
  {
    var nomeCampo_monto_uf = "monto_uf";
    var var_monto_uf = scAjaxGetFieldText(nomeCampo_monto_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_uf(var_monto_uf, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_uf_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_uf

  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_monto_uf_cb

  // ---------- Validate observaciones
  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_validate_observaciones_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_observaciones

  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_observaciones_cb

  // ---------- Validate avance_proyecto
  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_avance_proyecto()
  {
    var nomeCampo_avance_proyecto = "avance_proyecto";
    var var_avance_proyecto = scAjaxGetFieldText(nomeCampo_avance_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_validate_avance_proyecto(var_avance_proyecto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_validate_avance_proyecto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_avance_proyecto

  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_avance_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_avance_proyecto_cb

  // ---------- Validate id_partida
  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_partida()
  {
    var nomeCampo_id_partida = "id_partida";
    var var_id_partida = scAjaxGetFieldText(nomeCampo_id_partida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_detalle_validate_id_partida(var_id_partida, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_partida_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_partida

  function do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_partida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_detalle_validate_id_partida_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_presupuesto_periodo_detalle_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_presupuesto_periodo_detalle_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_detalle_submit_form(var_id_proyecto, var_id_item, var_fecha, var_monto_disponible, var_monto_uf, var_observaciones, var_id_partida, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_presupuesto_periodo_detalle_submit_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_submit_form

  function do_ajax_form_prod_presupuesto_periodo_detalle_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_detalle_submit_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_submit_form_cb
  function do_ajax_form_prod_presupuesto_periodo_detalle_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_presupuesto_periodo_detalle_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_prod_presupuesto_periodo"] = "off";

  function do_ajax_form_prod_presupuesto_periodo_detalle_navigate_form()
  {
    perform_ajax_form_prod_presupuesto_periodo_detalle_navigate_form();
  }

  function perform_ajax_form_prod_presupuesto_periodo_detalle_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_prod_presupuesto_periodo"] = "on";
    x_ajax_form_prod_presupuesto_periodo_detalle_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_detalle_navigate_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_detalle']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_presupuesto_periodo_detalle_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_prod_presupuesto_periodo"] && "nmsc_iframe_liga_form_prod_presupuesto_periodo" != scMasterDetailIframe["nmsc_iframe_liga_form_prod_presupuesto_periodo"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_prod_presupuesto_periodo"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_prod_presupuesto_periodo').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_prod_presupuesto_periodo').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_prod_presupuesto_periodo').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_detalle_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_detalle_navigate_form_cb
  function do_ajax_form_prod_presupuesto_periodo_detalle_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_presupuesto_periodo_detalle_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_presupuesto_periodo_detalle_navigate_form_cb_after_alert

  function sc_hide_form_prod_presupuesto_periodo_detalle_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_prod_presupuesto_periodo"])
    {
      return true;
    }
    return false;
