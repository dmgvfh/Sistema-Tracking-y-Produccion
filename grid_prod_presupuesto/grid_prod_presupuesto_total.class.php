...
class grid_prod_presupuesto_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_prod_presupuesto']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_prod_presupuesto']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $prod_presupuesto_id_partida_periodo, $prod_presupuesto_id_proyecto;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['tot_geral'] = array() ;  
      $nm_comando = "select count(*), sum(prod_presupuesto.unidades), sum(prod_presupuesto.monto_uf) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['contr_total_geral'] = "OK";
   } 

   //-----  agrupador
   function quebra_agrupador_sc_free_group_by($agrupador, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $prod_presupuesto_id_partida_periodo, $prod_presupuesto_id_proyecto;
      $tot_agrupador = array() ;  
      $nm_comando = "select count(*), sum(prod_presupuesto.unidades), sum(prod_presupuesto.monto_uf) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['where_pesq']; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          $tot_agrupador[0] = NM_encode_input(sc_strip_script($agrupador));
      }
      else {
          $tot_agrupador[0] = sc_strip_script($agrupador) ; 
      }
      $tot_agrupador[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_agrupador[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_agrupador[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_agrupador;
   } 
