...
class grid_prod_presupuesto_xml
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_label'];
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_prod_presupuesto.xml";
...
$_SESSION['scriptcase']['grid_prod_presupuesto']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_prod_presupuesto>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_prod_presupuesto";
...
$_SESSION['scriptcase']['grid_prod_presupuesto']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->agrupador))
         {
             $this->agrupador = sc_convert_encoding($this->agrupador, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->agrupador) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->agrupador) . "\"";
         }
   }
   //----- prod_items_base_item
   function NM_export_prod_items_base_item()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->prod_items_base_item))
         {
             $this->prod_items_base_item = sc_convert_encoding($this->prod_items_base_item, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_items_base_item) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_items_base_item) . "\"";
         }
   }
   ...
   function NM_export_prod_presupuesto_id_partida_periodo()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_prod_presupuesto_id_partida_periodo))
         {
             $this->look_prod_presupuesto_id_partida_periodo = sc_convert_encoding($this->look_prod_presupuesto_id_partida_periodo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_prod_presupuesto_id_partida_periodo) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_prod_presupuesto_id_partida_periodo) . "\"";
         }
   }
   ...
   function NM_export_prod_presupuesto_fecha()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_presupuesto_fecha) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_presupuesto_fecha) . "\"";
         }
   }
   ...
   function NM_export_prod_presupuesto_unidades()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_presupuesto_unidades) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_presupuesto_unidades) . "\"";
         }
   }
   //----- prod_presupuesto_tipo_moneda
   function NM_export_prod_presupuesto_tipo_moneda()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_prod_presupuesto_tipo_moneda))
         {
             $this->look_prod_presupuesto_tipo_moneda = sc_convert_encoding($this->look_prod_presupuesto_tipo_moneda, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_prod_presupuesto_tipo_moneda) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_prod_presupuesto_tipo_moneda) . "\"";
         }
   }
   ...
   function NM_export_prod_presupuesto_valor_unitario()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_presupuesto_valor_unitario) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_presupuesto_valor_unitario) . "\"";
         }
   }
   ...
   function NM_export_prod_presupuesto_monto_uf()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_presupuesto_monto_uf) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_presupuesto_monto_uf) . "\"";
         }
   }
   //----- prod_presupuesto_observaciones
   function NM_export_prod_presupuesto_observaciones()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->prod_presupuesto_observaciones))
         {
             $this->prod_presupuesto_observaciones = sc_convert_encoding($this->prod_presupuesto_observaciones, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_presupuesto_observaciones) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_presupuesto_observaciones) . "\"";
         }
   }
   //----- prod_presupuesto_id
   function NM_export_prod_presupuesto_id()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_presupuesto_id) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_presupuesto_id) . "\"";
         }
   }
   ...
   function NM_export_prod_presupuesto_id_proyecto()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_prod_presupuesto_id_proyecto))
         {
             $this->look_prod_presupuesto_id_proyecto = sc_convert_encoding($this->look_prod_presupuesto_id_proyecto, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_prod_presupuesto_id_proyecto) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_prod_presupuesto_id_proyecto) . "\"";
         }
   }
   //----- prod_presupuesto_vigente
   function NM_export_prod_presupuesto_vigente()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_prod_presupuesto_vigente))
         {
             $this->look_prod_presupuesto_vigente = sc_convert_encoding($this->look_prod_presupuesto_vigente, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_prod_presupuesto_vigente) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_prod_presupuesto_vigente) . "\"";
         }
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Presupuesto Del Proyecto :: XML</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
