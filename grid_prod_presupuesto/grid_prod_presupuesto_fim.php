...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_presupuesto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_presupuesto"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_presupuesto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_presupuesto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_presupuesto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_presupuesto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_prod_presupuesto']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_prod_presupuesto</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_prod_presupuesto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_prod_presupuesto']['embutida_filho'] as $ind => $sc_init)
          {
