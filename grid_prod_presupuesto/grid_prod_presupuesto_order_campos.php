...
<?php
   ...
   $Ord_Cmp = new grid_prod_presupuesto_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_presupuesto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['agrupador'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['agrupador'] = "agrupador";
   }
   else
   {
       $tab_def_campos['agrupador'] = "prod_agrupa_items.nombre_agrupador";
   }
   $tab_labels["agrupador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["agrupador"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["agrupador"] : "Agrupador";
   ...
   $tab_labels["prod_items_base_item"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_items_base_item"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_items_base_item"] : "Item";
   $tab_ger_campos['prod_presupuesto_id_partida_periodo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_id_partida_periodo'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_id_partida_periodo'] = "prod_presupuesto.id_partida_periodo";
   }
   $tab_labels["prod_presupuesto_id_partida_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_id_partida_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_id_partida_periodo"] : "Partida Periodo";
   $tab_ger_campos['prod_presupuesto_fecha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_fecha'] = "prod_presupuesto_fecha";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_fecha'] = "prod_presupuesto.fecha";
   }
   $tab_labels["prod_presupuesto_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_fecha"] : "Fecha Presupuesto";
   $tab_ger_campos['prod_presupuesto_unidades'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_unidades'] = "prod_presupuesto_unidades";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_unidades'] = "prod_presupuesto.unidades";
   }
   $tab_labels["prod_presupuesto_unidades"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_unidades"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_unidades"] : "Unidades";
   $tab_ger_campos['prod_presupuesto_tipo_moneda'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_tipo_moneda'] = "prod_presupuesto_tipo_moneda";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_tipo_moneda'] = "prod_presupuesto.tipo_moneda";
   }
   $tab_labels["prod_presupuesto_tipo_moneda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_tipo_moneda"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_tipo_moneda"] : "Tipo Moneda";
   $tab_ger_campos['prod_presupuesto_valor_unitario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_valor_unitario'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_valor_unitario'] = "prod_presupuesto.valor_unitario";
   }
   $tab_labels["prod_presupuesto_valor_unitario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_valor_unitario"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_valor_unitario"] : "Valor Unitario";
   $tab_ger_campos['prod_presupuesto_monto_uf'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_monto_uf'] = "prod_presupuesto_monto_uf";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_monto_uf'] = "prod_presupuesto.monto_uf";
   }
   $tab_labels["prod_presupuesto_monto_uf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_monto_uf"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_monto_uf"] : "Monto";
   $tab_ger_campos['prod_presupuesto_observaciones'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_observaciones'] = "prod_presupuesto_observaciones";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_observaciones'] = "prod_presupuesto.observaciones";
   }
   $tab_labels["prod_presupuesto_observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['labels']["prod_presupuesto_observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_presupuesto_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
