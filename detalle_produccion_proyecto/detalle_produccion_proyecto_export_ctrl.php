<?php
@session_start() ;
$_SESSION['scriptcase']['detalle_produccion_proyecto']['sc_process_barr'] = true;
require_once('../detalle_produccion_proyecto/index.php');
unset($_SESSION['scriptcase']['detalle_produccion_proyecto']['sc_process_barr']);
$ExportCtrl = new detalle_produccion_proyecto_export_control;
$ExportCtrl->Export_barr();

class detalle_produccion_proyecto_export_control
{
