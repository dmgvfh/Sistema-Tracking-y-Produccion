...
class grid_prod_hitos_contractuales_xml
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_label'];
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_prod_hitos_contractuales.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_prod_hitos_contractuales>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_prod_hitos_contractuales";
   ...
   function NM_export_prod_hitos_contractuales_id_proyecto()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_prod_hitos_contractuales_id_proyecto))
         {
             $this->look_prod_hitos_contractuales_id_proyecto = sc_convert_encoding($this->look_prod_hitos_contractuales_id_proyecto, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         ...
         {
             $SC_Label = "prod_hitos_contractuales_id_proyecto"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_prod_hitos_contractuales_id_proyecto) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_prod_hitos_contractuales_id_proyecto) . "\"";
         }
   }
   //----- mes
   function NM_export_mes()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->mes) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->mes) . "\"";
         }
   }
   ...
   function NM_export_prod_hitos_contractuales_id_usuario_asignado()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_prod_hitos_contractuales_id_usuario_asignado))
         {
             $this->look_prod_hitos_contractuales_id_usuario_asignado = sc_convert_encoding($this->look_prod_hitos_contractuales_id_usuario_asignado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "prod_hitos_contractuales_id_usuario_asignado"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_prod_hitos_contractuales_id_usuario_asignado) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_prod_hitos_contractuales_id_usuario_asignado) . "\"";
         }
   }
   ...
   function NM_export_prod_hitos_contractuales_id_actividad()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_prod_hitos_contractuales_id_actividad))
         {
             $this->look_prod_hitos_contractuales_id_actividad = sc_convert_encoding($this->look_prod_hitos_contractuales_id_actividad, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "prod_hitos_contractuales_id_actividad"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_prod_hitos_contractuales_id_actividad) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_prod_hitos_contractuales_id_actividad) . "\"";
         }
   }
   //----- prod_hitos_contractuales_observaciones
   function NM_export_prod_hitos_contractuales_observaciones()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->prod_hitos_contractuales_observaciones))
         {
             $this->prod_hitos_contractuales_observaciones = sc_convert_encoding($this->prod_hitos_contractuales_observaciones, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "prod_hitos_contractuales_observaciones"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_hitos_contractuales_observaciones) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_hitos_contractuales_observaciones) . "\"";
         }
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Hitos Contractuales Del Proyecto :: XML</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
