...
class grid_prod_hitos_contractuales_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_prod_hitos_contractuales.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['rtf_name']);
      }
   ...
   function NM_export_prod_hitos_contractuales_id_proyecto()
   {
         ...
         $this->look_prod_hitos_contractuales_id_proyecto = str_replace('<', '&lt;', $this->look_prod_hitos_contractuales_id_proyecto);
         $this->look_prod_hitos_contractuales_id_proyecto = str_replace('>', '&gt;', $this->look_prod_hitos_contractuales_id_proyecto);
         $this->Texto_tag .= "<td>" . $this->look_prod_hitos_contractuales_id_proyecto . "</td>\r\n";
   }
   //----- mes
   ...
   function NM_export_prod_hitos_contractuales_id_usuario_asignado()
   {
         ...
         $this->look_prod_hitos_contractuales_id_usuario_asignado = str_replace('<', '&lt;', $this->look_prod_hitos_contractuales_id_usuario_asignado);
         $this->look_prod_hitos_contractuales_id_usuario_asignado = str_replace('>', '&gt;', $this->look_prod_hitos_contractuales_id_usuario_asignado);
         $this->Texto_tag .= "<td>" . $this->look_prod_hitos_contractuales_id_usuario_asignado . "</td>\r\n";
   }
   ...
   function NM_export_prod_hitos_contractuales_id_actividad()
   {
         ...
         $this->look_prod_hitos_contractuales_id_actividad = str_replace('<', '&lt;', $this->look_prod_hitos_contractuales_id_actividad);
         $this->look_prod_hitos_contractuales_id_actividad = str_replace('>', '&gt;', $this->look_prod_hitos_contractuales_id_actividad);
         $this->Texto_tag .= "<td>" . $this->look_prod_hitos_contractuales_id_actividad . "</td>\r\n";
   }
   ...
   function NM_export_prod_hitos_contractuales_observaciones()
   {
         ...
         $this->prod_hitos_contractuales_observaciones = str_replace('<', '&lt;', $this->prod_hitos_contractuales_observaciones);
         $this->prod_hitos_contractuales_observaciones = str_replace('>', '&gt;', $this->prod_hitos_contractuales_observaciones);
         $this->Texto_tag .= "<td>" . $this->prod_hitos_contractuales_observaciones . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Hitos Contractuales Del Proyecto :: RTF</TITLE>
