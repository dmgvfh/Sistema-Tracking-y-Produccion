...
class grid_prod_hitos_contractuales_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_prod_hitos_contractuales']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_prod_hitos_contractuales']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['contr_total_geral'] == "OK")
      {
          $this->array_total_id_partida = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['arr_total']['id_partida'];
      }
      else
      {
          $this->array_total_id_partida = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['arr_total']['id_partida'] = $this->array_total_id_partida;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['json_use_label'])
       {
          $Lab_id_partida = "id_partida";
       }
       else
       {
       $Lab_id_partida = "Id Partida";
       }
       $this->comp_field = array(
           $Lab_id_partida,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id_proyecto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id_proyecto'] = "Código Proyecto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['mes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['mes'] = "Período Mes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id_tipo_hito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id_tipo_hito'] = "Tipo Hito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_nombre'] = "Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id_usuario_asignado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id_usuario_asignado'] = "Usuario Asignado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id_actividad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id_actividad'] = "Tipo Actividad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['hitos_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['hitos_periodo'] = "Hitos Asociados  Al Período"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_id'] = "Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_hito_start_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_hito_start_date'] = "Fecha Hito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_current_status_hito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['prod_hitos_contractuales_current_status_hito'] = "Estado Hito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['id_partida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['labels']['id_partida'] = "Id Partida"; 
       }
       //-----
       $this->comp_field_nm = array(
           'id_partida' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_order']['mes']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_order']['mes'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_order']['mes'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_display']['mes'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_display']['mes'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_display']['mes'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_display']['mes'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_display']['mes'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_display']['mes'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['summarizing_fields_display']['mes'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_prod_hitos_contractuales@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_prod_hitos_contractuales_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_mes("res", $this->NM_export);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_hitos_contractuales_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_prod_hitos_contractuales_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_hitos_contractuales_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_prod_hitos_contractuales/grid_prod_hitos_contractuales_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_prod_hitos_contractuales_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_prod_hitos_contractuales_config_pivot.php?nome_apl=grid_prod_hitos_contractuales&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("<SCRIPT language=\"Javascript\">\r\n");
      ...
      $nm_saida->saida("           document.Fexport.nmgp_password.value = password;\r\n");
      $nm_saida->saida("           document.Fexport.SC_module_export.value = SC_module_export;\r\n");
      $nm_saida->saida("               document.Fexport.action = \"grid_prod_hitos_contractuales_export_ctrl.php\";\r\n");
      $nm_saida->saida("           document.Fexport.submit() ;\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_prod_hitos_contractuales_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_hitos_contractuales_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_prod_hitos_contractuales/grid_prod_hitos_contractuales_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_hitos_contractuales']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $prod_hitos_contractuales_id_proyecto = (isset($Busca_temp['prod_hitos_contractuales_id_proyecto'])) ? $Busca_temp['prod_hitos_contractuales_id_proyecto'] : ""; 
          $tmp_pos = (is_string($prod_hitos_contractuales_id_proyecto)) ? strpos($prod_hitos_contractuales_id_proyecto, "##@@") : false;
          if ($tmp_pos !== false && !is_array($prod_hitos_contractuales_id_proyecto))
          {
              $prod_hitos_contractuales_id_proyecto = substr($prod_hitos_contractuales_id_proyecto, 0, $tmp_pos);
          }
      } 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->prod_hitos_contractuales_id_proyecto = $Busca_temp['prod_hitos_contractuales_id_proyecto']; 
       $this->prod_hitos_contractuales_id_proyecto = (isset($Busca_temp['prod_hitos_contractuales_id_proyecto'])) ? $Busca_temp['prod_hitos_contractuales_id_proyecto'] : ""; 
       $tmp_pos = (is_string($this->prod_hitos_contractuales_id_proyecto)) ? strpos($this->prod_hitos_contractuales_id_proyecto, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->prod_hitos_contractuales_id_proyecto))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('mes', 'id_partida');
     $campos_order = $this->Ini->Get_date_order_groupby("prod_produccion_proyecto.id", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->prod_hitos_contractuales_id_proyecto = $rs_res->fields[0] ;  
            $this->mes = $rs_res->fields[1] ;  
            $this->prod_hitos_contractuales_id_tipo_hito = $rs_res->fields[2] ;  
            $this->prod_hitos_contractuales_nombre = $rs_res->fields[3] ;  
            $this->prod_hitos_contractuales_id_usuario_asignado = $rs_res->fields[4] ;  
            $this->prod_hitos_contractuales_id_actividad = $rs_res->fields[5] ;  
            $this->prod_hitos_contractuales_observaciones = $rs_res->fields[6] ;  
            $this->id_partida = $rs_res->fields[7] ;  
            $this->prod_hitos_contractuales_current_status_hito = $rs_res->fields[8] ;  
            $this->prod_hitos_contractuales_id = $rs_res->fields[9] ;  
            $this->id_partida_orig = $this->id_partida;
            nmgp_Form_Num_Val($this->id_partida, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
