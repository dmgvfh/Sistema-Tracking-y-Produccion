<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_prod_hitos_contractuales']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_prod_hitos_contractuales_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_hitos_contractuales_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['prod_hitos_contractuales_id_proyecto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_hitos_contractuales_id_proyecto'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['prod_hitos_contractuales_id_proyecto'] = "prod_hitos_contractuales.id_proyecto";
   }
   $tab_labels["prod_hitos_contractuales_id_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_id_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_id_proyecto"] : "Código Proyecto";
   $tab_ger_campos['mes'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['mes'] = "mes";
   }
   else
   {
       $tab_def_campos['mes'] = "concat(month(prod_produccion_proyecto.fecha),'-',year(prod_produccion_proyecto.fecha))";
   }
   $tab_labels["mes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["mes"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["mes"] : "Período Mes";
   ...
   $tab_labels["prod_hitos_contractuales_id_tipo_hito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_id_tipo_hito"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_id_tipo_hito"] : "Tipo Hito";
   $tab_ger_campos['prod_hitos_contractuales_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_hitos_contractuales_nombre'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['prod_hitos_contractuales_nombre'] = "prod_hitos_contractuales.nombre";
   }
   $tab_labels["prod_hitos_contractuales_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_nombre"] : "Nombre";
   $tab_ger_campos['prod_hitos_contractuales_id_usuario_asignado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_hitos_contractuales_id_usuario_asignado'] = "cmp_maior_30_4";
   }
   else
   {
       $tab_def_campos['prod_hitos_contractuales_id_usuario_asignado'] = "prod_hitos_contractuales.id_usuario_asignado";
   }
   $tab_labels["prod_hitos_contractuales_id_usuario_asignado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_id_usuario_asignado"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_id_usuario_asignado"] : "Usuario Asignado";
   $tab_ger_campos['prod_hitos_contractuales_id_actividad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_hitos_contractuales_id_actividad'] = "cmp_maior_30_5";
   }
   else
   {
       $tab_def_campos['prod_hitos_contractuales_id_actividad'] = "prod_hitos_contractuales.id_actividad";
   }
   $tab_labels["prod_hitos_contractuales_id_actividad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_id_actividad"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_id_actividad"] : "Tipo Actividad";
   $tab_ger_campos['prod_hitos_contractuales_observaciones'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_hitos_contractuales_observaciones'] = "cmp_maior_30_6";
   }
   else
   {
       $tab_def_campos['prod_hitos_contractuales_observaciones'] = "prod_hitos_contractuales.observaciones";
   }
   $tab_labels["prod_hitos_contractuales_observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["prod_hitos_contractuales_observaciones"] : "Observaciones";
   $tab_ger_campos['hitos_periodo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['hitos_periodo'] = "hitos_periodo";
   }
   else
   {
       $tab_def_campos['hitos_periodo'] = "";
   }
   $tab_labels["hitos_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["hitos_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['labels']["hitos_periodo"] : "Hitos Asociados  Al Período";
   $tab_ger_campos['hitos_periodo'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>Hitos Contractuales Del Proyecto</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_hitos_contractuales_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_hitos_contractuales']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
