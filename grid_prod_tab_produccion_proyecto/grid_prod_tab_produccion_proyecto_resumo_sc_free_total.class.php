...
class grid_prod_tab_produccion_proyecto_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_prod_tab_produccion_proyecto']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_prod_tab_produccion_proyecto']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
...
$_SESSION['scriptcase']['grid_prod_tab_produccion_proyecto']['contr_erro'] = 'off'; 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['array_graf_pdf'] = array();
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['contr_total_geral'] == "OK")
      {
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_prod_tab_produccion_proyecto@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['anlt_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_prod_tab_produccion_proyecto_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_prod_tab_produccion_proyecto_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_prod_tab_produccion_proyecto_total.class.php"); 
      }
      ...
      $this->Total   = new grid_prod_tab_produccion_proyecto_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_tab_produccion_proyecto_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_prod_tab_produccion_proyecto_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_tab_produccion_proyecto_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_prod_tab_produccion_proyecto/grid_prod_tab_produccion_proyecto_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_prod_tab_produccion_proyecto/grid_prod_tab_produccion_proyecto_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=n&nm_tem_gb=s&nm_res_cons=n&nm_ini_pdf_res=resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_prod_tab_produccion_proyecto&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_prod_tab_produccion_proyecto_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_prod_tab_produccion_proyecto_config_pivot.php?nome_apl=grid_prod_tab_produccion_proyecto&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("<SCRIPT language=\"Javascript\">\r\n");
      ...
      $nm_saida->saida("           document.Fexport.nmgp_password.value = password;\r\n");
      $nm_saida->saida("           document.Fexport.SC_module_export.value = SC_module_export;\r\n");
      $nm_saida->saida("               document.Fexport.action = \"grid_prod_tab_produccion_proyecto_export_ctrl.php\";\r\n");
      $nm_saida->saida("           document.Fexport.submit() ;\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_prod_tab_produccion_proyecto_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_tab_produccion_proyecto_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_prod_tab_produccion_proyecto/grid_prod_tab_produccion_proyecto_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_prod_tab_produccion_proyecto_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_prod_tab_produccion_proyecto_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_modificacion_contrato, $sum_facturacion, $sum_reajuste, $sum_retencion, $sum_multa, $sum_produccion_periodo, $sum_avance, $sum_diferencia_facturacion)
   {
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_modificacion_contrato;
         $this->array_total_geral[2] = $sum_facturacion;
         $this->array_total_geral[3] = $sum_reajuste;
         $this->array_total_geral[4] = $sum_retencion;
         $this->array_total_geral[5] = $sum_multa;
         $this->array_total_geral[6] = $sum_produccion_periodo;
         $this->array_total_geral[7] = $sum_avance;
         $this->array_total_geral[8] = $sum_diferencia_facturacion;
      }
      else
      {
         $this->array_total_geral[0]++;
         $this->array_total_geral[1] = bcadd($this->array_total_geral[1], $sum_modificacion_contrato, 10);
         $this->array_total_geral[2] = bcadd($this->array_total_geral[2], $sum_facturacion, 10);
         $this->array_total_geral[3] = bcadd($this->array_total_geral[3], $sum_reajuste, 10);
         $this->array_total_geral[4] = bcadd($this->array_total_geral[4], $sum_retencion, 10);
         $this->array_total_geral[5] = bcadd($this->array_total_geral[5], $sum_multa, 10);
         $this->array_total_geral[6] = bcadd($this->array_total_geral[6], $sum_produccion_periodo, 10);
         $this->array_total_geral[7] = bcadd($this->array_total_geral[7], $sum_avance, 10);
         $this->array_total_geral[8] = bcadd($this->array_total_geral[8], $sum_diferencia_facturacion, 10);
      }
   }
