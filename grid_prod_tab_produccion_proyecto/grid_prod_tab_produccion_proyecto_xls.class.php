...
class grid_prod_tab_produccion_proyecto_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_prod_tab_produccion_proyecto" . $this->Xls_tp;
          $this->Tit_doc    = "grid_prod_tab_produccion_proyecto" . $this->Xls_tp;
      ...
      if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['SC_Ind_Groupby'], $this->GB_tot_php))
      {
          $Tot_Gb = "totaliza_php_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['SC_Ind_Groupby'];
          $this->$Tot_Gb();
      }
      else
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['SC_Ind_Groupby'] == "sc_free_total")
      {
          $this->sum_modificacion_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][2];
          $this->sum_facturacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][3];
          $this->sum_reajuste = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][4];
          $this->sum_retencion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][5];
          $this->sum_multa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][6];
          $this->sum_produccion_periodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][7];
          $this->sum_avance = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][8];
          $this->sum_diferencia_facturacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['tot_geral'][9];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_prod_tab_produccion_proyecto']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_prod_tab_produccion_proyecto']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['embutida'])
      { 
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['detalle_partida'])) ? $this->New_label['detalle_partida'] : "Detalle Facturación"; 
          if ((!isset($this->NM_cmp_hidden['detalle_partida']) || $this->NM_cmp_hidden['detalle_partida'] != "off") && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['embutida_label'] = true;
   ...
   function NM_sub_cons_detalle_partida()
   {
         ...
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?id_proyecto?#?" . str_replace("'", "@aspass@", $this->Orig_id_proyecto) . "?@?id_partida?#?" . str_replace("'", "@aspass@", $this->Orig_id) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_consulta']['embutida'] = true;
         if (method_exists($this->grid_prod_presupuesto_periodo_consulta, "controle"))
         {
             $this->grid_prod_presupuesto_periodo_consulta->controle();
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['nolabel'])
       {
...
$_SESSION['scriptcase']['grid_prod_tab_produccion_proyecto']['contr_erro'] = 'off';
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>REGISTROS E INDICADORES DE PRODUCCIÓN DEL PROYECTO :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_tab_produccion_proyecto']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
