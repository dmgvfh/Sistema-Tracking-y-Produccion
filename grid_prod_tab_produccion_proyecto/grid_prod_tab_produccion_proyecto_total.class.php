...
class grid_prod_tab_produccion_proyecto_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_prod_tab_produccion_proyecto']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_prod_tab_produccion_proyecto']['campos_busca']))
      { 
