  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_produccion_proyecto_1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_produccion_proyecto_1_form();
	}
...
?>
  ...
  function do_ajax_form_prod_produccion_proyecto_1_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_id_proyecto_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_id_proyecto

  function do_ajax_form_prod_produccion_proyecto_1_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_id_proyecto_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_produccion_proyecto_1_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_fecha_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_fecha

  function do_ajax_form_prod_produccion_proyecto_1_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_fecha_cb

  // ---------- Validate modificacion_contrato
  function do_ajax_form_prod_produccion_proyecto_1_validate_modificacion_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_modificacion_contrato(var_modificacion_contrato, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_modificacion_contrato_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_modificacion_contrato

  function do_ajax_form_prod_produccion_proyecto_1_validate_modificacion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_modificacion_contrato_cb

  // ---------- Validate avance
  function do_ajax_form_prod_produccion_proyecto_1_validate_avance()
  {
    var nomeCampo_avance = "avance";
    var var_avance = scAjaxGetFieldText(nomeCampo_avance);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_avance(var_avance, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_avance_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_avance

  function do_ajax_form_prod_produccion_proyecto_1_validate_avance_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avance";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_avance_cb

  // ---------- Validate facturacion
  function do_ajax_form_prod_produccion_proyecto_1_validate_facturacion()
  {
    var nomeCampo_facturacion = "facturacion";
    var var_facturacion = scAjaxGetFieldText(nomeCampo_facturacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_facturacion(var_facturacion, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_facturacion_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_facturacion

  function do_ajax_form_prod_produccion_proyecto_1_validate_facturacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_facturacion_cb

  // ---------- Validate costos
  function do_ajax_form_prod_produccion_proyecto_1_validate_costos()
  {
    var nomeCampo_costos = "costos";
    var var_costos = scAjaxGetFieldText(nomeCampo_costos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_costos(var_costos, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_costos_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_costos

  function do_ajax_form_prod_produccion_proyecto_1_validate_costos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "costos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_costos_cb

  // ---------- Validate saldo_ur
  function do_ajax_form_prod_produccion_proyecto_1_validate_saldo_ur()
  {
    var nomeCampo_saldo_ur = "saldo_ur";
    var var_saldo_ur = scAjaxGetFieldText(nomeCampo_saldo_ur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_saldo_ur(var_saldo_ur, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_saldo_ur_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_saldo_ur

  function do_ajax_form_prod_produccion_proyecto_1_validate_saldo_ur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_saldo_ur_cb

  // ---------- Validate backlog_p
  function do_ajax_form_prod_produccion_proyecto_1_validate_backlog_p()
  {
    var nomeCampo_backlog_p = "backlog_p";
    var var_backlog_p = scAjaxGetFieldText(nomeCampo_backlog_p);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_backlog_p(var_backlog_p, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_backlog_p_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_backlog_p

  function do_ajax_form_prod_produccion_proyecto_1_validate_backlog_p_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_backlog_p_cb

  // ---------- Validate backlog_f
  function do_ajax_form_prod_produccion_proyecto_1_validate_backlog_f()
  {
    var nomeCampo_backlog_f = "backlog_f";
    var var_backlog_f = scAjaxGetFieldText(nomeCampo_backlog_f);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_backlog_f(var_backlog_f, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_backlog_f_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_backlog_f

  function do_ajax_form_prod_produccion_proyecto_1_validate_backlog_f_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_backlog_f_cb

  // ---------- Validate valor_uf
  function do_ajax_form_prod_produccion_proyecto_1_validate_valor_uf()
  {
    var nomeCampo_valor_uf = "valor_uf";
    var var_valor_uf = scAjaxGetFieldText(nomeCampo_valor_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_produccion_proyecto_1_validate_valor_uf(var_valor_uf, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_validate_valor_uf_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_validate_valor_uf

  function do_ajax_form_prod_produccion_proyecto_1_validate_valor_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_produccion_proyecto_1_validate_valor_uf_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_produccion_proyecto_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_produccion_proyecto_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_prod_produccion_proyecto_1_submit_form(var_id_proyecto, var_fecha, var_modificacion_contrato, var_avance, var_facturacion, var_costos, var_saldo_ur, var_backlog_p, var_backlog_f, var_valor_uf, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_produccion_proyecto_1_submit_form_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_submit_form

  function do_ajax_form_prod_produccion_proyecto_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_1_submit_form_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_1_submit_form_cb
  function do_ajax_form_prod_produccion_proyecto_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_produccion_proyecto_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_produccion_proyecto_1_navigate_form()
  {
    perform_ajax_form_prod_produccion_proyecto_1_navigate_form();
  }

  function perform_ajax_form_prod_produccion_proyecto_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_produccion_proyecto_1_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_produccion_proyecto_1_navigate_form_cb);
  } // do_ajax_form_prod_produccion_proyecto_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_produccion_proyecto_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_produccion_proyecto_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_produccion_proyecto_1_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_produccion_proyecto_1_navigate_form_cb
  function do_ajax_form_prod_produccion_proyecto_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_produccion_proyecto_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_produccion_proyecto_1_navigate_form_cb_after_alert

  function sc_hide_form_prod_produccion_proyecto_1_form()
  {
