...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_appointments_adm_dashboard"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_appointments_adm_dashboard"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_appointments_adm_dashboard</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['embutida_filho'] as $ind => $sc_init)
          {
