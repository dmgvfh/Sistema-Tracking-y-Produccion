...
<?php
   ...
   $Ord_Cmp = new grid_appointments_adm_dashboard_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointments_adm_dashboard_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['staff'] = "staff";
   $tab_labels["staff"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["staff"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["staff"] : "" . $this->Nm_lang['lang_tbl_staff'] . "";
   $tab_ger_campos['total_appointments'] = "on";
   $tab_def_campos['total_appointments'] = "total_appointments";
   $tab_labels["total_appointments"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["total_appointments"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["total_appointments"] : "" . $this->Nm_lang['lang_total_appointments'] . "";
   $tab_ger_campos['concluded'] = "on";
   $tab_def_campos['concluded'] = "concluded";
   $tab_labels["concluded"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["concluded"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["concluded"] : "" . $this->Nm_lang['lang_concluded'] . "";
   $tab_ger_campos['canceled'] = "on";
   $tab_def_campos['canceled'] = "canceled";
   $tab_labels["canceled"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["canceled"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["canceled"] : "" . $this->Nm_lang['lang_canceled'] . "";
   $tab_ger_campos['avg_rating'] = "on";
   $tab_def_campos['avg_rating'] = "avg_rating";
   $tab_labels["avg_rating"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["avg_rating"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["avg_rating"] : "" . $this->Nm_lang['lang_avg_rating'] . "";
   $tab_ger_campos['total_hours'] = "on";
   $tab_def_campos['total_hours'] = "total_hours";
   $tab_labels["total_hours"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["total_hours"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["total_hours"] : "" . $this->Nm_lang['lang_total_hours'] . "";
   $tab_ger_campos['total_price'] = "on";
   $tab_def_campos['total_price'] = "total_price";
   $tab_labels["total_price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["total_price"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['labels']["total_price"] : "" . $this->Nm_lang['lang_appointments_fld_total_price'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointments_adm_dashboard_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_dashboard']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
