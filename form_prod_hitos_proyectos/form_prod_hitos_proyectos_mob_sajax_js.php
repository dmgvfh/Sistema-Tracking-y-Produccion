  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_hitos_proyectos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_hitos_proyectos_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_hito
  function do_ajax_form_prod_hitos_proyectos_mob_validate_id_hito()
  {
    var nomeCampo_id_hito = "id_hito";
    var var_id_hito = scAjaxGetFieldSelect(nomeCampo_id_hito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_proyectos_mob_validate_id_hito(var_id_hito, var_script_case_init, do_ajax_form_prod_hitos_proyectos_mob_validate_id_hito_cb);
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_id_hito

  function do_ajax_form_prod_hitos_proyectos_mob_validate_id_hito_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_id_hito_cb

  // ---------- Validate periodo
  function do_ajax_form_prod_hitos_proyectos_mob_validate_periodo()
  {
    var nomeCampo_periodo = "periodo";
    var var_periodo = scAjaxGetFieldSelect(nomeCampo_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_proyectos_mob_validate_periodo(var_periodo, var_script_case_init, do_ajax_form_prod_hitos_proyectos_mob_validate_periodo_cb);
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_periodo

  function do_ajax_form_prod_hitos_proyectos_mob_validate_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periodo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_periodo_cb

  // ---------- Validate fecha_hito
  function do_ajax_form_prod_hitos_proyectos_mob_validate_fecha_hito()
  {
    ...
    setTimeout(function() {
      var var_fecha_hito = scAjaxGetFieldText(nomeCampo_fecha_hito);
      x_ajax_form_prod_hitos_proyectos_mob_validate_fecha_hito(var_fecha_hito, var_script_case_init, do_ajax_form_prod_hitos_proyectos_mob_validate_fecha_hito_cb);
    }, 200);
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_fecha_hito

  function do_ajax_form_prod_hitos_proyectos_mob_validate_fecha_hito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_fecha_hito_cb

  // ---------- Validate estado
  function do_ajax_form_prod_hitos_proyectos_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_proyectos_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_prod_hitos_proyectos_mob_validate_estado_cb);
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_estado

  function do_ajax_form_prod_hitos_proyectos_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_estado_cb

  // ---------- Validate adjunto
  function do_ajax_form_prod_hitos_proyectos_mob_validate_adjunto()
  {
    var nomeCampo_adjunto = "adjunto";
    var var_adjunto = scAjaxGetFieldText(nomeCampo_adjunto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_proyectos_mob_validate_adjunto(var_adjunto, var_script_case_init, do_ajax_form_prod_hitos_proyectos_mob_validate_adjunto_cb);
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_adjunto

  function do_ajax_form_prod_hitos_proyectos_mob_validate_adjunto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adjunto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_adjunto_cb

  // ---------- Validate link_externo
  function do_ajax_form_prod_hitos_proyectos_mob_validate_link_externo()
  {
    var nomeCampo_link_externo = "link_externo";
    var var_link_externo = scAjaxGetFieldText(nomeCampo_link_externo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_proyectos_mob_validate_link_externo(var_link_externo, var_script_case_init, do_ajax_form_prod_hitos_proyectos_mob_validate_link_externo_cb);
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_link_externo

  function do_ajax_form_prod_hitos_proyectos_mob_validate_link_externo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_proyectos_mob_validate_link_externo_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_hitos_proyectos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_hitos_proyectos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_hito = scAjaxGetFieldSelect("id_hito");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_hitos_proyectos_mob_submit_form(var_id_hito, var_periodo, var_fecha_hito, var_estado, var_adjunto, var_link_externo, var_id_presupuesto_periodo, var_adjunto_ul_name, var_adjunto_ul_type, var_adjunto_salva, var_adjunto_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_hitos_proyectos_mob_submit_form_cb);
  } // do_ajax_form_prod_hitos_proyectos_mob_submit_form

  function do_ajax_form_prod_hitos_proyectos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_hito");
      scAjaxHideErrorDisplay("periodo");
      scAjaxHideErrorDisplay("fecha_hito");
      scAjaxHideErrorDisplay("estado");
      scAjaxHideErrorDisplay("adjunto");
      scAjaxHideErrorDisplay("link_externo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_hitos_proyectos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_hitos_proyectos_mob_submit_form_cb
  function do_ajax_form_prod_hitos_proyectos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_hitos_proyectos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_hitos_proyectos_mob_navigate_form()
  {
    perform_ajax_form_prod_hitos_proyectos_mob_navigate_form();
  }

  function perform_ajax_form_prod_hitos_proyectos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_id_hito = document.F2.id_hito.value;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_hitos_proyectos_mob_navigate_form(var_id_presupuesto_periodo, var_id_hito, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_hitos_proyectos_mob_navigate_form_cb);
  } // do_ajax_form_prod_hitos_proyectos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_hitos_proyectos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_hitos_proyectos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_hito.value = scAjaxGetKeyValue("id_hito");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_hitos_proyectos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_hitos_proyectos_mob_navigate_form_cb
  function do_ajax_form_prod_hitos_proyectos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_hitos_proyectos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_hitos_proyectos_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_hitos_proyectos_mob_form()
  {
  ...
  ajax_field_list[0] = "id_hito";
  ajax_field_list[1] = "periodo";
  ajax_field_list[2] = "fecha_hito";
  ajax_field_list[3] = "estado";
  ajax_field_list[4] = "adjunto";
  ajax_field_list[5] = "link_externo";
  ...
  var ajax_error_list = {
    "id_hito": {"label": "Hito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "periodo": {"label": "Período Facturación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
