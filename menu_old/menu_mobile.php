...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>tracking/tracking_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>tracking/tracking_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
