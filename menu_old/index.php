...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu']['glo_nm_perfil']         = "conn_example";
...
$this->str_schema_all = $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "tracking/tracking";
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("home") . "/home_ini.txt");
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_appointments_adm") . "/grid_appointments_adm_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_appointments_adm_gestion") . "/grid_appointments_adm_gestion_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_gestion']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_appointments_adm_grupo") . "/grid_appointments_adm_grupo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_grupo']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("calendar_appointments_staff") . "/calendar_appointments_staff_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['calendar_appointments_staff']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_appointments_staff") . "/grid_appointments_staff_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("reporte_tracking") . "/reporte_tracking_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['reporte_tracking']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("dashboard_adm") . "/dashboard_adm_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_adm']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['dashboard_adm'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_proyectos") . "/grid_proyectos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_proyectos']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_proyectos'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_prod_produccion_proyecto") . "/grid_prod_produccion_proyecto_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_produccion_proyecto']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_prod_produccion_proyecto'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_companias") . "/grid_companias_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_companias']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_prod_clientes") . "/grid_prod_clientes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_clientes']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_prod_items_base") . "/grid_prod_items_base_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_items_base']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_prod_agrupa_items") . "/grid_prod_agrupa_items_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_agrupa_items']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_prod_hitos_tipo") . "/grid_prod_hitos_tipo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_hitos_tipo']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_prod_hitos_tipo'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_portafolio") . "/grid_portafolio_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_portafolio']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_unidad_organizativa") . "/grid_unidad_organizativa_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_unidad_organizativa']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tipo_actividades") . "/grid_tipo_actividades_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_actividades']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_appointment_status") . "/form_appointment_status_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointment_status']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_horas_activas") . "/form_horas_activas_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_horas_activas']))
    {
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[0]))
{
 ...
 $nm_var_lab[1] = "Resumen de Horas Registradas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "Resumen de Horas Registradas Totales";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Validación De Horas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "BITÁCORA PERSONAL";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[4]))
{
 ...
 $nm_var_lab[5] = "Registro De Horas - Actividades";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[5]))
{
 ...
 $nm_var_lab[6] = "Resumen De Horas - Actividades";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[9]))
{
 ...
 $nm_var_lab[10] = "Información De Proyectos ";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[10]))
{
 ...
 $nm_var_lab[11] = "Producción - Proyectos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[14]))
{
 ...
 $nm_var_lab[15] = "Itemizado Proyectos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[15]))
{
 ...
 $nm_var_lab[16] = "Agrupadores De Itemizado";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[19]))
{
 ...
 $nm_var_lab[20] = "Unidades Organizativas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[20]))
{
 ...
 $nm_var_lab[21] = "Tipo De Actividades";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[21]))
{
 ...
 $nm_var_lab[22] = "Estados Registros Actividades";
...
$menu_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "|grp__NM__ico__NM__administrator-24 (1).png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm']) == "on")
{
    $menu_menuData['data'] .= "item_5|..|" . $nm_var_lab[1] . "|menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_appointments_adm&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_gestion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_gestion']) == "on")
{
    $menu_menuData['data'] .= "item_49|..|" . $nm_var_lab[2] . "|menu_form_php.php?sc_item_menu=item_49&sc_apl_menu=grid_appointments_adm_gestion&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_grupo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_grupo']) == "on")
{
    $menu_menuData['data'] .= "item_29|..|" . $nm_var_lab[3] . "|menu_form_php.php?sc_item_menu=item_29&sc_apl_menu=grid_appointments_adm_grupo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_3|.|" . $nm_var_lab[4] . "||" . $nm_var_hint[4] . "|grp__NM__ico__NM__worker-24 (1).png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['calendar_appointments_staff']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['calendar_appointments_staff']) == "on")
{
    $menu_menuData['data'] .= "item_15|..|" . $nm_var_lab[5] . "|menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=calendar_appointments_staff&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff']) == "on")
{
    $menu_menuData['data'] .= "item_16|..|" . $nm_var_lab[6] . "|menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_appointments_staff&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['reporte_tracking']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['reporte_tracking']) == "on")
{
    $menu_menuData['data'] .= "item_31|.|" . $nm_var_lab[7] . "|menu_form_php.php?sc_item_menu=item_31&sc_apl_menu=reporte_tracking&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "|scriptcase__NM__ico__NM__alarmclock_run_32.png|" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_adm']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['dashboard_adm']) == "on")
{
    $menu_menuData['data'] .= "item_37|.|" . $nm_var_lab[8] . "|menu_form_php.php?sc_item_menu=item_37&sc_apl_menu=dashboard_adm&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "|scriptcase__NM__ico__NM__calendar_up_32.png|" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_39|.|" . $nm_var_lab[9] . "||" . $nm_var_hint[9] . "|scriptcase__NM__ico__NM__address_book2_24.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_proyectos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_proyectos']) == "on")
{
    $menu_menuData['data'] .= "item_30|..|" . $nm_var_lab[10] . "|menu_form_php.php?sc_item_menu=item_30&sc_apl_menu=grid_proyectos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_produccion_proyecto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_produccion_proyecto']) == "on")
{
    $menu_menuData['data'] .= "item_45|..|" . $nm_var_lab[11] . "|menu_form_php.php?sc_item_menu=item_45&sc_apl_menu=grid_prod_produccion_proyecto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_9|.|" . $nm_var_lab[12] . "||" . $nm_var_hint[12] . "|grp__NM__ico__NM__settings-5-24 (1).png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_companias']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_companias']) == "on")
{
    $menu_menuData['data'] .= "item_46|..|" . $nm_var_lab[13] . "|menu_form_php.php?sc_item_menu=item_46&sc_apl_menu=grid_companias&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_clientes']) == "on")
{
    $menu_menuData['data'] .= "item_48|..|" . $nm_var_lab[14] . "|menu_form_php.php?sc_item_menu=item_48&sc_apl_menu=grid_prod_clientes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[14] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_items_base']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_items_base']) == "on")
{
    $menu_menuData['data'] .= "item_41|..|" . $nm_var_lab[15] . "|menu_form_php.php?sc_item_menu=item_41&sc_apl_menu=grid_prod_items_base&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_agrupa_items']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_agrupa_items']) == "on")
{
    $menu_menuData['data'] .= "item_50|..|" . $nm_var_lab[16] . "|menu_form_php.php?sc_item_menu=item_50&sc_apl_menu=grid_prod_agrupa_items&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_hitos_tipo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_hitos_tipo']) == "on")
{
    $menu_menuData['data'] .= "item_47|..|" . $nm_var_lab[17] . "|menu_form_php.php?sc_item_menu=item_47&sc_apl_menu=grid_prod_hitos_tipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[17] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_18|..|" . $nm_var_lab[18] . "|menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_portafolio']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_portafolio']) == "on")
{
    $menu_menuData['data'] .= "item_32|..|" . $nm_var_lab[19] . "|menu_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_portafolio&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[18] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_unidad_organizativa']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_unidad_organizativa']) == "on")
{
    $menu_menuData['data'] .= "item_34|..|" . $nm_var_lab[20] . "|menu_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_unidad_organizativa&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[19] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_actividades']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_actividades']) == "on")
{
    $menu_menuData['data'] .= "item_33|..|" . $nm_var_lab[21] . "|menu_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_tipo_actividades&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[20] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointment_status']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_appointment_status']) == "on")
{
    $menu_menuData['data'] .= "item_10|..|" . $nm_var_lab[22] . "|menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=form_appointment_status&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[21] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_horas_activas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_horas_activas']) == "on")
{
    $menu_menuData['data'] .= "item_35|..|" . $nm_var_lab[23] . "|menu_form_php.php?sc_item_menu=item_35&sc_apl_menu=form_horas_activas&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[22] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_36|.|" . $nm_var_lab[24] . "|menu_form_php.php?sc_item_menu=item_36&sc_apl_menu=/tracking/manual/Tracking_user.pdf&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[23] . "|scriptcase__NM__ico__NM__about_24.png|" . $this->menu_target('_blank') . "|" . "\n";
$menu_menuData['data'] .= "item_17|.|" . $nm_var_lab[25] . "||" . $this->Nm_lang['lang_menu_security'] . "|grp__NM__ico__NM__padlock-2-24.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $menu_menuData['data'] .= "item_19|..|" . $nm_var_lab[26] . "|menu_form_php.php?sc_item_menu=item_19&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_20|..|" . $nm_var_lab[27] . "|menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_21|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_form_php.php?sc_item_menu=item_21&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $menu_menuData['data'] .= "item_22|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_form_php.php?sc_item_menu=item_22&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_menuData['data'] .= "item_23|..|" . $nm_var_lab[28] . "|menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_menuData['data'] .= "item_24|.|" . $nm_var_lab[29] . "|menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "|grp__NM__ico__NM__exit-24 (1).png|" . $this->menu_target('_parent') . "|" . "\n";
}
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__administrator-24 (1).png";
$icon_aba = "";
$icon_aba_inactive = "";
...
$menu_menuData['data'][] = array(
    ...
    'icon_fa'     => "fas fa-user-tie",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_appointments_adm&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_49&sc_apl_menu=grid_appointments_adm_gestion&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_gestion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_gestion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_29&sc_apl_menu=grid_appointments_adm_grupo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_grupo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm_grupo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__worker-24 (1).png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=calendar_appointments_staff&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['calendar_appointments_staff']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['calendar_appointments_staff']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_appointments_staff&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_staff']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_31&sc_apl_menu=reporte_tracking&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['reporte_tracking']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['reporte_tracking']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_37&sc_apl_menu=dashboard_adm&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_adm']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['dashboard_adm']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "scriptcase__NM__ico__NM__address_book2_24.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_30&sc_apl_menu=grid_proyectos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_proyectos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_proyectos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_45&sc_apl_menu=grid_prod_produccion_proyecto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_produccion_proyecto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_produccion_proyecto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__settings-5-24 (1).png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_46&sc_apl_menu=grid_companias&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_companias']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_companias']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_48&sc_apl_menu=grid_prod_clientes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_41&sc_apl_menu=grid_prod_items_base&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_items_base']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_items_base']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_50&sc_apl_menu=grid_prod_agrupa_items&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_agrupa_items']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_agrupa_items']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_47&sc_apl_menu=grid_prod_hitos_tipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_hitos_tipo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_prod_hitos_tipo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_portafolio&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_portafolio']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_portafolio']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_unidad_organizativa&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_unidad_organizativa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_unidad_organizativa']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_tipo_actividades&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_actividades']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_actividades']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=form_appointment_status&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointment_status']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_appointment_status']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_35&sc_apl_menu=form_horas_activas&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_horas_activas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_horas_activas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_36&sc_apl_menu=/tracking/manual/Tracking_user.pdf&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
$str_icon = "scriptcase__NM__ico__NM__about_24.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__padlock-2-24.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$menu_menuData['data'][] = array(
    ...
    'display'     => "text_img",
    'display_position'=> "text_right",
    'icon_fa'     => "fas fa-unlock-alt",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_19&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_21&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_22&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "grp__NM__ico__NM__exit-24 (1).png";
    $icon_aba = "";
    $icon_aba_inactive = "";
...
<head>
 <title>Sistema De Control De Producción</title>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <?php
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/usr_Fair_Tracking_<?php echo ($this->menu_orientacao!='vertical')?'hor':'vert'; ?>_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "usr_Fair_Tracking" . '_' . (($this->menu_orientacao!='vertical')?'hor':'vert') . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "usr_Fair_Tracking" . '_' . (($this->menu_orientacao=='horizontal')?'hor':'vert') . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
...
echo "Tab_labels['menu'] = \"Registro de Horas - Actividades\";\r\n";
echo "Tab_hints['menu'] = \"Registro de Horas - Actividades\";\r\n";
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: ;" src=""></iframe>');
            }
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['home']) && $_SESSION['scriptcase']['sc_apl_seg']['home'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu');\" item-href=\"menu_form_php.php?sc_item_menu=menu&sc_apl_menu=home&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_iframe\"";
} 
else
{ 
...
?>
      <iframe id="iframe_menu" name="menu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: ;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
<div id="footer">
	<span></span>
	<div id="footerimg">
		<a href='https://www.facebook.com/Scriptcase'></a>
		<a href='https://twitter.com/ScriptCaseSales'></a>
    </div>
</div>    </td>
  </tr>
</table>
...
?>
        <td class='sc-layer-0' style='width:11.1%;text-align:center;'>
                        <span class='sc-layer-0-0' style='font-size: 16px;background-color: ;font-family: ;color: #000000;'>   <img src="<?php echo $path_imag_cab ?>/grp__NM__bg__NM__logo-color-grupo-o2.png" border="0"/></span><br/>

        </td>        <td class='sc-layer-3' style='width:0.16%;text-align:left;'>
            
        </td>        <td class='sc-layer-2' style='width:10.68%;text-align:center;'>
                        <span class='sc-layer-2-0' style='font-size: 24px;background-color: ;font-family: Open Sans,Arial,sans-serif;;color: #ffffff;'><?php echo "Sistema De Control De Producción" ?></span><br/>
  ...
  <div class=''>
      ...
      <div class=''>
        ...
        <td class='sc-layer-1' style='width:10.53%;text-align:right;'>
                        <span class='sc-layer-1-0' style='font-size: 14px;background-color: ;font-family: Open Sans,Arial,sans-serif;;color: #ffffff;'><?php echo "" . $this->Nm_lang['lang_log_user'] . ": " . $_SESSION['usr_name'] . "" ?></span><br/>
            <span class='sc-layer-1-1' style='font-size: 14px;background-color: ;font-family: Open Sans,Arial,sans-serif;;color: #ffffff;'><?php echo "Perfil: " . $_SESSION['group_name'] . "" ?></span><br/>

        </td>        <td class='sc-layer-4' style='width:1.08%;text-align:left;'>
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu") {
        ...
        if (isset($_COOKIE['sc_actual_lang_carga_horas'])) {
            $_SESSION['scriptcase']['menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_carga_horas'];
        }
    }
}
