  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_clientes_proyectos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_clientes_proyectos_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_prod_clientes_proyectos_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_nombre_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_nombre

  function do_ajax_form_prod_clientes_proyectos_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_nombre_cb

  // ---------- Validate nombre_legal
  function do_ajax_form_prod_clientes_proyectos_validate_nombre_legal()
  {
    var nomeCampo_nombre_legal = "nombre_legal";
    var var_nombre_legal = scAjaxGetFieldText(nomeCampo_nombre_legal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_nombre_legal(var_nombre_legal, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_nombre_legal_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_nombre_legal

  function do_ajax_form_prod_clientes_proyectos_validate_nombre_legal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_nombre_legal_cb

  // ---------- Validate rut
  function do_ajax_form_prod_clientes_proyectos_validate_rut()
  {
    var nomeCampo_rut = "rut";
    var var_rut = scAjaxGetFieldText(nomeCampo_rut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_rut(var_rut, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_rut_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_rut

  function do_ajax_form_prod_clientes_proyectos_validate_rut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rut";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_rut_cb

  // ---------- Validate direccion
  function do_ajax_form_prod_clientes_proyectos_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_direccion_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_direccion

  function do_ajax_form_prod_clientes_proyectos_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_direccion_cb

  // ---------- Validate email
  function do_ajax_form_prod_clientes_proyectos_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_email(var_email, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_email_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_email

  function do_ajax_form_prod_clientes_proyectos_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_email_cb

  // ---------- Validate telefono
  function do_ajax_form_prod_clientes_proyectos_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_telefono_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_telefono

  function do_ajax_form_prod_clientes_proyectos_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_telefono_cb

  // ---------- Validate contacto
  function do_ajax_form_prod_clientes_proyectos_validate_contacto()
  {
    var nomeCampo_contacto = "contacto";
    var var_contacto = scAjaxGetFieldText(nomeCampo_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_contacto(var_contacto, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_contacto_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_contacto

  function do_ajax_form_prod_clientes_proyectos_validate_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_contacto_cb

  // ---------- Validate contacto2
  function do_ajax_form_prod_clientes_proyectos_validate_contacto2()
  {
    var nomeCampo_contacto2 = "contacto2";
    var var_contacto2 = scAjaxGetFieldText(nomeCampo_contacto2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_contacto2(var_contacto2, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_contacto2_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_contacto2

  function do_ajax_form_prod_clientes_proyectos_validate_contacto2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_contacto2_cb

  // ---------- Validate email2
  function do_ajax_form_prod_clientes_proyectos_validate_email2()
  {
    var nomeCampo_email2 = "email2";
    var var_email2 = scAjaxGetFieldText(nomeCampo_email2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_email2(var_email2, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_email2_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_email2

  function do_ajax_form_prod_clientes_proyectos_validate_email2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_email2_cb

  // ---------- Validate telefono2
  function do_ajax_form_prod_clientes_proyectos_validate_telefono2()
  {
    var nomeCampo_telefono2 = "telefono2";
    var var_telefono2 = scAjaxGetFieldText(nomeCampo_telefono2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_clientes_proyectos_validate_telefono2(var_telefono2, var_script_case_init, do_ajax_form_prod_clientes_proyectos_validate_telefono2_cb);
  } // do_ajax_form_prod_clientes_proyectos_validate_telefono2

  function do_ajax_form_prod_clientes_proyectos_validate_telefono2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_clientes_proyectos_validate_telefono2_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_clientes_proyectos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_clientes_proyectos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_prod_clientes_proyectos_submit_form(var_nombre, var_nombre_legal, var_rut, var_direccion, var_email, var_telefono, var_contacto, var_contacto2, var_email2, var_telefono2, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_clientes_proyectos_submit_form_cb);
  } // do_ajax_form_prod_clientes_proyectos_submit_form

  function do_ajax_form_prod_clientes_proyectos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_clientes_proyectos_submit_form_cb_after_alert);
  } // do_ajax_form_prod_clientes_proyectos_submit_form_cb
  function do_ajax_form_prod_clientes_proyectos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_clientes_proyectos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_clientes_proyectos_navigate_form()
  {
    perform_ajax_form_prod_clientes_proyectos_navigate_form();
  }

  function perform_ajax_form_prod_clientes_proyectos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_clientes_proyectos_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_clientes_proyectos_navigate_form_cb);
  } // do_ajax_form_prod_clientes_proyectos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_clientes_proyectos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_clientes_proyectos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_clientes_proyectos_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_clientes_proyectos_navigate_form_cb
  function do_ajax_form_prod_clientes_proyectos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_clientes_proyectos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_clientes_proyectos_navigate_form_cb_after_alert

  function sc_hide_form_prod_clientes_proyectos_form()
  {
