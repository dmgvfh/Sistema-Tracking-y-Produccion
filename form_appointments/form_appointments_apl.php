...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_appointments']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_appointments']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_appointments']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_appointments']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_appointments']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_appointments']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_appointments']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_appointments']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_login)) 
          {
              $_SESSION['usr_login'] = $this->usr_login;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_appointments']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_appointments']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_appointments']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_appointments']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_appointments']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_appointments']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_appointments']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_appointments']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_appointments']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_appointments_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_appointments']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_appointments']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_appointments'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_appointments']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_appointments']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_appointments') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_appointments']['label'] = "Registro de Horas Informadas";
      ...
      $_SESSION['scriptcase']['error_icon']['form_appointments']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_appointments'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_appointments']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_appointments'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_appointments'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_appointments/form_appointments_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_appointments_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_appointments_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_appointments_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_appointments/form_appointments_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_appointments_erro.class.php"); 
      }
      $this->Erro      = new form_appointments_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao']))
         { 
             if ($this->appointments_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_appointments']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_appointments.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_appointments_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_appointments"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_appointments']) || !is_array($this->NM_ajax_info['errList']['geral_form_appointments']))
              {
                  $this->NM_ajax_info['errList']['geral_form_appointments'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_appointments'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->id_usuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['Lookup_id_usuario']) && !in_array($this->id_usuario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['Lookup_id_usuario']))
               {
                   $hasError = true;
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->id_proyecto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['Lookup_id_proyecto']) && !in_array($this->id_proyecto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['Lookup_id_proyecto']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_current_status_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->current_status_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['Lookup_current_status_id']) && !in_array($this->current_status_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['Lookup_current_status_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->id_actividad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['Lookup_id_actividad']) && !in_array($this->id_actividad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['Lookup_id_actividad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['appointments_id']['keyVal'] = form_appointments_pack_protect_string($this->nmgp_dados_form['appointments_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['foreign_key']['appointments_id'] = $this->nmgp_dados_form['appointments_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['where_filter'] = "appointments_id = " . $this->nmgp_dados_form['appointments_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['where_detal']  = "appointments_id = " . $this->nmgp_dados_form['appointments_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['grid_appointments_history_script_case_init'] ]['grid_appointments_history']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['grid_appointments_history_script_case_init'] ]['grid_appointments_history']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['grid_appointments_history_script_case_init'] ]['grid_appointments_history']['embutida_pai']        = "form_appointments";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['grid_appointments_history_script_case_init'] ]['grid_appointments_history']['embutida_form_parms'] = "var_appointment_id*scin" . $this->nmgp_dados_form['appointments_id'] . "*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['grid_appointments_history_script_case_init'] ]['grid_appointments_history']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['grid_appointments_history_script_case_init'] ]['grid_appointments_history']['total']);
          }
   } // ajax_return_values
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_appointments_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_appointments_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_usuario']['valList'][$i] = form_appointments_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_proyecto']['valList'][$i] = form_appointments_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['current_status_id']['valList'][$i] = form_appointments_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_actividad']['valList'][$i] = form_appointments_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_observaciones($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_appointments']['contr_erro'] = 'on';
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->appointments_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opcao'] = '';
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_appointments';
...
$_SESSION['scriptcase']['form_appointments']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['form_appointments']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['parms'] = "appointments_id?#?$this->appointments_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['parms'] = ""; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_appointments_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_appointments = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['total'] = $qt_geral_reg_form_appointments;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_appointments_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas["appointment_start_date"] = "date";$Nm_datas["appointment_start_time"] = "time";$Nm_datas["appointment_end_date"] = "date";$Nm_datas["appointment_end_time"] = "time";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_appointments_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_appointments_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['masterValue']))
{
...
<?php
  exit;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['ordem_ord'] == " desc") {
