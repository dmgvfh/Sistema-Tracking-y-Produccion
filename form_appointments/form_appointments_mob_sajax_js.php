  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointments_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointments_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_usuario
  function do_ajax_form_appointments_mob_validate_id_usuario()
  {
    var nomeCampo_id_usuario = "id_usuario";
    var var_id_usuario = scAjaxGetFieldSelect(nomeCampo_id_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_id_usuario(var_id_usuario, var_script_case_init, do_ajax_form_appointments_mob_validate_id_usuario_cb);
  } // do_ajax_form_appointments_mob_validate_id_usuario

  function do_ajax_form_appointments_mob_validate_id_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_id_usuario_cb

  // ---------- Validate id_proyecto
  function do_ajax_form_appointments_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_appointments_mob_validate_id_proyecto_cb);
  } // do_ajax_form_appointments_mob_validate_id_proyecto

  function do_ajax_form_appointments_mob_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_id_proyecto_cb

  // ---------- Validate current_status_id
  function do_ajax_form_appointments_mob_validate_current_status_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_current_status_id(var_current_status_id, var_script_case_init, do_ajax_form_appointments_mob_validate_current_status_id_cb);
  } // do_ajax_form_appointments_mob_validate_current_status_id

  function do_ajax_form_appointments_mob_validate_current_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_current_status_id_cb

  // ---------- Validate appointment_start_date
  function do_ajax_form_appointments_mob_validate_appointment_start_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_appointment_start_date(var_appointment_start_date, var_script_case_init, do_ajax_form_appointments_mob_validate_appointment_start_date_cb);
  } // do_ajax_form_appointments_mob_validate_appointment_start_date

  function do_ajax_form_appointments_mob_validate_appointment_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_appointment_start_date_cb

  // ---------- Validate appointment_start_time
  function do_ajax_form_appointments_mob_validate_appointment_start_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_appointment_start_time(var_appointment_start_time, var_script_case_init, do_ajax_form_appointments_mob_validate_appointment_start_time_cb);
  } // do_ajax_form_appointments_mob_validate_appointment_start_time

  function do_ajax_form_appointments_mob_validate_appointment_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_appointment_start_time_cb

  // ---------- Validate appointment_end_time
  function do_ajax_form_appointments_mob_validate_appointment_end_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_appointment_end_time(var_appointment_end_time, var_script_case_init, do_ajax_form_appointments_mob_validate_appointment_end_time_cb);
  } // do_ajax_form_appointments_mob_validate_appointment_end_time

  function do_ajax_form_appointments_mob_validate_appointment_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_appointment_end_time_cb

  // ---------- Validate intervalo
  function do_ajax_form_appointments_mob_validate_intervalo()
  {
    var nomeCampo_intervalo = "intervalo";
    var var_intervalo = scAjaxGetFieldText(nomeCampo_intervalo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_intervalo(var_intervalo, var_script_case_init, do_ajax_form_appointments_mob_validate_intervalo_cb);
  } // do_ajax_form_appointments_mob_validate_intervalo

  function do_ajax_form_appointments_mob_validate_intervalo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_intervalo_cb

  // ---------- Validate nombre
  function do_ajax_form_appointments_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_appointments_mob_validate_nombre_cb);
  } // do_ajax_form_appointments_mob_validate_nombre

  function do_ajax_form_appointments_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_nombre_cb

  // ---------- Validate id_actividad
  function do_ajax_form_appointments_mob_validate_id_actividad()
  {
    var nomeCampo_id_actividad = "id_actividad";
    var var_id_actividad = scAjaxGetFieldSelect(nomeCampo_id_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_id_actividad(var_id_actividad, var_script_case_init, do_ajax_form_appointments_mob_validate_id_actividad_cb);
  } // do_ajax_form_appointments_mob_validate_id_actividad

  function do_ajax_form_appointments_mob_validate_id_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_id_actividad_cb

  // ---------- Validate observaciones
  function do_ajax_form_appointments_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_appointments_mob_validate_observaciones_cb);
  } // do_ajax_form_appointments_mob_validate_observaciones

  function do_ajax_form_appointments_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_observaciones_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_appointments_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_appointments_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_mob_submit_form(var_id_usuario, var_id_proyecto, var_current_status_id, var_appointment_start_date, var_appointment_start_time, var_appointment_end_time, var_intervalo, var_nombre, var_id_actividad, var_observaciones, var_appointments_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointments_mob_submit_form_cb);
  } // do_ajax_form_appointments_mob_submit_form

  function do_ajax_form_appointments_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("current_status_id");
      scAjaxHideErrorDisplay("appointment_start_date");
      scAjaxHideErrorDisplay("appointment_start_time");
      scAjaxHideErrorDisplay("appointment_end_time");
      scAjaxHideErrorDisplay("intervalo");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_appointments_mob_submit_form_cb_after_alert);
  } // do_ajax_form_appointments_mob_submit_form_cb
  function do_ajax_form_appointments_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointments_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointments_mob_navigate_form()
  {
    perform_ajax_form_appointments_mob_navigate_form();
  }

  function perform_ajax_form_appointments_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_mob_navigate_form(var_appointments_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointments_mob_navigate_form_cb);
  } // do_ajax_form_appointments_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointments_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointments_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_appointments_mob_navigate_form_cb
  function do_ajax_form_appointments_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_appointments_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_appointments_mob_navigate_form_cb_after_alert

  function sc_hide_form_appointments_mob_form()
  {
  ...
  ajax_field_list[2] = "current_status_id";
  ajax_field_list[3] = "appointment_start_date";
  ajax_field_list[4] = "appointment_start_time";
  ajax_field_list[5] = "appointment_end_time";
  ajax_field_list[6] = "intervalo";
  ajax_field_list[7] = "nombre";
  ajax_field_list[8] = "id_actividad";
  ...
  var ajax_read_only = {
    ...
    "appointment_start_date": "on",
    "appointment_start_time": "on",
    "appointment_end_time": "on",
    "intervalo": "on",
    "nombre": "on",
    "id_actividad": "on",
    "observaciones": "off"
