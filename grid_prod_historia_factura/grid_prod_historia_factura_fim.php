...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_historia_factura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_historia_factura"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_historia_factura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_historia_factura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_historia_factura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_historia_factura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_prod_historia_factura']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_prod_historia_factura</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_prod_historia_factura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_prod_historia_factura']['embutida_filho'] as $ind => $sc_init)
          {
