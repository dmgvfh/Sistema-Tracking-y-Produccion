...
class grid_prod_historia_factura_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_prod_historia_factura_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_prod_historia_factura_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_prod_historia_factura_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_estado($estado)
   {
      $estado = substr($this->Db->qstr($estado), 1, -1);
            $estado_look = (is_string($estado) ? substr($this->Db->qstr($estado), 1, -1) : $estado); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct estado from " . $this->Ini->nm_tabela . " where (id_periodo=" . $_SESSION['id_periodo'] . ") and  estado like '%" . $estado . "%' order by estado"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_observaciones($observaciones)
   {
      $observaciones = substr($this->Db->qstr($observaciones), 1, -1);
            $observaciones_look = (is_string($observaciones) ? substr($this->Db->qstr($observaciones), 1, -1) : $observaciones); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Observaciones from " . $this->Ini->nm_tabela . " where (id_periodo=" . $_SESSION['id_periodo'] . ") and  Observaciones like '%" . $observaciones . "%' order by Observaciones"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "prod_historia_factura.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> prod_historia_factura</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_prod_historia_factura/grid_prod_historia_factura_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_prod_historia_factura_ajax_search.js"></script>
 <script type="text/javascript" src="grid_prod_historia_factura_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_prod_historia_factura_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_periodo_cond#NMF#' + search_get_sel_txt('SC_id_periodo_cond') + '@NMF@';
  str_out += 'SC_id_periodo#NMF#' + search_get_text('SC_id_periodo') + '@NMF@';
  str_out += 'SC_estado_cond#NMF#' + search_get_sel_txt('SC_estado_cond') + '@NMF@';
  str_out += 'SC_estado#NMF#' + search_get_text('SC_estado') + '@NMF@';
  str_out += 'id_ac_estado#NMF#' + search_get_text('id_ac_estado') + '@NMF@';
  ...
  str_out += 'id_ac_observaciones#NMF#' + search_get_text('id_ac_observaciones') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_estado").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_estado").autocomplete({
     minLength: 1,
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_estado").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_observaciones").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_observaciones").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
     ...
     select: function (event, ui) {
       $("#SC_observaciones").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> prod_historia_factura</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['id_cond']; 
          $id_periodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['id_periodo']; 
          $id_periodo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['id_periodo_cond']; 
          $estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['estado']; 
          $estado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['estado_cond']; 
          $observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['observaciones']; 
          $observaciones_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['observaciones_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($id_periodo_cond) != "II" && strtoupper($id_periodo_cond) != "QP" && strtoupper($id_periodo_cond) != "NP" && strtoupper($id_periodo_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_periodo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_periodo_cond) || empty($id_periodo_cond))
      {
         $id_periodo_cond = "gt";
      }
      ...
      $str_hide_id_periodo = (in_array($id_periodo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($id_periodo)) ? strpos($id_periodo, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_periodo = substr($id_periodo, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($estado)) ? strpos($estado, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      {
         $tmp_pos = (is_string($observaciones)) ? strpos($observaciones, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id'])) ? $this->New_label['id'] : "Id"; ?></TD>
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_id_periodo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_periodo'])) ? $this->New_label['id_periodo'] : "Id Periodo"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_periodo_cond" name="id_periodo_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_periodo'), this, 'id_periodo')">
       <OPTION value="gt" <?php if ("gt" == $id_periodo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_periodo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_periodo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_periodo" <?php echo $str_hide_id_periodo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_periodo'])) ? $this->New_label['id_periodo'] : "Id Periodo";
 $nmgp_tab_label .= "id_periodo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_periodo" name="id_periodo" value="<?php echo NM_encode_input($id_periodo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_estado_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['estado'])) ? $this->New_label['estado'] : "Estado"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_estado_cond" name="estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_estado'), this, 'estado')">
...
<?php
      ...
      $estado_look = (is_string($estado) ? substr($this->Db->qstr($estado), 1, -1) : $estado); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct estado from " . $this->Ini->nm_tabela . " where (id_periodo=" . $_SESSION['id_periodo'] . ") and estado = '$estado_look' order by estado"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_estado" name="estado" value="<?php echo NM_encode_input($estado) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_estado" name="estado_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_observaciones_cond" name="observaciones_cond" onChange="nm_campos_between(document.getElementById('id_vis_observaciones'), this, 'observaciones')">
       <OPTION value="qp" <?php if ("qp" == $observaciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $observaciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $observaciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $observaciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $observaciones_look = (is_string($observaciones) ? substr($this->Db->qstr($observaciones), 1, -1) : $observaciones); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Observaciones from " . $this->Ini->nm_tabela . " where (id_periodo=" . $_SESSION['id_periodo'] . ") and Observaciones = '$observaciones_look' order by Observaciones"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_observaciones" name="observaciones" value="<?php echo NM_encode_input($observaciones) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_observaciones" name="observaciones_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_prod_historia_factura_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_prod_historia_factura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_prod_historia_factura']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_periodo_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_periodo'), document.F1.id_periodo_cond, 'id_periodo');
   document.F1.id_periodo.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_prod_historia_factura";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_prod_historia_factura/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_periodo_cond'] = 'cond';
      $tp_fields['SC_id_periodo'] = 'text';
      $tp_fields['SC_estado_cond'] = 'cond';
      $tp_fields['SC_estado'] = 'text_aut';
      $tp_fields['id_ac_estado'] = 'text_aut';
      $tp_fields['SC_observaciones_cond'] = 'cond';
      $tp_fields['SC_observaciones'] = 'text_aut';
      $tp_fields['id_ac_observaciones'] = 'text_aut';
   ...
   function trata_campos()
   {
      ...
      $id_periodo_cond_salva = $id_periodo_cond; 
      if (!isset($id_periodo_input_2) || $id_periodo_input_2 == "")
      {
          $id_periodo_input_2 = $id_periodo;
      }
      ...
      if ($id_periodo_cond != "in")
      {
          nm_limpa_numero($id_periodo, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['id_periodo'] = $id_periodo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['id_periodo_cond'] = $id_periodo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['estado'] = $estado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['estado_cond'] = $estado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['observaciones'] = $observaciones; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['observaciones_cond'] = $observaciones_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['id_periodo'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($estado != '') {
      $estado_look = (is_string($estado) ? substr($this->Db->qstr($estado), 1, -1) : $estado); 
      $nmgp_def_dados = array(); 
    ...
    if ($observaciones != '') {
      ...
      //----- $id_periodo
      $this->Date_part = false;
      if (isset($id_periodo) || $id_periodo_cond == "nu" || $id_periodo_cond == "nn" || $id_periodo_cond == "ep" || $id_periodo_cond == "ne")
      {
         $this->monta_condicao("id_periodo", $id_periodo_cond, $id_periodo, "", "id_periodo", "INT", false);
      }
      ...
      {
         $this->monta_condicao("estado", $estado_cond, $estado, "", "estado", "VARCHAR", false);
      }
      ...
      {
         $this->monta_condicao("Observaciones", $observaciones_cond, $observaciones, "", "observaciones", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_historia_factura']['cond_pesq'] .= $this->NM_operador;
