<?php
@session_start() ;
$_SESSION['scriptcase']['grid_prod_historia_factura']['sc_process_barr'] = true;
require_once('../grid_prod_historia_factura/index.php');
unset($_SESSION['scriptcase']['grid_prod_historia_factura']['sc_process_barr']);
$ExportCtrl = new grid_prod_historia_factura_export_control;
$ExportCtrl->Export_barr();

class grid_prod_historia_factura_export_control
{
