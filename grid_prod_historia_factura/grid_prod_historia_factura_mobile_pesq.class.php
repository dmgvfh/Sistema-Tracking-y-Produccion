...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fecha";$Nm_numeric[] = "id";$Nm_numeric[] = "id_periodo";
...
<HTML>
<HEAD>
 <TITLE> prod_historia_factura</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_periodo_cond" name="id_periodo_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_periodo'), this, 'id_periodo')">
      ...
      <br><span id="id_hide_id_periodo"  <?php echo $str_hide_id_periodo?>><INPUT  type="text" id="SC_id_periodo" name="id_periodo" value="<?php echo NM_encode_input($id_periodo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_estado_cond" name="estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_estado'), this, 'estado')">
      ...
      <br><span id="id_hide_estado"  <?php echo $str_hide_estado?>><?php
      if ($estado != "")
      {
      $estado_look = (is_string($estado) ? substr($this->Db->qstr($estado), 1, -1) : $estado); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_observaciones_cond" name="observaciones_cond" onChange="nm_campos_between(document.getElementById('id_vis_observaciones'), this, 'observaciones')">
      ...
      <br><span id="id_hide_observaciones"  <?php echo $str_hide_observaciones?>><?php
      if ($observaciones != "")
      {
      $observaciones_look = (is_string($observaciones) ? substr($this->Db->qstr($observaciones), 1, -1) : $observaciones); 
      $nmgp_def_dados = array(); 
