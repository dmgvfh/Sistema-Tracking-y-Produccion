  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_items_proyecto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_items_proyecto_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_prod_items_proyecto_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_mob_validate_id(var_id, var_script_case_init, do_ajax_form_prod_items_proyecto_mob_validate_id_cb);
  } // do_ajax_form_prod_items_proyecto_mob_validate_id

  function do_ajax_form_prod_items_proyecto_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_mob_validate_id_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_prod_items_proyecto_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_prod_items_proyecto_mob_validate_sc_field_0_cb);
  } // do_ajax_form_prod_items_proyecto_mob_validate_sc_field_0

  function do_ajax_form_prod_items_proyecto_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_mob_validate_sc_field_0_cb

  // ---------- Validate agrupador1
  function do_ajax_form_prod_items_proyecto_mob_validate_agrupador1()
  {
    var nomeCampo_agrupador1 = "agrupador1";
    var var_agrupador1 = scAjaxGetFieldText(nomeCampo_agrupador1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_mob_validate_agrupador1(var_agrupador1, var_script_case_init, do_ajax_form_prod_items_proyecto_mob_validate_agrupador1_cb);
  } // do_ajax_form_prod_items_proyecto_mob_validate_agrupador1

  function do_ajax_form_prod_items_proyecto_mob_validate_agrupador1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "agrupador1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_mob_validate_agrupador1_cb

  // ---------- Validate tipo_proyecto
  function do_ajax_form_prod_items_proyecto_mob_validate_tipo_proyecto()
  {
    var nomeCampo_tipo_proyecto = "tipo_proyecto";
    var var_tipo_proyecto = scAjaxGetFieldText(nomeCampo_tipo_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_mob_validate_tipo_proyecto(var_tipo_proyecto, var_script_case_init, do_ajax_form_prod_items_proyecto_mob_validate_tipo_proyecto_cb);
  } // do_ajax_form_prod_items_proyecto_mob_validate_tipo_proyecto

  function do_ajax_form_prod_items_proyecto_mob_validate_tipo_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_proyecto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_mob_validate_tipo_proyecto_cb

  // ---------- Validate id_proyecto
  function do_ajax_form_prod_items_proyecto_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_items_proyecto_mob_validate_id_proyecto_cb);
  } // do_ajax_form_prod_items_proyecto_mob_validate_id_proyecto

  function do_ajax_form_prod_items_proyecto_mob_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_mob_validate_id_proyecto_cb

  // ---------- Validate items_proyecto
  function do_ajax_form_prod_items_proyecto_mob_validate_items_proyecto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_mob_validate_items_proyecto(var_items_proyecto, var_script_case_init, do_ajax_form_prod_items_proyecto_mob_validate_items_proyecto_cb);
  } // do_ajax_form_prod_items_proyecto_mob_validate_items_proyecto

  function do_ajax_form_prod_items_proyecto_mob_validate_items_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_mob_validate_items_proyecto_cb

  // ---------- Refresh id_proyecto
  function do_ajax_form_prod_items_proyecto_mob_refresh_id_proyecto()
  {
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_nmgp_refresh_fields = "items_proyecto";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_items_proyecto_mob_refresh_id_proyecto(var_id_proyecto, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_prod_items_proyecto_mob_refresh_id_proyecto_cb);
  } // do_ajax_form_prod_items_proyecto_mob_refresh_id_proyecto

  function do_ajax_form_prod_items_proyecto_mob_refresh_id_proyecto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_mob_refresh_id_proyecto_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_items_proyecto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_items_proyecto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_sc_field_0 = scAjaxGetFieldText("sc_field_0");
    var var_agrupador1 = scAjaxGetFieldText("agrupador1");
    var var_tipo_proyecto = scAjaxGetFieldText("tipo_proyecto");
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_items_proyecto_mob_submit_form(var_id, var_sc_field_0, var_agrupador1, var_tipo_proyecto, var_id_proyecto, var_items_proyecto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_items_proyecto_mob_submit_form_cb);
  } // do_ajax_form_prod_items_proyecto_mob_submit_form

  function do_ajax_form_prod_items_proyecto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("agrupador1");
      scAjaxHideErrorDisplay("tipo_proyecto");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_items_proyecto_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_items_proyecto_mob_submit_form_cb
  function do_ajax_form_prod_items_proyecto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_items_proyecto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_items_proyecto_mob_navigate_form()
  {
    perform_ajax_form_prod_items_proyecto_mob_navigate_form();
  }

  function perform_ajax_form_prod_items_proyecto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_prod_items_proyecto_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_items_proyecto_mob_navigate_form_cb);
  } // do_ajax_form_prod_items_proyecto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_items_proyecto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_items_proyecto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_items_proyecto_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_items_proyecto_mob_navigate_form_cb
  function do_ajax_form_prod_items_proyecto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_items_proyecto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_items_proyecto_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_items_proyecto_mob_form()
  {
  ...
  ajax_field_list[1] = "sc_field_0";
  ajax_field_list[2] = "agrupador1";
  ajax_field_list[3] = "tipo_proyecto";
  ajax_field_list[4] = "id_proyecto";
  ajax_field_list[5] = "items_proyecto";
  ...
  var ajax_error_list = {
    ...
    "sc_field_0": {"label": "Item", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "agrupador1": {"label": "Agrupador 1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tipo_proyecto": {"label": "Tipo Proyecto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "items_proyecto": {"label": "Items Asociados A Proyecto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "agrupador1": new Array(),
    "tipo_proyecto": new Array(),
    "id_proyecto": new Array(),
    "items_proyecto": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["sc_field_0"][1] = "sc_field_0";
  ajax_field_mult["agrupador1"][1] = "agrupador1";
  ajax_field_mult["tipo_proyecto"][1] = "tipo_proyecto";
  ...
  var ajax_field_id = {
    ...
    "agrupador1": new Array("hidden_field_label_agrupador1", "hidden_field_data_agrupador1"),
    "tipo_proyecto": new Array("hidden_field_label_tipo_proyecto", "hidden_field_data_tipo_proyecto"),
