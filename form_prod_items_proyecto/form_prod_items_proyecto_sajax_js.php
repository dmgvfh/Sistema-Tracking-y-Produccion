  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_items_proyecto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_items_proyecto_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_prod_items_proyecto_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_validate_id(var_id, var_script_case_init, do_ajax_form_prod_items_proyecto_validate_id_cb);
  } // do_ajax_form_prod_items_proyecto_validate_id

  function do_ajax_form_prod_items_proyecto_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_validate_id_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_prod_items_proyecto_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_prod_items_proyecto_validate_sc_field_0_cb);
  } // do_ajax_form_prod_items_proyecto_validate_sc_field_0

  function do_ajax_form_prod_items_proyecto_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_validate_sc_field_0_cb

  // ---------- Validate agrupador1
  function do_ajax_form_prod_items_proyecto_validate_agrupador1()
  {
    var nomeCampo_agrupador1 = "agrupador1";
    var var_agrupador1 = scAjaxGetFieldText(nomeCampo_agrupador1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_validate_agrupador1(var_agrupador1, var_script_case_init, do_ajax_form_prod_items_proyecto_validate_agrupador1_cb);
  } // do_ajax_form_prod_items_proyecto_validate_agrupador1

  function do_ajax_form_prod_items_proyecto_validate_agrupador1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_validate_agrupador1_cb

  // ---------- Validate tipo_proyecto
  function do_ajax_form_prod_items_proyecto_validate_tipo_proyecto()
  {
    var nomeCampo_tipo_proyecto = "tipo_proyecto";
    var var_tipo_proyecto = scAjaxGetFieldText(nomeCampo_tipo_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_validate_tipo_proyecto(var_tipo_proyecto, var_script_case_init, do_ajax_form_prod_items_proyecto_validate_tipo_proyecto_cb);
  } // do_ajax_form_prod_items_proyecto_validate_tipo_proyecto

  function do_ajax_form_prod_items_proyecto_validate_tipo_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_validate_tipo_proyecto_cb

  // ---------- Validate id_proyecto
  function do_ajax_form_prod_items_proyecto_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_items_proyecto_validate_id_proyecto_cb);
  } // do_ajax_form_prod_items_proyecto_validate_id_proyecto

  function do_ajax_form_prod_items_proyecto_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_validate_id_proyecto_cb

  // ---------- Validate items_proyecto
  function do_ajax_form_prod_items_proyecto_validate_items_proyecto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_proyecto_validate_items_proyecto(var_items_proyecto, var_script_case_init, do_ajax_form_prod_items_proyecto_validate_items_proyecto_cb);
  } // do_ajax_form_prod_items_proyecto_validate_items_proyecto

  function do_ajax_form_prod_items_proyecto_validate_items_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_validate_items_proyecto_cb

  // ---------- Refresh id_proyecto
  function do_ajax_form_prod_items_proyecto_refresh_id_proyecto()
  {
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_nmgp_refresh_fields = "items_proyecto";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_items_proyecto_refresh_id_proyecto(var_id_proyecto, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_prod_items_proyecto_refresh_id_proyecto_cb);
  } // do_ajax_form_prod_items_proyecto_refresh_id_proyecto

  function do_ajax_form_prod_items_proyecto_refresh_id_proyecto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_proyecto_refresh_id_proyecto_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_items_proyecto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_items_proyecto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_prod_items_proyecto_submit_form(var_id, var_sc_field_0, var_agrupador1, var_tipo_proyecto, var_id_proyecto, var_items_proyecto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_items_proyecto_submit_form_cb);
  } // do_ajax_form_prod_items_proyecto_submit_form

  function do_ajax_form_prod_items_proyecto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_items_proyecto_submit_form_cb_after_alert);
  } // do_ajax_form_prod_items_proyecto_submit_form_cb
  function do_ajax_form_prod_items_proyecto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_items_proyecto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_items_proyecto_navigate_form()
  {
    perform_ajax_form_prod_items_proyecto_navigate_form();
  }

  function perform_ajax_form_prod_items_proyecto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_prod_items_proyecto_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_items_proyecto_navigate_form_cb);
  } // do_ajax_form_prod_items_proyecto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_items_proyecto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_items_proyecto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_items_proyecto_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_items_proyecto_navigate_form_cb
  function do_ajax_form_prod_items_proyecto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_items_proyecto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_items_proyecto_navigate_form_cb_after_alert

  function sc_hide_form_prod_items_proyecto_form()
  {
