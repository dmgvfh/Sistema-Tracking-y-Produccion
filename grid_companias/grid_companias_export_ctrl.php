<?php
@session_start() ;
$_SESSION['scriptcase']['grid_companias']['sc_process_barr'] = true;
require_once('../grid_companias/index.php');
unset($_SESSION['scriptcase']['grid_companias']['sc_process_barr']);
$ExportCtrl = new grid_companias_export_control;
$ExportCtrl->Export_barr();

class grid_companias_export_control
{
