...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $prep_label['id_actividad'] = "Actividad";
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
