...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Gb_Free_cmp']))
      {
          $this->Tem_json_res  = false;
      }
      if (!is_file($this->Ini->root . $this->Ini->path_link . "reporte_tracking/reporte_tracking_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_format'];
      }
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "reporte_tracking.json";
...
$_SESSION['scriptcase']['reporte_tracking']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_name']);
      }
...
$_SESSION['scriptcase']['reporte_tracking']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "reporte_tracking_res_json.class.php");
              $this->Res = new reporte_tracking_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_res_grid']);
          } 
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>REPORTE DE HORAS APROBADAS :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
