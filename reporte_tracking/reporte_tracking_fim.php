...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____reporte_tracking"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____reporte_tracking"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_appointments'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_tracking']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reporte_tracking']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_tracking']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reporte_tracking']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reporte_tracking']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reporte_tracking']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reporte_tracking']['embutida_filho'] as $ind => $sc_init)
          {
