...
class reporte_tracking_resumo
{
   ...
   var $array_total_id_usuario;
   var $array_total_id_proyecto;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_id_usuario             = array();
      $this->array_total_id_proyecto            = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['reporte_tracking']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['reporte_tracking']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['orig_pesq'] = "resumo";
...
$_SESSION['scriptcase']['reporte_tracking']['contr_erro'] = 'off'; 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['contr_total_geral'] == "OK")
      {
          $this->array_total_appointment_start_date = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total']['appointment_start_date'];
          $this->array_total_id_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total']['id_usuario'];
          $this->array_total_id_proyecto = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total']['id_proyecto'];
      }
      else
      {
          $this->array_total_appointment_start_date = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total']['appointment_start_date'] = $this->array_total_appointment_start_date;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total']['id_usuario'] = $this->array_total_id_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total']['id_proyecto'] = $this->array_total_id_proyecto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['json_use_label'])
       {
          $Lab_appointment_start_date = "appointment_start_date";
          $Lab_id_usuario = "id_usuario";
          $Lab_id_proyecto = "id_proyecto";
       }
       else
       {
       $Lab_appointment_start_date = "Fecha";
       $Lab_appointment_start_date =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_appointment_start_date);
       $Lab_id_usuario = "Usuario";
       $Lab_id_proyecto = "Proyecto";
       }
       $this->comp_field = array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_start_date'] = $Lab_appointment_start_date; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_usuario'] = $Lab_id_usuario; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_proyecto'] = $Lab_id_proyecto; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_proyecto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_proyecto'] = "Proyecto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_usuario'] = "Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_actividad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_actividad'] = "Actividad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['nombre'] = "Nombre Actividad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['current_status_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['current_status_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_start_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_start_date'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_start_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_start_time'] = "Hora Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_end_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_end_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['intervalo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['intervalo'] = "Intervalo (horas)"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointments_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointments_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointments_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_end_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_end_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_recurrent']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_recurrent'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_recurrent'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_period']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['appointment_period'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_period'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_order']['status']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_order']['status'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_order']['status'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['status'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['status'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['status'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['status'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['status'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['status'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['status'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_appointment_start_date as $i_appointment_start_date => $d_appointment_start_date) {
           ...
           foreach ($this->array_total_id_usuario[$i_appointment_start_date] as $i_id_usuario => $d_id_usuario) {
               if (!isset($i_id_usuario, $this->comp_label[1][ $d_appointment_start_date[3] ]) || !in_array($i_id_usuario, $this->comp_label[1][ $d_appointment_start_date[3] ], true)) {
                   $this->comp_index[1][ $d_id_usuario[3] ] = $d_id_usuario[2];
                   $this->comp_label[1][ $d_appointment_start_date[3] ][ $d_id_usuario[3] ] = $d_id_usuario[2];
               }
               foreach ($this->array_total_id_proyecto[$i_appointment_start_date][$i_id_usuario] as $i_id_proyecto => $d_id_proyecto) {
                   if (!isset($i_id_proyecto, $this->comp_label[2][ $d_appointment_start_date[3] ][ $d_id_usuario[3] ]) || !in_array($i_id_proyecto, $this->comp_label[2][ $d_appointment_start_date[3] ][ $d_id_usuario[3] ], true)) {
                       $this->comp_index[2][ $d_id_proyecto[3] ] = $d_id_proyecto[2];
                       $this->comp_label[2][ $d_appointment_start_date[3] ][ $d_id_usuario[3] ][ $d_id_proyecto[3] ] = $d_id_proyecto[2];
                   }
               }
           }
       }
       ...
       //-----
       $this->comp_x_axys = array(0, 1);
       $this->comp_y_axys = array(2);

       //-----
       $this->comp_align = array('center', '', '');
       ...
       $this->comp_links_fl = array(
           ...
           array('name' => 'id_usuario', 'prot' => ''),
           array('name' => 'id_proyecto', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_appointment_start_date => $l_appointment_start_date) {
           ...
           foreach ($this->comp_label[1][$i_appointment_start_date] as $i_id_usuario => $l_id_usuario) {
               if (isset($this->array_total_id_usuario[$i_appointment_start_date][$i_id_usuario])) {
                   $this->comp_group[$i_appointment_start_date][$i_id_usuario] = array();
               }
               foreach ($this->comp_label[2][$i_appointment_start_date][$i_id_usuario] as $i_id_proyecto => $l_id_proyecto) {
                   if (isset($this->array_total_id_proyecto[$i_appointment_start_date][$i_id_usuario][$i_id_proyecto])) {
                       $this->comp_group[$i_appointment_start_date][$i_id_usuario][$i_id_proyecto] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_id_usuario;
       }
       elseif (2 == $level) {
           $return = $this->array_total_id_proyecto;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@reporte_tracking@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '1|1' => array(
               ...
               'field_x'  => 'id_usuario',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_id_usuario)),
               'label_y'  => $this->getChartText(strip_tags("Horas")),
               'format'   => $this->formatChartValue(1),
           ),
           '2|1' => array(
               ...
               'field_x'  => 'id_proyecto',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_id_proyecto)),
               'label_y'  => $this->getChartText(strip_tags("Horas")),
               'format'   => $this->formatChartValue(1),
           ),
           'T|1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['anlt_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_reporte_tracking_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_reporte_tracking_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new reporte_tracking_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_appointment_start_date)) {
          ksort($this->array_total_appointment_start_date);
      }
      if (is_array($this->array_total_id_usuario)) {
          ksort($this->array_total_id_usuario);
      }
      if (is_array($this->array_total_id_proyecto)) {
          ksort($this->array_total_id_proyecto);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_tracking_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_reporte_tracking_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_tracking_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "reporte_tracking/reporte_tracking_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "reporte_tracking/reporte_tracking_config_graf_flash.php?nome_apl=reporte_tracking&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $NM_btn = false;
         $NM_Gbtn = false;
         if (is_file("reporte_tracking_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'reporte_tracking_config_pivot.php?nome_apl=reporte_tracking&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("<SCRIPT language=\"Javascript\">\r\n");
      ...
      $nm_saida->saida("           document.Fexport.nmgp_password.value = password;\r\n");
      $nm_saida->saida("           document.Fexport.SC_module_export.value = SC_module_export;\r\n");
      $nm_saida->saida("               document.Fexport.action = \"reporte_tracking_export_ctrl.php\";\r\n");
      $nm_saida->saida("           document.Fexport.submit() ;\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"reporte_tracking_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_tracking_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "reporte_tracking/reporte_tracking_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $appointment_start_date_2 = (isset($Busca_temp['appointment_start_date_input_2'])) ? $Busca_temp['appointment_start_date_input_2'] : ""; 
          $nombre = (isset($Busca_temp['nombre'])) ? $Busca_temp['nombre'] : ""; 
          $tmp_pos = (is_string($nombre)) ? strpos($nombre, "##@@") : false;
          if ($tmp_pos !== false && !is_array($nombre))
          {
   ...
   //---- 
   function adiciona_registro($sum_intervalo, $quebra_appointment_start_date, $quebra_id_usuario, $quebra_id_proyecto, $quebra_appointment_start_date_orig, $quebra_id_usuario_orig, $quebra_id_proyecto_orig)
   {
      ...
      //----- Usuario
      if (!isset($this->array_total_id_usuario[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig]))
      {
         $this->array_total_id_usuario[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][0] = 1;
         $this->array_total_id_usuario[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][1] = $sum_intervalo;
         $this->array_total_id_usuario[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][2] = $quebra_id_usuario;
         $this->array_total_id_usuario[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][3] = $quebra_id_usuario_orig;
      }
      else
      {
         $this->array_total_id_usuario[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][0]++;
         $this->array_total_id_usuario[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][1] = bcadd($this->array_total_id_usuario[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][1], $sum_intervalo, 10);
      }
      //----- Proyecto
      if (!isset($this->array_total_id_proyecto[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][$quebra_id_proyecto_orig]))
      {
         $this->array_total_id_proyecto[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][$quebra_id_proyecto_orig][0] = 1;
         $this->array_total_id_proyecto[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][$quebra_id_proyecto_orig][1] = $sum_intervalo;
         $this->array_total_id_proyecto[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][$quebra_id_proyecto_orig][2] = $quebra_id_proyecto;
         $this->array_total_id_proyecto[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][$quebra_id_proyecto_orig][3] = $quebra_id_proyecto_orig;
      }
      else
      {
         $this->array_total_id_proyecto[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][$quebra_id_proyecto_orig][0]++;
         $this->array_total_id_proyecto[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][$quebra_id_proyecto_orig][1] = bcadd($this->array_total_id_proyecto[$quebra_appointment_start_date_orig][$quebra_id_usuario_orig][$quebra_id_proyecto_orig][1], $sum_intervalo, 10);
      }
   }
...
$_SESSION['scriptcase']['reporte_tracking']['contr_erro'] = 'off'; 
     ...
     $format       = $this->Ini->Get_Gb_date_format('status', 'id_usuario');
     $campos_order = $this->Ini->Get_date_order_groupby("id_usuario", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('status', 'id_proyecto');
     $campos_order = $this->Ini->Get_date_order_groupby("id_proyecto", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->id_proyecto = $rs_res->fields[0] ;  
            $this->id_usuario = $rs_res->fields[1] ;  
            $this->id_actividad = $rs_res->fields[2] ;  
            $this->nombre = $rs_res->fields[3] ;  
            $this->current_status_id = $rs_res->fields[4] ;  
            $this->appointment_start_date = $rs_res->fields[5] ;  
            $this->appointment_start_time = $rs_res->fields[6] ;  
            $this->appointment_end_time = $rs_res->fields[7] ;  
            $this->intervalo = $rs_res->fields[8] ;  
...
$_SESSION['scriptcase']['reporte_tracking']['contr_erro'] = 'off'; 
            ...
            $this->id_usuario_orig = $this->id_usuario;
            $this->id_proyecto_orig = $this->id_proyecto;
            $this->id_proyecto = $this->look_id_proyecto ;
            $this->id_usuario = $this->look_id_usuario ;
            $this->id_actividad = $this->look_id_actividad ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->intervalo, $this->appointment_start_date, $this->id_usuario, $this->id_proyecto, $this->appointment_start_date_orig,  $this->id_usuario_orig,  $this->id_proyecto_orig);
            }
   }
//
