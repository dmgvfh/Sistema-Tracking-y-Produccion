<?php
@session_start() ;
$_SESSION['scriptcase']['reporte_tracking']['sc_process_barr'] = true;
require_once('../reporte_tracking/index.php');
unset($_SESSION['scriptcase']['reporte_tracking']['sc_process_barr']);
$ExportCtrl = new reporte_tracking_export_control;
$ExportCtrl->Export_barr();

class reporte_tracking_export_control
{
