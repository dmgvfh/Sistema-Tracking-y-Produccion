...
class reporte_tracking_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . reporte_tracking_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . reporte_tracking_pack_protect_string($Tipo_filter[0]) . "\">.." . reporte_tracking_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>INGRESE PERÍODO - REPORTE DE HORAS APROBADAS</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>reporte_tracking/reporte_tracking_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="reporte_tracking_ajax_search.js"></script>
 <script type="text/javascript" src="reporte_tracking_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="reporte_tracking_message.js"></script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">INGRESE PERÍODO - REPORTE DE HORAS APROBADAS</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $appointment_start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_dia']; 
          $appointment_start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_mes']; 
          $appointment_start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_ano']; 
          $appointment_start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_input_2_dia']; 
          $appointment_start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_input_2_mes']; 
          $appointment_start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_input_2_ano']; 
          $appointment_start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['nombre_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_display_nombre = ('bw' == $nombre_cond) ? $display_aberto : $display_fechado;
...
?>
<?php
   if (is_file("reporte_tracking_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['opc_psq'])
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_appointment_start_date_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : "Fecha"; ?></TD>
...
?>
        ...
        <SPAN id="id_css_appointment_start_date" class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_nombre_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nombre'])) ? $this->New_label['nombre'] : "Nombre Actividad"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
<INPUT  type="text" id="SC_nombre" name="nombre" value="<?php echo NM_encode_input($nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
{
?>
<iframe id="nmsc_iframe_reporte_tracking" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_reporte_tracking" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_reporte_tracking_pesq"  name="nm_iframe_reporte_tracking_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_reporte_tracking";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_reporte_tracking').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
 ...
 {
    $('#SC_appointment_start_date_dia').bind('change', function() {sc_reporte_tracking_valida_dia(this)});
    $('#SC_appointment_start_date_input_2_dia').bind('change', function() {sc_reporte_tracking_valida_dia(this)});
    $('#SC_appointment_start_date_input_2_mes').bind('change', function() {sc_reporte_tracking_valida_mes(this)});
    $('#SC_appointment_start_date_mes').bind('change', function() {sc_reporte_tracking_valida_mes(this)});
 }
 function sc_reporte_tracking_valida_dia(obj)
 {
 ...
 function sc_reporte_tracking_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/reporte_tracking";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $appointment_start_date_cond, $appointment_start_date, $appointment_start_date_dia, $appointment_start_date_mes, $appointment_start_date_ano, $appointment_start_date_input_2_dia, $appointment_start_date_input_2_mes, $appointment_start_date_input_2_ano,
             $nombre_cond, $nombre, $nmgp_tab_label;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_dia'] = $appointment_start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_mes'] = $appointment_start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_ano'] = $appointment_start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_input_2_dia'] = $appointment_start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_input_2_mes'] = $appointment_start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_input_2_ano'] = $appointment_start_date_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_cond'] = $appointment_start_date_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['nombre'] = $nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $nombre;
      $this->cmp_formatado['nombre'] = $Conteudo;
      ...
      if ($appointment_start_date_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date'] = $val[0];
          ...
          if ($appointment_start_date_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']['appointment_start_date_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("nombre", $nombre_cond, $nombre, "", "nombre", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['cond_pesq'] .= $this->NM_operador;
