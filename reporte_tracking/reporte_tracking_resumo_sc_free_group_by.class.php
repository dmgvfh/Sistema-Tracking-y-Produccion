...
$_SESSION['scriptcase']['reporte_tracking']['contr_erro'] = 'off'; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_total']['id_actividad'] = $this->array_total_id_actividad;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['labels']['id_actividad'] = $Lab_id_actividad; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['appointment_start_date']['alin'] = "'center'";
       ...
       $Arr_parms['appointment_start_date']['order_enabled'] = 'true';
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
				if ($fieldData['display']) {
					$displayedSummarizations[] = $fieldIndex;
				}
			}

			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if (!in_array($summarizingLevel + 1, $displayedSummarizations)) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_charts'][$chartIndex]);
				}
			}

			$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_charts'];
		}
	}
...
{ 
   ...
   $nm_saida->saida("<SCRIPT language=\"Javascript\">\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_intervalo, $quebra_appointment_start_date, $quebra_id_usuario, $quebra_id_actividad, $quebra_id_proyecto, $quebra_appointment_start_date_orig, $quebra_id_usuario_orig, $quebra_id_actividad_orig, $quebra_id_proyecto_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->intervalo, $this->appointment_start_date, $this->id_usuario, $this->id_actividad, $this->id_proyecto, $this->appointment_start_date_orig,  $this->id_usuario_orig,  $this->id_actividad_orig,  $this->id_proyecto_orig);
            }
   }
//
