...
class reporte_tracking_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "reporte_tracking.rtf";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['rtf_name']);
      }
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['pivot_group_by'];
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['arr_export']['data'];
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_tracking']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>REPORTE DE HORAS APROBADAS :: RTF</TITLE>
