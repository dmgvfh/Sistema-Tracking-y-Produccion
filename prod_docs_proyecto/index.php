...
include_once('prod_docs_proyecto_session.php');
@ini_set('session.cookie_httponly', 1);
@ini_set('session.use_only_cookies', 1);
@ini_set('session.cookie_secure', 0);
@session_start();

$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_perfil']          = "";
$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_prod']       = "";
$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imagens']    = "";
$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imag_temp']  = "";
$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_doc']        = "";
...
//check prod
if(empty($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_prod_docs_proyecto($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "prod_docs_proyecto") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_carga_horas'])) {
            $_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_carga_horas'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_prod_docs_proyecto($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['prod_docs_proyecto']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['prod_docs_proyecto']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$prod_docs_proyecto_control = new prod_docs_proyecto_control();
$prod_docs_proyecto_control->control();

class prod_docs_proyecto_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto'])) {
            $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "prod_docs_proyecto";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        ...
        $this->nm_dt_criacao   = "20231016";
        $this->nm_hr_criacao   = "094050";
        $this->nm_autor_alt    = "admin";
        $this->nm_dt_ult_alt   = "20240220";
        $this->nm_hr_ult_alt   = "104156";
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/prod_docs_proyecto';
        ...
        if (isset($_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['prod_docs_proyecto']['actual_lang']) || $_SESSION['scriptcase']['prod_docs_proyecto']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['prod_docs_proyecto']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['redir'])) {
...
';
            ...
            if ($_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['prod_docs_proyecto']['session_timeout']);
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao']) && $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_perfil']) && $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['prod_docs_proyecto']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['prod_docs_proyecto']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['SC_sep_date1'];
      }
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['prod_docs_proyecto']['sc_outra_jan'] != 'prod_docs_proyecto')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['prod_docs_proyecto']['glo_nm_conexao'], $this->root . $this->path_prod, 'carga_horas', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
} // prod_docs_proyecto_ini

class prod_docs_proyecto_control {
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new prod_docs_proyecto_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['prod_docs_proyecto'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['prod_docs_proyecto'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['prod_docs_proyecto'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['prod_docs_proyecto']['dbifrm_widget2'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['prod_docs_proyecto']['dbifrm_widget3'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['prod_docs_proyecto'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['prod_docs_proyecto']['grid_prod_documentos'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['prod_docs_proyecto']['grid_prod_hitos_contractuales'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="prod_docs_proyecto_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['prod_docs_proyecto'] as $sIframe => $iSCInit) {
?>
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="11" data-gs-height="5"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head widget-is-moveable" style="display:">
                            ...
                            <a href="#" class="maximize" onclick="maximizeWidget('0');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Documentos Del Proyecto" /></a>
                            <h3 class="scContainerTitle">Documentos Del Proyecto</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget2" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_prod_documentos'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["prod_docs_proyecto"]["dbifrm_widget2"] ?>&under_dashboard=1&dashboard_app=prod_docs_proyecto&own_widget=dbifrm_widget2&compact_mode=1&remove_margin=1&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="5" data-gs-width="11" data-gs-height="5"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head widget-is-moveable" style="display:">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('1');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Documentos Hitos Contractuales Del Proyecto" /></a>
                            <h3 class="scContainerTitle">Documentos Hitos Contractuales Del Proyecto</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-1"><iframe id="id-iframe-1" name="dbifrm_widget3" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_prod_hitos_contractuales'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["prod_docs_proyecto"]["dbifrm_widget3"] ?>&under_dashboard=1&dashboard_app=prod_docs_proyecto&own_widget=dbifrm_widget3&compact_mode=1&remove_margin=1&remove_border=0"></iframe></div>
                    </div>
                </div></div>
...
} // prod_docs_proyecto_control

function nm_limpa_str_prod_docs_proyecto(&$str)
{
}
