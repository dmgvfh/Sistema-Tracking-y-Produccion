<?php
class form_prod_partida_presupuesto_periodo_form extends form_prod_partida_presupuesto_periodo_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_prod_partida_presupuesto_periodo/form_prod_partida_presupuesto_periodo_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_prod_partida_presupuesto_periodo_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_prod_partida_presupuesto_periodo_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    ...
    $remove_margin = '';
    $remove_border = '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['link_info']['remove_border']) {
...
<?php
 include_once("form_prod_partida_presupuesto_periodo_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_prod_partida_presupuesto_periodo'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_prod_partida_presupuesto_periodo'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['new'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_prod_partida_presupuesto_periodo_add_new_line(); return false;", "do_ajax_form_prod_partida_presupuesto_periodo_add_new_line(); return false;", "sc_b_new_t", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['sc_btn_0']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['sc_btn_0']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['sc_btn_0']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['sc_btn_0']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['sc_btn_0'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['sc_btn_1']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['sc_btn_1']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['sc_btn_1']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['sc_btn_1']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['sc_btn_1'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_prod_partida_presupuesto_periodo);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_prod_partida_presupuesto_periodo = $this->form_vert_form_prod_partida_presupuesto_periodo;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_prod_partida_presupuesto_periodo))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_prod_partida_presupuesto_periodo as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->id_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['id_'];
       $this->id_presupuesto_periodo_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['id_presupuesto_periodo_'];
       $this->monto_uf_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['monto_uf_'];
       $this->agrupador_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['agrupador_'];
       $this->nombre_item_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['nombre_item_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_partida_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['id_partida_']; 
       ...
       $this->id_proyecto_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['id_proyecto_']; 
       ...
       $this->id_item_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['id_item_']; 
       ...
       $this->tipo_moneda_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['tipo_moneda_']; 
       ...
       $this->valor_unitario_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['valor_unitario_']; 
       ...
       $this->unidades_periodo_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['unidades_periodo_']; 
       ...
       $this->avance_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['avance_']; 
       ...
       $this->observaciones_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['observaciones_']; 
       ...
       $this->facturado_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['facturado_']; 
       ...
       $this->monto_utilizado_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['monto_utilizado_']; 
       ...
       $this->monto_por_facturar_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['monto_por_facturar_']; 
       ...
       $this->monto_presupuesto_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['monto_presupuesto_']; 
       ...
       $this->presupuesto_disponible_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['presupuesto_disponible_']; 
       ...
       $this->atencion_ = $this->form_vert_form_prod_partida_presupuesto_periodo[$sc_seq_vert]['atencion_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_prod_partida_presupuesto_periodo_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_prod_partida_presupuesto_periodo_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_prod_partida_presupuesto_periodo_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_prod_partida_presupuesto_periodo_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_prod_partida_presupuesto_periodo_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_prod_partida_presupuesto_periodo_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_id_partida__line" id="hidden_field_data_id_partida_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_id_partida_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_id_partida__line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_partida_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_partida_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_unidades_periodo__line" id="hidden_field_data_unidades_periodo_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_unidades_periodo_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_unidades_periodo__line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_unidades_periodo_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_unidades_periodo_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_avance__line" id="hidden_field_data_avance_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_avance_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_avance__line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_avance_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_avance_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<span id="id_read_on_observaciones_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-observaciones_<?php echo $sc_seq_vert ?> css_observaciones__line" style="<?php echo $sStyleReadLab_observaciones_; ?>"><?php echo $this->form_format_readonly("observaciones_", $this->form_encode_input($observaciones__val)); ?></span><span id="id_read_off_observaciones_<?php echo $sc_seq_vert ?>" class="css_read_off_observaciones_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_observaciones_; ?>">
 <textarea class="sc-js-input scFormObjectOddMult css_observaciones__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="white-space: pre-wrap;" name="observaciones_<?php echo $sc_seq_vert ?>" id="id_sc_field_observaciones_<?php echo $sc_seq_vert ?>" rows="3" cols="25"
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_facturado__line" id="hidden_field_data_facturado_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_facturado_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_facturado__line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['Lookup_facturado_'][] = '0'; ?>
 <option  value="1" <?php  if ($this->facturado_ == "1") { echo " selected" ;} ?>>FACTURADO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['Lookup_facturado_'][] = '1'; ?>
 </select></span>
</span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_facturado_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_facturado_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_monto_utilizado__line" id="hidden_field_data_monto_utilizado_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_monto_utilizado_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOddMult css_monto_utilizado__line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_monto_utilizado_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_monto_utilizado_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_monto_por_facturar__line" id="hidden_field_data_monto_por_facturar_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_monto_por_facturar_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOddMult css_monto_por_facturar__line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_monto_por_facturar_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_monto_por_facturar_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_monto_presupuesto__line" id="hidden_field_data_monto_presupuesto_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_monto_presupuesto_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOddMult css_monto_presupuesto__line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_monto_presupuesto_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_monto_presupuesto_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_presupuesto_disponible__line" id="hidden_field_data_presupuesto_disponible_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_presupuesto_disponible_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOddMult css_presupuesto_disponible__line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_presupuesto_disponible_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_presupuesto_disponible_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_atencion__line" id="hidden_field_data_atencion_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_atencion_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_atencion__line" style="vertical-align: top;padding: 0px"><span id="id_ajax_label_atencion_<?php echo $sc_seq_vert; ?>"><?php echo $atencion_?></span>
<input type="hidden" name="atencion_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($atencion_); ?>">
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_atencion_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_atencion_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_prod_partida_presupuesto_periodo = $guarda_form_vert_form_prod_partida_presupuesto_periodo;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_prod_partida_presupuesto_periodo");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_prod_partida_presupuesto_periodo");
 parent.scAjaxDetailHeight("form_prod_partida_presupuesto_periodo", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_partida_presupuesto_periodo']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
