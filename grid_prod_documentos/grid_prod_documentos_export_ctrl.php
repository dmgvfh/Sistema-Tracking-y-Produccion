<?php
@session_start() ;
$_SESSION['scriptcase']['grid_prod_documentos']['sc_process_barr'] = true;
require_once('../grid_prod_documentos/index.php');
unset($_SESSION['scriptcase']['grid_prod_documentos']['sc_process_barr']);
$ExportCtrl = new grid_prod_documentos_export_control;
$ExportCtrl->Export_barr();

class grid_prod_documentos_export_control
{
