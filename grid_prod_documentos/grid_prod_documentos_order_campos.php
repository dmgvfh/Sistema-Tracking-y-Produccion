...
<?php
   ...
   $Ord_Cmp = new grid_prod_documentos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_documentos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["id_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["id_proyecto"] : "Código Proyecto";
   $tab_ger_campos['id_carpeta'] = "on";
   $tab_def_campos['id_carpeta'] = "id_carpeta";
   $tab_labels["id_carpeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["id_carpeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["id_carpeta"] : "Carpeta";
   $tab_ger_campos['id_tipo_doc'] = "on";
   $tab_def_campos['id_tipo_doc'] = "id_tipo_doc";
   $tab_labels["id_tipo_doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["id_tipo_doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["id_tipo_doc"] : "Tipo De Documento";
   $tab_ger_campos['nombre_documento'] = "on";
   $tab_def_campos['nombre_documento'] = "nombre_documento";
   $tab_labels["nombre_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["nombre_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["nombre_documento"] : "Nombre Documento";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["descripcion"] : "Descripción";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['nombre_documento'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_documentos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_documentos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
