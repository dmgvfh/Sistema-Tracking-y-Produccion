...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fecha";$Nm_numeric[] = "id_proyecto";$Nm_numeric[] = "id_carpeta";$Nm_numeric[] = "id_tipo_doc";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_id_proyecto"  <?php echo $str_hide_id_proyecto?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_id_carpeta"  <?php echo $str_hide_id_carpeta?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_id_tipo_doc"  <?php echo $str_hide_id_tipo_doc?>>
<?php
      $id_tipo_doc_look = (is_string($id_tipo_doc) ? substr($this->Db->qstr($id_tipo_doc), 1, -1) : $id_tipo_doc); 
      $nmgp_def_dados = "" ; 
   if (is_numeric($id_carpeta))
