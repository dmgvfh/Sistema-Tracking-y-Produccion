...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_documentos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_documentos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_prod_documentos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_documentos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_documentos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_documentos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_documentos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_prod_documentos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_prod_documentos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_prod_documentos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_prod_documentos']['embutida_filho'] as $ind => $sc_init)
          {
