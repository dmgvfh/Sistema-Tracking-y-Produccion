...
class grid_prod_documentos_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_prod_documentos.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['rtf_name']);
      }
   ...
   function NM_export_id_carpeta()
   {
         ...
         $this->look_id_carpeta = str_replace('<', '&lt;', $this->look_id_carpeta);
         $this->look_id_carpeta = str_replace('>', '&gt;', $this->look_id_carpeta);
         $this->Texto_tag .= "<td>" . $this->look_id_carpeta . "</td>\r\n";
   }
   //----- id_tipo_doc
   function NM_export_id_tipo_doc()
   {
         ...
         $this->look_id_tipo_doc = str_replace('<', '&lt;', $this->look_id_tipo_doc);
         $this->look_id_tipo_doc = str_replace('>', '&gt;', $this->look_id_tipo_doc);
         $this->Texto_tag .= "<td>" . $this->look_id_tipo_doc . "</td>\r\n";
   }
   //----- nombre_documento
   function NM_export_nombre_documento()
   {
         $this->nombre_documento = NM_charset_to_utf8($this->nombre_documento);
         $this->nombre_documento = str_replace('<', '&lt;', $this->nombre_documento);
         $this->nombre_documento = str_replace('>', '&gt;', $this->nombre_documento);
         $this->Texto_tag .= "<td>" . $this->nombre_documento . "</td>\r\n";
   }
   //----- descripcion
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Documentos Proyectos :: RTF</TITLE>
