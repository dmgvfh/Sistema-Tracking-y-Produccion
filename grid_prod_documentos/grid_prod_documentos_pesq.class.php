...
class grid_prod_documentos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_prod_documentos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_prod_documentos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_prod_documentos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_refresh_field")
      {
          ...
          if (in_array("id_tipo_doc", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_id_tipo_doc($id_carpeta);
              ...
              $this->Arr_result['set_option'][] = array('field' => 'SC_id_tipo_doc', 'value' => $list);
          }
      }
   }
   function lookup_ajax_id_tipo_doc($id_carpeta)
   {
      $tmp_pos = (is_string($id_carpeta)) ? strpos($id_carpeta, "##@@") : false;
      if ($tmp_pos !== false)
      {
          $id_carpeta = substr($id_carpeta, 0, $tmp_pos);
      }
            $id_tipo_doc_look = (is_string($id_tipo_doc) ? substr($this->Db->qstr($id_tipo_doc), 1, -1) : $id_tipo_doc); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_carpeta))
   { 
      $nm_comando = "SELECT id, tipo_documento  FROM prod_tipo_documento where id_carpeta=$id_carpeta ORDER BY tipo_documento"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_tipo_doc'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_tipo_doc'][] = trim($rs->fields[0]);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_proyecto";$Nm_numeric[] = "id_carpeta";$Nm_numeric[] = "id_tipo_doc";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Documentos Proyectos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_prod_documentos/grid_prod_documentos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_prod_documentos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_prod_documentos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_prod_documentos_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_proyecto#NMF#' + search_get_select('SC_id_proyecto') + '@NMF@';
  str_out += 'SC_id_carpeta_cond#NMF#' + search_get_sel_txt('SC_id_carpeta_cond') + '@NMF@';
  str_out += 'SC_id_carpeta#NMF#' + search_get_select('SC_id_carpeta') + '@NMF@';
  str_out += 'SC_id_tipo_doc_cond#NMF#' + search_get_sel_txt('SC_id_tipo_doc_cond') + '@NMF@';
  str_out += 'SC_id_tipo_doc#NMF#' + search_get_select('SC_id_tipo_doc') + '@NMF@';
 ...
 function nm_refresh_id_carpeta(Proc_on)
 {
   var parms  = "";
   var fields = "id_tipo_doc";
   parms += 'id_carpeta#NMF#' + search_get_select('SC_id_carpeta') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Documentos Proyectos</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $id_carpeta_cond, $id_carpeta,
             $id_tipo_doc_cond, $id_tipo_doc,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_proyecto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_proyecto']; 
          $id_proyecto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_proyecto_cond']; 
          $id_carpeta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_carpeta']; 
          $id_carpeta_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_carpeta_cond']; 
          $id_tipo_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_tipo_doc']; 
          $id_tipo_doc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_tipo_doc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_id_carpeta = (in_array($id_carpeta_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_tipo_doc = (in_array($id_tipo_doc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($id_carpeta) || $id_carpeta == "")
      {
          $id_carpeta = "";
      }
      if (isset($id_carpeta) && !empty($id_carpeta))
      {
         $tmp_pos = (is_string($id_carpeta)) ? strpos($id_carpeta, "##@@") : false;
         if ($tmp_pos === false)
         { }
      ...
      if (isset($id_tipo_doc) && !empty($id_tipo_doc))
      {
         $tmp_pos = (is_string($id_tipo_doc)) ? strpos($id_tipo_doc, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_tipo_doc = substr($id_tipo_doc, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_proyecto_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_proyecto'])) ? $this->New_label['id_proyecto'] : "Proyecto"; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_proyecto'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_proyecto'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_id_proyecto">
      <SELECT class="scFilterObjectOdd" id="SC_id_proyecto" name="id_proyecto"  size="1">
       <OPTION value=""></OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_proyecto)
            {
                    $id_proyecto_sel = ($nm_opc_cod === $id_proyecto) ? "selected" : "";
            }
            else
            {
...
?>
      ...
      <TD id='SC_id_carpeta_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_carpeta'])) ? $this->New_label['id_carpeta'] : "Carpeta"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_carpeta_cond" name="id_carpeta_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_carpeta" <?php echo $str_hide_id_carpeta?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_carpeta'])) ? $this->New_label['id_carpeta'] : "Carpeta";
 $nmgp_tab_label .= "id_carpeta?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $id_carpeta_look = (is_string($id_carpeta) ? substr($this->Db->qstr($id_carpeta), 1, -1) : $id_carpeta); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_carpeta'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_carpeta'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_id_carpeta">
      <SELECT class="scFilterObjectEven" id="SC_id_carpeta" name="id_carpeta" onChange="nm_refresh_id_carpeta();" size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_carpeta)
            {
                    $id_carpeta_sel = ($nm_opc_cod === $id_carpeta) ? "selected" : "";
            }
            else
            {
               $id_carpeta_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $id_carpeta_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_id_tipo_doc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_tipo_doc'])) ? $this->New_label['id_tipo_doc'] : "Tipo De Documento"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_tipo_doc_cond" name="id_tipo_doc_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_tipo_doc" <?php echo $str_hide_id_tipo_doc?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_tipo_doc'])) ? $this->New_label['id_tipo_doc'] : "Tipo De Documento";
 $nmgp_tab_label .= "id_tipo_doc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <span id="idAjaxSelect_id_tipo_doc">
      <SELECT class="scFilterObjectOdd" id="SC_id_tipo_doc" name="id_tipo_doc"  size="1">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_tipo_doc)
            {
                    $id_tipo_doc_sel = ($nm_opc_cod === $id_tipo_doc) ? "selected" : "";
            }
            else
            {
               $id_tipo_doc_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $id_tipo_doc_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
<?php
   if (is_file("grid_prod_documentos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_prod_documentos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_prod_documentos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_proyecto.value = "";
   nm_campos_between(document.getElementById('id_vis_id_carpeta'), document.F1.id_carpeta_cond, 'id_carpeta');
   document.F1.id_carpeta.value = "";
   nm_campos_between(document.getElementById('id_vis_id_tipo_doc'), document.F1.id_tipo_doc_cond, 'id_tipo_doc');
   document.F1.id_tipo_doc.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_prod_documentos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_proyecto'] = 'select';
      $tp_fields['SC_id_carpeta_cond'] = 'cond';
      $tp_fields['SC_id_carpeta'] = 'select';
      $tp_fields['SC_id_tipo_doc_cond'] = 'cond';
      $tp_fields['SC_id_tipo_doc'] = 'select';
   ...
   {
      global $id_proyecto_cond, $id_proyecto,
             $id_carpeta_cond, $id_carpeta,
             $id_tipo_doc_cond, $id_tipo_doc, $nmgp_tab_label;
      ...
      $id_carpeta_cond_salva = $id_carpeta_cond; 
      if (!isset($id_carpeta_input_2) || $id_carpeta_input_2 == "")
      {
          $id_carpeta_input_2 = $id_carpeta;
      }
      $id_tipo_doc_cond_salva = $id_tipo_doc_cond; 
      if (!isset($id_tipo_doc_input_2) || $id_tipo_doc_input_2 == "")
      {
          $id_tipo_doc_input_2 = $id_tipo_doc;
      }
      $tmp_pos = (is_string($id_proyecto)) ? strpos($id_proyecto, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $id_proyecto;
      }
      else {
          $L_lookup = substr($id_proyecto, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_proyecto'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($id_carpeta, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_carpeta'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Carpeta : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = (is_string($id_tipo_doc)) ? strpos($id_tipo_doc, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $id_tipo_doc;
      }
      else {
          $L_lookup = substr($id_tipo_doc, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['psq_check_ret']['id_tipo_doc'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Tipo De Documento : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_proyecto'] = $id_proyecto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_proyecto_cond'] = $id_proyecto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_carpeta'] = $id_carpeta; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_carpeta_cond'] = $id_carpeta_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_tipo_doc'] = $id_tipo_doc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['id_tipo_doc_cond'] = $id_tipo_doc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $id_proyecto;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['id_proyecto'] = $Conteudo;
      $Conteudo = $id_carpeta;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['id_carpeta'] = $Conteudo;
      $Conteudo = $id_tipo_doc;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['id_tipo_doc'] = $Conteudo;

      //----- $id_proyecto
      $this->Date_part = false;
      if (isset($id_proyecto))
      {
         $this->monta_condicao("id_proyecto", $id_proyecto_cond, $id_proyecto, "", "id_proyecto", "INT", false);
      }
      ...
      if (isset($id_carpeta))
      {
         $this->monta_condicao("id_carpeta", $id_carpeta_cond, $id_carpeta, "", "id_carpeta", "INT", false);
      }

      //----- $id_tipo_doc
      $this->Date_part = false;
      if (isset($id_tipo_doc))
      {
         $this->monta_condicao("id_tipo_doc", $id_tipo_doc_cond, $id_tipo_doc, "", "id_tipo_doc", "INT", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_documentos']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "id_proyecto" : return ('class="scFilterObjectOdd"'); break;
         case "id_carpeta" : return ('class="scFilterObjectEven"'); break;
         case "id_tipo_doc" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
