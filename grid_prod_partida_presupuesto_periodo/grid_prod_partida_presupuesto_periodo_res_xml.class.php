...
class grid_prod_partida_presupuesto_periodo_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      if ($this->New_Format)
      {
          fwrite($xml_f, "<grid_prod_partida_presupuesto_periodo>\r\n");
      }
      if ($this->Grava_view)
      {
          ...
          if ($this->New_Format)
          {
              fwrite($xml_v, "<grid_prod_partida_presupuesto_periodo>\r\n");
          }
      }
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          if (!$this->New_Format)
          {
              $xml_registro = "<grid_prod_partida_presupuesto_periodo";
          }
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
