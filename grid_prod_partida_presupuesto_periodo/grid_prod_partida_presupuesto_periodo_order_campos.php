<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_prod_partida_presupuesto_periodo']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_prod_partida_presupuesto_periodo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_partida_presupuesto_periodo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['prod_agrupa_items_nombre_agrupador'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_agrupa_items_nombre_agrupador'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['prod_agrupa_items_nombre_agrupador'] = "prod_agrupa_items.nombre_agrupador";
   }
   $tab_labels["prod_agrupa_items_nombre_agrupador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_agrupa_items_nombre_agrupador"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_agrupa_items_nombre_agrupador"] : "Agrupador";
   $tab_ger_campos['prod_items_base_item'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_items_base_item'] = "prod_items_base_item";
   }
   else
   {
       $tab_def_campos['prod_items_base_item'] = "prod_items_base.item";
   }
   $tab_labels["prod_items_base_item"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_items_base_item"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_items_base_item"] : "Item";
   $tab_ger_campos['no_facturado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['no_facturado'] = "no_facturado";
   }
   else
   {
       $tab_def_campos['no_facturado'] = "";
   }
   $tab_labels["no_facturado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["no_facturado"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["no_facturado"] : "Por Facturar<bR>Unidades - Acumulado";
   ...
   {
       $tab_def_campos['tipo_moneda'] = "SELECT 
...
WHERE
  proyectos.id =" . $_SESSION['id_proyecto'] . "";
   ...
   $tab_labels["tipo_moneda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["tipo_moneda"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["tipo_moneda"] : "Tipo Moneda";
   $tab_ger_campos['prod_partida_presupuesto_periodo_unidades_periodo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_partida_presupuesto_periodo_unidades_periodo'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['prod_partida_presupuesto_periodo_unidades_periodo'] = "prod_partida_presupuesto_periodo.unidades_periodo";
   }
   $tab_labels["prod_partida_presupuesto_periodo_unidades_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_partida_presupuesto_periodo_unidades_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_partida_presupuesto_periodo_unidades_periodo"] : "Unidades Producción<br>Informadas En Período";
   ...
   {
       $tab_def_campos['valor_unitario'] = "";
   }
   $tab_labels["valor_unitario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["valor_unitario"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["valor_unitario"] : "Valor Unitario";
   $tab_ger_campos['prod_partida_presupuesto_periodo_avance'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_partida_presupuesto_periodo_avance'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['prod_partida_presupuesto_periodo_avance'] = "prod_partida_presupuesto_periodo.avance";
   }
   $tab_labels["prod_partida_presupuesto_periodo_avance"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_partida_presupuesto_periodo_avance"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_partida_presupuesto_periodo_avance"] : "Producción Total<br>Valorizado - Período";
   $tab_ger_campos['utilizado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['utilizado'] = "utilizado";
   }
   else
   {
       $tab_def_campos['utilizado'] = "";
   }
   $tab_labels["utilizado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["utilizado"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["utilizado"] : "Unidades Producción<br>Ejecutadas - Total";
   $tab_ger_campos['prod_partida_presupuesto_periodo_observaciones'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_partida_presupuesto_periodo_observaciones'] = "cmp_maior_30_4";
   }
   else
   {
       $tab_def_campos['prod_partida_presupuesto_periodo_observaciones'] = "prod_partida_presupuesto_periodo.observaciones";
   }
   $tab_labels["prod_partida_presupuesto_periodo_observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_partida_presupuesto_periodo_observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_partida_presupuesto_periodo_observaciones"] : "Observaciones";
   $tab_ger_campos['prod_partida_presupuesto_periodo_id_periodo_factura'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_partida_presupuesto_periodo_id_periodo_factura'] = "cmp_maior_30_5";
   }
   else
   {
       $tab_def_campos['prod_partida_presupuesto_periodo_id_periodo_factura'] = "prod_partida_presupuesto_periodo.id_periodo_factura";
   }
   $tab_labels["prod_partida_presupuesto_periodo_id_periodo_factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_partida_presupuesto_periodo_id_periodo_factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['labels']["prod_partida_presupuesto_periodo_id_periodo_factura"] : "ID Periodo<br>Facturación";
   $tab_ger_campos['no_facturado'] = "none";
   $tab_ger_campos['tipo_moneda'] = "none";
   $tab_ger_campos['valor_unitario'] = "none";
   $tab_ger_campos['utilizado'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>PARTIDAS DE AVANCE - PRODUCCIÓN</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_partida_presupuesto_periodo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_partida_presupuesto_periodo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
