...
class grid_prod_partida_presupuesto_periodo_xml
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_label'];
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_prod_partida_presupuesto_periodo.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_prod_partida_presupuesto_periodo>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_prod_partida_presupuesto_periodo";
...
$_SESSION['scriptcase']['grid_prod_partida_presupuesto_periodo']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->prod_agrupa_items_nombre_agrupador))
         {
             $this->prod_agrupa_items_nombre_agrupador = sc_convert_encoding($this->prod_agrupa_items_nombre_agrupador, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         ...
         {
             $SC_Label = "prod_agrupa_items_nombre_agrupador"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_agrupa_items_nombre_agrupador) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_agrupa_items_nombre_agrupador) . "\"";
         }
   }
   ...
   function NM_export_no_facturado()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->no_facturado))
         {
             $this->no_facturado = sc_convert_encoding($this->no_facturado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "no_facturado"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->no_facturado) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->no_facturado) . "\"";
         }
   }
   //----- tipo_moneda
   ...
   function NM_export_prod_partida_presupuesto_periodo_unidades_periodo()
   {
         ...
         {
             $SC_Label = "prod_partida_presupuesto_periodo_unidades_periodo"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_partida_presupuesto_periodo_unidades_periodo) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_partida_presupuesto_periodo_unidades_periodo) . "\"";
         }
   }
   //----- valor_unitario
   ...
   function NM_export_prod_partida_presupuesto_periodo_avance()
   {
         ...
         {
             $SC_Label = "prod_partida_presupuesto_periodo_avance"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_partida_presupuesto_periodo_avance) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_partida_presupuesto_periodo_avance) . "\"";
         }
   }
   //----- utilizado
   function NM_export_utilizado()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->utilizado))
         {
             $this->utilizado = sc_convert_encoding($this->utilizado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->utilizado) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->utilizado) . "\"";
         }
   }
   //----- prod_partida_presupuesto_periodo_observaciones
   function NM_export_prod_partida_presupuesto_periodo_observaciones()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->prod_partida_presupuesto_periodo_observaciones))
         {
             $this->prod_partida_presupuesto_periodo_observaciones = sc_convert_encoding($this->prod_partida_presupuesto_periodo_observaciones, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         {
             $SC_Label = "prod_partida_presupuesto_periodo_observaciones"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_partida_presupuesto_periodo_observaciones) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_partida_presupuesto_periodo_observaciones) . "\"";
         }
   }
   ...
   function NM_export_prod_partida_presupuesto_periodo_id_periodo_factura()
   {
         ...
         {
             $SC_Label = "prod_partida_presupuesto_periodo_id_periodo_factura"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->prod_partida_presupuesto_periodo_id_periodo_factura) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->prod_partida_presupuesto_periodo_id_periodo_factura) . "\"";
         }
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>PARTIDAS DE AVANCE - PRODUCCIÓN :: XML</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
