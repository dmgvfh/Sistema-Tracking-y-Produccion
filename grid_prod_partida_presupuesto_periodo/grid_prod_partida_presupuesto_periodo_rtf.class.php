...
class grid_prod_partida_presupuesto_periodo_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_prod_partida_presupuesto_periodo.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_prod_partida_presupuesto_periodo']['contr_erro'] = 'off'; 
   ...
   function NM_export_no_facturado()
   {
         ...
         $this->no_facturado = str_replace('<', '&lt;', $this->no_facturado);
         $this->no_facturado = str_replace('>', '&gt;', $this->no_facturado);
         $this->Texto_tag .= "<td>" . $this->no_facturado . "</td>\r\n";
   }
   //----- tipo_moneda
   ...
   function NM_export_prod_partida_presupuesto_periodo_unidades_periodo()
   {
         ...
         $this->prod_partida_presupuesto_periodo_unidades_periodo = str_replace('<', '&lt;', $this->prod_partida_presupuesto_periodo_unidades_periodo);
         $this->prod_partida_presupuesto_periodo_unidades_periodo = str_replace('>', '&gt;', $this->prod_partida_presupuesto_periodo_unidades_periodo);
         $this->Texto_tag .= "<td>" . $this->prod_partida_presupuesto_periodo_unidades_periodo . "</td>\r\n";
   }
   //----- valor_unitario
   ...
   function NM_export_prod_partida_presupuesto_periodo_avance()
   {
         ...
         $this->prod_partida_presupuesto_periodo_avance = str_replace('<', '&lt;', $this->prod_partida_presupuesto_periodo_avance);
         $this->prod_partida_presupuesto_periodo_avance = str_replace('>', '&gt;', $this->prod_partida_presupuesto_periodo_avance);
         $this->Texto_tag .= "<td>" . $this->prod_partida_presupuesto_periodo_avance . "</td>\r\n";
   }
   //----- utilizado
   function NM_export_utilizado()
   {
         ...
         $this->utilizado = str_replace('<', '&lt;', $this->utilizado);
         $this->utilizado = str_replace('>', '&gt;', $this->utilizado);
         $this->Texto_tag .= "<td>" . $this->utilizado . "</td>\r\n";
   }
   ...
   function NM_export_prod_partida_presupuesto_periodo_observaciones()
   {
         ...
         $this->prod_partida_presupuesto_periodo_observaciones = str_replace('<', '&lt;', $this->prod_partida_presupuesto_periodo_observaciones);
         $this->prod_partida_presupuesto_periodo_observaciones = str_replace('>', '&gt;', $this->prod_partida_presupuesto_periodo_observaciones);
         $this->Texto_tag .= "<td>" . $this->prod_partida_presupuesto_periodo_observaciones . "</td>\r\n";
   }
   ...
   function NM_export_prod_partida_presupuesto_periodo_id_periodo_factura()
   {
         ...
         $this->prod_partida_presupuesto_periodo_id_periodo_factura = str_replace('<', '&lt;', $this->prod_partida_presupuesto_periodo_id_periodo_factura);
         $this->prod_partida_presupuesto_periodo_id_periodo_factura = str_replace('>', '&gt;', $this->prod_partida_presupuesto_periodo_id_periodo_factura);
         $this->Texto_tag .= "<td>" . $this->prod_partida_presupuesto_periodo_id_periodo_factura . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_partida_presupuesto_periodo']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>PARTIDAS DE AVANCE - PRODUCCIÓN :: RTF</TITLE>
