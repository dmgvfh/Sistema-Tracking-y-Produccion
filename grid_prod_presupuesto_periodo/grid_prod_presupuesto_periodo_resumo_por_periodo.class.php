...
class grid_prod_presupuesto_periodo_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_id_partida = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_prod_presupuesto_periodo']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_prod_presupuesto_periodo']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['contr_total_geral'] == "OK")
      {
          $this->array_total_id_partida = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['arr_total']['id_partida'];
      }
      else
      {
          $this->array_total_id_partida = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['arr_total']['id_partida'] = $this->array_total_id_partida;
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['json_use_label'])
       {
          $Lab_id_partida = "id_partida";
       }
       else
       {
       $Lab_id_partida = "Período";
       }
       $this->comp_field = array(
           $Lab_id_partida,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['id_partida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['id_partida'] = "Período"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['monto_disponible']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['monto_disponible'] = "Presupuesto<br>BASE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha_desde']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha_desde'] = "Fecha<br>Desde"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha_hasta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha_hasta'] = "Fecha<br>Hasta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['dias_desde']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['dias_desde'] = "Días<br>Mes<br>Actual "; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['dias_hasta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['dias_hasta'] = "Días<br>Mes<br>Siguiente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['dias_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['dias_periodo'] = "Dias<br>Totales<br>Período"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha_desde_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha_desde_factura'] = " Facturación<br>Desde"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha_hasta_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha_hasta_factura'] = " Facturación<br>Hasta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['monto_uf']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['monto_uf'] = "Monto<br>Facturación<br>Neto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['iva'] = "Monto<br>Facturación Con IVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['produccion_neto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['produccion_neto'] = "Monto<br>Producción<br>Neto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['reajuste']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['reajuste'] = "Reajuste<br>Neto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['retencion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['retencion'] = "Retención<br>Neto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['multa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['multa'] = "Multa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance_informado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance_informado'] = "Producción<br> Informada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance'] = "Producción<br>Total "; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance_periodo'] = "Producción<br>Mes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance_periodo_siguiente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance_periodo_siguiente'] = "Avance<br>Mes<br>Siguiente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['facturado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['facturado'] = "Estado<br>Facturación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['factura'] = "Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['fecha'] = "Fecha <br>Facturación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['facturado_obs']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['facturado_obs'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['detalle_partida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['detalle_partida'] = "Detalle Partida <br>Facturación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['hitos_asociados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['hitos_asociados'] = "Hitos Contractuales<br> Asociados"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['historial_facturacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['historial_facturacion'] = "Historial Facturación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['id'] = "ID<br>Período"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['id_proyecto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['id_proyecto'] = "Proyecto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['vigente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['vigente'] = "Vigente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['observaciones'] = "Observaciones Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['orden']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['orden'] = "Orden"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['valor_uf']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['valor_uf'] = "Valor UF Día"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['factor_produccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['factor_produccion'] = "Factor Produccion<Br>Mes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance_periodo_anterior']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['avance_periodo_anterior'] = "Avance Periodo Anterior"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['produccion_total_final']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['produccion_total_final'] = "Produccion<br>Total<br>Período"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['total_facturado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['total_facturado'] = "Total Facturado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['total_facturado_ur']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['total_facturado_ur'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['id_partida_num']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['labels']['id_partida_num'] = "Id Partida Número"; 
       }
       //-----
       $this->comp_field_nm = array(
           'id_partida' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_order']['por_periodo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_order']['por_periodo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_order']['por_periodo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_display']['por_periodo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_display']['por_periodo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_display']['por_periodo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_display']['por_periodo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_display']['por_periodo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_display']['por_periodo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['summarizing_fields_display']['por_periodo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_id_partida as $i_id_partida => $d_id_partida) {
           if (!isset($i_id_partida, $this->comp_label[0]) || !in_array($i_id_partida, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_id_partida[2] ] = $d_id_partida[1];
               $this->comp_label[0][ $d_id_partida[2] ] = $d_id_partida[1];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_id_partida => $l_id_partida) {
           if (isset($this->array_total_id_partida[$i_id_partida])) {
               $this->comp_group[$i_id_partida] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_id_partida;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_prod_presupuesto_periodo@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_prod_presupuesto_periodo_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_por_periodo("res", $this->NM_export);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_id_partida)) {
          ksort($this->array_total_id_partida);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_presupuesto_periodo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_prod_presupuesto_periodo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_presupuesto_periodo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_prod_presupuesto_periodo/grid_prod_presupuesto_periodo_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_prod_presupuesto_periodo_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_prod_presupuesto_periodo_config_pivot.php?nome_apl=grid_prod_presupuesto_periodo&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("<SCRIPT language=\"Javascript\">\r\n");
      ...
      $nm_saida->saida("           document.Fexport.nmgp_password.value = password;\r\n");
      $nm_saida->saida("           document.Fexport.SC_module_export.value = SC_module_export;\r\n");
      $nm_saida->saida("               document.Fexport.action = \"grid_prod_presupuesto_periodo_export_ctrl.php\";\r\n");
      $nm_saida->saida("           document.Fexport.submit() ;\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_prod_presupuesto_periodo_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_prod_presupuesto_periodo_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_prod_presupuesto_periodo/grid_prod_presupuesto_periodo_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $id_proyecto = (isset($Busca_temp['id_proyecto'])) ? $Busca_temp['id_proyecto'] : ""; 
          $tmp_pos = (is_string($id_proyecto)) ? strpos($id_proyecto, "##@@") : false;
          if ($tmp_pos !== false && !is_array($id_proyecto))
          {
              $id_proyecto = substr($id_proyecto, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_id_partida, $quebra_id_partida_orig)
   {
      //----- Período
      if (!isset($this->array_total_id_partida[$quebra_id_partida_orig]))
      {
         $this->array_total_id_partida[$quebra_id_partida_orig][0] = 1;
         $this->array_total_id_partida[$quebra_id_partida_orig][1] = $quebra_id_partida;
         $this->array_total_id_partida[$quebra_id_partida_orig][2] = $quebra_id_partida_orig;
      }
      else
      {
         $this->array_total_id_partida[$quebra_id_partida_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->id_proyecto = $Busca_temp['id_proyecto']; 
       $this->id_proyecto = (isset($Busca_temp['id_proyecto'])) ? $Busca_temp['id_proyecto'] : ""; 
       $tmp_pos = (is_string($this->id_proyecto)) ? strpos($this->id_proyecto, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->id_proyecto))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('por_periodo', 'id_partida');
     $campos_order = $this->Ini->Get_date_order_groupby("id_partida", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->id_partida = $rs_res->fields[0] ;  
            $this->fecha_desde = $rs_res->fields[1] ;  
            $this->fecha_hasta = $rs_res->fields[2] ;  
            $this->dias_desde = $rs_res->fields[3] ;  
            $this->dias_hasta = $rs_res->fields[4] ;  
            $this->dias_periodo = $rs_res->fields[5] ;  
            $this->fecha_desde_factura = $rs_res->fields[6] ;  
            $this->fecha_hasta_factura = $rs_res->fields[7] ;  
            $this->monto_uf = $rs_res->fields[8] ;  
            $this->monto_uf =  str_replace(",", ".", $this->monto_uf);
            $this->produccion_neto = $rs_res->fields[9] ;  
            $this->produccion_neto =  str_replace(",", ".", $this->produccion_neto);
            $this->reajuste = $rs_res->fields[10] ;  
            $this->reajuste =  str_replace(",", ".", $this->reajuste);
            $this->retencion = $rs_res->fields[11] ;  
            $this->retencion =  str_replace(",", ".", $this->retencion);
            $this->multa = $rs_res->fields[12] ;  
            $this->multa =  str_replace(",", ".", $this->multa);
            $this->avance_informado = $rs_res->fields[13] ;  
            $this->avance_informado =  str_replace(",", ".", $this->avance_informado);
            $this->avance = $rs_res->fields[14] ;  
            $this->avance =  str_replace(",", ".", $this->avance);
            $this->avance_periodo = $rs_res->fields[15] ;  
            $this->avance_periodo =  str_replace(",", ".", $this->avance_periodo);
            $this->avance_periodo_siguiente = $rs_res->fields[16] ;  
            $this->avance_periodo_siguiente =  str_replace(",", ".", $this->avance_periodo_siguiente);
            $this->facturado = $rs_res->fields[17] ;  
            $this->factura = $rs_res->fields[18] ;  
            $this->fecha = $rs_res->fields[19] ;  
            $this->id = $rs_res->fields[20] ;  
            $this->id_proyecto = $rs_res->fields[21] ;  
            $this->observaciones = $rs_res->fields[22] ;  
            $this->produccion_total_final = $rs_res->fields[23] ;  
...
$_SESSION['scriptcase']['grid_prod_presupuesto_periodo']['contr_erro'] = 'off'; 
            $this->id_partida_orig = $this->id_partida;
            $this->id_partida = $this->look_id_partida ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->id_partida, $this->id_partida_orig);
            }
   }
//
