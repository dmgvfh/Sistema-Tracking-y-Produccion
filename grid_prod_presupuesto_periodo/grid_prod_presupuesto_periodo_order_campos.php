<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_prod_presupuesto_periodo']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_prod_presupuesto_periodo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_presupuesto_periodo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_partida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["id_partida"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["id_partida"] : "Período";
   ...
   $tab_labels["monto_disponible"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["monto_disponible"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["monto_disponible"] : "Presupuesto<br>BASE";
   $tab_ger_campos['fecha_desde'] = "on";
   $tab_def_campos['fecha_desde'] = "fecha_desde";
   $tab_labels["fecha_desde"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha_desde"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha_desde"] : "Fecha<br>Desde";
   $tab_ger_campos['fecha_hasta'] = "on";
   $tab_def_campos['fecha_hasta'] = "fecha_hasta";
   $tab_labels["fecha_hasta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha_hasta"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha_hasta"] : "Fecha<br>Hasta";
   $tab_ger_campos['dias_desde'] = "on";
   $tab_def_campos['dias_desde'] = "dias_desde";
   $tab_labels["dias_desde"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["dias_desde"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["dias_desde"] : "Días<br>Mes<br>Actual ";
   $tab_ger_campos['dias_hasta'] = "on";
   $tab_def_campos['dias_hasta'] = "dias_hasta";
   $tab_labels["dias_hasta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["dias_hasta"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["dias_hasta"] : "Días<br>Mes<br>Siguiente";
   $tab_ger_campos['dias_periodo'] = "on";
   $tab_def_campos['dias_periodo'] = "dias_periodo";
   $tab_labels["dias_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["dias_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["dias_periodo"] : "Dias<br>Totales<br>Período";
   $tab_ger_campos['fecha_desde_factura'] = "on";
   $tab_def_campos['fecha_desde_factura'] = "fecha_desde_factura";
   $tab_labels["fecha_desde_factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha_desde_factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha_desde_factura"] : " Facturación<br>Desde";
   $tab_ger_campos['fecha_hasta_factura'] = "on";
   $tab_def_campos['fecha_hasta_factura'] = "fecha_hasta_factura";
   $tab_labels["fecha_hasta_factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha_hasta_factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha_hasta_factura"] : " Facturación<br>Hasta";
   $tab_ger_campos['monto_uf'] = "on";
   $tab_def_campos['monto_uf'] = "monto_uf";
   $tab_labels["monto_uf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["monto_uf"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["monto_uf"] : "Monto<br>Facturación<br>Neto";
   $tab_ger_campos['iva'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['iva'] = "iva";
   }
   else
   {
       $tab_def_campos['iva'] = "";
   }
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["iva"] : "Monto<br>Facturación Con IVA";
   $tab_ger_campos['produccion_neto'] = "on";
   $tab_def_campos['produccion_neto'] = "produccion_neto";
   $tab_labels["produccion_neto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["produccion_neto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["produccion_neto"] : "Monto<br>Producción<br>Neto";
   $tab_ger_campos['reajuste'] = "on";
   $tab_def_campos['reajuste'] = "reajuste";
   $tab_labels["reajuste"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["reajuste"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["reajuste"] : "Reajuste<br>Neto";
   $tab_ger_campos['retencion'] = "on";
   $tab_def_campos['retencion'] = "retencion";
   $tab_labels["retencion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["retencion"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["retencion"] : "Retención<br>Neto";
   $tab_ger_campos['multa'] = "on";
   $tab_def_campos['multa'] = "multa";
   $tab_labels["multa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["multa"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["multa"] : "Multa";
   $tab_ger_campos['avance_informado'] = "on";
   $tab_def_campos['avance_informado'] = "avance_informado";
   $tab_labels["avance_informado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["avance_informado"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["avance_informado"] : "Producción<br> Informada";
   $tab_ger_campos['avance'] = "on";
   $tab_def_campos['avance'] = "avance";
   $tab_labels["avance"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["avance"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["avance"] : "Producción<br>Total ";
   $tab_ger_campos['avance_periodo'] = "on";
   $tab_def_campos['avance_periodo'] = "avance_periodo";
   $tab_labels["avance_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["avance_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["avance_periodo"] : "Producción<br>Mes";
   $tab_ger_campos['avance_periodo_siguiente'] = "on";
   $tab_def_campos['avance_periodo_siguiente'] = "avance_periodo_siguiente";
   $tab_labels["avance_periodo_siguiente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["avance_periodo_siguiente"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["avance_periodo_siguiente"] : "Avance<br>Mes<br>Siguiente";
   $tab_ger_campos['facturado'] = "on";
   $tab_def_campos['facturado'] = "facturado";
   $tab_labels["facturado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["facturado"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["facturado"] : "Estado<br>Facturación";
   $tab_ger_campos['factura'] = "on";
   $tab_def_campos['factura'] = "factura";
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["factura"] : "Factura";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["fecha"] : "Fecha <br>Facturación";
   ...
   $tab_labels["facturado_obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["facturado_obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['labels']["facturado_obs"] : "Observaciones";
   $tab_ger_campos['monto_disponible'] = "none";
   $tab_ger_campos['iva'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_presupuesto_periodo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
