  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_portafolio" == sTestField)
        {
...
?>
  ...
  // ---------- Validate nombre_portafolio
  function do_ajax_form_portafolio_validate_nombre_portafolio()
  {
    var nomeCampo_nombre_portafolio = "nombre_portafolio";
    var var_nombre_portafolio = scAjaxGetFieldText(nomeCampo_nombre_portafolio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_portafolio_validate_nombre_portafolio(var_nombre_portafolio, var_script_case_init, do_ajax_form_portafolio_validate_nombre_portafolio_cb);
  } // do_ajax_form_portafolio_validate_nombre_portafolio

  function do_ajax_form_portafolio_validate_nombre_portafolio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_portafolio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_portafolio_validate_nombre_portafolio_cb

  // ---------- Validate potafolio_unidades
  function do_ajax_form_portafolio_validate_potafolio_unidades()
  {
    var nomeCampo_potafolio_unidades = "potafolio_unidades";
    nm_pack(nomeCampo_potafolio_unidades + '_dest', nomeCampo_potafolio_unidades);
    var var_potafolio_unidades = scAjaxGetFieldText(nomeCampo_potafolio_unidades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_portafolio_validate_potafolio_unidades(var_potafolio_unidades, var_script_case_init, do_ajax_form_portafolio_validate_potafolio_unidades_cb);
  } // do_ajax_form_portafolio_validate_potafolio_unidades

  function do_ajax_form_portafolio_validate_potafolio_unidades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "potafolio_unidades";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_portafolio_validate_potafolio_unidades_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_portafolio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_portafolio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre_portafolio = scAjaxGetFieldText("nombre_portafolio");
    nm_pack("potafolio_unidades_dest", "potafolio_unidades");
    var var_potafolio_unidades = scAjaxGetFieldText("potafolio_unidades", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_form_portafolio_submit_form(var_nombre_portafolio, var_potafolio_unidades, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_portafolio_submit_form_cb);
  } // do_ajax_form_portafolio_submit_form

  function do_ajax_form_portafolio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nombre_portafolio");
      scAjaxHideErrorDisplay("potafolio_unidades");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_portafolio_submit_form_cb_after_alert);
  } // do_ajax_form_portafolio_submit_form_cb
  function do_ajax_form_portafolio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_portafolio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_portafolio_navigate_form()
  {
    perform_ajax_form_portafolio_navigate_form();
  }

  function perform_ajax_form_portafolio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_portafolio_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_portafolio_navigate_form_cb);
  } // do_ajax_form_portafolio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_portafolio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_portafolio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_portafolio_navigate_form_cb_after_alert);
  } // do_ajax_form_portafolio_navigate_form_cb
  function do_ajax_form_portafolio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_portafolio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_portafolio_navigate_form_cb_after_alert

  function sc_hide_form_portafolio_form()
  {
  ...
  ajax_field_list[0] = "nombre_portafolio";
  ajax_field_list[1] = "potafolio_unidades";
  ...
  var ajax_error_list = {
    "nombre_portafolio": {"label": "Nombre Portafolio (Centro de Negocio)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "potafolio_unidades": {"label": "Unidades Org. Asociadas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "nombre_portafolio": new Array(),
    "potafolio_unidades": new Array()
  };
  ajax_field_mult["nombre_portafolio"][1] = "nombre_portafolio";
  ajax_field_mult["potafolio_unidades"][1] = "potafolio_unidades";

  var ajax_field_id = {
    "nombre_portafolio": new Array("hidden_field_label_nombre_portafolio", "hidden_field_data_nombre_portafolio"),
    "potafolio_unidades": new Array("hidden_field_label_potafolio_unidades", "hidden_field_data_potafolio_unidades")
  };

  var ajax_read_only = {
    "nombre_portafolio": "off",
    "potafolio_unidades": "off"
  };
