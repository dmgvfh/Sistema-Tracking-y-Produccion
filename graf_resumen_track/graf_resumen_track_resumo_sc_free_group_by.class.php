...
class graf_resumen_track_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_appointment_status_appointment_status_descr;
   var $array_total_sec_users_name;
   var $array_total_proyectos_nombre_proyecto;
   var $array_total_tipo_actividades_nombre_actividad;
   ...
   var $sc_proc_quebra_appointment_status_appointment_status_descr;
   var $count_appointment_status_appointment_status_descr;
   var $sum_appointment_status_appointment_status_descr_appointments_intervalo;
   var $sc_proc_quebra_sec_users_name;
   var $count_sec_users_name;
   var $sum_sec_users_name_appointments_intervalo;
   var $sc_proc_quebra_proyectos_nombre_proyecto;
   var $count_proyectos_nombre_proyecto;
   var $sum_proyectos_nombre_proyecto_appointments_intervalo;
   var $sc_proc_quebra_tipo_actividades_nombre_actividad;
   var $count_tipo_actividades_nombre_actividad;
   var $sum_tipo_actividades_nombre_actividad_appointments_intervalo;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_appointment_status_appointment_status_descr = array();
      $this->array_total_sec_users_name                              = array();
      $this->array_total_proyectos_nombre_proyecto                   = array();
      $this->array_total_tipo_actividades_nombre_actividad           = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['graf_resumen_track'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['graf_resumen_track'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['graf_resumen_track']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['graf_resumen_track']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['graf_resumen_track']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_step']     = 'image';
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_step'] = 'end';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['graf_resumen_track']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['orig_pesq'] = "resumo";
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca'];
       ...
       $this->appointments_appointment_start_date_2 = $appointments_appointment_start_date_2; 
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_type']        = 'column3d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_field'] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_rule_groupby']["appointments_appointment_start_date"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_field_groupby']["appointments_appointment_start_date"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_rule_groupby']["appointment_status_appointment_status_descr"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_field_groupby']["appointment_status_appointment_status_descr"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_rule_groupby']["sec_users_name"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_field_groupby']["sec_users_name"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_rule_groupby']["proyectos_nombre_proyecto"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_field_groupby']["proyectos_nombre_proyecto"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_rule_groupby']["tipo_actividades_nombre_actividad"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_combination_order_field_groupby']["tipo_actividades_nombre_actividad"] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys'][1] = 1;
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys'][2] = 2;
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys'][3] = 3;
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys'][4] = 4;

           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp']["appointments_appointment_start_date"] = 'appointments_appointment_start_date';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp']["appointment_status_appointment_status_descr"] = 'appointment_status_appointment_status_descr';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp']["sec_users_name"] = 'sec_users_name';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp']["proyectos_nombre_proyecto"] = 'proyectos_nombre_proyecto';
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp']["tipo_actividades_nombre_actividad"] = 'tipo_actividades_nombre_actividad';
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['comb_field_display_type'][2] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_display_values'][2] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_order']['sc_free_group_by'][] = 2;
       }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("graf_resumen_track", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral(false, $this->NM_export);
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_total']['appointments_appointment_start_date'] = $this->array_total_appointments_appointment_start_date;
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_total']['appointment_status_appointment_status_descr'] = $this->array_total_appointment_status_appointment_status_descr;
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_total']['sec_users_name'] = $this->array_total_sec_users_name;
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_total']['proyectos_nombre_proyecto'] = $this->array_total_proyectos_nombre_proyecto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_total']['tipo_actividades_nombre_actividad'] = $this->array_total_tipo_actividades_nombre_actividad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['json_use_label'])
       {
          $Lab_appointments_appointment_start_date = "appointments.appointment_start_date";
          $Lab_appointment_status_appointment_status_descr = "appointment_status.appointment_status_descr";
          $Lab_sec_users_name = "sec_users.name";
          $Lab_proyectos_nombre_proyecto = "proyectos.nombre_proyecto";
          $Lab_tipo_actividades_nombre_actividad = "tipo_actividades.nombre_actividad";
       }
       else
       {
       $Lab_appointments_appointment_start_date = "Fecha Actividad";
       $Lab_appointments_appointment_start_date =  sprintf("" . $this->Ini->Nm_lang['lang_othr_chart_title_YYYYMM'] . "  - Fecha Actividad", $Lab_appointments_appointment_start_date);
       $Lab_appointment_status_appointment_status_descr = "Estado";
       $Lab_sec_users_name = "Usuario";
       $Lab_proyectos_nombre_proyecto = "Proyecto";
       $Lab_tipo_actividades_nombre_actividad = "Nombre Actividad";
       }
       $prep_field = array();
       $prep_field['appointments_appointment_start_date'] = $Lab_appointments_appointment_start_date;
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_start_date'] = $Lab_appointments_appointment_start_date; 
       $prep_field['appointment_status_appointment_status_descr'] = $Lab_appointment_status_appointment_status_descr;
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointment_status_appointment_status_descr'] = $Lab_appointment_status_appointment_status_descr; 
       $prep_field['sec_users_name'] = $Lab_sec_users_name;
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['sec_users_name'] = $Lab_sec_users_name; 
       $prep_field['proyectos_nombre_proyecto'] = $Lab_proyectos_nombre_proyecto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['proyectos_nombre_proyecto'] = $Lab_proyectos_nombre_proyecto; 
       $prep_field['tipo_actividades_nombre_actividad'] = $Lab_tipo_actividades_nombre_actividad;
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['tipo_actividades_nombre_actividad'] = $Lab_tipo_actividades_nombre_actividad; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointments_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointments_id'] = "Appointments Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_start_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_start_date'] = "Appointment Start Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_start_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_start_time'] = "Appointment Start Time"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_end_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_end_date'] = "Appointment End Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_end_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_end_time'] = "Appointment End Time"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_recurrent']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_recurrent'] = "Appointment Recurrent"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_period']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_appointment_period'] = "Appointment Period"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_intervalo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointments_intervalo'] = "Intervalo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointment_status_appointment_status_descr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['appointment_status_appointment_status_descr'] = "Appointment Status Descr"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['tipo_actividades_nombre_actividad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['tipo_actividades_nombre_actividad'] = "Nombre Actividad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['sec_users_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['sec_users_name'] = "Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['proyectos_nombre_proyecto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['labels']['proyectos_nombre_proyecto'] = "Nombre Proyecto"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['appointments_appointment_start_date']['alin'] = "''";
       $Arr_parms['appointments_appointment_start_date']['link'] = "S";
       $Arr_parms['appointment_status_appointment_status_descr']['alin'] = "''";
       $Arr_parms['appointment_status_appointment_status_descr']['link'] = "S";
       $Arr_parms['sec_users_name']['alin'] = "''";
       $Arr_parms['sec_users_name']['link'] = "S";
       $Arr_parms['proyectos_nombre_proyecto']['alin'] = "''";
       $Arr_parms['proyectos_nombre_proyecto']['link'] = "S";
       $Arr_parms['tipo_actividades_nombre_actividad']['alin'] = "''";
       $Arr_parms['tipo_actividades_nombre_actividad']['link'] = "S";
       $Arr_parms['appointments_appointment_start_date']['fill'] = "true";
       $Arr_parms['appointments_appointment_start_date']['order'] = "value";
       $Arr_parms['appointments_appointment_start_date']['order_start'] = 'asc';
       $Arr_parms['appointments_appointment_start_date']['order_invert'] = 'false';
       $Arr_parms['appointments_appointment_start_date']['order_enabled'] = 'true';
       $Arr_parms['appointments_appointment_start_date']['order_datatype'] = 'date';
       $Arr_parms['appointments_appointment_start_date']['rating_function'] = '';
       $Arr_parms['appointment_status_appointment_status_descr']['fill'] = "true";
       $Arr_parms['appointment_status_appointment_status_descr']['order'] = "label";
       $Arr_parms['appointment_status_appointment_status_descr']['order_start'] = 'asc';
       $Arr_parms['appointment_status_appointment_status_descr']['order_invert'] = 'false';
       $Arr_parms['appointment_status_appointment_status_descr']['order_enabled'] = 'true';
       $Arr_parms['appointment_status_appointment_status_descr']['order_datatype'] = 'varchar';
       $Arr_parms['appointment_status_appointment_status_descr']['rating_function'] = '';
       $Arr_parms['sec_users_name']['fill'] = "true";
       $Arr_parms['sec_users_name']['order'] = "label";
       $Arr_parms['sec_users_name']['order_start'] = 'asc';
       $Arr_parms['sec_users_name']['order_invert'] = 'false';
       $Arr_parms['sec_users_name']['order_enabled'] = 'true';
       $Arr_parms['sec_users_name']['order_datatype'] = 'varchar';
       $Arr_parms['sec_users_name']['rating_function'] = '';
       $Arr_parms['proyectos_nombre_proyecto']['fill'] = "true";
       $Arr_parms['proyectos_nombre_proyecto']['order'] = "label";
       $Arr_parms['proyectos_nombre_proyecto']['order_start'] = 'asc';
       $Arr_parms['proyectos_nombre_proyecto']['order_invert'] = 'false';
       $Arr_parms['proyectos_nombre_proyecto']['order_enabled'] = 'true';
       $Arr_parms['proyectos_nombre_proyecto']['order_datatype'] = 'varchar';
       $Arr_parms['proyectos_nombre_proyecto']['rating_function'] = '';
       $Arr_parms['tipo_actividades_nombre_actividad']['fill'] = "true";
       $Arr_parms['tipo_actividades_nombre_actividad']['order'] = "label";
       $Arr_parms['tipo_actividades_nombre_actividad']['order_start'] = 'asc';
       $Arr_parms['tipo_actividades_nombre_actividad']['order_invert'] = 'false';
       $Arr_parms['tipo_actividades_nombre_actividad']['order_enabled'] = 'true';
       $Arr_parms['tipo_actividades_nombre_actividad']['order_datatype'] = 'varchar';
       $Arr_parms['tipo_actividades_nombre_actividad']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['appointments_appointment_start_date'] = array(0 => 'appointments_appointment_start_date', 1 => '@aspass@');
       $prep_links_fl['appointment_status_appointment_status_descr'] = array(0 => 'appointment_status_appointment_status_descr', 1 => '@aspass@');
       $prep_links_fl['sec_users_name'] = array(0 => 'sec_users_name', 1 => '@aspass@');
       $prep_links_fl['proyectos_nombre_proyecto'] = array(0 => 'proyectos_nombre_proyecto', 1 => '@aspass@');
       $prep_links_fl['tipo_actividades_nombre_actividad'] = array(0 => 'tipo_actividades_nombre_actividad', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@graf_resumen_track@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'appointments_appointment_start_date' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'appointments_appointment_start_date',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_appointments_appointment_start_date)),
               'label_y'  => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'appointment_status_appointment_status_descr' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'appointment_status_appointment_status_descr',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_appointment_status_appointment_status_descr)),
               'label_y'  => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'sec_users_name' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'sec_users_name',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_sec_users_name)),
               'label_y'  => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'proyectos_nombre_proyecto' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'proyectos_nombre_proyecto',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_proyectos_nombre_proyecto)),
               'label_y'  => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'tipo_actividades_nombre_actividad' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'tipo_actividades_nombre_actividad',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_tipo_actividades_nombre_actividad)),
               'label_y'  => $this->getChartText(strip_tags("Intervalo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_graf_resumen_track_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_graf_resumen_track_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['anlt_table_def']  = array();
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
				if ($fieldData['display']) {
					$displayedSummarizations[] = $fieldIndex;
				}
			}

			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if (!in_array($summarizingLevel + 1, $displayedSummarizations)) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts'][$chartIndex]);
				}
			}

			$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts'];
		}
	}
	...
	function filterChartsByMultiseries() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_level']) {
			$applyFilter = true;
		}
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_graf_resumen_track_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_graf_resumen_track_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['graf_resumen_track']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['graf_resumen_track']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['graf_resumen_track']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['graf_resumen_track']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "graf_resumen_track_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new graf_resumen_track_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Horas De Actividades Por Período</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"graf_resumen_track_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"graf_resumen_track_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"graf_resumen_track_message.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_graf_resumen_track_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_graf_resumen_track_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_graf_resumen_track_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "graf_resumen_track/graf_resumen_track_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
$nm_saida->saida(".sc-chart-type-button img { filter: grayscale(100%) }\r\n");
$nm_saida->saida(".sc-chart-type-button.selected img { filter: none }\r\n");
$nm_saida->saida(".sc-chart-type-button.disabled img { filter: alpha(opacity=20); opacity:0.2 }\r\n");
      $nm_saida->saida(" </style>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['embutida'])
      {
      ...
      $nm_saida->saida("function scChartPrintExportShow(exportType) {\r\n");
          $nm_saida->saida("  scShowCombinationPrint(0, exportType, \"color\");\r\n");
      $nm_saida->saida("}\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      {
          $Cod_Btn = nmButtonGroupOutput($this->arr_buttons, "group_group_1", 'ini');
          $nm_saida->saida("           $Cod_Btn\r\n");
         $nm_saida->saida("     <script type=\"text/javascript\">\r\n");
         ...
         if ($this->nmgp_botoes['chart_pizza'] == 'on') {
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_pizza", "scChangeChartTypeButton('pie2d');", "scChangeChartTypeButton('pie2d');", "chart_pizza_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "sc-chart-type-button", "", "", "only_text", "text_right", "", "", "", "", "", "", " last=last");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
         }
          $Cod_Btn = nmButtonGroupOutput($this->arr_buttons, "group_group_1", 'fim');
          $nm_saida->saida("           $Cod_Btn\r\n");
      }
         $nm_saida->saida("     </TD> \r\n");
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "graf_resumen_track/graf_resumen_track_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=n&nm_tem_gb=s&nm_res_cons=n&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=es&conf_socor=N&is_chart_app=Y&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=graf_resumen_track&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "scChartPrintExportShow('direct')", "scChartPrintExportShow('direct')", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $this->nm_btn_exist['filter'][] = "Rpesq_top";
         ...
         if (is_file("graf_resumen_track_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("graf_resumen_track_help.txt"); 
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'graf_resumen_track_config_pivot.php?nome_apl=graf_resumen_track&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"graf_resumen_track_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("<SCRIPT language=\"Javascript\">\r\n");
          ...
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "graf_resumen_track/graf_resumen_track_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\" + str_type +\"&sAdd=__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_tp_xls=\" + tp_xls + \"__E__nmgp_tot_xls=\" + tot_xls + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
          ...
          $nm_saida->saida("       document.Fexport.action = \"graf_resumen_track_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['graf_resumen_track_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@graf_resumen_track@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
          ...
          $nm_saida->saida("          document.Fres_pdf.action = \"graf_resumen_track_iframe.php\";\r\n");
...
;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_graf_resumen_track_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "graf_resumen_track/graf_resumen_track_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['skip_charts']))
   {
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts'] as $chart_index => $chart_data)
       {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               graf_resumen_track_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if ($bChartFP)
       {
           ...
           graf_resumen_track_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new graf_resumen_track_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           graf_resumen_track_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           graf_resumen_track_pdf_progress_call("\n", $this->Ini->Nm_lang);
           graf_resumen_track_pdf_progress_call("\n", $this->Ini->Nm_lang);
           graf_resumen_track_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   graf_resumen_track_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>Horas De Actividades Por Período</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_appointments_intervalo, $quebra_appointments_appointment_start_date, $quebra_appointment_status_appointment_status_descr, $quebra_sec_users_name, $quebra_proyectos_nombre_proyecto, $quebra_tipo_actividades_nombre_actividad, $quebra_appointments_appointment_start_date_orig, $quebra_appointment_status_appointment_status_descr_orig, $quebra_sec_users_name_orig, $quebra_proyectos_nombre_proyecto_orig, $quebra_tipo_actividades_nombre_actividad_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_appointments_intervalo)) {$sum_appointments_intervalo = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_appointments_intervalo . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_appointments_intervalo . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT appointments.appointment_start_date as cmp_maior_30_1, appointments.intervalo as appointments_intervalo, appointment_status.appointment_status_descr as cmp_maior_30_2, tipo_actividades.nombre_actividad as cmp_maior_30_3, sec_users.name as sec_users_name, proyectos.nombre_proyecto as proyectos_nombre_proyecto from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT appointments.appointment_start_date as cmp_maior_30_1, appointments.intervalo as appointments_intervalo, appointment_status.appointment_status_descr as cmp_maior_30_2, tipo_actividades.nombre_actividad as cmp_maior_30_3, sec_users.name as sec_users_name, proyectos.nombre_proyecto as proyectos_nombre_proyecto from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->appointments_appointment_start_date = $rs_res->fields[0] ;  
            $this->appointments_intervalo = $rs_res->fields[1] ;  
            $this->appointments_intervalo =  str_replace(",", ".", $this->appointments_intervalo);
            $this->appointment_status_appointment_status_descr = $rs_res->fields[2] ;  
            $this->tipo_actividades_nombre_actividad = $rs_res->fields[3] ;  
            $this->sec_users_name = $rs_res->fields[4] ;  
            $this->proyectos_nombre_proyecto = $rs_res->fields[5] ;  
            $this->appointments_appointment_start_date_orig = $this->appointments_appointment_start_date;
            $this->appointment_status_appointment_status_descr_orig = $this->appointment_status_appointment_status_descr;
            $this->sec_users_name_orig = $this->sec_users_name;
            $this->proyectos_nombre_proyecto_orig = $this->proyectos_nombre_proyecto;
            $this->tipo_actividades_nombre_actividad_orig = $this->tipo_actividades_nombre_actividad;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->appointments_intervalo, $this->appointments_appointment_start_date, $this->appointment_status_appointment_status_descr, $this->sec_users_name, $this->proyectos_nombre_proyecto, $this->tipo_actividades_nombre_actividad, $this->appointments_appointment_start_date_orig,  $this->appointment_status_appointment_status_descr_orig,  $this->sec_users_name_orig,  $this->proyectos_nombre_proyecto_orig,  $this->tipo_actividades_nombre_actividad_orig);
            }
   }
//
