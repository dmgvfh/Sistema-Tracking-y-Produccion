<?php
@session_start() ;
$_SESSION['scriptcase']['graf_resumen_track']['sc_process_barr'] = true;
require_once('../graf_resumen_track/index.php');
unset($_SESSION['scriptcase']['graf_resumen_track']['sc_process_barr']);
$ExportCtrl = new graf_resumen_track_export_control;
$ExportCtrl->Export_barr();

class graf_resumen_track_export_control
{
