...
class graf_resumen_track_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . graf_resumen_track_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . graf_resumen_track_pack_protect_string($Tipo_filter[0]) . "\">.." . graf_resumen_track_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "appointments_appointments_id";$Nm_numeric[] = "appointments_intervalo";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Horas De Actividades Por Período</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>graf_resumen_track/graf_resumen_track_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="graf_resumen_track_ajax_search.js"></script>
 <script type="text/javascript" src="graf_resumen_track_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="graf_resumen_track_message.js"></script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Horas De Actividades Por Período</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $appointments_appointment_start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_dia']; 
          $appointments_appointment_start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_mes']; 
          $appointments_appointment_start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_ano']; 
          $appointments_appointment_start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_input_2_dia']; 
          $appointments_appointment_start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_input_2_mes']; 
          $appointments_appointment_start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_input_2_ano']; 
          $appointments_appointment_start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_appointments_appointment_start_date_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['appointments_appointment_start_date'])) ? $this->New_label['appointments_appointment_start_date'] : "Appointment Start Date"; ?></TD>
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_appointments_appointment_start_date" <?php echo $str_hide_appointments_appointment_start_date?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['appointments_appointment_start_date'])) ? $this->New_label['appointments_appointment_start_date'] : "Appointment Start Date";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_appointments_appointment_start_date"  <?php echo $str_display_appointments_appointment_start_date; ?> class="scFilterFieldFontOdd">
...
?>
<?php
   if (is_file("graf_resumen_track_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['graf_resumen_track']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['graf_resumen_track']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_appointments_appointment_start_date_dia').bind('change', function() {sc_graf_resumen_track_valida_dia(this)});
    $('#SC_appointments_appointment_start_date_input_2_dia').bind('change', function() {sc_graf_resumen_track_valida_dia(this)});
    $('#SC_appointments_appointment_start_date_input_2_mes').bind('change', function() {sc_graf_resumen_track_valida_mes(this)});
    $('#SC_appointments_appointment_start_date_mes').bind('change', function() {sc_graf_resumen_track_valida_mes(this)});
 }
 function sc_graf_resumen_track_valida_dia(obj)
 {
 ...
 function sc_graf_resumen_track_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/graf_resumen_track";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $appointments_appointment_start_date_cond, $appointments_appointment_start_date, $appointments_appointment_start_date_dia, $appointments_appointment_start_date_mes, $appointments_appointment_start_date_ano, $appointments_appointment_start_date_input_2_dia, $appointments_appointment_start_date_input_2_mes, $appointments_appointment_start_date_input_2_ano, $nmgp_tab_label;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_dia'] = $appointments_appointment_start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_mes'] = $appointments_appointment_start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_ano'] = $appointments_appointment_start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_input_2_dia'] = $appointments_appointment_start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_input_2_mes'] = $appointments_appointment_start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_input_2_ano'] = $appointments_appointment_start_date_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_cond'] = $appointments_appointment_start_date_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($appointments_appointment_start_date_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date'] = $val[0];
          ...
          if ($appointments_appointment_start_date_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']['appointments_appointment_start_date_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['graf_resumen_track']['cond_pesq'] .= $this->NM_operador;
