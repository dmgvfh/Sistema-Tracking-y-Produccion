...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____graf_resumen_track"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____graf_resumen_track"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['graf_resumen_track']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['graf_resumen_track']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['graf_resumen_track']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['graf_resumen_track']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['graf_resumen_track']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>graf_resumen_track</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['graf_resumen_track']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['graf_resumen_track']['embutida_filho'] as $ind => $sc_init)
          {
