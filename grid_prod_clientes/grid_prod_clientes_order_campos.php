<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_prod_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_prod_clientes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_clientes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['nombre_legal'] = "on";
   $tab_def_campos['nombre_legal'] = "nombre_legal";
   $tab_labels["nombre_legal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["nombre_legal"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["nombre_legal"] : "Nombre Legal";
   $tab_ger_campos['rut'] = "on";
   $tab_def_campos['rut'] = "rut";
   $tab_labels["rut"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["rut"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["rut"] : "Rut";
   $tab_ger_campos['giro'] = "on";
   $tab_def_campos['giro'] = "giro";
   $tab_labels["giro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["giro"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["giro"] : "Giro";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['contacto'] = "on";
   $tab_def_campos['contacto'] = "contacto";
   $tab_labels["contacto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["contacto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["contacto"] : "Contacto";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["email"] : "Email";
   $tab_ger_campos['telefono'] = "on";
   $tab_def_campos['telefono'] = "telefono";
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["telefono"] : "Telefono";
   $tab_ger_campos['contacto2'] = "on";
   $tab_def_campos['contacto2'] = "contacto2";
   $tab_labels["contacto2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["contacto2"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["contacto2"] : "Contacto 2";
   $tab_ger_campos['email2'] = "on";
   $tab_def_campos['email2'] = "email2";
   $tab_labels["email2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["email2"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["email2"] : "Email 2";
   $tab_ger_campos['telefono2'] = "on";
   $tab_def_campos['telefono2'] = "telefono2";
   $tab_labels["telefono2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["telefono2"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['labels']["telefono2"] : "Telefono 2";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> Clientes</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_clientes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_clientes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
