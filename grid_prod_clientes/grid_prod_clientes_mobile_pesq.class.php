...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_email_cond" name="email_cond" onChange="nm_campos_between(document.getElementById('id_vis_email'), this, 'email')">
      ...
      <br><span id="id_hide_email"  <?php echo $str_hide_email?>><?php
      if ($email != "")
      {
      $email_look = (is_string($email) ? substr($this->Db->qstr($email), 1, -1) : $email); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nombre_cond" name="nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre'), this, 'nombre')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_direccion_cond" name="direccion_cond" onChange="nm_campos_between(document.getElementById('id_vis_direccion'), this, 'direccion')">
      ...
      <br><span id="id_hide_direccion"  <?php echo $str_hide_direccion?>><?php
      if ($direccion != "")
      {
      $direccion_look = (is_string($direccion) ? substr($this->Db->qstr($direccion), 1, -1) : $direccion); 
      $nmgp_def_dados = array(); 
