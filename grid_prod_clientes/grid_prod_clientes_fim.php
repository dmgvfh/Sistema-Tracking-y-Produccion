...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_clientes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_clientes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_prod_clientes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_clientes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_clientes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_clientes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_clientes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_prod_clientes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_prod_clientes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_prod_clientes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_prod_clientes']['embutida_filho'] as $ind => $sc_init)
          {
