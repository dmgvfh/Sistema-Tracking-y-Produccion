  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_presupuesto_periodo_hitos_asociar_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_presupuesto_periodo_hitos_asociar_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id(var_id, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id

  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_cb

  // ---------- Validate id_presupuesto_periodo
  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_presupuesto_periodo()
  {
    var nomeCampo_id_presupuesto_periodo = "id_presupuesto_periodo";
    var var_id_presupuesto_periodo = scAjaxGetFieldSelect(nomeCampo_id_presupuesto_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_presupuesto_periodo(var_id_presupuesto_periodo, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_presupuesto_periodo_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_presupuesto_periodo

  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_presupuesto_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_presupuesto_periodo_cb

  // ---------- Validate id_hito
  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_hito()
  {
    var nomeCampo_id_hito = "id_hito";
    var var_id_hito = scAjaxGetFieldSelect(nomeCampo_id_hito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_hito(var_id_hito, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_hito_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_hito

  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_hito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_hito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_validate_id_hito_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_presupuesto_periodo = scAjaxGetFieldSelect("id_presupuesto_periodo");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form(var_id, var_id_presupuesto_periodo, var_id_hito, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form

  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form_cb
  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form()
  {
    perform_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form();
  }

  function perform_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_hitos_asociar_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form_cb
  function do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_presupuesto_periodo_hitos_asociar_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_presupuesto_periodo_hitos_asociar_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "id_presupuesto_periodo": {"label": "Período Mes", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
