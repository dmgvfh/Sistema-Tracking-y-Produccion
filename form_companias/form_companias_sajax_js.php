  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_companias" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_companias_validate_razon_social()
  {
    var nomeCampo_razon_social = "razon_social";
    var var_razon_social = scAjaxGetFieldText(nomeCampo_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_companias_validate_razon_social(var_razon_social, var_script_case_init, do_ajax_form_companias_validate_razon_social_cb);
  } // do_ajax_form_companias_validate_razon_social

  function do_ajax_form_companias_validate_razon_social_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_companias_validate_razon_social_cb

  // ---------- Validate rut
  function do_ajax_form_companias_validate_rut()
  {
    var nomeCampo_rut = "rut";
    var var_rut = scAjaxGetFieldText(nomeCampo_rut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_companias_validate_rut(var_rut, var_script_case_init, do_ajax_form_companias_validate_rut_cb);
  } // do_ajax_form_companias_validate_rut

  function do_ajax_form_companias_validate_rut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rut";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_companias_validate_rut_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_companias_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_companias_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_companias_submit_form(var_razon_social, var_rut, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_companias_submit_form_cb);
  } // do_ajax_form_companias_submit_form

  function do_ajax_form_companias_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_companias_submit_form_cb_after_alert);
  } // do_ajax_form_companias_submit_form_cb
  function do_ajax_form_companias_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_companias_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_companias_navigate_form()
  {
    perform_ajax_form_companias_navigate_form();
  }

  function perform_ajax_form_companias_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_companias_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_companias_navigate_form_cb);
  } // do_ajax_form_companias_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_companias']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_companias_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_companias_navigate_form_cb_after_alert);
  } // do_ajax_form_companias_navigate_form_cb
  function do_ajax_form_companias_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_companias_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_companias_navigate_form_cb_after_alert

  function sc_hide_form_companias_form()
  {
