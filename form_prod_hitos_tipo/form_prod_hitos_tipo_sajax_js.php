  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_hitos_tipo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_hitos_tipo_form();
	}
...
?>
  ...
  // ---------- Validate tipo_hito
  function do_ajax_form_prod_hitos_tipo_validate_tipo_hito()
  {
    var nomeCampo_tipo_hito = "tipo_hito";
    var var_tipo_hito = scAjaxGetFieldText(nomeCampo_tipo_hito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_tipo_validate_tipo_hito(var_tipo_hito, var_script_case_init, do_ajax_form_prod_hitos_tipo_validate_tipo_hito_cb);
  } // do_ajax_form_prod_hitos_tipo_validate_tipo_hito

  function do_ajax_form_prod_hitos_tipo_validate_tipo_hito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_hito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_tipo_validate_tipo_hito_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_hitos_tipo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_hitos_tipo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tipo_hito = scAjaxGetFieldText("tipo_hito");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_hitos_tipo_submit_form(var_tipo_hito, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_hitos_tipo_submit_form_cb);
  } // do_ajax_form_prod_hitos_tipo_submit_form

  function do_ajax_form_prod_hitos_tipo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_hitos_tipo_submit_form_cb_after_alert);
  } // do_ajax_form_prod_hitos_tipo_submit_form_cb
  function do_ajax_form_prod_hitos_tipo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_hitos_tipo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_hitos_tipo_navigate_form()
  {
    perform_ajax_form_prod_hitos_tipo_navigate_form();
  }

  function perform_ajax_form_prod_hitos_tipo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_hitos_tipo_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_hitos_tipo_navigate_form_cb);
  } // do_ajax_form_prod_hitos_tipo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_hitos_tipo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_hitos_tipo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_hitos_tipo_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_hitos_tipo_navigate_form_cb
  function do_ajax_form_prod_hitos_tipo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_hitos_tipo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_hitos_tipo_navigate_form_cb_after_alert

  function sc_hide_form_prod_hitos_tipo_form()
  {
  ...
  ajax_field_list[0] = "tipo_hito";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "tipo_hito": {"label": "Tipo Hito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["tipo_hito"][1] = "tipo_hito";

  var ajax_field_id = {
    "tipo_hito": new Array("hidden_field_label_tipo_hito", "hidden_field_data_tipo_hito")
  };
