...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_tipo_actividades"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_tipo_actividades"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tipo_actividades'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipo_actividades']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tipo_actividades']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipo_actividades']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tipo_actividades']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tipo_actividades']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tipo_actividades</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tipo_actividades']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tipo_actividades']['embutida_filho'] as $ind => $sc_init)
          {
