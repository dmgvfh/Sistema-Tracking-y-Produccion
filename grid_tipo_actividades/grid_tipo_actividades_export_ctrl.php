<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipo_actividades']['sc_process_barr'] = true;
require_once('../grid_tipo_actividades/index.php');
unset($_SESSION['scriptcase']['grid_tipo_actividades']['sc_process_barr']);
$ExportCtrl = new grid_tipo_actividades_export_control;
$ExportCtrl->Export_barr();

class grid_tipo_actividades_export_control
{
