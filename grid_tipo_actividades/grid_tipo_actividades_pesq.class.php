...
class grid_tipo_actividades_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tipo_actividades_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tipo_actividades_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tipo_actividades_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombre_actividad')
      {
          $nombre_actividad = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombre_actividad($nombre_actividad);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_descripcion_actividad')
      {
          $descripcion_actividad = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_descripcion_actividad($descripcion_actividad);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_nombre_actividad($nombre_actividad)
   {
      $nombre_actividad = substr($this->Db->qstr($nombre_actividad), 1, -1);
            $nombre_actividad_look = (is_string($nombre_actividad) ? substr($this->Db->qstr($nombre_actividad), 1, -1) : $nombre_actividad); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre_actividad from " . $this->Ini->nm_tabela . " where  nombre_actividad like '%" . $nombre_actividad . "%' order by nombre_actividad"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_descripcion_actividad($descripcion_actividad)
   {
      $descripcion_actividad = substr($this->Db->qstr($descripcion_actividad), 1, -1);
            $descripcion_actividad_look = (is_string($descripcion_actividad) ? substr($this->Db->qstr($descripcion_actividad), 1, -1) : $descripcion_actividad); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct descripcion_actividad from " . $this->Ini->nm_tabela . " where  descripcion_actividad like '%" . $descripcion_actividad . "%' order by descripcion_actividad"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      else
      {
         ...
         $nome_sum = "tipo_actividades.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> tipo de actividades</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tipo_actividades/grid_tipo_actividades_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_tipo_actividades_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tipo_actividades_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tipo_actividades_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_unidad_organizativa_cond#NMF#' + search_get_sel_txt('SC_id_unidad_organizativa_cond') + '@NMF@';
  str_out += 'SC_id_unidad_organizativa#NMF#' + search_get_text('SC_id_unidad_organizativa') + '@NMF@';
  str_out += 'SC_id_cond#NMF#' + search_get_sel_txt('SC_id_cond') + '@NMF@';
  str_out += 'SC_id#NMF#' + search_get_text('SC_id') + '@NMF@';
  str_out += 'SC_nombre_actividad_cond#NMF#' + search_get_sel_txt('SC_nombre_actividad_cond') + '@NMF@';
  str_out += 'SC_nombre_actividad#NMF#' + search_get_text('SC_nombre_actividad') + '@NMF@';
  str_out += 'id_ac_nombre_actividad#NMF#' + search_get_text('id_ac_nombre_actividad') + '@NMF@';
  str_out += 'SC_descripcion_actividad_cond#NMF#' + search_get_sel_txt('SC_descripcion_actividad_cond') + '@NMF@';
  str_out += 'SC_descripcion_actividad#NMF#' + search_get_text('SC_descripcion_actividad') + '@NMF@';
  str_out += 'id_ac_descripcion_actividad#NMF#' + search_get_text('id_ac_descripcion_actividad') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nombre_actividad").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nombre_actividad").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombre_actividad",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nombre_actividad").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombre_actividad").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_descripcion_actividad").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_descripcion_actividad").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_descripcion_actividad",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_descripcion_actividad").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_descripcion_actividad").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> tipo de actividades</span></td>
...
<?php
   ...
   {
      global 
             $id_unidad_organizativa_cond, $id_unidad_organizativa,
             $id_cond, $id,
             $nombre_actividad_cond, $nombre_actividad, $nombre_actividad_autocomp,
             $descripcion_actividad_cond, $descripcion_actividad, $descripcion_actividad_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_unidad_organizativa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['id_unidad_organizativa']; 
          $id_unidad_organizativa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['id_unidad_organizativa_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['id_cond']; 
          $nombre_actividad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['nombre_actividad']; 
          $nombre_actividad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['nombre_actividad_cond']; 
          $descripcion_actividad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['descripcion_actividad']; 
          $descripcion_actividad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['descripcion_actividad_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['NM_operador']; 
          if (strtoupper($id_unidad_organizativa_cond) != "II" && strtoupper($id_unidad_organizativa_cond) != "QP" && strtoupper($id_unidad_organizativa_cond) != "NP" && strtoupper($id_unidad_organizativa_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_unidad_organizativa, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      ...
      if (!isset($id_unidad_organizativa_cond) || empty($id_unidad_organizativa_cond))
      {
         $id_unidad_organizativa_cond = "gt";
      }
      if (!isset($id_cond) || empty($id_cond))
      {
         $id_cond = "gt";
      }
      if (!isset($nombre_actividad_cond) || empty($nombre_actividad_cond))
      {
         $nombre_actividad_cond = "qp";
      }
      if (!isset($descripcion_actividad_cond) || empty($descripcion_actividad_cond))
      {
         $descripcion_actividad_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_id_unidad_organizativa = (in_array($id_unidad_organizativa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre_actividad = (in_array($nombre_actividad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descripcion_actividad = (in_array($descripcion_actividad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($id_unidad_organizativa) || $id_unidad_organizativa == "")
      {
          $id_unidad_organizativa = "";
      }
      if (isset($id_unidad_organizativa) && !empty($id_unidad_organizativa))
      {
         $tmp_pos = (is_string($id_unidad_organizativa)) ? strpos($id_unidad_organizativa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_unidad_organizativa = substr($id_unidad_organizativa, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($nombre_actividad) || $nombre_actividad == "")
      {
          $nombre_actividad = "";
      }
      if (isset($nombre_actividad) && !empty($nombre_actividad))
      {
         $tmp_pos = (is_string($nombre_actividad)) ? strpos($nombre_actividad, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $nombre_actividad = substr($nombre_actividad, 0, $tmp_pos);
         }
      }
      if (!isset($descripcion_actividad) || $descripcion_actividad == "")
      {
          $descripcion_actividad = "";
      }
      if (isset($descripcion_actividad) && !empty($descripcion_actividad))
      {
         $tmp_pos = (is_string($descripcion_actividad)) ? strpos($descripcion_actividad, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $descripcion_actividad = substr($descripcion_actividad, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_unidad_organizativa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_unidad_organizativa'])) ? $this->New_label['id_unidad_organizativa'] : "Unidad Organizativa"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_unidad_organizativa_cond" name="id_unidad_organizativa_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_unidad_organizativa'), this, 'id_unidad_organizativa')">
       <OPTION value="gt" <?php if ("gt" == $id_unidad_organizativa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_unidad_organizativa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_unidad_organizativa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_unidad_organizativa" <?php echo $str_hide_id_unidad_organizativa?> valign="top">
 ...
 $nmgp_tab_label .= "id_unidad_organizativa?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_id_unidad_organizativa" name="id_unidad_organizativa" value="<?php echo NM_encode_input($id_unidad_organizativa) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_nombre_actividad_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nombre_actividad'])) ? $this->New_label['nombre_actividad'] : "Nombre Actividad"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nombre_actividad_cond" name="nombre_actividad_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_actividad'), this, 'nombre_actividad')">
       <OPTION value="qp" <?php if ("qp" == $nombre_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombre_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombre_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombre_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_actividad" <?php echo $str_hide_nombre_actividad?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nombre_actividad'])) ? $this->New_label['nombre_actividad'] : "Nombre Actividad";
 $nmgp_tab_label .= "nombre_actividad?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $nombre_actividad_look = (is_string($nombre_actividad) ? substr($this->Db->qstr($nombre_actividad), 1, -1) : $nombre_actividad); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre_actividad from " . $this->Ini->nm_tabela . " where nombre_actividad = '$nombre_actividad_look' order by nombre_actividad"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$nombre_actividad]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nombre_actividad];
      }
      else
      {
          $sAutocompValue = $nombre_actividad;
      }
?>
<INPUT  type="text" id="SC_nombre_actividad" name="nombre_actividad" value="<?php echo NM_encode_input($nombre_actividad) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nombre_actividad" name="nombre_actividad_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_descripcion_actividad_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['descripcion_actividad'])) ? $this->New_label['descripcion_actividad'] : "Descripcion Actividad"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_descripcion_actividad_cond" name="descripcion_actividad_cond" onChange="nm_campos_between(document.getElementById('id_vis_descripcion_actividad'), this, 'descripcion_actividad')">
       <OPTION value="qp" <?php if ("qp" == $descripcion_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $descripcion_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $descripcion_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $descripcion_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_descripcion_actividad" <?php echo $str_hide_descripcion_actividad?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['descripcion_actividad'])) ? $this->New_label['descripcion_actividad'] : "Descripcion Actividad";
 $nmgp_tab_label .= "descripcion_actividad?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $descripcion_actividad_look = (is_string($descripcion_actividad) ? substr($this->Db->qstr($descripcion_actividad), 1, -1) : $descripcion_actividad); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct descripcion_actividad from " . $this->Ini->nm_tabela . " where descripcion_actividad = '$descripcion_actividad_look' order by descripcion_actividad"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$descripcion_actividad]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$descripcion_actividad];
      }
      else
      {
          $sAutocompValue = $descripcion_actividad;
      }
?>
<INPUT  type="text" id="SC_descripcion_actividad" name="descripcion_actividad" value="<?php echo NM_encode_input($descripcion_actividad) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descripcion_actividad" name="descripcion_actividad_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_tipo_actividades_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tipo_actividades']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tipo_actividades']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_unidad_organizativa_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_unidad_organizativa'), document.F1.id_unidad_organizativa_cond, 'id_unidad_organizativa');
   document.F1.id_unidad_organizativa.value = "";
   ...
   document.F1.nombre_actividad_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nombre_actividad'), document.F1.nombre_actividad_cond, 'nombre_actividad');
   document.F1.nombre_actividad.value = "";
   document.F1.nombre_actividad_autocomp.value = "";
   document.F1.descripcion_actividad_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_descripcion_actividad'), document.F1.descripcion_actividad_cond, 'descripcion_actividad');
   document.F1.descripcion_actividad.value = "";
   document.F1.descripcion_actividad_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_tipo_actividades";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_tipo_actividades/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_unidad_organizativa_cond'] = 'cond';
      $tp_fields['SC_id_unidad_organizativa'] = 'text';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text';
      $tp_fields['SC_nombre_actividad_cond'] = 'cond';
      $tp_fields['SC_nombre_actividad'] = 'text_aut';
      $tp_fields['id_ac_nombre_actividad'] = 'text_aut';
      $tp_fields['SC_descripcion_actividad_cond'] = 'cond';
      $tp_fields['SC_descripcion_actividad'] = 'text_aut';
      $tp_fields['id_ac_descripcion_actividad'] = 'text_aut';
   ...
   {
      global $id_unidad_organizativa_cond, $id_unidad_organizativa,
             $id_cond, $id,
             $nombre_actividad_cond, $nombre_actividad, $nombre_actividad_autocomp,
             $descripcion_actividad_cond, $descripcion_actividad, $descripcion_actividad_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($nombre_actividad_autocomp) && empty($nombre_actividad))
      {
          $nombre_actividad = $nombre_actividad_autocomp;
      }
      if (!empty($descripcion_actividad_autocomp) && empty($descripcion_actividad))
      {
          $descripcion_actividad = $descripcion_actividad_autocomp;
      }
      $id_unidad_organizativa_cond_salva = $id_unidad_organizativa_cond; 
      if (!isset($id_unidad_organizativa_input_2) || $id_unidad_organizativa_input_2 == "")
      {
          $id_unidad_organizativa_input_2 = $id_unidad_organizativa;
      }
      ...
      $nombre_actividad_cond_salva = $nombre_actividad_cond; 
      if (!isset($nombre_actividad_input_2) || $nombre_actividad_input_2 == "")
      {
          $nombre_actividad_input_2 = $nombre_actividad;
      }
      $descripcion_actividad_cond_salva = $descripcion_actividad_cond; 
      if (!isset($descripcion_actividad_input_2) || $descripcion_actividad_input_2 == "")
      {
          $descripcion_actividad_input_2 = $descripcion_actividad;
      }
      if ($id_unidad_organizativa_cond != "in")
      {
          nm_limpa_numero($id_unidad_organizativa, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['id_unidad_organizativa'] = $id_unidad_organizativa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['id_unidad_organizativa_cond'] = $id_unidad_organizativa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['nombre_actividad'] = $nombre_actividad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['nombre_actividad_cond'] = $nombre_actividad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['descripcion_actividad'] = $descripcion_actividad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['descripcion_actividad_cond'] = $descripcion_actividad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $id_unidad_organizativa;
      if (strtoupper($id_unidad_organizativa_cond) != "II" && strtoupper($id_unidad_organizativa_cond) != "QP" && strtoupper($id_unidad_organizativa_cond) != "NP" && strtoupper($id_unidad_organizativa_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_unidad_organizativa'] = $Conteudo;
      $Conteudo = $id;
      if (strtoupper($id_cond) != "II" && strtoupper($id_cond) != "QP" && strtoupper($id_cond) != "NP" && strtoupper($id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
    ...
    if ($nombre_actividad != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombre_actividad'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nombre_actividad'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombre_actividad'] = $nombre_actividad;
      }
      $nmgp_def_dados = array();
    if ($descripcion_actividad != '') {
      $descripcion_actividad_look = (is_string($descripcion_actividad) ? substr($this->Db->qstr($descripcion_actividad), 1, -1) : $descripcion_actividad); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['descripcion_actividad'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['descripcion_actividad'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['descripcion_actividad'] = $descripcion_actividad;
      }

      //----- $id_unidad_organizativa
      $this->Date_part = false;
      if (isset($id_unidad_organizativa) || $id_unidad_organizativa_cond == "nu" || $id_unidad_organizativa_cond == "nn" || $id_unidad_organizativa_cond == "ep" || $id_unidad_organizativa_cond == "ne")
      {
         $this->monta_condicao("id_unidad_organizativa", $id_unidad_organizativa_cond, $id_unidad_organizativa, "", "id_unidad_organizativa", "INT", false);
      }
      ...
      //----- $nombre_actividad
      $this->Date_part = false;
      if (isset($nombre_actividad) || $nombre_actividad_cond == "nu" || $nombre_actividad_cond == "nn" || $nombre_actividad_cond == "ep" || $nombre_actividad_cond == "ne")
      {
         $this->monta_condicao("nombre_actividad", $nombre_actividad_cond, $nombre_actividad, "", "nombre_actividad", "VARCHAR", false);
      }

      //----- $descripcion_actividad
      $this->Date_part = false;
      if (isset($descripcion_actividad) || $descripcion_actividad_cond == "nu" || $descripcion_actividad_cond == "nn" || $descripcion_actividad_cond == "ep" || $descripcion_actividad_cond == "ne")
      {
         $this->monta_condicao("descripcion_actividad", $descripcion_actividad_cond, $descripcion_actividad, "", "descripcion_actividad", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_actividades']['cond_pesq'] .= $this->NM_operador;
