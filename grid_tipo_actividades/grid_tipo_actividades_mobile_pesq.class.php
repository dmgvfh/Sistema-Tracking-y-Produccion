...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "id_unidad_organizativa";$Nm_numeric[] = "habilitado";$Nm_numeric[] = "id";$Nm_numeric[] = "id_unidad_organizativa";$Nm_numeric[] = "habilitado";
...
<HTML>
<HEAD>
 <TITLE> tipo de actividades</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_unidad_organizativa_cond" name="id_unidad_organizativa_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_unidad_organizativa'), this, 'id_unidad_organizativa')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nombre_actividad_cond" name="nombre_actividad_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_actividad'), this, 'nombre_actividad')">
      ...
      <br><span id="id_hide_nombre_actividad"  <?php echo $str_hide_nombre_actividad?>><?php
      if ($nombre_actividad != "")
      {
      $nombre_actividad_look = (is_string($nombre_actividad) ? substr($this->Db->qstr($nombre_actividad), 1, -1) : $nombre_actividad); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_descripcion_actividad_cond" name="descripcion_actividad_cond" onChange="nm_campos_between(document.getElementById('id_vis_descripcion_actividad'), this, 'descripcion_actividad')">
      ...
      <br><span id="id_hide_descripcion_actividad"  <?php echo $str_hide_descripcion_actividad?>><?php
