...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app_form_sec_groups_mob_submit_form_cb_after_alert);
  } // do_ajax_app_form_sec_groups_mob_submit_form_cb
  function do_ajax_app_form_sec_groups_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_form_sec_groups_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_form_sec_groups_mob_navigate_form()
  {
    perform_ajax_app_form_sec_groups_mob_navigate_form();
  }

  function perform_ajax_app_form_sec_groups_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
...
?>
  function do_ajax_app_form_sec_groups_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_form_sec_groups_mob_navigate_form_cb_after_alert);
  } // do_ajax_app_form_sec_groups_mob_navigate_form_cb
  function do_ajax_app_form_sec_groups_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_app_form_sec_groups_mob_navigate_form_cb_after_alert
  ...
  var ajax_error_list = {
    "description": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_groups_fld_description'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
