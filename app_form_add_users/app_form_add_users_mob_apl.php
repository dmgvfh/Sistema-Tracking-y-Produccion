...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['app_form_add_users_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['app_form_add_users_mob']['opc_ant'] = "inicio";
      }
  ...
  if(isset($_GET['a']) && substr($_GET['a'],0,4) == 'new_')
{
     ...
     $nm_select ="UPDATE sec_users SET is_active = 'Y', activation_code ='' WHERE activation_code = ". $this->Db->qstr($_GET['a']); 
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('login') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };
}
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_list_users'] . "";
      ...
      $this->Db = $this->Ini->Db; 
      $this->nm_new_label['login'] = '' . $this->Ini->Nm_lang['lang_sec_users_fld_login'] . '';
      $this->nm_new_label['pswd'] = '' . $this->Ini->Nm_lang['lang_sec_users_fld_pswd'] . '';
      $this->nm_new_label['name'] = '' . $this->Ini->Nm_lang['lang_sec_users_fld_name'] . '';
      $this->nm_new_label['email'] = '' . $this->Ini->Nm_lang['lang_sec_users_fld_email'] . '';
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['opc_ant'] : "";
      } 
...
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_list_users'] . "") ?></TITLE>
...
//--------------------------------------------------------------------------------------
   ...
   function Recupera_Nome_Campo($campo) 
   {
       ...
       {
           case 'login':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fld_login'] . "";
               break;
           case 'pswd':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fld_pswd'] . "";
               break;
           case 'confirm_pswd':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fild_pswd_confirm'] . "";
               break;
           case 'name':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fld_name'] . "";
               break;
           case 'email':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fld_email'] . "";
               break;
           case 'is_active':
               return "Is Active";
               break;
...
//---------------------------------------------------------
    ...
    function ValidateField_login(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_sec_users_fld_login'] . "" ; 
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_sec_users_fld_login'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['login']))
              {
                  $Campos_Erros['login'] = array();
              }
    ...
    function ValidateField_pswd(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_sec_users_fld_pswd'] . "" ; 
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_sec_users_fld_pswd'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['pswd']))
              {
                  $Campos_Erros['pswd'] = array();
              }
    ...
    function ValidateField_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_sec_users_fld_name'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 64 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                      $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_sec_users_fld_email'] . "; " ; 
          ...
          { 
              $hasError = true;
              $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_sec_users_fld_email'] . "" ; 
              if (!isset($Campos_Erros['email']))
              {
                  $Campos_Erros['email'] = array();
              }
    ...
    function ValidateField_is_active(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (NM_utf8_strlen($this->is_active) > 1) 
          { 
              $hasError = true;
              $Campos_Crit .= "Is Active " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['is_active']))
              {
                  $Campos_Erros['is_active'] = array();
              }
              $Campos_Erros['is_active'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['is_active'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
  ...
  if($this->pswd  != $this->confirm_pswd )
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_app_form_add_users_mob';
...
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $aUpdateOk = array();
              ...
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_ukey'] . " " . $this->Ini->Nm_lang['lang_sec_users_fld_email'] . ""); 
                  $this->nmgp_opcao = "nada"; 
                  $aUpdateOk[] = 'email';
                  $rsUni->Close();
              }
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "is_active = '$this->is_active'"; 
              } 
              else 
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'pswd', 'confirm_pswd', 'name', 'email', 'is_active'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          $aInsertOk = array(); 
              ...
              elseif (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_inst_uniq'] . " " . $this->Ini->Nm_lang['lang_sec_users_fld_email'] . ""); 
                  $this->nmgp_opcao = "nada"; 
                  $GLOBALS["erro_incl"] = 1; 
                  $aInsertOk[] = 'email';
                  $rsUni->Close();
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "login, pswd, name, email, is_active, activation_code, priv_admin) VALUES (" . $NM_seq_auto . "'$this->login', '$this->pswd', '$this->name', '$this->email', '$this->is_active', '$this->activation_code', '$this->priv_admin')"; 
              }
...
//---------- 
      ...
      { 
          ...
          $nmgp_select = "SELECT login, pswd, name, email, is_active, activation_code, priv_admin from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    ...
    <div class="scFormHeaderFont" style="float: right;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_list_users'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_list_users'] . ""; } ?></div>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['ordem_ord'] == " desc") {
