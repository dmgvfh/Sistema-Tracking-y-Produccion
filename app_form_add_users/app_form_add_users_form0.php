...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['last'] : 'off'); ?>";
...
else
{
    ...
    $remove_margin = '';
    $remove_border = '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['link_info']['remove_border']) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_is_active_label" id="hidden_field_label_is_active" style="<?php echo $sStyleHidden_is_active; ?>"><span id="id_label_is_active"><?php echo $this->nm_new_label['is_active']; ?></span></TD>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['btn_label']['exit'];
        }
?>
