...
?>
  ...
  // ---------- Validate is_active
  function do_ajax_app_form_add_users_validate_is_active()
  {
    var nomeCampo_is_active = "is_active";
    var var_is_active = scAjaxGetFieldText(nomeCampo_is_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_is_active(var_is_active, var_script_case_init, do_ajax_app_form_add_users_validate_is_active_cb);
  } // do_ajax_app_form_add_users_validate_is_active

  function do_ajax_app_form_add_users_validate_is_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_is_active_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_form_add_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_is_active, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_submit_form_cb);
