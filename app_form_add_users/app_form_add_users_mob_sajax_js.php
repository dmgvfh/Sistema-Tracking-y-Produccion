...
?>
  ...
  // ---------- Validate is_active
  function do_ajax_app_form_add_users_mob_validate_is_active()
  {
    var nomeCampo_is_active = "is_active";
    var var_is_active = scAjaxGetFieldText(nomeCampo_is_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_mob_validate_is_active(var_is_active, var_script_case_init, do_ajax_app_form_add_users_mob_validate_is_active_cb);
  } // do_ajax_app_form_add_users_mob_validate_is_active

  function do_ajax_app_form_add_users_mob_validate_is_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_mob_validate_is_active_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_form_add_users_mob_submit_form()
  {
    ...
    var var_is_active = scAjaxGetFieldText("is_active");
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_mob_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_is_active, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_mob_submit_form_cb);
...
?>
  ...
  ajax_field_list[5] = "is_active";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pswd": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_pswd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "name": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "is_active": {"label": "Is Active", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
