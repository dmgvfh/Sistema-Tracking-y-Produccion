<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['home']['glo_nm_perfil']          = "conn_example";
   $_SESSION['scriptcase']['home']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['home']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['home']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['home']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['home']['glo_nm_path_doc']        = "";
    ...
    //check img
    if(empty($_SESSION['scriptcase']['home']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['home']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['home']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['home']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['home']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['home']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['home']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "home"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20151006"; 
      $this->nm_hr_criacao   = "142247"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20240403"; 
      $this->nm_hr_ult_alt   = "171931"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['home']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['home']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['home']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['home']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['home']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['home']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['home']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['home']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['home']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['home']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['home']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/home';
      ...
      $_SESSION['sc_session'][$this->sc_page]['home']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      {
          include_once("home_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['home']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['home']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['home']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['home']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["home"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["home"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['home']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['home']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['home']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['home']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['home']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['home']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['home']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['home']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['home']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['home']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['home']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['home']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      $_SESSION['sc_session'][$this->sc_page]['home']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['home']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['home']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['home']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "home_erro.class.php"); 
...
/*NM*/            $_SESSION['scriptcase']['home']['glo_nm_perfil'] = $NM_con_dest;
      ...
      $con_devel             = (isset($_SESSION['scriptcase']['home']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['home']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      {
          $perfil_trab = $_SESSION['scriptcase']['home']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['home']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['home']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['home']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['home']['glo_nm_conexao'], $this->root . $this->path_prod, 'carga_horas', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['home']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['home']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           $delim  = "'";
           $delim1 = "'";
           if (isset($_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['home']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['home']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['home']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['home']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['home']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new home_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['home']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['home']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['home']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['home'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['home']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['home']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('home') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['home']['label'] = "home";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['home']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['home']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['home']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "home_erro.class.php"); 
      $this->Erro      = new home_erro();
...
if (!isset($this->sc_temp_glo_staff_id)) {$this->sc_temp_glo_staff_id = (isset($_SESSION['glo_staff_id'])) ? $_SESSION['glo_staff_id'] : "";}
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('calendar_appointments_staff') . "/", $this->nm_location, "glo_staff_id?#?" . NM_encode_input($this->sc_temp_glo_staff_id) . "?@?","_self", 440, 630, "ret_self");
 };
	break;
...
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('calendar_appointments_staff') . "/", $this->nm_location, "glo_staff_id?#?" . NM_encode_input($this->sc_temp_glo_staff_id) . "?@?","_self", 440, 630, "ret_self");
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_proyectos') . "/", $this->nm_location, "","_self", 440, 630, "ret_self");
 };
	break;
...
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_proyectos') . "/", $this->nm_location, "","_self", 440, 630, "ret_self");
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('dashboard_adm') . "/", $this->nm_location, "","_self", 440, 630, "ret_self");
 };
	break;
}
if (isset($this->sc_temp_glo_staff_id)) {$_SESSION['glo_staff_id'] = $this->sc_temp_glo_staff_id;}
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['home'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['home']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['home']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "home") {
           ...
           if (isset($_COOKIE['sc_actual_lang_carga_horas'])) {
               $_SESSION['scriptcase']['home']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_carga_horas'];
           }
       }
   }
   ...
   if (isset($_POST["glo_staff_id"])) 
   {
       ...
       nm_limpa_str_home($_SESSION["glo_staff_id"]);
   }
   ...
   if (isset($_POST["usr_group"])) 
   {
       ...
       nm_limpa_str_home($_SESSION["usr_group"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['home']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['home']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['home']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "home";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'home' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['home']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['home']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['home']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['home']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['home']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('home' == $sReferer || 'home_' == substr($sReferer, 0, 5))
       {
           $_SESSION['sc_session'][$script_case_init]['home']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'home')
   {
       $_SESSION['sc_session'][$script_case_init]['home']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['home']['menu_desenv'] = false;   
   ...
   $contr_home = new home_apl();
   $contr_home->controle();
//
   function nm_limpa_str_home(&$str)
   {
   }
?>
