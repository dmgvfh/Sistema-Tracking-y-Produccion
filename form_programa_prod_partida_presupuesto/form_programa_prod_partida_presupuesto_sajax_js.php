  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_programa_prod_partida_presupuesto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_programa_prod_partida_presupuesto_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_form_programa_prod_partida_presupuesto_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programa_prod_partida_presupuesto_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_validate_id__cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_id_

  function do_ajax_form_programa_prod_partida_presupuesto_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_id__cb

  // ---------- Validate id_presupuesto_periodo_
  function do_ajax_form_programa_prod_partida_presupuesto_validate_id_presupuesto_periodo_(iNumLinha)
  {
    var nomeCampo_id_presupuesto_periodo_ = "id_presupuesto_periodo_" + iNumLinha;
    var var_id_presupuesto_periodo_ = scAjaxGetFieldText(nomeCampo_id_presupuesto_periodo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programa_prod_partida_presupuesto_validate_id_presupuesto_periodo_(var_id_presupuesto_periodo_, iNumLinha, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_validate_id_presupuesto_periodo__cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_id_presupuesto_periodo_

  function do_ajax_form_programa_prod_partida_presupuesto_validate_id_presupuesto_periodo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_presupuesto_periodo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_presupuesto_periodo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_id_presupuesto_periodo__cb

  // ---------- Validate id_proyecto_
  function do_ajax_form_programa_prod_partida_presupuesto_validate_id_proyecto_(iNumLinha)
  {
    var nomeCampo_id_proyecto_ = "id_proyecto_" + iNumLinha;
    var var_id_proyecto_ = scAjaxGetFieldText(nomeCampo_id_proyecto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programa_prod_partida_presupuesto_validate_id_proyecto_(var_id_proyecto_, iNumLinha, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_validate_id_proyecto__cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_id_proyecto_

  function do_ajax_form_programa_prod_partida_presupuesto_validate_id_proyecto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_id_proyecto__cb

  // ---------- Validate id_item_
  function do_ajax_form_programa_prod_partida_presupuesto_validate_id_item_(iNumLinha)
  {
    var nomeCampo_id_item_ = "id_item_" + iNumLinha;
    var var_id_item_ = scAjaxGetFieldText(nomeCampo_id_item_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programa_prod_partida_presupuesto_validate_id_item_(var_id_item_, iNumLinha, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_validate_id_item__cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_id_item_

  function do_ajax_form_programa_prod_partida_presupuesto_validate_id_item__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_id_item__cb

  // ---------- Validate monto_uf_
  function do_ajax_form_programa_prod_partida_presupuesto_validate_monto_uf_(iNumLinha)
  {
    var nomeCampo_monto_uf_ = "monto_uf_" + iNumLinha;
    var var_monto_uf_ = scAjaxGetFieldText(nomeCampo_monto_uf_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programa_prod_partida_presupuesto_validate_monto_uf_(var_monto_uf_, iNumLinha, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_validate_monto_uf__cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_monto_uf_

  function do_ajax_form_programa_prod_partida_presupuesto_validate_monto_uf__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_monto_uf__cb

  // ---------- Validate avance_
  function do_ajax_form_programa_prod_partida_presupuesto_validate_avance_(iNumLinha)
  {
    var nomeCampo_avance_ = "avance_" + iNumLinha;
    var var_avance_ = scAjaxGetFieldText(nomeCampo_avance_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programa_prod_partida_presupuesto_validate_avance_(var_avance_, iNumLinha, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_validate_avance__cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_avance_

  function do_ajax_form_programa_prod_partida_presupuesto_validate_avance__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programa_prod_partida_presupuesto_validate_avance__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_programa_prod_partida_presupuesto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_programa_prod_partida_presupuesto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_programa_prod_partida_presupuesto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_add_new_line_cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_add_new_line

  function do_ajax_form_programa_prod_partida_presupuesto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_programa_prod_partida_presupuesto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_programa_prod_partida_presupuesto_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programa_prod_partida_presupuesto_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_backup_line_cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_backup_line

  function do_ajax_form_programa_prod_partida_presupuesto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_programa_prod_partida_presupuesto_backup_line_cb

  function do_ajax_form_programa_prod_partida_presupuesto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_programa_prod_partida_presupuesto_cancel_insert

  function do_ajax_form_programa_prod_partida_presupuesto_cancel_update(iSeqVert)
  {
    do_ajax_form_programa_prod_partida_presupuesto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_programa_prod_partida_presupuesto_cancel_update

  function do_ajax_form_programa_prod_partida_presupuesto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_programa_prod_partida_presupuesto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_programa_prod_partida_presupuesto_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_programa_prod_partida_presupuesto_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_table_refresh_cb);
  } //  do_ajax_form_programa_prod_partida_presupuesto_table_refresh

  function do_ajax_form_programa_prod_partida_presupuesto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_programa_prod_partida_presupuesto_table_refresh_cb_after_alert);
  } // do_ajax_form_programa_prod_partida_presupuesto_table_refresh_cb
  function do_ajax_form_programa_prod_partida_presupuesto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_programa_prod_partida_presupuesto_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_programa_prod_partida_presupuesto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_programa_prod_partida_presupuesto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_id_presupuesto_periodo_ = scAjaxGetFieldText("id_presupuesto_periodo_" + iNumLinha);
...
?>
    x_ajax_form_programa_prod_partida_presupuesto_submit_form(var_id_, var_id_presupuesto_periodo_, var_id_proyecto_, var_id_item_, var_monto_uf_, var_avance_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_programa_prod_partida_presupuesto_submit_form_cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_submit_form

  function do_ajax_form_programa_prod_partida_presupuesto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_programa_prod_partida_presupuesto_submit_form_cb_after_alert);
  } // do_ajax_form_programa_prod_partida_presupuesto_submit_form_cb
  function do_ajax_form_programa_prod_partida_presupuesto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_programa_prod_partida_presupuesto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_programa_prod_partida_presupuesto_navigate_form()
  {
    perform_ajax_form_programa_prod_partida_presupuesto_navigate_form();
  }

  function perform_ajax_form_programa_prod_partida_presupuesto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_programa_prod_partida_presupuesto_cancel_insert(sc_form_programa_prod_partida_presupuesto_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_programa_prod_partida_presupuesto_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_programa_prod_partida_presupuesto_navigate_form_cb);
  } // do_ajax_form_programa_prod_partida_presupuesto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_programa_prod_partida_presupuesto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_programa_prod_partida_presupuesto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_programa_prod_partida_presupuesto_navigate_form_cb_after_alert);
  } // do_ajax_form_programa_prod_partida_presupuesto_navigate_form_cb
  function do_ajax_form_programa_prod_partida_presupuesto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_programa_prod_partida_presupuesto_navigate_form_cb_after_alert

    function sc_form_programa_prod_partida_presupuesto_get_last_line_number()
    {
    ...
    } //sc_form_programa_prod_partida_presupuesto_get_last_line_number

  function sc_hide_form_programa_prod_partida_presupuesto_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_presupuesto_periodo_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["id_presupuesto_periodo_" + iNumLinha] = {"label": "Id Presupuesto Periodo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_field_mult["id_presupuesto_periodo_"][iNumLinha] = "id_presupuesto_periodo_" + iNumLinha;
    ...
    ajax_field_id["id_presupuesto_periodo_" + iNumLinha] = new Array("hidden_field_label_id_presupuesto_periodo_", "hidden_field_data_id_presupuesto_periodo_" + iNumLinha);
    ...
    ajax_error_count["id_presupuesto_periodo_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["id_presupuesto_periodo_" + iNumLinha] = "off";
...
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["id_presupuesto_periodo_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["id_presupuesto_periodo_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "id_": new Array(),
    "id_presupuesto_periodo_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["id_presupuesto_periodo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_presupuesto_periodo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_presupuesto_periodo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_presupuesto_periodo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_presupuesto_periodo_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_presupuesto_periodo_'])) ? $this->nmgp_cmp_readonly['id_presupuesto_periodo_'] : 'off';
?>
    scAjaxFieldRead("id_presupuesto_periodo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("id_presupuesto_periodo_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["id_presupuesto_periodo_" + iRow] || "on" == ajax_error_count["id_proyecto_" + iRow] || "on" == ajax_error_count["id_item_" + iRow] || "on" == ajax_error_count["monto_uf_" + iRow] || "on" == ajax_error_count["avance_" + iRow]))
    {
      ...
      $("#hidden_field_data_id_presupuesto_periodo_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["id_presupuesto_periodo_" + iRow] && "off" == ajax_error_count["id_proyecto_" + iRow] && "off" == ajax_error_count["id_item_" + iRow] && "off" == ajax_error_count["monto_uf_" + iRow] && "off" == ajax_error_count["avance_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["id_presupuesto_periodo_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_presupuesto_periodo_" + iRow).removeClass("scFormErrorLine");
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("id_presupuesto_periodo_" == sIndex)
    {
