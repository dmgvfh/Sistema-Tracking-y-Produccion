...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____app_search_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____app_search_sec_groups"]);
   }
