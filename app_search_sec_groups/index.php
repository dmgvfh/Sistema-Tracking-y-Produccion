<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_perfil']          = "conn_example";
...
// 
      ...
      $this->str_conf_reg    = (isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['str_conf_reg']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['str_conf_reg'])) ? $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['str_conf_reg'] : "es_es";
      ...
      $this->str_schema_filter = (isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['str_schema_all']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['str_schema_all'])) ? $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['str_schema_all'] : "tracking/tracking";
      if (isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['sub_cons_schema_filter'];
      } 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'carga_horas', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['embutida'])
      {
   ...
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_search_sec_groups']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_search_sec_groups']['label'] = "" . $this->Ini->Nm_lang['lang_othr_srch_titl'] . " - " . $this->Ini->Nm_lang['lang_list_groups'] . "";
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'carga_horas', 1, $this->Ini->force_db_utf8); 
      } 
      else 
      { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_carga_horas'])) {
               $_SESSION['scriptcase']['app_search_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_carga_horas'];
           }
       }
   }
   if (isset($group)) 
   ...
   if (isset($_SESSION['scriptcase']['app_search_sec_groups']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['app_search_sec_groups']['session_timeout']['lang'];
   }
     $STR_schema_all = "tracking/tracking";
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['app_search_sec_groups']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['app_search_sec_groups']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['app_search_sec_groups']['opc_psq'] && !isset($_SESSION['scriptcase']['app_search_sec_groups']['session_timeout']['redir'])) 
       { 
          ...
          { 
              ...
              $str_schema_app = (isset($_SESSION['sc_session'][$script_case_init]['app_search_sec_groups']['str_schema_all']) && !empty($_SESSION['sc_session'][$script_case_init]['app_search_sec_groups']['str_schema_all'])) ? $_SESSION['sc_session'][$script_case_init]['app_search_sec_groups']['str_schema_all'] : "tracking/tracking";
