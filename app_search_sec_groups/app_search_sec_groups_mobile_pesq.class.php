...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_list_groups'] ?></TITLE>
...
?>
 ...
 <TR align="center">
  <TD class="scFilterTableTd" id='sc_filter_toolbar_top'>
   ...
   <?php echo nmButtonOutput($this->arr_buttons, "bpesquisa", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "sc_b_pesq_top", "", " ok ", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "" . $this->Ini->Nm_lang['lang_btns_srch_lone_hint'] . "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_group_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['group_id'])) ? $this->New_label['group_id'] : "" . $this->Ini->Nm_lang['lang_sec_groups_fld_group_id'] . ""; ?></TD>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['psq_check_ret']['group_id'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_sec_groups_fld_group_id'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
