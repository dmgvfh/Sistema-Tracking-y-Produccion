  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_hitos_contractuales_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_hitos_contractuales_mob_form();
	}
...
?>
  ...
  function do_ajax_form_prod_hitos_contractuales_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_validate_id_proyecto_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_id_proyecto

  function do_ajax_form_prod_hitos_contractuales_mob_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_id_proyecto_cb

  // ---------- Validate id_tipo_hito
  function do_ajax_form_prod_hitos_contractuales_mob_validate_id_tipo_hito()
  {
    var nomeCampo_id_tipo_hito = "id_tipo_hito";
    var var_id_tipo_hito = scAjaxGetFieldSelect(nomeCampo_id_tipo_hito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_mob_validate_id_tipo_hito(var_id_tipo_hito, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_validate_id_tipo_hito_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_id_tipo_hito

  function do_ajax_form_prod_hitos_contractuales_mob_validate_id_tipo_hito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_tipo_hito";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_id_tipo_hito_cb

  // ---------- Validate nombre
  function do_ajax_form_prod_hitos_contractuales_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_validate_nombre_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_nombre

  function do_ajax_form_prod_hitos_contractuales_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_nombre_cb

  // ---------- Validate id_usuario_asignado
  function do_ajax_form_prod_hitos_contractuales_mob_validate_id_usuario_asignado()
  {
    var nomeCampo_id_usuario_asignado = "id_usuario_asignado";
    var var_id_usuario_asignado = scAjaxGetFieldSelect(nomeCampo_id_usuario_asignado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_mob_validate_id_usuario_asignado(var_id_usuario_asignado, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_validate_id_usuario_asignado_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_id_usuario_asignado

  function do_ajax_form_prod_hitos_contractuales_mob_validate_id_usuario_asignado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_usuario_asignado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_id_usuario_asignado_cb

  // ---------- Validate id_actividad
  function do_ajax_form_prod_hitos_contractuales_mob_validate_id_actividad()
  {
    var nomeCampo_id_actividad = "id_actividad";
    var var_id_actividad = scAjaxGetFieldSelect(nomeCampo_id_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_mob_validate_id_actividad(var_id_actividad, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_validate_id_actividad_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_id_actividad

  function do_ajax_form_prod_hitos_contractuales_mob_validate_id_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_id_actividad_cb

  // ---------- Validate observaciones
  function do_ajax_form_prod_hitos_contractuales_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_validate_observaciones_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_observaciones

  function do_ajax_form_prod_hitos_contractuales_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_observaciones_cb

  // ---------- Validate periodos_partidas_asociados
  function do_ajax_form_prod_hitos_contractuales_mob_validate_periodos_partidas_asociados()
  {
    var nomeCampo_periodos_partidas_asociados = "periodos_partidas_asociados";
    nm_pack(nomeCampo_periodos_partidas_asociados + '_dest', nomeCampo_periodos_partidas_asociados);
    var var_periodos_partidas_asociados = scAjaxGetFieldText(nomeCampo_periodos_partidas_asociados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_mob_validate_periodos_partidas_asociados(var_periodos_partidas_asociados, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_validate_periodos_partidas_asociados_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_periodos_partidas_asociados

  function do_ajax_form_prod_hitos_contractuales_mob_validate_periodos_partidas_asociados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periodos_partidas_asociados";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_mob_validate_periodos_partidas_asociados_cb

  // ---------- Refresh id_proyecto
  function do_ajax_form_prod_hitos_contractuales_mob_refresh_id_proyecto()
  {
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_nmgp_refresh_fields = "id_usuario_asignado_#fld#_periodos_partidas_asociados";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_hitos_contractuales_mob_refresh_id_proyecto(var_id_proyecto, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_refresh_id_proyecto_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_refresh_id_proyecto

  function do_ajax_form_prod_hitos_contractuales_mob_refresh_id_proyecto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_mob_refresh_id_proyecto_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_hitos_contractuales_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_hitos_contractuales_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_id_tipo_hito = scAjaxGetFieldSelect("id_tipo_hito");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_id_usuario_asignado = scAjaxGetFieldSelect("id_usuario_asignado");
    var var_id_actividad = scAjaxGetFieldSelect("id_actividad");
    var var_observaciones = scAjaxGetFieldText("observaciones");
    nm_pack("periodos_partidas_asociados_dest", "periodos_partidas_asociados");
    var var_periodos_partidas_asociados = scAjaxGetFieldText("periodos_partidas_asociados", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_hitos_contractuales_mob_submit_form(var_id_proyecto, var_id_tipo_hito, var_nombre, var_id_usuario_asignado, var_id_actividad, var_observaciones, var_periodos_partidas_asociados, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_hitos_contractuales_mob_submit_form_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_submit_form

  function do_ajax_form_prod_hitos_contractuales_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_tipo_hito");
      scAjaxHideErrorDisplay("nombre");
      scAjaxHideErrorDisplay("id_usuario_asignado");
      scAjaxHideErrorDisplay("id_actividad");
      scAjaxHideErrorDisplay("observaciones");
      scAjaxHideErrorDisplay("periodos_partidas_asociados");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_hitos_contractuales_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_hitos_contractuales_mob_submit_form_cb
  function do_ajax_form_prod_hitos_contractuales_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_hitos_contractuales_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_hitos_contractuales_mob_navigate_form()
  {
    perform_ajax_form_prod_hitos_contractuales_mob_navigate_form();
  }

  function perform_ajax_form_prod_hitos_contractuales_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_hitos_contractuales_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_hitos_contractuales_mob_navigate_form_cb);
  } // do_ajax_form_prod_hitos_contractuales_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_hitos_contractuales_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_hitos_contractuales_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_hitos_contractuales_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_hitos_contractuales_mob_navigate_form_cb
  function do_ajax_form_prod_hitos_contractuales_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_hitos_contractuales_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_hitos_contractuales_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_hitos_contractuales_mob_form()
  {
  ...
  ajax_field_list[1] = "id_tipo_hito";
  ajax_field_list[2] = "nombre";
  ajax_field_list[3] = "id_usuario_asignado";
  ajax_field_list[4] = "id_actividad";
  ajax_field_list[5] = "observaciones";
  ajax_field_list[6] = "periodos_partidas_asociados";
  ...
  var ajax_error_list = {
    ...
    "id_tipo_hito": {"label": "Tipo Hito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nombre": {"label": "Nombre Hito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_usuario_asignado": {"label": "Usuario Asignado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_actividad": {"label": "Tipo Actividad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "periodos_partidas_asociados": {"label": "Períodos Disponibles A Asociar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "id_tipo_hito": new Array(),
    "nombre": new Array(),
    "id_usuario_asignado": new Array(),
    "id_actividad": new Array(),
    "observaciones": new Array(),
    "periodos_partidas_asociados": new Array()
  };
  ajax_field_mult["id_proyecto"][1] = "id_proyecto";
  ajax_field_mult["id_tipo_hito"][1] = "id_tipo_hito";
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["id_usuario_asignado"][1] = "id_usuario_asignado";
  ajax_field_mult["id_actividad"][1] = "id_actividad";
  ajax_field_mult["observaciones"][1] = "observaciones";
  ajax_field_mult["periodos_partidas_asociados"][1] = "periodos_partidas_asociados";

  var ajax_field_id = {
    "id_proyecto": new Array("hidden_field_label_id_proyecto", "hidden_field_data_id_proyecto"),
    "id_tipo_hito": new Array("hidden_field_label_id_tipo_hito", "hidden_field_data_id_tipo_hito"),
    "nombre": new Array("hidden_field_label_nombre", "hidden_field_data_nombre"),
    "id_usuario_asignado": new Array("hidden_field_label_id_usuario_asignado", "hidden_field_data_id_usuario_asignado"),
    ...
    "periodos_partidas_asociados": new Array("hidden_field_label_periodos_partidas_asociados", "hidden_field_data_periodos_partidas_asociados")
  };
  ...
  var ajax_read_only = {
    ...
    "id_tipo_hito": "off",
    "nombre": "off",
    "id_usuario_asignado": "off",
    "id_actividad": "off",
    "observaciones": "off",
    "periodos_partidas_asociados": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("periodos_partidas_asociados" == sIndex)
    {
      updateHeaderFooter(sIndex, aValue);
