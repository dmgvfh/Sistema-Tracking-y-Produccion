  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_hitos_contractuales" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_hitos_contractuales_form();
	}
...
?>
  ...
  function do_ajax_form_prod_hitos_contractuales_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_hitos_contractuales_validate_id_proyecto_cb);
  } // do_ajax_form_prod_hitos_contractuales_validate_id_proyecto

  function do_ajax_form_prod_hitos_contractuales_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_validate_id_proyecto_cb

  // ---------- Validate id_tipo_hito
  function do_ajax_form_prod_hitos_contractuales_validate_id_tipo_hito()
  {
    var nomeCampo_id_tipo_hito = "id_tipo_hito";
    var var_id_tipo_hito = scAjaxGetFieldSelect(nomeCampo_id_tipo_hito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_validate_id_tipo_hito(var_id_tipo_hito, var_script_case_init, do_ajax_form_prod_hitos_contractuales_validate_id_tipo_hito_cb);
  } // do_ajax_form_prod_hitos_contractuales_validate_id_tipo_hito

  function do_ajax_form_prod_hitos_contractuales_validate_id_tipo_hito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_validate_id_tipo_hito_cb

  // ---------- Validate nombre
  function do_ajax_form_prod_hitos_contractuales_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_prod_hitos_contractuales_validate_nombre_cb);
  } // do_ajax_form_prod_hitos_contractuales_validate_nombre

  function do_ajax_form_prod_hitos_contractuales_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_validate_nombre_cb

  // ---------- Validate id_usuario_asignado
  function do_ajax_form_prod_hitos_contractuales_validate_id_usuario_asignado()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_validate_id_usuario_asignado(var_id_usuario_asignado, var_script_case_init, do_ajax_form_prod_hitos_contractuales_validate_id_usuario_asignado_cb);
  } // do_ajax_form_prod_hitos_contractuales_validate_id_usuario_asignado

  function do_ajax_form_prod_hitos_contractuales_validate_id_usuario_asignado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_validate_id_usuario_asignado_cb

  // ---------- Validate id_actividad
  function do_ajax_form_prod_hitos_contractuales_validate_id_actividad()
  {
    var nomeCampo_id_actividad = "id_actividad";
    var var_id_actividad = scAjaxGetFieldSelect(nomeCampo_id_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_validate_id_actividad(var_id_actividad, var_script_case_init, do_ajax_form_prod_hitos_contractuales_validate_id_actividad_cb);
  } // do_ajax_form_prod_hitos_contractuales_validate_id_actividad

  function do_ajax_form_prod_hitos_contractuales_validate_id_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_validate_id_actividad_cb

  // ---------- Validate observaciones
  function do_ajax_form_prod_hitos_contractuales_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_prod_hitos_contractuales_validate_observaciones_cb);
  } // do_ajax_form_prod_hitos_contractuales_validate_observaciones

  function do_ajax_form_prod_hitos_contractuales_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_validate_observaciones_cb

  // ---------- Validate periodos_partidas_asociados
  function do_ajax_form_prod_hitos_contractuales_validate_periodos_partidas_asociados()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_hitos_contractuales_validate_periodos_partidas_asociados(var_periodos_partidas_asociados, var_script_case_init, do_ajax_form_prod_hitos_contractuales_validate_periodos_partidas_asociados_cb);
  } // do_ajax_form_prod_hitos_contractuales_validate_periodos_partidas_asociados

  function do_ajax_form_prod_hitos_contractuales_validate_periodos_partidas_asociados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_validate_periodos_partidas_asociados_cb

  // ---------- Refresh id_proyecto
  function do_ajax_form_prod_hitos_contractuales_refresh_id_proyecto()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_prod_hitos_contractuales_refresh_id_proyecto(var_id_proyecto, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_prod_hitos_contractuales_refresh_id_proyecto_cb);
  } // do_ajax_form_prod_hitos_contractuales_refresh_id_proyecto

  function do_ajax_form_prod_hitos_contractuales_refresh_id_proyecto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_hitos_contractuales_refresh_id_proyecto_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_hitos_contractuales_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_hitos_contractuales_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_hitos_contractuales_submit_form(var_id_proyecto, var_id_tipo_hito, var_nombre, var_id_usuario_asignado, var_id_actividad, var_observaciones, var_periodos_partidas_asociados, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_hitos_contractuales_submit_form_cb);
  } // do_ajax_form_prod_hitos_contractuales_submit_form

  function do_ajax_form_prod_hitos_contractuales_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_hitos_contractuales_submit_form_cb_after_alert);
  } // do_ajax_form_prod_hitos_contractuales_submit_form_cb
  function do_ajax_form_prod_hitos_contractuales_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_hitos_contractuales_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_hitos_contractuales_navigate_form()
  {
    perform_ajax_form_prod_hitos_contractuales_navigate_form();
  }

  function perform_ajax_form_prod_hitos_contractuales_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_hitos_contractuales_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_hitos_contractuales_navigate_form_cb);
  } // do_ajax_form_prod_hitos_contractuales_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_hitos_contractuales']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_hitos_contractuales_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_hitos_contractuales_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_hitos_contractuales_navigate_form_cb
  function do_ajax_form_prod_hitos_contractuales_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_hitos_contractuales_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_hitos_contractuales_navigate_form_cb_after_alert

  function sc_hide_form_prod_hitos_contractuales_form()
  {
