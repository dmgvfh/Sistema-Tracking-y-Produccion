<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_prod_presupuesto_periodo_hitos']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_prod_presupuesto_periodo_hitos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_prod_presupuesto_periodo_hitos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['prod_hitos_contractuales_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_hitos_contractuales_id'] = "prod_hitos_contractuales_id";
   }
   else
   {
       $tab_def_campos['prod_hitos_contractuales_id'] = "prod_hitos_contractuales.id";
   }
   $tab_labels["prod_hitos_contractuales_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_hitos_contractuales_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_hitos_contractuales_id"] : "Id Hito";
   $tab_ger_campos['prod_hitos_contractuales_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_hitos_contractuales_nombre'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['prod_hitos_contractuales_nombre'] = "prod_hitos_contractuales.nombre";
   }
   $tab_labels["prod_hitos_contractuales_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_hitos_contractuales_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_hitos_contractuales_nombre"] : "Nombre";
   $tab_ger_campos['prod_hitos_contractuales_id_tipo_hito'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_hitos_contractuales_id_tipo_hito'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['prod_hitos_contractuales_id_tipo_hito'] = "prod_hitos_contractuales.id_tipo_hito";
   }
   $tab_labels["prod_hitos_contractuales_id_tipo_hito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_hitos_contractuales_id_tipo_hito"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_hitos_contractuales_id_tipo_hito"] : "Tipo Hito";
   $tab_ger_campos['prod_presupuesto_periodo_hitos_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_periodo_hitos_estado'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_periodo_hitos_estado'] = "prod_presupuesto_periodo_hitos.estado";
   }
   $tab_labels["prod_presupuesto_periodo_hitos_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_presupuesto_periodo_hitos_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_presupuesto_periodo_hitos_estado"] : "Estado";
   $tab_ger_campos['prod_presupuesto_periodo_hitos_fecha_hito'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_periodo_hitos_fecha_hito'] = "cmp_maior_30_4";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_periodo_hitos_fecha_hito'] = "prod_presupuesto_periodo_hitos.fecha_hito";
   }
   $tab_labels["prod_presupuesto_periodo_hitos_fecha_hito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_presupuesto_periodo_hitos_fecha_hito"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_presupuesto_periodo_hitos_fecha_hito"] : "Fecha Hito";
   $tab_ger_campos['prod_presupuesto_periodo_hitos_adjunto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_periodo_hitos_adjunto'] = "cmp_maior_30_5";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_periodo_hitos_adjunto'] = "prod_presupuesto_periodo_hitos.adjunto";
   }
   $tab_labels["prod_presupuesto_periodo_hitos_adjunto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_presupuesto_periodo_hitos_adjunto"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_presupuesto_periodo_hitos_adjunto"] : "Adjunto";
   $tab_ger_campos['prod_presupuesto_periodo_hitos_link_externo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prod_presupuesto_periodo_hitos_link_externo'] = "cmp_maior_30_6";
   }
   else
   {
       $tab_def_campos['prod_presupuesto_periodo_hitos_link_externo'] = "prod_presupuesto_periodo_hitos.link_externo";
   }
   $tab_labels["prod_presupuesto_periodo_hitos_link_externo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_presupuesto_periodo_hitos_link_externo"])) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['labels']["prod_presupuesto_periodo_hitos_link_externo"] : "Link";
   $tab_ger_campos['prod_presupuesto_periodo_hitos_adjunto'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_prod_presupuesto_periodo_hitos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_prod_presupuesto_periodo_hitos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
