...
class grid_prod_presupuesto_periodo_hitos_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_prod_presupuesto_periodo_hitos.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['rtf_name']);
      }
   ...
   function NM_export_prod_hitos_contractuales_id()
   {
         ...
         $this->prod_hitos_contractuales_id = str_replace('<', '&lt;', $this->prod_hitos_contractuales_id);
         $this->prod_hitos_contractuales_id = str_replace('>', '&gt;', $this->prod_hitos_contractuales_id);
         $this->Texto_tag .= "<td>" . $this->prod_hitos_contractuales_id . "</td>\r\n";
   }
   ...
   function NM_export_prod_hitos_contractuales_id_tipo_hito()
   {
         ...
         $this->look_prod_hitos_contractuales_id_tipo_hito = str_replace('<', '&lt;', $this->look_prod_hitos_contractuales_id_tipo_hito);
         $this->look_prod_hitos_contractuales_id_tipo_hito = str_replace('>', '&gt;', $this->look_prod_hitos_contractuales_id_tipo_hito);
         $this->Texto_tag .= "<td>" . $this->look_prod_hitos_contractuales_id_tipo_hito . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
