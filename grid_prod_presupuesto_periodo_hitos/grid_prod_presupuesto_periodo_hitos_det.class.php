<?php
//--- 
class grid_prod_presupuesto_periodo_hitos_det
{
   var $Ini;
   var $Erro;
   var $Db;
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['sub_dir'] = array(); 
   ...
   $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
       $nmgp_select = "SELECT prod_hitos_contractuales.nombre as cmp_maior_30_1, prod_hitos_contractuales.id_tipo_hito as cmp_maior_30_2, prod_hitos_contractuales.id_proyecto as cmp_maior_30_9, prod_hitos_contractuales.id_usuario_asignado as cmp_maior_30_10, prod_hitos_contractuales.id_actividad as cmp_maior_30_11, prod_hitos_contractuales.observaciones as cmp_maior_30_12, prod_presupuesto_periodo_hitos.id_presupuesto_periodo as cmp_maior_30_7, prod_presupuesto_periodo_hitos.adjunto as cmp_maior_30_5, prod_presupuesto_periodo_hitos.link_externo as cmp_maior_30_6, prod_presupuesto_periodo_hitos.id_hito as cmp_maior_30_8 from " . $this->Ini->nm_tabela; 
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['chave_det']) ; 
   ...
   $nmgp_select .= " where  prod_hitos_contractuales.id = $parms_det[0] and prod_hitos_contractuales.nombre = '$parms_det[1]' and prod_hitos_contractuales.id_tipo_hito = $parms_det[2] and prod_presupuesto_periodo_hitos.estado = $parms_det[3] and prod_presupuesto_periodo_hitos.adjunto = '$parms_det[4]' and prod_presupuesto_periodo_hitos.link_externo = '$parms_det[5]' and prod_presupuesto_periodo_hitos.id_presupuesto_periodo = $parms_det[6] and prod_presupuesto_periodo_hitos.id_hito = $parms_det[7]" ;  
   ...
   $this->prod_presupuesto_periodo_hitos_adjunto = $rs->fields[7] ;  
   $this->prod_presupuesto_periodo_hitos_link_externo = $rs->fields[8] ;  
   $this->prod_presupuesto_periodo_hitos_id_hito = $rs->fields[9] ;  
...
//--- 
   ...
   if (($this->Ini->sc_export_ajax || $this->Ini->Export_det_zip) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['det_print'] == "print")
   {
       ...
       $NM_css_cmp  = $this->Ini->path_link . "grid_prod_presupuesto_periodo_hitos/grid_prod_presupuesto_periodo_hitos_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css";
       $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   elseif (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_prod_presupuesto_periodo_hitos/grid_prod_presupuesto_periodo_hitos_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   }
   else
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("</HEAD>\r\n");
    $removeMargin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['link_info']['remove_margin'] ? 'margin: 0;' : '';
    $removeBorder = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['link_info']['remove_border'] ? 'border-width: 0' : '';
   if (!$this->Ini->Export_html_zip && !$this->Ini->Export_det_zip && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['det_print'] == "print")
   {
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['cmp_acum']);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['link_info']['compact_mode']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['link_info']['compact_mode']) {
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->prod_hitos_contractuales_id_tipo_hito))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          $str_tem_display = $conteudo;
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_prod_hitos_contractuales_id_tipo_hito_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_prod_hitos_contractuales_id_tipo_hito_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_prod_hitos_contractuales_id_tipo_hito\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   $SC_Label = (isset($this->New_label['prod_hitos_contractuales_id_proyecto'])) ? $this->New_label['prod_hitos_contractuales_id_proyecto'] : "Id Proyecto"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->prod_hitos_contractuales_id_proyecto))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          $str_tem_display = $conteudo;
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_prod_hitos_contractuales_id_proyecto_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_prod_hitos_contractuales_id_proyecto_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_prod_hitos_contractuales_id_proyecto\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   $SC_Label = (isset($this->New_label['prod_hitos_contractuales_id_usuario_asignado'])) ? $this->New_label['prod_hitos_contractuales_id_usuario_asignado'] : "Id Usuario Asignado"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->prod_hitos_contractuales_id_usuario_asignado))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          $str_tem_display = $conteudo;
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_prod_hitos_contractuales_id_usuario_asignado_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_prod_hitos_contractuales_id_usuario_asignado_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_prod_hitos_contractuales_id_usuario_asignado\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   $SC_Label = (isset($this->New_label['prod_hitos_contractuales_id_actividad'])) ? $this->New_label['prod_hitos_contractuales_id_actividad'] : "Id Actividad"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->prod_hitos_contractuales_id_actividad))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          $str_tem_display = $conteudo;
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_prod_hitos_contractuales_id_actividad_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_prod_hitos_contractuales_id_actividad_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_prod_hitos_contractuales_id_actividad\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = trim(NM_encode_input(sc_strip_script($this->prod_hitos_contractuales_observaciones)));
       $conteudo_original =  NM_encode_input(sc_strip_script($conteudo)); 
   }
   else {
       $conteudo = trim(sc_strip_script($this->prod_hitos_contractuales_observaciones)); 
       $conteudo_original = $conteudo; 
   }
          if ($conteudo === "") 
          { 
          ...
          $str_tem_display = $conteudo;
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_prod_hitos_contractuales_observaciones_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_prod_hitos_contractuales_observaciones_det_line\"   ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_prod_hitos_contractuales_observaciones\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   $SC_Label = (isset($this->New_label['prod_presupuesto_periodo_hitos_id_presupuesto_periodo'])) ? $this->New_label['prod_presupuesto_periodo_hitos_id_presupuesto_periodo'] : "Id Presupuesto Periodo"; 
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_prod_presupuesto_periodo_hitos_id_presupuesto_periodo_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_prod_presupuesto_periodo_hitos_id_presupuesto_periodo\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   ...
   $conteudo_original = ''; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['opcao'] != "pdf" && $conteudo != "&nbsp;") 
          { 
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_prod_presupuesto_periodo_hitos_id_hito_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_prod_presupuesto_periodo_hitos_id_hito\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if(isset($_SESSION['scriptcase']['proc_mobile']) && $_SESSION['scriptcase']['proc_mobile'])
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_prod_presupuesto_periodo_hitos_doc.php?nmgp_parms=\" + campo1, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   {
      global $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto_periodo_hitos']['pdf_det']) 
   { 
       ...
       if ($this->nmgp_botoes['det_pdf'] == "on")
       {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_prod_presupuesto_periodo_hitos/grid_prod_presupuesto_periodo_hitos_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=8&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=es&conf_socor=N&sc_ver_93=n&password=n&pdf_zip=N&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
