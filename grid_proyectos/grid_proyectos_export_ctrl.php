<?php
@session_start() ;
$_SESSION['scriptcase']['grid_proyectos']['sc_process_barr'] = true;
require_once('../grid_proyectos/index.php');
unset($_SESSION['scriptcase']['grid_proyectos']['sc_process_barr']);
$ExportCtrl = new grid_proyectos_export_control;
$ExportCtrl->Export_barr();

class grid_proyectos_export_control
{
