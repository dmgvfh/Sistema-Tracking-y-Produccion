 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fecha_inicio_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha_inicio'])) ? $this->New_label['fecha_inicio'] : "Fecha Inicio"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fecha_inicio_cond" name="fecha_inicio_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_inicio'), this, 'fecha_inicio')">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fecha_inicio"  <?php echo $str_display_fecha_inicio; ?> class="scFilterFieldFontOdd">
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_codigo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codigo'])) ? $this->New_label['codigo'] : "Código"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codigo_cond" name="codigo_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo'), this, 'codigo')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigo" <?php echo $str_hide_codigo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigo" name="codigo_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_nombre_proyecto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nombre_proyecto'])) ? $this->New_label['nombre_proyecto'] : "Nombre<br>Proyecto"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nombre_proyecto_cond" name="nombre_proyecto_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_proyecto'), this, 'nombre_proyecto')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_proyecto" <?php echo $str_hide_nombre_proyecto?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
