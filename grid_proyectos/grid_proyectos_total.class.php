...
class grid_proyectos_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_proyectos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_proyectos']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $id_empresa, $id_cliente, $id_jefe_proyecto, $id_direccion, $id_portafolio, $tipo_moneda, $id_fase, $id_estado, $id;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['contr_total_geral'] = "OK";
   } 
