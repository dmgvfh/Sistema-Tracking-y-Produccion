<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_proyectos']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_proyectos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_proyectos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["codigo"] : "Código";
   $tab_ger_campos['nombre_proyecto'] = "on";
   $tab_def_campos['nombre_proyecto'] = "nombre_proyecto";
   $tab_labels["nombre_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["nombre_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["nombre_proyecto"] : "Nombre<br>Proyecto";
   $tab_ger_campos['id_empresa'] = "on";
   $tab_def_campos['id_empresa'] = "id_empresa";
   $tab_labels["id_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_empresa"] : "Empresa";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_cliente"] : "Cliente";
   $tab_ger_campos['id_jefe_proyecto'] = "on";
   $tab_def_campos['id_jefe_proyecto'] = "id_jefe_proyecto";
   $tab_labels["id_jefe_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_jefe_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_jefe_proyecto"] : "Jefe De Proyecto";
   $tab_ger_campos['id_direccion'] = "on";
   $tab_def_campos['id_direccion'] = "id_direccion";
   $tab_labels["id_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_direccion"] : "Gerente De Proyecto";
   $tab_ger_campos['id_portafolio'] = "on";
   $tab_def_campos['id_portafolio'] = "id_portafolio";
   $tab_labels["id_portafolio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_portafolio"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_portafolio"] : "Portafolio<br>(Centro Negocio)";
   $tab_ger_campos['fecha_inicio'] = "on";
   $tab_def_campos['fecha_inicio'] = "fecha_inicio";
   $tab_labels["fecha_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["fecha_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["fecha_inicio"] : "Fecha Inicio";
   $tab_ger_campos['fecha_termino'] = "on";
   $tab_def_campos['fecha_termino'] = "fecha_termino";
   $tab_labels["fecha_termino"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["fecha_termino"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["fecha_termino"] : "Fecha Término";
   $tab_ger_campos['tipo_moneda'] = "on";
   $tab_def_campos['tipo_moneda'] = "tipo_moneda";
   $tab_labels["tipo_moneda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["tipo_moneda"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["tipo_moneda"] : "Tipo Moneda";
   $tab_ger_campos['duracion'] = "on";
   $tab_def_campos['duracion'] = "duracion";
   $tab_labels["duracion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["duracion"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["duracion"] : "Duración (Meses)";
   $tab_ger_campos['presupuesto'] = "on";
   $tab_def_campos['presupuesto'] = "presupuesto";
   $tab_labels["presupuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["presupuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["presupuesto"] : "Presupuesto<br>Base";
   $tab_ger_campos['id_fase'] = "on";
   $tab_def_campos['id_fase'] = "id_fase";
   $tab_labels["id_fase"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_fase"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_fase"] : "Fase";
   $tab_ger_campos['id_estado'] = "on";
   $tab_def_campos['id_estado'] = "id_estado";
   $tab_labels["id_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["id_estado"] : "Estado";
   $tab_ger_campos['habilitado'] = "on";
   $tab_def_campos['habilitado'] = "habilitado";
   $tab_labels["habilitado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["habilitado"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["habilitado"] : "Habilitado";
   $tab_ger_campos['afecta_iva'] = "on";
   $tab_def_campos['afecta_iva'] = "afecta_iva";
   $tab_labels["afecta_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["afecta_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["afecta_iva"] : "Afecta a IVA";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_proyectos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_proyectos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_proyectos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_proyectos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
