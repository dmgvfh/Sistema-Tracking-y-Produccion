...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_proyectos" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_proyectos_total.class.php"); 
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_proyectos']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_proyectos']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['embutida'])
      { 
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['presupuesto_itemizado'])) ? $this->New_label['presupuesto_itemizado'] : "Presupuesto<br>Itemizado"; 
          if ((!isset($this->NM_cmp_hidden['presupuesto_itemizado']) || $this->NM_cmp_hidden['presupuesto_itemizado'] != "off") && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->arr_span['presupuesto_itemizado'] = $this->count_span;
              $this->Emb_label_cols_presupuesto_itemizado = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['embutida_label'] = true;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_presupuesto_itemizado += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_presupuesto_itemizado += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_presupuesto_itemizado++;
                         }
                     }
                  }
              }
      ...
      { 
          ...
          {
              while ($this->count_span < $this->Emb_label_cols_presupuesto_itemizado)
              {
   ...
   function NM_export_id_cliente()
   {
         ...
         if (is_numeric($this->look_id_cliente))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_id_cliente);
         $this->Xls_col++;
   }
   //----- id_jefe_proyecto
   function NM_export_id_jefe_proyecto()
   {
         ...
         if (is_numeric($this->look_id_jefe_proyecto))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_id_jefe_proyecto);
         $this->Xls_col++;
   }
   //----- id_direccion
   function NM_export_id_direccion()
   {
         ...
         if (is_numeric($this->look_id_direccion))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_id_direccion);
         $this->Xls_col++;
   }
   //----- id_portafolio
   function NM_export_id_portafolio()
   {
         ...
         if (is_numeric($this->look_id_portafolio))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_id_portafolio);
         $this->Xls_col++;
   }
   //----- fecha_inicio
   function NM_export_fecha_inicio()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fecha_inicio = substr($this->fecha_inicio, 0, 10);
         if (empty($this->fecha_inicio) || $this->fecha_inicio == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_inicio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_inicio, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fecha_inicio);
   ...
   function NM_export_fecha_termino()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fecha_termino = substr($this->fecha_termino, 0, 10);
         if (empty($this->fecha_termino) || $this->fecha_termino == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_termino, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_termino, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fecha_termino);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_tipo_moneda()
   {
         ...
         if (is_numeric($this->look_tipo_moneda))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_tipo_moneda);
         $this->Xls_col++;
   }
   //----- duracion
   function NM_export_duracion()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->duracion);
         $this->Xls_col++;
   }
   //----- presupuesto
   ...
   function NM_export_id_fase()
   {
         ...
         if (is_numeric($this->look_id_fase))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_id_fase);
         $this->Xls_col++;
   }
   //----- id_estado
   function NM_export_id_estado()
   {
         ...
         if (is_numeric($this->look_id_estado))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_id_estado);
         $this->Xls_col++;
   }
   //----- habilitado
   ...
   function NM_export_afecta_iva()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_afecta_iva, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_afecta_iva, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- observaciones
   ...
   function NM_export_usuarios()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuarios, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuarios, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- codigo
   ...
   //----- id_jefe_proyecto
   function NM_sub_cons_id_jefe_proyecto()
   {
         $this->look_id_jefe_proyecto = NM_charset_to_utf8($this->look_id_jefe_proyecto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_id_jefe_proyecto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- id_direccion
   function NM_sub_cons_id_direccion()
   {
         $this->look_id_direccion = NM_charset_to_utf8($this->look_id_direccion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_id_direccion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- id_portafolio
   function NM_sub_cons_id_portafolio()
   {
         $this->look_id_portafolio = NM_charset_to_utf8($this->look_id_portafolio);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_id_portafolio;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- fecha_inicio
   function NM_sub_cons_fecha_inicio()
   {
         $this->fecha_inicio = substr($this->fecha_inicio, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_inicio;
   ...
   //----- fecha_termino
   function NM_sub_cons_fecha_termino()
   {
         $this->fecha_termino = substr($this->fecha_termino, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_termino;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "data";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = $this->SC_date_conf_region;
         $this->Xls_col++;
   ...
   {
         $this->look_tipo_moneda = NM_charset_to_utf8($this->look_tipo_moneda);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_tipo_moneda;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- duracion
   function NM_sub_cons_duracion()
   {
         $this->duracion = NM_charset_to_utf8($this->duracion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->duracion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- id_fase
   function NM_sub_cons_id_fase()
   {
         $this->look_id_fase = NM_charset_to_utf8($this->look_id_fase);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_id_fase;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- id_estado
   function NM_sub_cons_id_estado()
   {
         $this->look_id_estado = NM_charset_to_utf8($this->look_id_estado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_id_estado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- presupuesto_itemizado
   function NM_sub_cons_presupuesto_itemizado()
   {
         $this->Rows_sub_presupuesto_itemizado = array();
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?id_proyecto?#?" . str_replace("'", "@aspass@", $this->Orig_id) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['embutida'] = true;
         if (method_exists($this->grid_prod_presupuesto, "controle"))
         {
             $this->grid_prod_presupuesto->controle();
             ...
             {
                 $this->row_sub = 1;
             $this->Rows_sub_presupuesto_itemizado = $_SESSION['scriptcase']['export_return'];
             return;
             }
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_presupuesto']['embutida'] = false;
   ...
   //----- afecta_iva
   function NM_sub_cons_afecta_iva()
   {
         $this->look_afecta_iva = NM_charset_to_utf8($this->look_afecta_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_afecta_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- usuarios
   function NM_sub_cons_usuarios()
   {
         $this->usuarios = NM_charset_to_utf8($this->usuarios);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->usuarios;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyectos']['nolabel'])
       {
