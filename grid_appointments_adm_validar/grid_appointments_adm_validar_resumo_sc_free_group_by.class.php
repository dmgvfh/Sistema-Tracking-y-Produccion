...
class grid_appointments_adm_validar_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_id_actividad           = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_appointments_adm_validar']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_appointments_adm_validar']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['orig_pesq'] = "resumo";
...
$_SESSION['scriptcase']['grid_appointments_adm_validar']['contr_erro'] = 'off'; 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total']['appointment_start_date'] = $this->array_total_appointment_start_date;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total']['id_usuario'] = $this->array_total_id_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total']['current_status_id'] = $this->array_total_current_status_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total']['id_proyecto'] = $this->array_total_id_proyecto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total']['id_actividad'] = $this->array_total_id_actividad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['json_use_label'])
       {
          ...
          $Lab_id_actividad = "id_actividad";
       }
       else
       {
       $Lab_appointment_start_date = "Mes / Año";
       ...
       $Lab_id_actividad = "Tipo Actividad";
       }
       $prep_field = array();
       $prep_field['appointment_start_date'] = $Lab_appointment_start_date;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_start_date'] = $Lab_appointment_start_date; 
       $prep_field['id_usuario'] = $Lab_id_usuario;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_usuario'] = $Lab_id_usuario; 
       $prep_field['current_status_id'] = $Lab_current_status_id;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['current_status_id'] = $Lab_current_status_id; 
       $prep_field['id_proyecto'] = $Lab_id_proyecto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_proyecto'] = $Lab_id_proyecto; 
       $prep_field['id_actividad'] = $Lab_id_actividad;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_actividad'] = $Lab_id_actividad; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_proyecto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_proyecto'] = "Proyecto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_usuario'] = "Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_actividad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['id_actividad'] = "Tipo Actividad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['nombre'] = "Nombre Actividad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['current_status_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['current_status_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_start_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_start_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_start_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_start_time'] = "Hora Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_end_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_end_time'] = "Hora Término"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['intervalo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['intervalo'] = "Duración (horas)"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['accion_revertir']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['accion_revertir'] = "Acción"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['accion_aprobar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['accion_aprobar'] = "Aprobar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['accion_rechazar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['accion_rechazar'] = "Rechazar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['hisoria']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['hisoria'] = "Historia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointments_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointments_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointments_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_end_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_end_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_recurrent']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_recurrent'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_recurrent'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_period']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['appointment_period'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_period'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['intervalo_seg']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['labels']['intervalo_seg'] = "Intervalo Seg"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['id_usuario']['alin'] = "''";
       $Arr_parms['id_usuario']['link'] = "S";
       $Arr_parms['current_status_id']['alin'] = "''";
       $Arr_parms['current_status_id']['link'] = "S";
       $Arr_parms['id_proyecto']['alin'] = "''";
       $Arr_parms['id_proyecto']['link'] = "S";
       $Arr_parms['id_actividad']['alin'] = "''";
       $Arr_parms['id_actividad']['link'] = "S";
       ...
       $Arr_parms['id_usuario']['fill'] = "true";
       $Arr_parms['id_usuario']['order'] = "label";
       $Arr_parms['id_usuario']['order_start'] = 'asc';
       $Arr_parms['id_usuario']['order_invert'] = 'false';
       $Arr_parms['id_usuario']['order_enabled'] = 'true';
       $Arr_parms['id_usuario']['order_datatype'] = 'int';
       $Arr_parms['id_usuario']['rating_function'] = '';
       $Arr_parms['current_status_id']['fill'] = "true";
       $Arr_parms['current_status_id']['order'] = "label";
       $Arr_parms['current_status_id']['order_start'] = 'asc';
       $Arr_parms['current_status_id']['order_invert'] = 'false';
       $Arr_parms['current_status_id']['order_enabled'] = 'true';
       $Arr_parms['current_status_id']['order_datatype'] = 'int';
       $Arr_parms['current_status_id']['rating_function'] = '';
       $Arr_parms['id_proyecto']['fill'] = "true";
       $Arr_parms['id_proyecto']['order'] = "label";
       $Arr_parms['id_proyecto']['order_start'] = 'asc';
       $Arr_parms['id_proyecto']['order_invert'] = 'false';
       $Arr_parms['id_proyecto']['order_enabled'] = 'true';
       $Arr_parms['id_proyecto']['order_datatype'] = 'int';
       $Arr_parms['id_proyecto']['rating_function'] = '';
       $Arr_parms['id_actividad']['fill'] = "true";
       $Arr_parms['id_actividad']['order'] = "label";
       $Arr_parms['id_actividad']['order_start'] = 'asc';
       $Arr_parms['id_actividad']['order_invert'] = 'false';
       $Arr_parms['id_actividad']['order_enabled'] = 'true';
       $Arr_parms['id_actividad']['order_datatype'] = 'int';
       $Arr_parms['id_actividad']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['id_usuario'] = array(0 => 'id_usuario', 1 => '');
       $prep_links_fl['current_status_id'] = array(0 => 'current_status_id', 1 => '');
       $prep_links_fl['id_proyecto'] = array(0 => 'id_proyecto', 1 => '');
       $prep_links_fl['id_actividad'] = array(0 => 'id_actividad', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_appointments_adm_validar@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'id_actividad',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_id_actividad)),
               'label_y'  => $this->getChartText(strip_tags("Total Horas")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['anlt_table_def']  = array();
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
				if ($fieldData['display']) {
					$displayedSummarizations[] = $fieldIndex;
				}
			}

			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if (!in_array($summarizingLevel + 1, $displayedSummarizations)) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_charts'][$chartIndex]);
				}
			}

			$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_charts'];
		}
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_appointments_adm_validar_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_appointments_adm_validar_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['proc_pdf_vert']) { 
       ...
       $apl_cab_resumo = "RESUMEN DE HORAS USUARIO";
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_appointments_adm_validar_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Validación de Horas</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_appointments_adm_validar_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_appointments_adm_validar_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_appointments_adm_validar_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_appointments_adm_validar/grid_appointments_adm_validar_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_adm_validar/grid_appointments_adm_validar_config_graf_flash.php?nome_apl=grid_appointments_adm_validar&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_appointments_adm_validar_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if ($this->nmgp_botoes['filter'] == 'on' && !$this->Ini->SC_Link_View && !$this->grid_emb_form)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpesquisa", "", "", "Rpesq_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_adm_validar/grid_appointments_adm_validar.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_opcao=busca&nmgp_orig_pesq=res&KeepThis=true&TB_iframe=true&height=0&width=0&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_appointments_adm_validar_config_pivot.php?nome_apl=grid_appointments_adm_validar&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("<SCRIPT language=\"Javascript\">\r\n");
      ...
      $nm_saida->saida("           document.Fexport.nmgp_password.value = password;\r\n");
      $nm_saida->saida("           document.Fexport.SC_module_export.value = SC_module_export;\r\n");
      $nm_saida->saida("               document.Fexport.action = \"grid_appointments_adm_validar_export_ctrl.php\";\r\n");
      $nm_saida->saida("           document.Fexport.submit() ;\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_appointments_adm_validar_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_appointments_adm_validar_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_appointments_adm_validar/grid_appointments_adm_validar_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
           $tp_quebra .= "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">RESUMEN DE HORAS USUARIO</H1></div>";
       }
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $current_status_id = (isset($Busca_temp['current_status_id'])) ? $Busca_temp['current_status_id'] : ""; 
          $tmp_pos = (is_string($current_status_id)) ? strpos($current_status_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($current_status_id))
          {
              $current_status_id = substr($current_status_id, 0, $tmp_pos);
          }
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">Validación de Horas</div>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_intervalo, $quebra_appointment_start_date, $quebra_id_usuario, $quebra_current_status_id, $quebra_id_proyecto, $quebra_id_actividad, $quebra_appointment_start_date_orig, $quebra_id_usuario_orig, $quebra_current_status_id_orig, $quebra_id_proyecto_orig, $quebra_id_actividad_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->current_status_id = $Busca_temp['current_status_id']; 
       $this->current_status_id = (isset($Busca_temp['current_status_id'])) ? $Busca_temp['current_status_id'] : ""; 
       $tmp_pos = (is_string($this->current_status_id)) ? strpos($this->current_status_id, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->current_status_id))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->id_actividad_orig = $this->id_actividad;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->intervalo, $this->appointment_start_date, $this->id_usuario, $this->current_status_id, $this->id_proyecto, $this->id_actividad, $this->appointment_start_date_orig,  $this->id_usuario_orig,  $this->current_status_id_orig,  $this->id_proyecto_orig,  $this->id_actividad_orig);
            }
   }
//
