...
class grid_appointments_adm_validar_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_appointments_adm_validar_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_appointments_adm_validar_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_appointments_adm_validar_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "appointment_start_date";$Nm_datas[] = "appointment_start_time";$Nm_datas[] = "appointment_end_date";$Nm_datas[] = "appointment_end_time";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " = " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       if (in_array($nome_campo, $this->Out_dyn_search))
                       {
                           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = $NM_cmd;
                           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       }
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   if (in_array($nome_campo, $this->Out_dyn_search))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   }
               }
            break;
            case "DF":     // 
               ...
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome > " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome < " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome between " . $nm_aspas . $campo . $nm_aspas1 . " and " . $nm_aspas . $campo2 . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               }
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " in (" . $cond_str . ")";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
               }
            break;
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome IS NULL ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'];
               }
            break;
            case "NN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome IS NOT NULL ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'];
               }
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome = '' ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'];
               }
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd'][]  = " $nome <> '' ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'];
               }
            break;
         }
      }
...
<?php
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['orig_pesq'] == "res")  
    { 
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_appointments_adm_validar/grid_appointments_adm_validar_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_appointments_adm_validar_ajax_search.js"></script>
 <script type="text/javascript" src="grid_appointments_adm_validar_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_appointments_adm_validar_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_current_status_id_cond#NMF#' + search_get_sel_txt('SC_current_status_id_cond') + '@NMF@';
  str_out += 'SC_current_status_id#NMF#' + search_get_select('SC_current_status_id') + '@NMF@';
  str_out += 'SC_appointment_start_date_cond#NMF#' + search_get_sel_txt('SC_appointment_start_date_cond') + '@NMF@';
  str_out += 'SC_appointment_start_date_dia#NMF#' + search_get_sel_txt('SC_appointment_start_date_dia') + '@NMF@';
  str_out += 'SC_appointment_start_date_mes#NMF#' + search_get_sel_txt('SC_appointment_start_date_mes') + '@NMF@';
  str_out += 'SC_appointment_start_date_ano#NMF#' + search_get_sel_txt('SC_appointment_start_date_ano') + '@NMF@';
  str_out += 'SC_appointment_start_date_input_2_dia#NMF#' + search_get_sel_txt('SC_appointment_start_date_input_2_dia') + '@NMF@';
  str_out += 'SC_appointment_start_date_input_2_mes#NMF#' + search_get_sel_txt('SC_appointment_start_date_input_2_mes') + '@NMF@';
  str_out += 'SC_appointment_start_date_input_2_ano#NMF#' + search_get_sel_txt('SC_appointment_start_date_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"></div>
...
<?php
   ...
   {
      global 
             $current_status_id_cond, $current_status_id,
             $appointment_start_date_cond, $appointment_start_date, $appointment_start_date_dia, $appointment_start_date_mes, $appointment_start_date_ano, $appointment_start_date_input_2_dia, $appointment_start_date_input_2_mes, $appointment_start_date_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['current_status_id']; 
          $current_status_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['current_status_id_cond']; 
          $appointment_start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_dia']; 
          $appointment_start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_mes']; 
          $appointment_start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_ano']; 
          $appointment_start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_input_2_dia']; 
          $appointment_start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_input_2_mes']; 
          $appointment_start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_input_2_ano']; 
          $appointment_start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['NM_operador']; 
      } 
      if (!isset($current_status_id_cond) || empty($current_status_id_cond))
      {
         $current_status_id_cond = "eq";
      }
      if (!isset($appointment_start_date_cond) || empty($appointment_start_date_cond))
      {
         $appointment_start_date_cond = "bw";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_current_status_id = (in_array($current_status_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_appointment_start_date = (in_array($appointment_start_date_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_current_status_id = ('bw' == $current_status_id_cond) ? $display_aberto : $display_fechado;
      $str_display_appointment_start_date = ('bw' == $appointment_start_date_cond) ? $display_aberto : $display_fechado;

      if (!isset($current_status_id) || $current_status_id == "")
      {
          $current_status_id = "";
      }
      if (isset($current_status_id) && !empty($current_status_id))
      {
      ...
      if (!isset($appointment_start_date) || $appointment_start_date == "")
      {
          $appointment_start_date = "";
      }
      if (isset($appointment_start_date) && !empty($appointment_start_date))
      {
...
?>
<?php
   if (is_file("grid_appointments_adm_validar_help.txt"))
   {
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "self.parent.tb_remove();", "self.parent.tb_remove();", "sc_b_cancel_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
    </td>
   </tr></table>
<?php
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_current_status_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['current_status_id'])) ? $this->New_label['current_status_id'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_current_status_id_cond" name="current_status_id_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_current_status_id" <?php echo $str_hide_current_status_id?> valign="top">
 ...
 $nmgp_tab_label .= "current_status_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      $current_status_id_look = (is_string($current_status_id) ? substr($this->Db->qstr($current_status_id), 1, -1) : $current_status_id); 
      $nmgp_def_dados = "" ; 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['psq_check_ret']['current_status_id'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['psq_check_ret']['current_status_id'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_current_status_id">
      <SELECT class="scFilterObjectOdd" id="SC_current_status_id" name="current_status_id"  size="1">
       <OPTION value=""></OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
                    $current_status_id_sel = ($nm_opc_cod === $current_status_id) ? "selected" : "";
            }
            else
            {
               $current_status_id_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $current_status_id_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_appointment_start_date_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_appointment_start_date_cond" name="appointment_start_date_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_appointment_start_date" <?php echo $str_hide_appointment_start_date?> valign="top">
 ...
 $nmgp_tab_label .= "appointment_start_date?#?" . $SC_Label . "?@?";
 $date_sep_bw = " Hasta ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_appointment_start_date_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_appointment_start_date_dia" name="appointment_start_date_dia" value="<?php echo NM_encode_input($appointment_start_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_appointment_start_date_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_appointment_start_date_mes" name="appointment_start_date_mes" value="<?php echo NM_encode_input($appointment_start_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_appointment_start_date_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_appointment_start_date_ano" name="appointment_start_date_ano" value="<?php echo NM_encode_input($appointment_start_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_vis_appointment_start_date"  <?php echo $str_display_appointment_start_date; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<span id='id_date_part_appointment_start_date_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_appointment_start_date_input_2_dia" name="appointment_start_date_input_2_dia" value="<?php echo NM_encode_input($appointment_start_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_appointment_start_date_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_appointment_start_date_input_2_mes" name="appointment_start_date_input_2_mes" value="<?php echo NM_encode_input($appointment_start_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_appointment_start_date_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_appointment_start_date_input_2_ano" name="appointment_start_date_input_2_ano" value="<?php echo NM_encode_input($appointment_start_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        ...
        <SPAN id="id_css_appointment_start_date" class="scFilterFieldFontEven">
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.current_status_id_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_current_status_id'), document.F1.current_status_id_cond, 'current_status_id');
   document.F1.current_status_id.value = "";
   document.F1.appointment_start_date_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_appointment_start_date'), document.F1.appointment_start_date_cond, 'appointment_start_date');
   document.F1.appointment_start_date_dia.value = "";
   document.F1.appointment_start_date_mes.value = "";
   document.F1.appointment_start_date_ano.value = "";
   document.F1.appointment_start_date_input_2_dia.value = "";
   document.F1.appointment_start_date_input_2_mes.value = "";
   document.F1.appointment_start_date_input_2_ano.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_appointment_start_date_dia').bind('change', function() {sc_grid_appointments_adm_validar_valida_dia(this)});
    $('#SC_appointment_start_date_input_2_dia').bind('change', function() {sc_grid_appointments_adm_validar_valida_dia(this)});
    $('#SC_appointment_start_date_input_2_mes').bind('change', function() {sc_grid_appointments_adm_validar_valida_mes(this)});
    $('#SC_appointment_start_date_mes').bind('change', function() {sc_grid_appointments_adm_validar_valida_mes(this)});
 }
 function sc_grid_appointments_adm_validar_valida_dia(obj)
 {
 ...
 function sc_grid_appointments_adm_validar_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_appointments_adm_validar";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_appointments_adm_validar/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_current_status_id_cond'] = 'cond';
      $tp_fields['SC_current_status_id'] = 'select';
      $tp_fields['SC_appointment_start_date_cond'] = 'cond';
      $tp_fields['SC_appointment_start_date_dia'] = 'text';
      $tp_fields['SC_appointment_start_date_mes'] = 'text';
      $tp_fields['SC_appointment_start_date_ano'] = 'text';
      $tp_fields['SC_appointment_start_date_input_2_dia'] = 'text';
      $tp_fields['SC_appointment_start_date_input_2_mes'] = 'text';
      $tp_fields['SC_appointment_start_date_input_2_ano'] = 'text';
   ...
   {
      global $current_status_id_cond, $current_status_id,
             $appointment_start_date_cond, $appointment_start_date, $appointment_start_date_dia, $appointment_start_date_mes, $appointment_start_date_ano, $appointment_start_date_input_2_dia, $appointment_start_date_input_2_mes, $appointment_start_date_input_2_ano, $nmgp_tab_label;
      ...
      $this->Out_dyn_search[] = "current_status_id";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cmd']  = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search_out_cond'] = array();
      $current_status_id_cond_salva = $current_status_id_cond; 
      if (!isset($current_status_id_input_2) || $current_status_id_input_2 == "")
      {
          $current_status_id_input_2 = $current_status_id;
      }
      $appointment_start_date_cond_salva = $appointment_start_date_cond; 
      if (!isset($appointment_start_date_input_2_dia) || $appointment_start_date_input_2_dia == "")
      {
          $appointment_start_date_input_2_dia = $appointment_start_date_dia;
      }
      if (!isset($appointment_start_date_input_2_mes) || $appointment_start_date_input_2_mes == "")
      {
          $appointment_start_date_input_2_mes = $appointment_start_date_mes;
      }
      if (!isset($appointment_start_date_input_2_ano) || $appointment_start_date_input_2_ano == "")
      {
          $appointment_start_date_input_2_ano = $appointment_start_date_ano;
      }
      $tmp_pos = (is_string($current_status_id)) ? strpos($current_status_id, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $current_status_id;
      }
      else {
          $L_lookup = substr($current_status_id, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['psq_check_ret']['current_status_id'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      ...
      $I_Dyn = 0;
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['current_status_id'] = $current_status_id; 
      if (is_array($current_status_id) && !empty($current_status_id))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['val'][0] = $current_status_id;
      }
      elseif ($current_status_id_cond_salva == "nu" || $current_status_id_cond_salva == "nn" || $current_status_id_cond_salva == "ep" || $current_status_id_cond_salva == "ne" || !empty($current_status_id))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['val'][0][0] = $current_status_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['current_status_id_cond'] = $current_status_id_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['cmp'] = "current_status_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['opc'] = $current_status_id_cond_salva; 
          $I_Dyn++;
      }
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_dia'] = $appointment_start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_mes'] = $appointment_start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_ano'] = $appointment_start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_input_2_dia'] = $appointment_start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_input_2_mes'] = $appointment_start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_input_2_ano'] = $appointment_start_date_input_2_ano; 
      if (!empty($appointment_start_date_dia) || !empty($appointment_start_date_mes) || !empty($appointment_start_date_ano) || $appointment_start_date_cond_salva == "nu" || $appointment_start_date_cond_salva == "nn" || $appointment_start_date_cond_salva == "ep" || $appointment_start_date_cond_salva == "ne")
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['val'][0][] = "D:" . $appointment_start_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['val'][0][] = "M:" . $appointment_start_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['val'][0][] = "Y:" . $appointment_start_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['val'][1][] = "D:" . $appointment_start_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['val'][1][] = "M:" . $appointment_start_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['val'][1][] = "Y:" . $appointment_start_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_cond'] = $appointment_start_date_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['cmp'] = "appointment_start_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['dyn_search'][$I_Dyn]['opc'] = $appointment_start_date_cond_salva; 
          $I_Dyn++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $current_status_id;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['current_status_id'] = $Conteudo;

      //----- $current_status_id
      $this->Date_part = false;
      if (isset($current_status_id))
      {
         $this->monta_condicao("current_status_id", $current_status_id_cond, $current_status_id, "", "current_status_id", "INT", false);
      }

      //----- $appointment_start_date
      $this->Date_part = false;
      if ($appointment_start_date_cond != "bi_TP")
      {
          $appointment_start_date_cond = strtoupper($appointment_start_date_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $appointment_start_date_ano;
          $Dtxt .= $appointment_start_date_mes;
          $Dtxt .= $appointment_start_date_dia;
          $val[0]['ano'] = $appointment_start_date_ano;
          $val[0]['mes'] = $appointment_start_date_mes;
          $val[0]['dia'] = $appointment_start_date_dia;
          if ($appointment_start_date_cond == "BW")
          {
              $val[1]['ano'] = $appointment_start_date_input_2_ano;
              $val[1]['mes'] = $appointment_start_date_input_2_mes;
              $val[1]['dia'] = $appointment_start_date_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $appointment_start_date_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $appointment_start_date = $val[0];
          $this->cmp_formatado['appointment_start_date'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['appointment_start_date'], "YYYY-MM-DD");
          $this->cmp_formatado['appointment_start_date'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($appointment_start_date_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $appointment_start_date_input_2     = $val[1];
              $this->cmp_formatado['appointment_start_date_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']['appointment_start_date_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['appointment_start_date_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['appointment_start_date_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $appointment_start_date_cond == "NU" || $appointment_start_date_cond == "NN"|| $appointment_start_date_cond == "EP"|| $appointment_start_date_cond == "NE")
          {
              $this->monta_condicao("appointment_start_date", $appointment_start_date_cond, $appointment_start_date, $appointment_start_date_input_2, 'appointment_start_date', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['cond_pesq'] .= $this->NM_operador;
...
?>
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "current_status_id" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
