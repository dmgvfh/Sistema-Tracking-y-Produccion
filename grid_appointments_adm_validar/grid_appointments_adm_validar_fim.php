...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_appointments_adm_validar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_appointments_adm_validar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_validar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_validar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_validar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_validar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_validar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_appointments_adm_validar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_validar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_validar']['embutida_filho'] as $ind => $sc_init)
          {
