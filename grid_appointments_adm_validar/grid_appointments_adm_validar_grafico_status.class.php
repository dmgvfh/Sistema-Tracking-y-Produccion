...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . "";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['contr_label_graf']['current_status_id']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['contr_label_graf']['current_status_id']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['contr_label_graf']['current_status_id'];
      }
   }
