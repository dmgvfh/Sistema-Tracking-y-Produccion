...
$_SESSION['scriptcase']['grid_appointments_adm_validar']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['arr_total']['current_status_id'];
      }
      else
      {
          $this->array_total_current_status_id = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_order']['status']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_order']['status'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_order']['status'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['status'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['status'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['status'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['status'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['status'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['status'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_validar']['summarizing_fields_display']['status'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_current_status_id as $i_current_status_id => $d_current_status_id) {
           if (!isset($i_current_status_id, $this->comp_label[0]) || !in_array($i_current_status_id, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_current_status_id[3] ] = $d_current_status_id[2];
               $this->comp_label[0][ $d_current_status_id[3] ] = $d_current_status_id[2];
           }
       }
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_current_status_id => $l_current_status_id) {
           if (isset($this->array_total_current_status_id[$i_current_status_id])) {
               $this->comp_group[$i_current_status_id] = array();
           }
       }
     }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_intervalo, $quebra_current_status_id, $quebra_current_status_id_orig)
   {
      //----- current_status_id
      if (!isset($this->array_total_current_status_id[$quebra_current_status_id_orig]))
      {
         $this->array_total_current_status_id[$quebra_current_status_id_orig][0] = 1;
         $this->array_total_current_status_id[$quebra_current_status_id_orig][1] = $sum_intervalo;
         $this->array_total_current_status_id[$quebra_current_status_id_orig][2] = $quebra_current_status_id;
         $this->array_total_current_status_id[$quebra_current_status_id_orig][3] = $quebra_current_status_id_orig;
      }
      else
      {
         $this->array_total_current_status_id[$quebra_current_status_id_orig][0]++;
         $this->array_total_current_status_id[$quebra_current_status_id_orig][1] = bcadd($this->array_total_current_status_id[$quebra_current_status_id_orig][1], $sum_intervalo, 10);
      }
   }
...
$_SESSION['scriptcase']['grid_appointments_adm_validar']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->intervalo, $this->current_status_id, $this->current_status_id_orig);
            }
   }
//
