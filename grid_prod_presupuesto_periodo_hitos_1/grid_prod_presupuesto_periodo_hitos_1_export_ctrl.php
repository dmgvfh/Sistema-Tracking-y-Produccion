<?php
@session_start() ;
$_SESSION['scriptcase']['grid_prod_presupuesto_periodo_hitos_1']['sc_process_barr'] = true;
require_once('../grid_prod_presupuesto_periodo_hitos_1/index.php');
unset($_SESSION['scriptcase']['grid_prod_presupuesto_periodo_hitos_1']['sc_process_barr']);
$ExportCtrl = new grid_prod_presupuesto_periodo_hitos_1_export_control;
$ExportCtrl->Export_barr();

class grid_prod_presupuesto_periodo_hitos_1_export_control
{
