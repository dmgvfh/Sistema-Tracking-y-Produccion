...
?>
  ...
  function do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_con_iva()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_con_iva(var_reajuste_acumulado_con_iva, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_con_iva_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_con_iva

  function do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_con_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_con_iva_cb
  ...
  function do_ajax_form_prod_presupuesto_periodo_validate_hitos_facturacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_hitos_facturacion(var_hitos_facturacion, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_hitos_facturacion_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_hitos_facturacion

  function do_ajax_form_prod_presupuesto_periodo_validate_hitos_facturacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_hitos_facturacion_cb
  ...
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange(var_produccion_neto, var_reajuste_acumulado_neto, var_retencion_acumulada, var_fecha_desde_factura, var_fecha_hasta_factura, var_fecha_desde, var_id_proyecto, var_reajuste_acumulado_con_iva, var_avance_informado_con_iva, var_multa, var_retencion_con_iva, var_existe_retencion, var_retencion, var_considera_retencion, var_iva, var_monto_uf, var_total_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange_cb);
  ...
  function do_ajax_form_prod_presupuesto_periodo_event_multa_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_multa_onchange(var_produccion_neto, var_reajuste_acumulado_neto, var_fecha_desde_factura, var_fecha_hasta_factura, var_fecha_desde, var_id_proyecto, var_reajuste_acumulado_con_iva, var_avance_informado_con_iva, var_multa, var_retencion_con_iva, var_retencion, var_incluye_retencion, var_iva, var_monto_uf, var_total_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_multa_onchange_cb);
  ...
  function do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_retencion_onchange(var_monto_uf, var_retencion, var_iva, var_retencion_con_iva, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange_cb);
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_form_prod_presupuesto_periodo_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_submit_form(var_id, var_id_proyecto, var_monto_contrato, var_tipo_moneda, var_empresa, var_cliente, var_id_partida, var_fecha_desde, var_fecha_hasta, var_dias_desde, var_dias_hasta, var_dias_periodo, var_fecha_desde_factura, var_fecha_hasta_factura, var_avance_informado_con_iva, var_produccion_neto, var_retencion, var_retencion_con_iva, var_retencion_acumulada, var_reajuste_acumulado_con_iva, var_reajuste_acumulado_neto, var_multa, var_total_facturado, var_afecta_iva, var_existe_retencion, var_incluye_retencion, var_considera_retencion, var_facturado, var_observaciones_solicitud, var_iva, var_monto_uf, var_fecha, var_valor_uf, var_observaciones, var_factura, var_hitos_facturacion, var_factura_ul_name, var_factura_ul_type, var_factura_salva, var_factura_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_presupuesto_periodo_submit_form_cb);
