    ...
    function ValidateField_reajuste_acumulado_con_iva(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->reajuste_acumulado_con_iva, 10, 1, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_total_facturado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->total_facturado, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
      ...
      if ($this->hitos_facturacion != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_hitos_facturacion']) && !in_array($dados_hitos_facturacion_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_hitos_facturacion']))
                       {
                           $hasError = true;
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_hitos_facturacion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_hitos_facturacion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_hitos_facturacion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_hitos_facturacion'] = array(); 
}
if ($this->id_partida != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_hitos_facturacion'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
