...
class grid_appointments_adm_gestion_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_appointments_adm_gestion.rtf";
   }
...
$_SESSION['scriptcase']['grid_appointments_adm_gestion']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_appointments_adm_gestion']['contr_erro'] = 'off'; 
   ...
   function NM_export_codigo_proyecto()
   {
         ...
         $this->codigo_proyecto = str_replace('<', '&lt;', $this->codigo_proyecto);
         $this->codigo_proyecto = str_replace('>', '&gt;', $this->codigo_proyecto);
         $this->Texto_tag .= "<td>" . $this->codigo_proyecto . "</td>\r\n";
   }
   //----- nombre_usuario
   function NM_export_nombre_usuario()
   {
         ...
         $this->nombre_usuario = str_replace('<', '&lt;', $this->nombre_usuario);
         $this->nombre_usuario = str_replace('>', '&gt;', $this->nombre_usuario);
         $this->Texto_tag .= "<td>" . $this->nombre_usuario . "</td>\r\n";
   }
   //----- appointments_nombre
   function NM_export_appointments_nombre()
   {
         ...
         $this->appointments_nombre = str_replace('<', '&lt;', $this->appointments_nombre);
         $this->appointments_nombre = str_replace('>', '&gt;', $this->appointments_nombre);
         $this->Texto_tag .= "<td>" . $this->appointments_nombre . "</td>\r\n";
   }
   //----- nombre_actividad
   ...
   function NM_export_appointments_current_status_id()
   {
         ...
         $this->look_appointments_current_status_id = str_replace('<', '&lt;', $this->look_appointments_current_status_id);
         $this->look_appointments_current_status_id = str_replace('>', '&gt;', $this->look_appointments_current_status_id);
         $this->Texto_tag .= "<td>" . $this->look_appointments_current_status_id . "</td>\r\n";
   }
   ...
   function NM_export_appointments_appointment_start_date()
   {
         ...
         $this->appointments_appointment_start_date = NM_charset_to_utf8($this->appointments_appointment_start_date);
         $this->appointments_appointment_start_date = str_replace('<', '&lt;', $this->appointments_appointment_start_date);
         $this->appointments_appointment_start_date = str_replace('>', '&gt;', $this->appointments_appointment_start_date);
         $this->Texto_tag .= "<td>" . $this->appointments_appointment_start_date . "</td>\r\n";
   }
   ...
   function NM_export_appointments_appointment_start_time()
   {
         ...
         $this->appointments_appointment_start_time = str_replace('<', '&lt;', $this->appointments_appointment_start_time);
         $this->appointments_appointment_start_time = str_replace('>', '&gt;', $this->appointments_appointment_start_time);
         $this->Texto_tag .= "<td>" . $this->appointments_appointment_start_time . "</td>\r\n";
   }
   ...
   function NM_export_appointments_appointment_end_time()
   {
         ...
         $this->appointments_appointment_end_time = str_replace('<', '&lt;', $this->appointments_appointment_end_time);
         $this->appointments_appointment_end_time = str_replace('>', '&gt;', $this->appointments_appointment_end_time);
         $this->Texto_tag .= "<td>" . $this->appointments_appointment_end_time . "</td>\r\n";
   }
   ...
   function NM_export_appointments_intervalo()
   {
         ...
         $this->appointments_intervalo = str_replace('<', '&lt;', $this->appointments_intervalo);
         $this->appointments_intervalo = str_replace('>', '&gt;', $this->appointments_intervalo);
         $this->Texto_tag .= "<td>" . $this->appointments_intervalo . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Resumen General de  Horas De Actividades :: RTF</TITLE>
