...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->array_total_nombre_actividad = array();
      $this->array_total_nombre_proyecto = array();
      //---- 
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['appointments_appointment_start_date'] = "Mes / Año";
      $prep_label['appointments_current_status_id'] = "Estado";
      $prep_label['nombre_usuario'] = "Nombre Usuario";
      $prep_label['nombre_actividad'] = "Tipo Actividad";
      $prep_label['nombre_proyecto'] = "Nombre Proyecto";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
