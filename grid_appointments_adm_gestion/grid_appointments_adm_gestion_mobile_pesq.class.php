...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "appointments.appointment_start_date";$Nm_datas[] = "appointments_appointment_start_date";$Nm_datas[] = "appointments.appointment_start_time";$Nm_datas[] = "appointments_appointment_start_time";$Nm_datas[] = "appointments.appointment_end_date";$Nm_datas[] = "appointments_appointment_end_date";$Nm_datas[] = "appointments.appointment_end_time";$Nm_datas[] = "appointments_appointment_end_time";$Nm_numeric[] = "appointments_appointments_id";$Nm_numeric[] = "appointments_current_status_id";$Nm_numeric[] = "appointments_id_proyecto";$Nm_numeric[] = "appointments_id_usuario";$Nm_numeric[] = "appointments_id_actividad";$Nm_numeric[] = "appointments_intervalo";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_appointments_current_status_id"  <?php echo $str_hide_appointments_current_status_id?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_appointments_appointment_start_date"  <?php echo $str_hide_appointments_appointment_start_date?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
