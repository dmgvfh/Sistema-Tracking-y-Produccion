...
<?php
   ...
   $Ord_Cmp = new grid_appointments_adm_gestion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointments_adm_gestion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['codigo_proyecto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['codigo_proyecto'] = "codigo_proyecto";
   }
   else
   {
       $tab_def_campos['codigo_proyecto'] = "proyectos.codigo";
   }
   $tab_labels["codigo_proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["codigo_proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["codigo_proyecto"] : "Código Proyecto";
   $tab_ger_campos['nombre_usuario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nombre_usuario'] = "nombre_usuario";
   }
   else
   {
       $tab_def_campos['nombre_usuario'] = "sec_users.name";
   }
   $tab_labels["nombre_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["nombre_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["nombre_usuario"] : "Nombre Usuario";
   $tab_ger_campos['appointments_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_nombre'] = "appointments_nombre";
   }
   else
   {
       $tab_def_campos['appointments_nombre'] = "appointments.nombre";
   }
   $tab_labels["appointments_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_nombre"] : "Nombre Actividad";
   $tab_ger_campos['nombre_actividad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nombre_actividad'] = "nombre_actividad";
   }
   else
   {
       $tab_def_campos['nombre_actividad'] = "tipo_actividades.nombre_actividad";
   }
   $tab_labels["nombre_actividad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["nombre_actividad"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["nombre_actividad"] : "Tipo Actividad";
   $tab_ger_campos['appointments_current_status_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_current_status_id'] = "appointments_current_status_id";
   }
   else
   {
       $tab_def_campos['appointments_current_status_id'] = "appointments.current_status_id";
   }
   $tab_labels["appointments_current_status_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_current_status_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_current_status_id"] : "Estado";
   $tab_ger_campos['appointments_appointment_start_date'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_appointment_start_date'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['appointments_appointment_start_date'] = "appointments.appointment_start_date";
   }
   $tab_labels["appointments_appointment_start_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_appointment_start_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_appointment_start_date"] : "Fecha Actividad";
   $tab_ger_campos['appointments_appointment_start_time'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_appointment_start_time'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['appointments_appointment_start_time'] = "appointments.appointment_start_time";
   }
   $tab_labels["appointments_appointment_start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_appointment_start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_appointment_start_time"] : "Hora Inicio";
   $tab_ger_campos['appointments_appointment_end_time'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_appointment_end_time'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['appointments_appointment_end_time'] = "appointments.appointment_end_time";
   }
   $tab_labels["appointments_appointment_end_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_appointment_end_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_appointment_end_time"] : "Hora Término";
   $tab_ger_campos['appointments_intervalo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_intervalo'] = "appointments_intervalo";
   }
   else
   {
       $tab_def_campos['appointments_intervalo'] = "appointments.intervalo";
   }
   $tab_labels["appointments_intervalo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_intervalo"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['labels']["appointments_intervalo"] : "Duración (horas)";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointments_adm_gestion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointments_adm_gestion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
