...
class grid_appointments_adm_gestion_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arq_zip    = $this->Arquivo . "_grid_appointments_adm_gestion.zip";
          $this->Arquivo   .= "_grid_appointments_adm_gestion" . $this->Xls_tp;
          $this->Tit_doc    = "grid_appointments_adm_gestion" . $this->Xls_tp;
          $this->Tit_zip    = "grid_appointments_adm_gestion.zip";
...
$_SESSION['scriptcase']['grid_appointments_adm_gestion']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->nombre_actividad = $rs->fields[3] ;  
         $this->appointments_current_status_id = $rs->fields[4] ;  
         $this->appointments_current_status_id = (string)$this->appointments_current_status_id;
         $this->appointments_appointment_start_date = $rs->fields[5] ;  
         $this->appointments_appointment_start_time = $rs->fields[6] ;  
         $this->appointments_appointment_end_time = $rs->fields[7] ;  
         $this->appointments_intervalo = $rs->fields[8] ;  
         ...
         $this->nombre_proyecto = $rs->fields[10] ;  
         $this->appointments_appointments_id = $rs->fields[11] ;  
         ...
         $this->Orig_nombre_actividad = $this->nombre_actividad;
...
$_SESSION['scriptcase']['grid_appointments_adm_gestion']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['embutida'])
      { 
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "nombre_actividad" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   //----- nombre_actividad
   function NM_export_nombre_actividad()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->nombre_actividad = html_entity_decode($this->nombre_actividad, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nombre_actividad = strip_tags($this->nombre_actividad);
         $this->nombre_actividad = NM_charset_to_utf8($this->nombre_actividad);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre_actividad, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre_actividad, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   //----- nombre_actividad
   function NM_sub_cons_nombre_actividad()
   {
         $this->nombre_actividad = html_entity_decode($this->nombre_actividad, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nombre_actividad = strip_tags($this->nombre_actividad);
         $this->nombre_actividad = NM_charset_to_utf8($this->nombre_actividad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nombre_actividad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['nolabel'])
       {
 ...
 function quebra_nombre_proyecto_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_nombre_actividad_sc_free_group_by_top() {
   }
   function quebra_nombre_actividad_sc_free_group_by_bot() {
   }
   function quebra_nombre_proyecto_sc_free_group_by_top() {
   }
   function quebra_nombre_proyecto_sc_free_group_by_bot() {
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion'][$path_doc_md5][1] = $this->Tit_doc;
?>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
