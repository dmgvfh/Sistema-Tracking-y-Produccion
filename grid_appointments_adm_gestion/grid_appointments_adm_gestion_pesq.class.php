...
class grid_appointments_adm_gestion_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_appointments_adm_gestion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_appointments_adm_gestion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_appointments_adm_gestion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " = " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       if (in_array($nome_campo, $this->Out_dyn_search))
                       {
                           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = $NM_cmd;
                           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       }
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   if (in_array($nome_campo, $this->Out_dyn_search))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   }
               }
            break;
            case "DF":     // 
               ...
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome > " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome < " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome between " . $nm_aspas . $campo . $nm_aspas1 . " and " . $nm_aspas . $campo2 . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               }
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " in (" . $cond_str . ")";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
               }
            break;
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome IS NULL ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'];
               }
            break;
            case "NN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome IS NOT NULL ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'];
               }
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome = '' ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'];
               }
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd'][]  = " $nome <> '' ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'];
               }
            break;
         }
      }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_appointments_adm_gestion/grid_appointments_adm_gestion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_appointments_adm_gestion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_appointments_adm_gestion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_appointments_adm_gestion_message.js"></script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $appointments_current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_current_status_id']; 
          $appointments_current_status_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_current_status_id_cond']; 
          $appointments_appointment_start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_dia']; 
          $appointments_appointment_start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_mes']; 
          $appointments_appointment_start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_ano']; 
          $appointments_appointment_start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_input_2_dia']; 
          $appointments_appointment_start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_input_2_mes']; 
          $appointments_appointment_start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_input_2_ano']; 
          $appointments_appointment_start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['NM_operador']; 
      } 
...
?>
<?php
   if (is_file("grid_appointments_adm_gestion_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dashboard_info']['under_dashboard'])
       { }
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['opc_psq'])
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_appointments_current_status_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['appointments_current_status_id'])) ? $this->New_label['appointments_current_status_id'] : "Estado"; ?></TD>
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['psq_check_ret']['appointments_current_status_id'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['psq_check_ret']['appointments_current_status_id'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_appointments_current_status_id">
      <SELECT class="scFilterObjectOdd" id="SC_appointments_current_status_id" name="appointments_current_status_id"  size="1">
       <OPTION value=""></OPTION>
<?php
...
?>
      ...
      <TD id='SC_appointments_appointment_start_date_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['appointments_appointment_start_date'])) ? $this->New_label['appointments_appointment_start_date'] : "Fecha Actividad"; ?></TD>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_appointments_appointment_start_date_dia" name="appointments_appointment_start_date_dia" value="<?php echo NM_encode_input($appointments_appointment_start_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_vis_appointments_appointment_start_date"  <?php echo $str_display_appointments_appointment_start_date; ?> class="scFilterFieldFontEven">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_appointments_appointment_start_date_input_2_ano" name="appointments_appointment_start_date_input_2_ano" value="<?php echo NM_encode_input($appointments_appointment_start_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        ...
        <SPAN id="id_css_appointments_appointment_start_date" class="scFilterFieldFontEven">
...
{
?>
<iframe id="nmsc_iframe_grid_appointments_adm_gestion" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_appointments_adm_gestion" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_appointments_adm_gestion_pesq"  name="nm_iframe_grid_appointments_adm_gestion_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_appointments_adm_gestion";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_appointments_adm_gestion').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
 ...
 {
    $('#SC_appointments_appointment_start_date_dia').bind('change', function() {sc_grid_appointments_adm_gestion_valida_dia(this)});
    $('#SC_appointments_appointment_start_date_input_2_dia').bind('change', function() {sc_grid_appointments_adm_gestion_valida_dia(this)});
    $('#SC_appointments_appointment_start_date_input_2_mes').bind('change', function() {sc_grid_appointments_adm_gestion_valida_mes(this)});
    $('#SC_appointments_appointment_start_date_mes').bind('change', function() {sc_grid_appointments_adm_gestion_valida_mes(this)});
 }
 function sc_grid_appointments_adm_gestion_valida_dia(obj)
 {
 ...
 function sc_grid_appointments_adm_gestion_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_appointments_adm_gestion";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_appointments_adm_gestion/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $appointments_current_status_id_cond, $appointments_current_status_id,
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cmd']  = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search_out_cond'] = array();
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['psq_check_ret']['appointments_current_status_id'])) {
      ...
      $I_Dyn = 0;
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_current_status_id'] = $appointments_current_status_id; 
      if (is_array($appointments_current_status_id) && !empty($appointments_current_status_id))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['val'][0] = $appointments_current_status_id;
      }
      ...
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['val'][0][0] = $appointments_current_status_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_current_status_id_cond'] = $appointments_current_status_id_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['cmp'] = "appointments_current_status_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['opc'] = $appointments_current_status_id_cond_salva; 
          $I_Dyn++;
      }
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_dia'] = $appointments_appointment_start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_mes'] = $appointments_appointment_start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_ano'] = $appointments_appointment_start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_input_2_dia'] = $appointments_appointment_start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_input_2_mes'] = $appointments_appointment_start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_input_2_ano'] = $appointments_appointment_start_date_input_2_ano; 
      ...
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['val'][0][] = "D:" . $appointments_appointment_start_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['val'][0][] = "M:" . $appointments_appointment_start_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['val'][0][] = "Y:" . $appointments_appointment_start_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['val'][1][] = "D:" . $appointments_appointment_start_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['val'][1][] = "M:" . $appointments_appointment_start_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['val'][1][] = "Y:" . $appointments_appointment_start_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_cond'] = $appointments_appointment_start_date_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['cmp'] = "appointments_appointment_start_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['dyn_search'][$I_Dyn]['opc'] = $appointments_appointment_start_date_cond_salva; 
          $I_Dyn++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($appointments_appointment_start_date_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date'] = $val[0];
          ...
          if ($appointments_appointment_start_date_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']['appointments_appointment_start_date_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "appointments_current_status_id" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
