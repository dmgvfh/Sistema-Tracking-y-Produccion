...
class grid_appointments_adm_gestion_resumo
{
   ...
   var $array_total_nombre_actividad;
   var $array_total_nombre_proyecto;
...
$_SESSION['scriptcase']['grid_appointments_adm_gestion']['contr_erro'] = 'off'; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['arr_total']['nombre_usuario'] = $this->array_total_nombre_usuario;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['arr_total']['nombre_actividad'] = $this->array_total_nombre_actividad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['arr_total']['nombre_proyecto'] = $this->array_total_nombre_proyecto;
   ...
   function completeMatrix()
   {
       ...
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['json_use_label'])
       {
          ...
          $Lab_nombre_actividad = "nombre_actividad";
          $Lab_nombre_proyecto = "nombre_proyecto";
       }
       else
       {
       ...
       $Lab_nombre_actividad = "Tipo Actividad";
       $Lab_nombre_proyecto = "Proyecto";
       }
       $prep_field = array();
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['labels']['nombre_usuario'] = $Lab_nombre_usuario; 
       $prep_field['nombre_actividad'] = $Lab_nombre_actividad;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['labels']['nombre_actividad'] = $Lab_nombre_actividad; 
       $prep_field['nombre_proyecto'] = $Lab_nombre_proyecto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['labels']['nombre_proyecto'] = $Lab_nombre_proyecto; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['nombre_actividad']['alin'] = "''";
       $Arr_parms['nombre_actividad']['link'] = "S";
       $Arr_parms['nombre_proyecto']['alin'] = "''";
       $Arr_parms['nombre_proyecto']['link'] = "S";
       ...
       $Arr_parms['nombre_actividad']['fill'] = "true";
       $Arr_parms['nombre_actividad']['order'] = "label";
       $Arr_parms['nombre_actividad']['order_start'] = 'asc';
       $Arr_parms['nombre_actividad']['order_invert'] = 'false';
       $Arr_parms['nombre_actividad']['order_enabled'] = 'true';
       $Arr_parms['nombre_actividad']['order_datatype'] = 'varchar';
       $Arr_parms['nombre_actividad']['rating_function'] = '';
       $Arr_parms['nombre_proyecto']['fill'] = "true";
       $Arr_parms['nombre_proyecto']['order'] = "label";
       $Arr_parms['nombre_proyecto']['order_start'] = 'asc';
       $Arr_parms['nombre_proyecto']['order_invert'] = 'false';
       $Arr_parms['nombre_proyecto']['order_enabled'] = 'true';
       $Arr_parms['nombre_proyecto']['order_datatype'] = 'varchar';
       $Arr_parms['nombre_proyecto']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['nombre_actividad'] = array(0 => 'nombre_actividad', 1 => '@aspass@');
       $prep_links_fl['nombre_proyecto'] = array(0 => 'nombre_proyecto', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'nombre_actividad',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_nombre_actividad)),
               'label_y'  => $this->getChartText(strip_tags("Total Horas")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'nombre_proyecto',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_nombre_proyecto)),
               'label_y'  => $this->getChartText(strip_tags("Total Horas")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
				if ($fieldData['display']) {
					$displayedSummarizations[] = $fieldIndex;
				}
			}

			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if (!in_array($summarizingLevel + 1, $displayedSummarizations)) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['pivot_charts'][$chartIndex]);
				}
			}

			$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['pivot_charts'];
		}
	}
...
{ 
   ...
   $nm_saida->saida("<SCRIPT language=\"Javascript\">\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_appointments_intervalo, $quebra_appointments_appointment_start_date, $quebra_appointments_current_status_id, $quebra_nombre_usuario, $quebra_nombre_actividad, $quebra_nombre_proyecto, $quebra_appointments_appointment_start_date_orig, $quebra_appointments_current_status_id_orig, $quebra_nombre_usuario_orig, $quebra_nombre_actividad_orig, $quebra_nombre_proyecto_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_gestion']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nombre_actividad_orig = $this->nombre_actividad;
            $this->nombre_proyecto_orig = $this->nombre_proyecto;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->appointments_intervalo, $this->appointments_appointment_start_date, $this->appointments_current_status_id, $this->nombre_usuario, $this->nombre_actividad, $this->nombre_proyecto, $this->appointments_appointment_start_date_orig,  $this->appointments_current_status_id_orig,  $this->nombre_usuario_orig,  $this->nombre_actividad_orig,  $this->nombre_proyecto_orig);
            }
   }
//
