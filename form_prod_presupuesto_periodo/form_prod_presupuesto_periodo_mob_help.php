...
@session_start() ;
class form_prod_presupuesto_periodo_mob_help
{
    function __construct()
    {
        ...
        if ($nm_cod_campo ==  "hitos_facturacion")
        {
?>
...
<?php echo "<b>Hitos Relacionados</b><br>" . nl2br("Asocie Hitos Contractuales, Disponibles para el Período"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_prod_presupuesto_periodo_mob_help();
?>
