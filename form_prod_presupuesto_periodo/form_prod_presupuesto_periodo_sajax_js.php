  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_presupuesto_periodo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_presupuesto_periodo_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_prod_presupuesto_periodo_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_id(var_id, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_id_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_id

  function do_ajax_form_prod_presupuesto_periodo_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_id_cb

  // ---------- Validate id_proyecto
  function do_ajax_form_prod_presupuesto_periodo_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_id_proyecto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_id_proyecto

  function do_ajax_form_prod_presupuesto_periodo_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_id_proyecto_cb

  // ---------- Validate monto_contrato
  function do_ajax_form_prod_presupuesto_periodo_validate_monto_contrato()
  {
    var nomeCampo_monto_contrato = "monto_contrato";
    var var_monto_contrato = scAjaxGetFieldText(nomeCampo_monto_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_monto_contrato(var_monto_contrato, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_monto_contrato_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_monto_contrato

  function do_ajax_form_prod_presupuesto_periodo_validate_monto_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_monto_contrato_cb

  // ---------- Validate tipo_moneda
  function do_ajax_form_prod_presupuesto_periodo_validate_tipo_moneda()
  {
    var nomeCampo_tipo_moneda = "tipo_moneda";
    var var_tipo_moneda = scAjaxGetFieldSelect(nomeCampo_tipo_moneda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_tipo_moneda(var_tipo_moneda, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_tipo_moneda_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_tipo_moneda

  function do_ajax_form_prod_presupuesto_periodo_validate_tipo_moneda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_tipo_moneda_cb

  // ---------- Validate empresa
  function do_ajax_form_prod_presupuesto_periodo_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldSelect(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_empresa_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_empresa

  function do_ajax_form_prod_presupuesto_periodo_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_empresa_cb

  // ---------- Validate id_partida
  function do_ajax_form_prod_presupuesto_periodo_validate_id_partida()
  {
    var nomeCampo_id_partida = "id_partida";
    var var_id_partida = scAjaxGetFieldSelect(nomeCampo_id_partida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_id_partida(var_id_partida, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_id_partida_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_id_partida

  function do_ajax_form_prod_presupuesto_periodo_validate_id_partida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_id_partida_cb

  // ---------- Validate fecha_desde
  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde()
  {
    ...
    setTimeout(function() {
      var var_fecha_desde = scAjaxGetFieldText(nomeCampo_fecha_desde);
      x_ajax_form_prod_presupuesto_periodo_validate_fecha_desde(var_fecha_desde, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_cb);
    }, 200);
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde

  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_cb

  // ---------- Validate fecha_hasta
  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta()
  {
    ...
    setTimeout(function() {
      var var_fecha_hasta = scAjaxGetFieldText(nomeCampo_fecha_hasta);
      x_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta(var_fecha_hasta, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_cb);
    }, 200);
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta

  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_cb

  // ---------- Validate dias_desde
  function do_ajax_form_prod_presupuesto_periodo_validate_dias_desde()
  {
    var nomeCampo_dias_desde = "dias_desde";
    var var_dias_desde = scAjaxGetFieldText(nomeCampo_dias_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_dias_desde(var_dias_desde, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_dias_desde_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_dias_desde

  function do_ajax_form_prod_presupuesto_periodo_validate_dias_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_dias_desde_cb

  // ---------- Validate dias_hasta
  function do_ajax_form_prod_presupuesto_periodo_validate_dias_hasta()
  {
    var nomeCampo_dias_hasta = "dias_hasta";
    var var_dias_hasta = scAjaxGetFieldText(nomeCampo_dias_hasta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_dias_hasta(var_dias_hasta, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_dias_hasta_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_dias_hasta

  function do_ajax_form_prod_presupuesto_periodo_validate_dias_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_dias_hasta_cb

  // ---------- Validate dias_periodo
  function do_ajax_form_prod_presupuesto_periodo_validate_dias_periodo()
  {
    var nomeCampo_dias_periodo = "dias_periodo";
    var var_dias_periodo = scAjaxGetFieldText(nomeCampo_dias_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_dias_periodo(var_dias_periodo, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_dias_periodo_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_dias_periodo

  function do_ajax_form_prod_presupuesto_periodo_validate_dias_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_dias_periodo_cb

  // ---------- Validate fecha_desde_factura
  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_factura()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_factura(var_fecha_desde_factura, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_factura_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_factura

  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_factura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_factura_cb

  // ---------- Validate fecha_hasta_factura
  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_factura()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_factura(var_fecha_hasta_factura, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_factura_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_factura

  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_factura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_factura_cb

  // ---------- Validate avance_informado_con_iva
  function do_ajax_form_prod_presupuesto_periodo_validate_avance_informado_con_iva()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_avance_informado_con_iva(var_avance_informado_con_iva, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_avance_informado_con_iva_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_avance_informado_con_iva

  function do_ajax_form_prod_presupuesto_periodo_validate_avance_informado_con_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_avance_informado_con_iva_cb

  // ---------- Validate produccion_neto
  function do_ajax_form_prod_presupuesto_periodo_validate_produccion_neto()
  {
    var nomeCampo_produccion_neto = "produccion_neto";
    var var_produccion_neto = scAjaxGetFieldText(nomeCampo_produccion_neto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_produccion_neto(var_produccion_neto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_produccion_neto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_produccion_neto

  function do_ajax_form_prod_presupuesto_periodo_validate_produccion_neto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_produccion_neto_cb

  // ---------- Validate reajuste_acumulado_neto
  function do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_neto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_neto(var_reajuste_acumulado_neto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_neto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_neto

  function do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_neto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_reajuste_acumulado_neto_cb

  // ---------- Validate multa
  function do_ajax_form_prod_presupuesto_periodo_validate_multa()
  {
    var nomeCampo_multa = "multa";
    var var_multa = scAjaxGetFieldText(nomeCampo_multa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_multa(var_multa, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_multa_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_multa

  function do_ajax_form_prod_presupuesto_periodo_validate_multa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "multa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_multa_cb

  // ---------- Validate retencion
  function do_ajax_form_prod_presupuesto_periodo_validate_retencion()
  {
    var nomeCampo_retencion = "retencion";
    var var_retencion = scAjaxGetFieldText(nomeCampo_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_retencion(var_retencion, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_retencion_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_retencion

  function do_ajax_form_prod_presupuesto_periodo_validate_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_retencion_cb

  // ---------- Validate retencion_con_iva
  function do_ajax_form_prod_presupuesto_periodo_validate_retencion_con_iva()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_retencion_con_iva(var_retencion_con_iva, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_retencion_con_iva_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_retencion_con_iva

  function do_ajax_form_prod_presupuesto_periodo_validate_retencion_con_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_retencion_con_iva_cb

  // ---------- Validate retencion_acumulada
  function do_ajax_form_prod_presupuesto_periodo_validate_retencion_acumulada()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_retencion_acumulada(var_retencion_acumulada, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_retencion_acumulada_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_retencion_acumulada

  function do_ajax_form_prod_presupuesto_periodo_validate_retencion_acumulada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_retencion_acumulada_cb

  // ---------- Validate total_facturado
  function do_ajax_form_prod_presupuesto_periodo_validate_total_facturado()
  {
    var nomeCampo_total_facturado = "total_facturado";
    var var_total_facturado = scAjaxGetFieldText(nomeCampo_total_facturado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_total_facturado(var_total_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_total_facturado_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_total_facturado

  function do_ajax_form_prod_presupuesto_periodo_validate_total_facturado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_total_facturado_cb

  // ---------- Validate afecta_iva
  function do_ajax_form_prod_presupuesto_periodo_validate_afecta_iva()
  {
  } // do_ajax_form_prod_presupuesto_periodo_validate_afecta_iva

  function do_ajax_form_prod_presupuesto_periodo_validate_afecta_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_afecta_iva_cb

  // ---------- Validate existe_retencion
  function do_ajax_form_prod_presupuesto_periodo_validate_existe_retencion()
  {
  } // do_ajax_form_prod_presupuesto_periodo_validate_existe_retencion

  function do_ajax_form_prod_presupuesto_periodo_validate_existe_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_existe_retencion_cb

  // ---------- Validate incluye_retencion
  function do_ajax_form_prod_presupuesto_periodo_validate_incluye_retencion()
  {
  } // do_ajax_form_prod_presupuesto_periodo_validate_incluye_retencion

  function do_ajax_form_prod_presupuesto_periodo_validate_incluye_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_incluye_retencion_cb

  // ---------- Validate considera_retencion
  function do_ajax_form_prod_presupuesto_periodo_validate_considera_retencion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_considera_retencion(var_considera_retencion, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_considera_retencion_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_considera_retencion

  function do_ajax_form_prod_presupuesto_periodo_validate_considera_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_considera_retencion_cb

  // ---------- Validate facturado
  function do_ajax_form_prod_presupuesto_periodo_validate_facturado()
  {
    var nomeCampo_facturado = "facturado";
    var var_facturado = scAjaxGetFieldSelect(nomeCampo_facturado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_facturado(var_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_facturado_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_facturado

  function do_ajax_form_prod_presupuesto_periodo_validate_facturado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_facturado_cb

  // ---------- Validate observaciones_solicitud
  function do_ajax_form_prod_presupuesto_periodo_validate_observaciones_solicitud()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_observaciones_solicitud(var_observaciones_solicitud, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_observaciones_solicitud_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_observaciones_solicitud

  function do_ajax_form_prod_presupuesto_periodo_validate_observaciones_solicitud_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_observaciones_solicitud_cb

  // ---------- Validate cliente
  function do_ajax_form_prod_presupuesto_periodo_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldSelect(nomeCampo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_cliente(var_cliente, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_cliente_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente

  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_cb

  // ---------- Validate cliente_rut
  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_rut()
  {
    var nomeCampo_cliente_rut = "cliente_rut";
    var var_cliente_rut = scAjaxGetFieldSelect(nomeCampo_cliente_rut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_cliente_rut(var_cliente_rut, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_cliente_rut_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_rut

  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_rut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_rut";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_rut_cb

  // ---------- Validate cliente_giro
  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_giro()
  {
    var nomeCampo_cliente_giro = "cliente_giro";
    var var_cliente_giro = scAjaxGetFieldSelect(nomeCampo_cliente_giro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_cliente_giro(var_cliente_giro, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_cliente_giro_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_giro

  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_giro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_giro";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_giro_cb

  // ---------- Validate cliente_direccion
  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_direccion()
  {
    var nomeCampo_cliente_direccion = "cliente_direccion";
    var var_cliente_direccion = scAjaxGetFieldSelect(nomeCampo_cliente_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_cliente_direccion(var_cliente_direccion, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_cliente_direccion_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_direccion

  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_direccion_cb

  // ---------- Validate cliente_contacto
  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_contacto()
  {
    var nomeCampo_cliente_contacto = "cliente_contacto";
    var var_cliente_contacto = scAjaxGetFieldSelect(nomeCampo_cliente_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_cliente_contacto(var_cliente_contacto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_cliente_contacto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_contacto

  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_contacto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_contacto_cb

  // ---------- Validate cliente_email
  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_email()
  {
    var nomeCampo_cliente_email = "cliente_email";
    var var_cliente_email = scAjaxGetFieldSelect(nomeCampo_cliente_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_cliente_email(var_cliente_email, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_cliente_email_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_email

  function do_ajax_form_prod_presupuesto_periodo_validate_cliente_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_cliente_email_cb

  // ---------- Validate monto_real_facturacion
  function do_ajax_form_prod_presupuesto_periodo_validate_monto_real_facturacion()
  {
    var nomeCampo_monto_real_facturacion = "monto_real_facturacion";
    var var_monto_real_facturacion = scAjaxGetFieldText(nomeCampo_monto_real_facturacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_monto_real_facturacion(var_monto_real_facturacion, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_monto_real_facturacion_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_monto_real_facturacion

  function do_ajax_form_prod_presupuesto_periodo_validate_monto_real_facturacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto_real_facturacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_monto_real_facturacion_cb

  // ---------- Validate monto_uf
  function do_ajax_form_prod_presupuesto_periodo_validate_monto_uf()
  {
    var nomeCampo_monto_uf = "monto_uf";
    var var_monto_uf = scAjaxGetFieldText(nomeCampo_monto_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_monto_uf(var_monto_uf, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_monto_uf_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_monto_uf

  function do_ajax_form_prod_presupuesto_periodo_validate_monto_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_monto_uf_cb

  // ---------- Validate iva
  function do_ajax_form_prod_presupuesto_periodo_validate_iva()
  {
    var nomeCampo_iva = "iva";
    var var_iva = scAjaxGetFieldText(nomeCampo_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_iva(var_iva, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_iva_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_iva

  function do_ajax_form_prod_presupuesto_periodo_validate_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_iva_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_presupuesto_periodo_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_fecha_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha

  function do_ajax_form_prod_presupuesto_periodo_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_fecha_cb

  // ---------- Validate valor_uf
  function do_ajax_form_prod_presupuesto_periodo_validate_valor_uf()
  {
    var nomeCampo_valor_uf = "valor_uf";
    var var_valor_uf = scAjaxGetFieldText(nomeCampo_valor_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_valor_uf(var_valor_uf, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_valor_uf_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_valor_uf

  function do_ajax_form_prod_presupuesto_periodo_validate_valor_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_valor_uf_cb

  // ---------- Validate observaciones
  function do_ajax_form_prod_presupuesto_periodo_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_observaciones_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_observaciones

  function do_ajax_form_prod_presupuesto_periodo_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_observaciones_cb

  // ---------- Validate factura
  function do_ajax_form_prod_presupuesto_periodo_validate_factura()
  {
    var nomeCampo_factura = "factura";
    var var_factura = scAjaxGetFieldText(nomeCampo_factura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_validate_factura(var_factura, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_validate_factura_cb);
  } // do_ajax_form_prod_presupuesto_periodo_validate_factura

  function do_ajax_form_prod_presupuesto_periodo_validate_factura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factura";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_validate_factura_cb

  // ---------- Event onchange considera_retencion
  function do_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange(var_considera_retencion, var_monto_uf, var_retencion, var_iva, var_retencion_con_iva, var_produccion_neto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange_cb);
  } // do_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange

  function do_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "considera_retencion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange_cb
  function do_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_presupuesto_periodo_event_considera_retencion_onchange_cb_after_alert

  // ---------- Event onchange fecha_desde_factura
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange()
  {
    var var_produccion_neto = scAjaxGetFieldText("produccion_neto");
    ...
    var var_retencion_con_iva = scAjaxGetFieldText("retencion_con_iva");
    var var_iva = scAjaxGetFieldText("iva");
    var var_monto_real_facturacion = scAjaxGetFieldText("monto_real_facturacion");
    var var_monto_uf = scAjaxGetFieldText("monto_uf");
    var var_total_facturado = scAjaxGetFieldText("total_facturado");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange(var_produccion_neto, var_reajuste_acumulado_neto, var_incluye_retencion, var_existe_retencion, var_afecta_iva, var_retencion_acumulada, var_fecha_desde_factura, var_fecha_hasta_factura, var_fecha_desde, var_id_proyecto, var_avance_informado_con_iva, var_multa, var_retencion, var_retencion_con_iva, var_iva, var_monto_real_facturacion, var_monto_uf, var_total_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange_cb);
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange

  function do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha_desde_factura";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange_cb
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_factura_onchange_cb_after_alert

  // ---------- Event onchange fecha_desde
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange()
  {
    var var_fecha_desde = scAjaxGetFieldText("fecha_desde");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange(var_fecha_desde, var_dias_desde, var_dias_periodo, var_fecha_hasta, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange_cb);
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange

  function do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha_desde";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange_cb
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_desde_onchange_cb_after_alert

  // ---------- Event onchange fecha_hasta_factura
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange()
  {
    var var_produccion_neto = scAjaxGetFieldText("produccion_neto");
    var var_reajuste_acumulado_neto = scAjaxGetFieldText("reajuste_acumulado_neto");
    var var_incluye_retencion = scAjaxGetFieldHidden("incluye_retencion");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange(var_produccion_neto, var_reajuste_acumulado_neto, var_incluye_retencion, var_existe_retencion, var_afecta_iva, var_retencion_acumulada, var_fecha_desde_factura, var_fecha_hasta_factura, var_fecha_desde, var_id_proyecto, var_avance_informado_con_iva, var_multa, var_retencion, var_retencion_con_iva, var_iva, var_monto_real_facturacion, var_monto_uf, var_total_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange_cb);
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange

  function do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha_hasta_factura";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange_cb
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_factura_onchange_cb_after_alert

  // ---------- Event onchange fecha_hasta
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange()
  {
    var var_fecha_hasta = scAjaxGetFieldText("fecha_hasta");
    var var_fecha_desde = scAjaxGetFieldText("fecha_desde");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange(var_fecha_hasta, var_fecha_desde, var_dias_hasta, var_dias_desde, var_dias_periodo, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange_cb);
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange

  function do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha_hasta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange_cb
  function do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_presupuesto_periodo_event_fecha_hasta_onchange_cb_after_alert

  // ---------- Event onchange id_partida
  function do_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange(var_id_partida, var_monto_contrato, var_monto_uf, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange_cb);
  } // do_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange

  function do_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_partida";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange_cb
  function do_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_prod_presupuesto_periodo_refresh_id_partida();
    scAjaxRedir();
  } // do_ajax_form_prod_presupuesto_periodo_event_id_partida_onchange_cb_after_alert

  // ---------- Event onchange multa
  function do_ajax_form_prod_presupuesto_periodo_event_multa_onchange()
  {
    var var_produccion_neto = scAjaxGetFieldText("produccion_neto");
    var var_reajuste_acumulado_neto = scAjaxGetFieldText("reajuste_acumulado_neto");
    var var_fecha_desde_factura = scAjaxGetFieldText("fecha_desde_factura");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_multa_onchange(var_produccion_neto, var_reajuste_acumulado_neto, var_fecha_desde_factura, var_fecha_hasta_factura, var_fecha_desde, var_id_proyecto, var_avance_informado_con_iva, var_multa, var_retencion_con_iva, var_retencion, var_incluye_retencion, var_iva, var_monto_uf, var_total_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_multa_onchange_cb);
  } // do_ajax_form_prod_presupuesto_periodo_event_multa_onchange

  function do_ajax_form_prod_presupuesto_periodo_event_multa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "multa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_event_multa_onchange_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_event_multa_onchange_cb
  function do_ajax_form_prod_presupuesto_periodo_event_multa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_presupuesto_periodo_event_multa_onchange_cb_after_alert

  // ---------- Event onchange retencion
  function do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange()
  {
    var var_monto_real_facturacion = scAjaxGetFieldText("monto_real_facturacion");
    var var_retencion = scAjaxGetFieldText("retencion");
    var var_monto_uf = scAjaxGetFieldText("monto_uf");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_event_retencion_onchange(var_monto_real_facturacion, var_retencion, var_monto_uf, var_iva, var_retencion_con_iva, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange_cb);
  } // do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange

  function do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "retencion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange_cb
  function do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_prod_presupuesto_periodo_event_retencion_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_presupuesto_periodo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_presupuesto_periodo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_cliente_rut = scAjaxGetFieldSelect("cliente_rut");
    var var_cliente_giro = scAjaxGetFieldSelect("cliente_giro");
    var var_cliente_direccion = scAjaxGetFieldSelect("cliente_direccion");
    var var_cliente_contacto = scAjaxGetFieldSelect("cliente_contacto");
    var var_cliente_email = scAjaxGetFieldSelect("cliente_email");
    var var_monto_real_facturacion = scAjaxGetFieldText("monto_real_facturacion");
    var var_monto_uf = scAjaxGetFieldText("monto_uf");
    var var_iva = scAjaxGetFieldText("iva");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_submit_form(var_id, var_id_proyecto, var_monto_contrato, var_tipo_moneda, var_empresa, var_id_partida, var_fecha_desde, var_fecha_hasta, var_dias_desde, var_dias_hasta, var_dias_periodo, var_fecha_desde_factura, var_fecha_hasta_factura, var_avance_informado_con_iva, var_produccion_neto, var_reajuste_acumulado_neto, var_multa, var_retencion, var_retencion_con_iva, var_retencion_acumulada, var_total_facturado, var_afecta_iva, var_existe_retencion, var_incluye_retencion, var_considera_retencion, var_facturado, var_observaciones_solicitud, var_cliente, var_cliente_rut, var_cliente_giro, var_cliente_direccion, var_cliente_contacto, var_cliente_email, var_monto_real_facturacion, var_monto_uf, var_iva, var_fecha, var_valor_uf, var_observaciones, var_factura, var_factura_ul_name, var_factura_ul_type, var_factura_salva, var_factura_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_presupuesto_periodo_submit_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_submit_form

  function do_ajax_form_prod_presupuesto_periodo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("cliente_rut");
      scAjaxHideErrorDisplay("cliente_giro");
      scAjaxHideErrorDisplay("cliente_direccion");
      scAjaxHideErrorDisplay("cliente_contacto");
      scAjaxHideErrorDisplay("cliente_email");
      scAjaxHideErrorDisplay("monto_real_facturacion");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_submit_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_submit_form_cb
  function do_ajax_form_prod_presupuesto_periodo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_presupuesto_periodo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_presupuesto_periodo_navigate_form()
  {
    perform_ajax_form_prod_presupuesto_periodo_navigate_form();
  }

  function perform_ajax_form_prod_presupuesto_periodo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_prod_presupuesto_periodo_navigate_form(var_id, var_id_proyecto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_navigate_form_cb);
  } // do_ajax_form_prod_presupuesto_periodo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_presupuesto_periodo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_presupuesto_periodo_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_presupuesto_periodo_navigate_form_cb
  function do_ajax_form_prod_presupuesto_periodo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_presupuesto_periodo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_presupuesto_periodo_navigate_form_cb_after_alert

  function sc_hide_form_prod_presupuesto_periodo_form()
  {
  ...
  ajax_field_list[5] = "id_partida";
  ajax_field_list[6] = "fecha_desde";
  ajax_field_list[7] = "fecha_hasta";
  ajax_field_list[8] = "dias_desde";
  ajax_field_list[9] = "dias_hasta";
  ajax_field_list[10] = "dias_periodo";
  ajax_field_list[11] = "fecha_desde_factura";
  ajax_field_list[12] = "fecha_hasta_factura";
  ajax_field_list[13] = "avance_informado_con_iva";
  ajax_field_list[14] = "produccion_neto";
  ajax_field_list[15] = "reajuste_acumulado_neto";
  ajax_field_list[16] = "multa";
  ajax_field_list[17] = "retencion";
  ajax_field_list[18] = "retencion_con_iva";
  ajax_field_list[19] = "retencion_acumulada";
  ajax_field_list[20] = "total_facturado";
  ajax_field_list[21] = "afecta_iva";
  ajax_field_list[22] = "existe_retencion";
  ajax_field_list[23] = "incluye_retencion";
  ajax_field_list[24] = "considera_retencion";
  ajax_field_list[25] = "facturado";
  ajax_field_list[26] = "observaciones_solicitud";
  ajax_field_list[27] = "cliente";
  ajax_field_list[28] = "cliente_rut";
  ajax_field_list[29] = "cliente_giro";
  ajax_field_list[30] = "cliente_direccion";
  ajax_field_list[31] = "cliente_contacto";
  ajax_field_list[32] = "cliente_email";
  ajax_field_list[33] = "monto_real_facturacion";
  ajax_field_list[34] = "monto_uf";
  ajax_field_list[35] = "iva";
  ajax_field_list[36] = "fecha";
  ajax_field_list[37] = "valor_uf";
  ajax_field_list[38] = "observaciones";
  ajax_field_list[39] = "factura";
  ...
  var ajax_error_list = {
    ...
    "retencion_acumulada": {"label": "Retención Total Acumulada Neto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "total_facturado": {"label": "Total A Facturar EP - Neto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "facturado": {"label": "Estado De Facturación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "cliente_rut": {"label": "RUT ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cliente_giro": {"label": "Giro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cliente_direccion": {"label": "Dirección", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cliente_contacto": {"label": "Contacto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cliente_email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "monto_real_facturacion": {"label": "Monto Neto A Facturar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "monto_uf": {"label": "Monto Neto Real A Facturar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    ...
    "cliente": new Array(),
    "cliente_rut": new Array(),
    "cliente_giro": new Array(),
    "cliente_direccion": new Array(),
    "cliente_contacto": new Array(),
    "cliente_email": new Array(),
    "monto_real_facturacion": new Array(),
    "monto_uf": new Array(),
    "iva": new Array(),
    "fecha": new Array(),
    "valor_uf": new Array(),
  ...
  ajax_field_mult["cliente_rut"][1] = "cliente_rut";
  ajax_field_mult["cliente_giro"][1] = "cliente_giro";
  ajax_field_mult["cliente_direccion"][1] = "cliente_direccion";
  ajax_field_mult["cliente_contacto"][1] = "cliente_contacto";
  ajax_field_mult["cliente_email"][1] = "cliente_email";
  ajax_field_mult["monto_real_facturacion"][1] = "monto_real_facturacion";
  ...
  var ajax_field_id = {
    ...
    "cliente_rut": new Array("hidden_field_label_cliente_rut", "hidden_field_data_cliente_rut"),
    "cliente_giro": new Array("hidden_field_label_cliente_giro", "hidden_field_data_cliente_giro"),
    "cliente_direccion": new Array("hidden_field_label_cliente_direccion", "hidden_field_data_cliente_direccion"),
    "cliente_contacto": new Array("hidden_field_label_cliente_contacto", "hidden_field_data_cliente_contacto"),
    "cliente_email": new Array("hidden_field_label_cliente_email", "hidden_field_data_cliente_email"),
    "monto_real_facturacion": new Array("hidden_field_label_monto_real_facturacion", "hidden_field_data_monto_real_facturacion"),
  ...
  var ajax_read_only = {
    ...
    "cliente_rut": "off",
    "cliente_giro": "off",
    "cliente_direccion": "off",
    "cliente_contacto": "off",
    "cliente_email": "off",
    "monto_real_facturacion": "on",
    "monto_uf": "off",
    "iva": "off",
    "fecha": "off",
    "valor_uf": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("monto_real_facturacion" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
