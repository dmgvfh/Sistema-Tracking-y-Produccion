...
//---
   ...
   if ($this->nmgp_opcao == "incluir")
   {
    ...
    function ValidateField_cliente_rut(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_rut) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_rut']) && !in_array($this->cliente_rut, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_rut']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cliente_giro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_giro) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_giro']) && !in_array($this->cliente_giro, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_giro']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cliente_direccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_direccion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_direccion']) && !in_array($this->cliente_direccion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_direccion']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cliente_contacto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_contacto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_contacto']) && !in_array($this->cliente_contacto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_contacto']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cliente_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_email) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_email']) && !in_array($this->cliente_email, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['Lookup_cliente_email']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_monto_real_facturacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->monto_real_facturacion, 10, 1, 0, 0, "N") == false)  
              { 
                  $hasError = true;
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cliente_rut']['valList'][$i] = form_prod_presupuesto_periodo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cliente_giro']['valList'][$i] = form_prod_presupuesto_periodo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cliente_direccion']['valList'][$i] = form_prod_presupuesto_periodo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cliente_contacto']['valList'][$i] = form_prod_presupuesto_periodo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cliente_email']['valList'][$i] = form_prod_presupuesto_periodo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
