<?php
//
class form_prod_presupuesto_periodo_mob_apl
{
   ...
   var $cliente_direccion_1;
   var $cliente_contacto;
   var $cliente_contacto_1;
   var $cliente_giro;
   var $cliente_giro_1;
   var $cliente_email;
   var $cliente_email_1;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['cliente_contacto']))
          {
              $this->cliente_contacto = $this->NM_ajax_info['param']['cliente_contacto'];
          }
          if (isset($this->NM_ajax_info['param']['cliente_direccion']))
          {
              $this->cliente_direccion = $this->NM_ajax_info['param']['cliente_direccion'];
          }
          if (isset($this->NM_ajax_info['param']['cliente_email']))
          {
              $this->cliente_email = $this->NM_ajax_info['param']['cliente_email'];
          }
          if (isset($this->NM_ajax_info['param']['cliente_giro']))
          {
              $this->cliente_giro = $this->NM_ajax_info['param']['cliente_giro'];
          }
          if (isset($this->NM_ajax_info['param']['cliente_rut']))
          {
              $this->cliente_rut = $this->NM_ajax_info['param']['cliente_rut'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['monto_real_facturacion']))
          {
              $this->monto_real_facturacion = $this->NM_ajax_info['param']['monto_real_facturacion'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->group_name)) 
          {
              $_SESSION['group_name'] = $this->group_name;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_prod_presupuesto_periodo_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_prod_presupuesto_periodo_mob']['upload_field_info']['factura'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_prod_presupuesto_periodo_mob',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_prod_presupuesto_periodo_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_prod_presupuesto_periodo_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_prod_presupuesto_periodo_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_prod_presupuesto_periodo_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_prod_presupuesto_periodo_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_prod_presupuesto_periodo_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " Partida De Producción";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_prod_presupuesto_periodo_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_prod_presupuesto_periodo_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_prod_presupuesto_periodo_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_field_ul_name'][$this->factura_ul_name]))
          {
              $this->NM_ajax_info['param']['factura_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_field_ul_name'][$this->factura_ul_name];
          }
      ...
      elseif (isset($this->factura_ul_name) && '' != $this->factura_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_field_ul_name'][$this->factura_ul_name]))
          {
              $this->factura_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_field_ul_name'][$this->factura_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_prod_presupuesto_periodo_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_prod_presupuesto_periodo_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_prod_presupuesto_periodo_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dados_form'];
          ...
          if (!isset($this->reajuste_acumulado_con_iva)){$this->reajuste_acumulado_con_iva = $this->nmgp_dados_form['reajuste_acumulado_con_iva'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_prod_presupuesto_periodo_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_prod_presupuesto_periodo/form_prod_presupuesto_periodo_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_prod_presupuesto_periodo_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_prod_presupuesto_periodo_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_prod_presupuesto_periodo_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_prod_presupuesto_periodo/form_prod_presupuesto_periodo_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_prod_presupuesto_periodo_mob_erro.class.php"); 
      }
      $this->Erro      = new form_prod_presupuesto_periodo_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao']))
         { 
             if ($this->id != "" || $this->id_proyecto != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_prod_presupuesto_periodo_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['form_prod_presupuesto_periodo_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_prod_presupuesto_periodo_mob']['contr_erro'] = 'off'; 
      ...
      if (isset($this->monto_real_facturacion)) { $this->nm_limpa_alfa($this->monto_real_facturacion); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['total_facturado']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_num'];
      ...
      //-- monto_real_facturacion
      $this->field_config['monto_real_facturacion']               = array();
      $this->field_config['monto_real_facturacion']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['monto_real_facturacion']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['monto_real_facturacion']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['monto_real_facturacion']['symbol_mon'] = '';
      $this->field_config['monto_real_facturacion']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['monto_real_facturacion']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- monto_uf
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_cliente_rut' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cliente_rut');
          }
          if ('validate_cliente_giro' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cliente_giro');
          }
          if ('validate_cliente_direccion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cliente_direccion');
          }
          if ('validate_cliente_contacto' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cliente_contacto');
          }
          if ('validate_cliente_email' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cliente_email');
          }
          if ('validate_monto_real_facturacion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'monto_real_facturacion');
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_prod_presupuesto_periodo_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_prod_presupuesto_periodo_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_prod_presupuesto_periodo_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_prod_presupuesto_periodo_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'retencion_acumulada':
               return "Retención Total Acumulada Neto";
               break;
           case 'total_facturado':
               return "Total A Facturar EP - Neto";
               break;
           case 'afecta_iva':
               return "Afecta a IVA";
               break;
           ...
           case 'cliente_email':
               return "Email";
               break;
           case 'monto_real_facturacion':
               return "Monto Neto A Facturar";
               break;
           case 'monto_uf':
               return "Monto Neto Real A Facturar";
               break;
           case 'iva':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_prod_presupuesto_periodo_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_prod_presupuesto_periodo_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_prod_presupuesto_periodo_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_prod_presupuesto_periodo_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'cliente_rut' == $filtro)) || (is_array($filtro) && in_array('cliente_rut', $filtro)))
        $this->ValidateField_cliente_rut($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'cliente_giro' == $filtro)) || (is_array($filtro) && in_array('cliente_giro', $filtro)))
        $this->ValidateField_cliente_giro($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'cliente_direccion' == $filtro)) || (is_array($filtro) && in_array('cliente_direccion', $filtro)))
        $this->ValidateField_cliente_direccion($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'cliente_contacto' == $filtro)) || (is_array($filtro) && in_array('cliente_contacto', $filtro)))
        $this->ValidateField_cliente_contacto($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'cliente_email' == $filtro)) || (is_array($filtro) && in_array('cliente_email', $filtro)))
        $this->ValidateField_cliente_email($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'monto_real_facturacion' == $filtro)) || (is_array($filtro) && in_array('monto_real_facturacion', $filtro)))
        $this->ValidateField_monto_real_facturacion($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->id_proyecto == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['id_proyecto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['id_proyecto'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->id_proyecto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_proyecto']) && !in_array($this->id_proyecto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_proyecto']))
          {
              $hasError = true;
    ...
    function ValidateField_monto_contrato(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->monto_contrato, 18, 2, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_tipo_moneda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->tipo_moneda == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['tipo_moneda']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['tipo_moneda'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->tipo_moneda) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_tipo_moneda']) && !in_array($this->tipo_moneda, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_tipo_moneda']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tipo_moneda']))
    ...
    function ValidateField_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->empresa == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['empresa'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->empresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_empresa']) && !in_array($this->empresa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_empresa']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['empresa']))
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->id_partida == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['id_partida']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['id_partida'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->id_partida) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_partida']) && !in_array($this->id_partida, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_partida']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['id_partida']))
    ...
    function ValidateField_fecha_desde(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['fecha_desde']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['fecha_desde'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_fecha_hasta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['fecha_hasta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['fecha_hasta'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_dias_desde(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->dias_desde, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_dias_hasta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->dias_hasta, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_dias_periodo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->dias_periodo, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_avance_informado_con_iva(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->avance_informado_con_iva, 10, 1, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_produccion_neto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->produccion_neto, 10, 1, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_reajuste_acumulado_neto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->reajuste_acumulado_neto, 10, 1, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_multa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->multa, 9, 2, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_retencion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->retencion, 10, 1, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_retencion_con_iva(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->retencion_con_iva, 10, 1, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_retencion_acumulada(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Retención Total Acumulada Neto: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Retención Total Acumulada Neto; " ; 
                  if (!isset($Campos_Erros['retencion_acumulada']))
                  {
                      $Campos_Erros['retencion_acumulada'] = array();
                  }
    ...
    function ValidateField_total_facturado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (!empty($this->field_config['total_facturado']['symbol_dec']))
      {
          nm_limpa_valor($this->total_facturado, $this->field_config['total_facturado']['symbol_dec'], $this->field_config['total_facturado']['symbol_grp']) ; 
          if ('.' == substr($this->total_facturado, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->total_facturado, 1)))
              {
                  $this->total_facturado = '';
              }
              else
              {
                  $this->total_facturado = '0' . $this->total_facturado;
              }
          }
      }
      if ($this->nmgp_opcao == "incluir")
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->total_facturado, -1))
              {
                  $iTestSize++;
                  $this->total_facturado = '-' . substr($this->total_facturado, 0, -1);
              }
              if (strlen($this->total_facturado) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Total A Facturar EP - Neto: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->total_facturado, 11, 0, 0, 0, "S") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Total A Facturar EP - Neto; " ; 
                  if (!isset($Campos_Erros['total_facturado']))
                  {
                      $Campos_Erros['total_facturado'] = array();
                  }
    ...
    function ValidateField_facturado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->facturado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_facturado']) && !in_array($this->facturado, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_facturado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->cliente == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['php_cmp_required']['cliente'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->cliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente']) && !in_array($this->cliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['cliente']))
    ...
    function ValidateField_cliente_rut(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_rut) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_rut']) && !in_array($this->cliente_rut, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_rut']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['cliente_rut']))
                   {
                       $Campos_Erros['cliente_rut'] = array();
                   }
                   $Campos_Erros['cliente_rut'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['cliente_rut']) || !is_array($this->NM_ajax_info['errList']['cliente_rut']))
                   {
                       $this->NM_ajax_info['errList']['cliente_rut'] = array();
                   }
                   $this->NM_ajax_info['errList']['cliente_rut'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'cliente_rut';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_cliente_rut

    function ValidateField_cliente_giro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_giro) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_giro']) && !in_array($this->cliente_giro, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_giro']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['cliente_giro']))
                   {
                       $Campos_Erros['cliente_giro'] = array();
                   }
                   $Campos_Erros['cliente_giro'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['cliente_giro']) || !is_array($this->NM_ajax_info['errList']['cliente_giro']))
                   {
                       $this->NM_ajax_info['errList']['cliente_giro'] = array();
                   }
                   $this->NM_ajax_info['errList']['cliente_giro'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'cliente_giro';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_cliente_giro

    function ValidateField_cliente_direccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_direccion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_direccion']) && !in_array($this->cliente_direccion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_direccion']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['cliente_direccion']))
                   {
                       $Campos_Erros['cliente_direccion'] = array();
                   }
                   $Campos_Erros['cliente_direccion'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['cliente_direccion']) || !is_array($this->NM_ajax_info['errList']['cliente_direccion']))
                   {
                       $this->NM_ajax_info['errList']['cliente_direccion'] = array();
                   }
                   $this->NM_ajax_info['errList']['cliente_direccion'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'cliente_direccion';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_cliente_direccion

    function ValidateField_cliente_contacto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_contacto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_contacto']) && !in_array($this->cliente_contacto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_contacto']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['cliente_contacto']))
                   {
                       $Campos_Erros['cliente_contacto'] = array();
                   }
                   $Campos_Erros['cliente_contacto'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['cliente_contacto']) || !is_array($this->NM_ajax_info['errList']['cliente_contacto']))
                   {
                       $this->NM_ajax_info['errList']['cliente_contacto'] = array();
                   }
                   $this->NM_ajax_info['errList']['cliente_contacto'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'cliente_contacto';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_cliente_contacto

    function ValidateField_cliente_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cliente_email) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_email']) && !in_array($this->cliente_email, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_email']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['cliente_email']))
                   {
                       $Campos_Erros['cliente_email'] = array();
                   }
                   $Campos_Erros['cliente_email'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['cliente_email']) || !is_array($this->NM_ajax_info['errList']['cliente_email']))
                   {
                       $this->NM_ajax_info['errList']['cliente_email'] = array();
                   }
                   $this->NM_ajax_info['errList']['cliente_email'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
    ...
    } // ValidateField_cliente_email

    function ValidateField_monto_real_facturacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->monto_real_facturacion === "" || is_null($this->monto_real_facturacion))  
      { 
          $this->monto_real_facturacion = 0;
          $this->sc_force_zero[] = 'monto_real_facturacion';
      } 
      if (!empty($this->field_config['monto_real_facturacion']['symbol_dec']))
      {
          $this->sc_remove_currency($this->monto_real_facturacion, $this->field_config['monto_real_facturacion']['symbol_dec'], $this->field_config['monto_real_facturacion']['symbol_grp'], $this->field_config['monto_real_facturacion']['symbol_mon']); 
          nm_limpa_valor($this->monto_real_facturacion, $this->field_config['monto_real_facturacion']['symbol_dec'], $this->field_config['monto_real_facturacion']['symbol_grp']) ; 
          if ('.' == substr($this->monto_real_facturacion, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->monto_real_facturacion, 1)))
              {
                  $this->monto_real_facturacion = '';
              }
              else
              {
                  $this->monto_real_facturacion = '0' . $this->monto_real_facturacion;
              }
          }
      }
      if ($this->nmgp_opcao == "incluir")
      { 
          if ($this->monto_real_facturacion != '')  
          { 
              $iTestSize = 12;
              if (strlen($this->monto_real_facturacion) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Monto Neto A Facturar: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['monto_real_facturacion']))
                  {
                      $Campos_Erros['monto_real_facturacion'] = array();
                  }
                  $Campos_Erros['monto_real_facturacion'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['monto_real_facturacion']) || !is_array($this->NM_ajax_info['errList']['monto_real_facturacion']))
                  {
                      $this->NM_ajax_info['errList']['monto_real_facturacion'] = array();
                  }
                  $this->NM_ajax_info['errList']['monto_real_facturacion'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->monto_real_facturacion, 10, 1, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['monto_real_facturacion'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['monto_real_facturacion']) || !is_array($this->NM_ajax_info['errList']['monto_real_facturacion']))
                  {
                      $this->NM_ajax_info['errList']['monto_real_facturacion'] = array();
                  }
                  $this->NM_ajax_info['errList']['monto_real_facturacion'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'monto_real_facturacion';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_monto_real_facturacion
    ...
    function ValidateField_monto_uf(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Monto Neto Real A Facturar: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->monto_uf, 10, 1, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Monto Neto Real A Facturar; " ; 
                  if (!isset($Campos_Erros['monto_uf']))
                  {
                      $Campos_Erros['monto_uf'] = array();
                  }
    ...
    function ValidateField_valor_uf(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->valor_uf, 9, 2, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_factura(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                include_once 'form_prod_presupuesto_periodo_mob_doc_name.php';
            }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['cliente_rut'] = $this->cliente_rut;
    $this->nmgp_dados_form['cliente_giro'] = $this->cliente_giro;
    $this->nmgp_dados_form['cliente_direccion'] = $this->cliente_direccion;
    $this->nmgp_dados_form['cliente_contacto'] = $this->cliente_contacto;
    $this->nmgp_dados_form['cliente_email'] = $this->cliente_email;
    $this->nmgp_dados_form['monto_real_facturacion'] = $this->monto_real_facturacion;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['monto_real_facturacion'] = $this->monto_real_facturacion;
      if (!empty($this->field_config['monto_real_facturacion']['symbol_dec']))
      {
         $this->sc_remove_currency($this->monto_real_facturacion, $this->field_config['monto_real_facturacion']['symbol_dec'], $this->field_config['monto_real_facturacion']['symbol_grp'], $this->field_config['monto_real_facturacion']['symbol_mon']);
         nm_limpa_valor($this->monto_real_facturacion, $this->field_config['monto_real_facturacion']['symbol_dec'], $this->field_config['monto_real_facturacion']['symbol_grp']);
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "monto_real_facturacion")
      {
          if (!empty($this->field_config['monto_real_facturacion']['symbol_dec']))
          {
             $this->sc_remove_currency($this->monto_real_facturacion, $this->field_config['monto_real_facturacion']['symbol_dec'], $this->field_config['monto_real_facturacion']['symbol_grp'], $this->field_config['monto_real_facturacion']['symbol_mon']);
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->monto_real_facturacion || (!empty($format_fields) && isset($format_fields['monto_real_facturacion'])))
      {
          nmgp_Form_Num_Val($this->monto_real_facturacion, $this->field_config['monto_real_facturacion']['symbol_grp'], $this->field_config['monto_real_facturacion']['symbol_dec'], "1", "S", $this->field_config['monto_real_facturacion']['format_neg'], "", "", "-", $this->field_config['monto_real_facturacion']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_cliente_rut();
          $this->ajax_return_values_cliente_giro();
          $this->ajax_return_values_cliente_direccion();
          $this->ajax_return_values_cliente_contacto();
          $this->ajax_return_values_cliente_email();
          $this->ajax_return_values_monto_real_facturacion();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_prod_presupuesto_periodo_mob_pack_protect_string($this->nmgp_dados_form['id']);
              $this->NM_ajax_info['fldList']['id_proyecto']['keyVal'] = form_prod_presupuesto_periodo_mob_pack_protect_string($this->nmgp_dados_form['id_proyecto']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_proyecto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_proyecto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_proyecto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_proyecto'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_prod_presupuesto_periodo_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_prod_presupuesto_periodo_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_proyecto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_proyecto']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_tipo_moneda']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_tipo_moneda'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_tipo_moneda']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_tipo_moneda'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_tipo_moneda'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_moneda']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_empresa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_empresa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_empresa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_empresa'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_empresa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['empresa']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_partida']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_partida'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_partida']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_partida'] = array(); 
}
$aLookup[] = array(form_prod_presupuesto_periodo_mob_pack_protect_string('') => str_replace('<', '&lt;',form_prod_presupuesto_periodo_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_partida'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_id_partida'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_partida']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_prod_presupuesto_periodo_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_prod_presupuesto_periodo_mob_pack_protect_string("NO")));
$aLookup[] = array(form_prod_presupuesto_periodo_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_prod_presupuesto_periodo_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_considera_retencion'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_considera_retencion'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['considera_retencion']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_facturado']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_facturado'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_facturado']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_facturado'] = array(); 
}
$aLookup[] = array(form_prod_presupuesto_periodo_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_prod_presupuesto_periodo_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_facturado'][] = '0';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_facturado'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['facturado']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cliente']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          //----- cliente_rut
   function ajax_return_values_cliente_rut($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cliente_rut", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cliente_rut);
              $aLookup = array();
              $this->_tmp_lookup_cliente_rut = $this->cliente_rut;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_rut']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_rut'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_rut']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_rut'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_rut'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cliente_rut\"";
          if (isset($this->NM_ajax_info['select_html']['cliente_rut']) && !empty($this->NM_ajax_info['select_html']['cliente_rut']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['cliente_rut']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->cliente_rut == $sValue)
                  {
                      $this->_tmp_lookup_cliente_rut = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['cliente_rut'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['cliente_rut']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['cliente_rut']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['cliente_rut']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['cliente_rut']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['cliente_rut']['labList'] = $aLabel;
          }
   }

          //----- cliente_giro
   function ajax_return_values_cliente_giro($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cliente_giro", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cliente_giro);
              $aLookup = array();
              $this->_tmp_lookup_cliente_giro = $this->cliente_giro;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_giro']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_giro'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_giro']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_giro'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_giro'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cliente_giro\"";
          if (isset($this->NM_ajax_info['select_html']['cliente_giro']) && !empty($this->NM_ajax_info['select_html']['cliente_giro']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['cliente_giro']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->cliente_giro == $sValue)
                  {
                      $this->_tmp_lookup_cliente_giro = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['cliente_giro'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['cliente_giro']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['cliente_giro']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['cliente_giro']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['cliente_giro']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['cliente_giro']['labList'] = $aLabel;
          }
   }

          //----- cliente_direccion
   function ajax_return_values_cliente_direccion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cliente_direccion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cliente_direccion);
              $aLookup = array();
              $this->_tmp_lookup_cliente_direccion = $this->cliente_direccion;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_direccion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_direccion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_direccion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_direccion'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_direccion'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cliente_direccion\"";
          if (isset($this->NM_ajax_info['select_html']['cliente_direccion']) && !empty($this->NM_ajax_info['select_html']['cliente_direccion']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['cliente_direccion']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->cliente_direccion == $sValue)
                  {
                      $this->_tmp_lookup_cliente_direccion = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['cliente_direccion'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['cliente_direccion']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['cliente_direccion']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['cliente_direccion']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['cliente_direccion']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['cliente_direccion']['labList'] = $aLabel;
          }
   }

          //----- cliente_contacto
   function ajax_return_values_cliente_contacto($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cliente_contacto", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cliente_contacto);
              $aLookup = array();
              $this->_tmp_lookup_cliente_contacto = $this->cliente_contacto;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_contacto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_contacto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_contacto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_contacto'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_contacto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cliente_contacto\"";
          if (isset($this->NM_ajax_info['select_html']['cliente_contacto']) && !empty($this->NM_ajax_info['select_html']['cliente_contacto']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['cliente_contacto']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->cliente_contacto == $sValue)
                  {
                      $this->_tmp_lookup_cliente_contacto = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['cliente_contacto'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['cliente_contacto']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['cliente_contacto']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['cliente_contacto']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['cliente_contacto']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['cliente_contacto']['labList'] = $aLabel;
          }
   }

          //----- cliente_email
   function ajax_return_values_cliente_email($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cliente_email", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cliente_email);
              $aLookup = array();
              $this->_tmp_lookup_cliente_email = $this->cliente_email;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_email']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_email'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_email']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_email'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_email'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cliente_email\"";
          if (isset($this->NM_ajax_info['select_html']['cliente_email']) && !empty($this->NM_ajax_info['select_html']['cliente_email']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['cliente_email']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->cliente_email == $sValue)
                  {
                      $this->_tmp_lookup_cliente_email = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['cliente_email'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['cliente_email']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['cliente_email']['valList'][$i] = form_prod_presupuesto_periodo_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['cliente_email']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['cliente_email']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['cliente_email']['labList'] = $aLabel;
          }
   }

          //----- monto_real_facturacion
   function ajax_return_values_monto_real_facturacion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("monto_real_facturacion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->monto_real_facturacion);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['monto_real_facturacion'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
               'labList' => array($this->form_format_readonly("monto_real_facturacion", $this->form_encode_input($sTmpValue))),
              );
          }
   }
   ...
   function ajax_return_values_factura($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
   ...
   { 
      ...
      $this->total_facturado = str_replace($sc_parm1, $sc_parm2, $this->total_facturado); 
      $this->monto_real_facturacion = str_replace($sc_parm1, $sc_parm2, $this->monto_real_facturacion); 
   ...
   { 
      ...
      $this->total_facturado = "'" . $this->total_facturado . "'";
      $this->monto_real_facturacion = "'" . $this->monto_real_facturacion . "'";
   ...
   { 
      ...
      $this->total_facturado = str_replace("'", "", $this->total_facturado); 
      $this->monto_real_facturacion = str_replace("'", "", $this->monto_real_facturacion); 
...
$_SESSION['scriptcase']['form_prod_presupuesto_periodo_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['cliente_rut'] = $this->cliente_rut;
      $NM_val_form['cliente_giro'] = $this->cliente_giro;
      $NM_val_form['cliente_direccion'] = $this->cliente_direccion;
      $NM_val_form['cliente_contacto'] = $this->cliente_contacto;
      $NM_val_form['cliente_email'] = $this->cliente_email;
      $NM_val_form['monto_real_facturacion'] = $this->monto_real_facturacion;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "fecha = " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", monto_uf = $this->monto_uf, observaciones = '$this->observaciones', facturado = $this->facturado, valor_uf = $this->valor_uf, tipo_moneda = $this->tipo_moneda, retencion = $this->retencion, multa = $this->multa, fecha_desde = " . $this->Ini->date_delim . $this->fecha_desde . $this->Ini->date_delim1 . ", fecha_hasta = " . $this->Ini->date_delim . $this->fecha_hasta . $this->Ini->date_delim1 . ", fecha_desde_factura = " . $this->Ini->date_delim . $this->fecha_desde_factura . $this->Ini->date_delim1 . ", fecha_hasta_factura = " . $this->Ini->date_delim . $this->fecha_hasta_factura . $this->Ini->date_delim1 . ", considera_retencion = $this->considera_retencion"; 
              } 
              else 
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['monto_real_facturacion']) && $NM_val_form['monto_real_facturacion'] != $this->nmgp_dados_select['monto_real_facturacion']) 
              { 
                  $SC_fields_update[] = "monto_real_facturacion = $this->monto_real_facturacion"; 
              } 
              $temp_cmd_sql = "";
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['factura_salva'] = array(
                      'row'     => '',
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['monto_real_facturacion'])) { $this->monto_real_facturacion = $NM_val_form['monto_real_facturacion']; }
              elseif (isset($this->monto_real_facturacion)) { $this->nm_limpa_alfa($this->monto_real_facturacion); }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] = 0; 
              }
...
if (false == $this->rs)     
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_prod_presupuesto_periodo_mob';
...
$_SESSION['scriptcase']['form_prod_presupuesto_periodo_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['parms'] = "id?#?$this->id?@?id_proyecto?#?$this->id_proyecto?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_prod_presupuesto_periodo_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total'] = $qt_geral_reg_form_prod_presupuesto_periodo_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id) && !empty($this->id_proyecto))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_prod_presupuesto_periodo_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] > $qt_geral_reg_form_prod_presupuesto_periodo_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] = $qt_geral_reg_form_prod_presupuesto_periodo_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_prod_presupuesto_periodo_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['parms'] = ""; 
          $nmgp_select = "SELECT id, id_proyecto, id_item, fecha, monto_uf, vigente, observaciones, orden, id_partida, avance, facturado, valor_uf, factura, tipo_moneda, retencion, reajuste, multa, fecha_desde, fecha_hasta, dias_desde, dias_hasta, factor_produccion, dias_periodo, avance_periodo, avance_periodo_siguiente, avance_informado, avance_periodo_anterior, produccion_total_final, total_facturado, total_facturado_ur, fecha_desde_factura, fecha_hasta_factura, avance_informado_con_iva, produccion_ep, reajuste_con_iva, retencion_con_iva, produccion_neto, reajuste_acumulado_neto, reajuste_acumulado_con_iva, considera_retencion, monto_real_facturacion from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->monto_real_facturacion = $rs->fields[40] ; 
              $this->nmgp_dados_select['monto_real_facturacion'] = $this->monto_real_facturacion;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              ...
              $this->monto_real_facturacion = (string)$this->monto_real_facturacion; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['parms'] = "id?#?$this->id?@?id_proyecto?#?$this->id_proyecto?@?";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] < $qt_geral_reg_form_prod_presupuesto_periodo_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['reg_start'] + 1;
...
$original_retencion_con_iva = $this->retencion_con_iva;
$original_iva = $this->iva;
$original_monto_real_facturacion = $this->monto_real_facturacion;
$original_monto_uf = $this->monto_uf;
$original_total_facturado = $this->total_facturado;
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
			...
			if (isset($this->rs[0][0]))     
			  ...
			  $this->produccion_neto =$this->produccion_neto -$this->reajuste_acumulado_neto ;  
	        ...
	        if ($this->afecta_iva =="SI")
				{
				  ...
				  $this->produccion_ep =$this->produccion_ep  + $this->reajuste_acumulado_neto  ;
				}
			else
				{
				  if ($this->incluye_retencion =="SI")
					  {
					 	$this->produccion_ep =$this->produccion_neto  - $this->retencion ; 
					  }
				  else
					  {
					  	$this->produccion_ep =$this->produccion_neto ;
					  }
				  $this->produccion_ep =$this->produccion_ep  + $this->reajuste_acumulado_neto ;
				}
			  ...
			  if ($this->afecta_iva =="SI")
			  	{ 	   
				  $this->monto_real_facturacion =$this->iva /1.19;
				  $this->monto_uf =$this->iva /1.19;
				  $this->total_facturado =$this->produccion_ep /1.19;
			  	}
			  else
				  {
				   $this->monto_real_facturacion =$this->iva ;
				   $this->monto_uf =$this->iva ;
				  $this->total_facturado =$this->produccion_ep ;
				  }
...
$modificado_afecta_iva = $this->afecta_iva;
...
$modificado_retencion_con_iva = $this->retencion_con_iva;
$modificado_iva = $this->iva;
$modificado_monto_real_facturacion = $this->monto_real_facturacion;
$modificado_monto_uf = $this->monto_uf;
$modificado_total_facturado = $this->total_facturado;
$this->nm_formatar_campos('produccion_neto', 'reajuste_acumulado_neto', 'incluye_retencion', 'existe_retencion', 'afecta_iva', 'retencion_acumulada', 'fecha_desde_factura', 'fecha_hasta_factura', 'fecha_desde', 'id_proyecto', 'avance_informado_con_iva', 'multa', 'retencion', 'retencion_con_iva', 'iva', 'monto_real_facturacion', 'monto_uf', 'total_facturado');
if ($original_produccion_neto !== $modificado_produccion_neto || isset($this->nmgp_cmp_readonly['produccion_neto']) || (isset($bFlagRead_produccion_neto) && $bFlagRead_produccion_neto))
{
    $this->ajax_return_values_produccion_neto(true);
}
...
if ($original_afecta_iva !== $modificado_afecta_iva || isset($this->nmgp_cmp_readonly['afecta_iva']) || (isset($bFlagRead_afecta_iva) && $bFlagRead_afecta_iva))
{
    $this->ajax_return_values_afecta_iva(true);
}
...
if ($original_monto_real_facturacion !== $modificado_monto_real_facturacion || isset($this->nmgp_cmp_readonly['monto_real_facturacion']) || (isset($bFlagRead_monto_real_facturacion) && $bFlagRead_monto_real_facturacion))
{
    $this->ajax_return_values_monto_real_facturacion(true);
}
if ($original_monto_uf !== $modificado_monto_uf || isset($this->nmgp_cmp_readonly['monto_uf']) || (isset($bFlagRead_monto_uf) && $bFlagRead_monto_uf))
{
    $this->ajax_return_values_monto_uf(true);
...
$modificado_monto_uf = $this->monto_uf;
$modificado_total_facturado = $this->total_facturado;
$this->nm_formatar_campos('produccion_neto', 'reajuste_acumulado_neto', 'fecha_desde_factura', 'fecha_hasta_factura', 'fecha_desde', 'id_proyecto', 'avance_informado_con_iva', 'multa', 'retencion_con_iva', 'retencion', 'incluye_retencion', 'iva', 'monto_uf', 'total_facturado');
if ($original_produccion_neto !== $modificado_produccion_neto || isset($this->nmgp_cmp_readonly['produccion_neto']) || (isset($bFlagRead_produccion_neto) && $bFlagRead_produccion_neto))
{
    $this->ajax_return_values_produccion_neto(true);
}
...
if ($existe_retencion=="SI")
	{
		$this->monto_real_facturacion =$this->monto_real_facturacion -$this->retencion ; 
		$this->monto_uf =$this->monto_uf -$this->retencion ; 
		$this->iva =$this->monto_uf *1.19; 
		$this->retencion_con_iva =$this->retencion  * 1.19; 
	}
...
$modificado_iva = $this->iva;
$modificado_retencion_con_iva = $this->retencion_con_iva;
$this->nm_formatar_campos('monto_real_facturacion', 'retencion', 'monto_uf', 'iva', 'retencion_con_iva');
if ($original_monto_real_facturacion !== $modificado_monto_real_facturacion || isset($this->nmgp_cmp_readonly['monto_real_facturacion']) || (isset($bFlagRead_monto_real_facturacion) && $bFlagRead_monto_real_facturacion))
{
    $this->ajax_return_values_monto_real_facturacion(true);
}
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo']['download_filenames'][$sTmpFile_factura] = $this->factura;
        ...
        $this->initFormPages();
    include_once("form_prod_presupuesto_periodo_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_cliente_rut()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_rut']))
{
...
else
{
   ...
   function Form_lookup_cliente_giro()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_giro']))
{
...
else
{
   ...
   function Form_lookup_cliente_direccion()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_direccion']))
{
...
else
{
   ...
   function Form_lookup_cliente_contacto()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_contacto']))
{
...
else
{
   ...
   function Form_lookup_cliente_email()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['Lookup_cliente_email']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_prod_presupuesto_periodo_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['total'] = $qt_geral_reg_form_prod_presupuesto_periodo_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_prod_presupuesto_periodo_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas["fecha"] = "date";$Nm_datas["fecha_desde"] = "date";$Nm_datas["fecha_hasta"] = "date";$Nm_datas["fecha_desde_factura"] = "date";$Nm_datas["fecha_hasta_factura"] = "date";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_prod_presupuesto_periodo_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_prod_presupuesto_periodo_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_presupuesto_periodo_mob']['ordem_ord'] == " desc") {
