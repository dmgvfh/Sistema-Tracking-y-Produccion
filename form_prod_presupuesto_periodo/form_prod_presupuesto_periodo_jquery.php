...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["cliente_rut" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["cliente_giro" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["cliente_direccion" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["cliente_contacto" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["cliente_email" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["monto_real_facturacion" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["cliente_rut" + iSeqRow] && scEventControl_data["cliente_rut" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["cliente_rut" + iSeqRow] && scEventControl_data["cliente_rut" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["cliente_giro" + iSeqRow] && scEventControl_data["cliente_giro" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["cliente_giro" + iSeqRow] && scEventControl_data["cliente_giro" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["cliente_direccion" + iSeqRow] && scEventControl_data["cliente_direccion" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["cliente_direccion" + iSeqRow] && scEventControl_data["cliente_direccion" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["cliente_contacto" + iSeqRow] && scEventControl_data["cliente_contacto" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["cliente_contacto" + iSeqRow] && scEventControl_data["cliente_contacto" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["cliente_email" + iSeqRow] && scEventControl_data["cliente_email" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["cliente_email" + iSeqRow] && scEventControl_data["cliente_email" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["monto_real_facturacion" + iSeqRow] && scEventControl_data["monto_real_facturacion" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["monto_real_facturacion" + iSeqRow] && scEventControl_data["monto_real_facturacion" + iSeqRow]["change"]) {
    return true;
  }
...
function scEventControl_onFocus(oField, iSeq) {
  ...
  if ("cliente_rut" + iSeq == fieldName) {
    scEventControl_data[fieldName]["blur"] = false;
  }
  if ("cliente_giro" + iSeq == fieldName) {
    scEventControl_data[fieldName]["blur"] = false;
  }
  if ("cliente_direccion" + iSeq == fieldName) {
    scEventControl_data[fieldName]["blur"] = false;
  }
  if ("cliente_contacto" + iSeq == fieldName) {
    scEventControl_data[fieldName]["blur"] = false;
  }
  if ("cliente_email" + iSeq == fieldName) {
    scEventControl_data[fieldName]["blur"] = false;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_id_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_prod_presupuesto_periodo_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_proyecto' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_id_proyecto_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_prod_presupuesto_periodo_id_proyecto_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_prod_presupuesto_periodo_id_proyecto_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_item' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_id_item_onchange(this, iSeqRow) });
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_fecha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_prod_presupuesto_periodo_fecha_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_monto_uf' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_monto_uf_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_prod_presupuesto_periodo_monto_uf_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_prod_presupuesto_periodo_monto_uf_onfocus(this, iSeqRow) });
  $('#id_sc_field_vigente' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_vigente_onchange(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_prod_presupuesto_periodo_observaciones_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_prod_presupuesto_periodo_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_orden' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_orden_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_avance' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_avance_onchange(this, iSeqRow) });
  $('#id_sc_field_facturado' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_facturado_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_prod_presupuesto_periodo_facturado_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_valor_uf' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_valor_uf_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_prod_presupuesto_periodo_valor_uf_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_factura' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_factura_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_prod_presupuesto_periodo_factura_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo_moneda' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_tipo_moneda_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_prod_presupuesto_periodo_tipo_moneda_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_reajuste' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_reajuste_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_dias_desde' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_dias_desde_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_prod_presupuesto_periodo_dias_desde_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dias_hasta' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_dias_hasta_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_prod_presupuesto_periodo_dias_hasta_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_prod_presupuesto_periodo_dias_hasta_onfocus(this, iSeqRow) });
  $('#id_sc_field_factor_produccion' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_factor_produccion_onchange(this, iSeqRow) });
  $('#id_sc_field_dias_periodo' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_dias_periodo_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_prod_presupuesto_periodo_dias_periodo_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_prod_presupuesto_periodo_dias_periodo_onfocus(this, iSeqRow) });
  $('#id_sc_field_avance_periodo' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_avance_periodo_onchange(this, iSeqRow) });
  $('#id_sc_field_avance_periodo_siguiente' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_avance_periodo_siguiente_onchange(this, iSeqRow) });
  $('#id_sc_field_avance_informado' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_avance_informado_onchange(this, iSeqRow) });
  $('#id_sc_field_avance_periodo_anterior' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_avance_periodo_anterior_onchange(this, iSeqRow) });
  $('#id_sc_field_produccion_total_final' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_produccion_total_final_onchange(this, iSeqRow) });
  $('#id_sc_field_total_facturado' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_total_facturado_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_prod_presupuesto_periodo_total_facturado_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_prod_presupuesto_periodo_total_facturado_onfocus(this, iSeqRow) });
  $('#id_sc_field_total_facturado_ur' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_total_facturado_ur_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_avance_informado_con_iva' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_avance_informado_con_iva_onblur(this, iSeqRow) })
                                                      .bind('change', function() { sc_form_prod_presupuesto_periodo_avance_informado_con_iva_onchange(this, iSeqRow) })
                                                      .bind('focus', function() { sc_form_prod_presupuesto_periodo_avance_informado_con_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_produccion_ep' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_produccion_ep_onchange(this, iSeqRow) });
  $('#id_sc_field_reajuste_con_iva' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_reajuste_con_iva_onchange(this, iSeqRow) });
  $('#id_sc_field_retencion_con_iva' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_retencion_con_iva_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_prod_presupuesto_periodo_retencion_con_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_produccion_neto' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_produccion_neto_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_prod_presupuesto_periodo_produccion_neto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_reajuste_acumulado_neto' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_reajuste_acumulado_neto_onblur(this, iSeqRow) })
                                                     .bind('change', function() { sc_form_prod_presupuesto_periodo_reajuste_acumulado_neto_onchange(this, iSeqRow) })
                                                     .bind('focus', function() { sc_form_prod_presupuesto_periodo_reajuste_acumulado_neto_onfocus(this, iSeqRow) });
  $('#id_sc_field_reajuste_acumulado_con_iva' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_reajuste_acumulado_con_iva_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_monto_real_facturacion' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_monto_real_facturacion_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_form_prod_presupuesto_periodo_monto_real_facturacion_onchange(this, iSeqRow) })
                                                    .bind('focus', function() { sc_form_prod_presupuesto_periodo_monto_real_facturacion_onfocus(this, iSeqRow) });
  $('#id_sc_field_afecta_iva' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_afecta_iva_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_prod_presupuesto_periodo_afecta_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cliente' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_cliente_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_prod_presupuesto_periodo_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_empresa' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_empresa_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_prod_presupuesto_periodo_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_incluye_retencion' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_incluye_retencion_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_prod_presupuesto_periodo_incluye_retencion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_iva' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_iva_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_prod_presupuesto_periodo_iva_onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_prod_presupuesto_periodo_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_modificacion_contrato' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_modificacion_contrato_onchange(this, iSeqRow) });
  $('#id_sc_field_monto_contrato' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_monto_contrato_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_prod_presupuesto_periodo_monto_contrato_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_prod_presupuesto_periodo_monto_contrato_onfocus(this, iSeqRow) });
  $('#id_sc_field_monto_disponible' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_monto_disponible_onchange(this, iSeqRow) });
  $('#id_sc_field_observaciones_solicitud' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_observaciones_solicitud_onblur(this, iSeqRow) })
                                                     .bind('change', function() { sc_form_prod_presupuesto_periodo_observaciones_solicitud_onchange(this, iSeqRow) })
                                                     .bind('focus', function() { sc_form_prod_presupuesto_periodo_observaciones_solicitud_onfocus(this, iSeqRow) });
  $('#id_sc_field_porcentaje_retencion' + iSeqRow).bind('change', function() { sc_form_prod_presupuesto_periodo_porcentaje_retencion_onchange(this, iSeqRow) });
  $('#id_sc_field_retencion_acumulada' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_retencion_acumulada_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_prod_presupuesto_periodo_retencion_acumulada_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_existe_retencion' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_existe_retencion_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_prod_presupuesto_periodo_existe_retencion_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_prod_presupuesto_periodo_existe_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente_direccion' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_cliente_direccion_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_prod_presupuesto_periodo_cliente_direccion_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_prod_presupuesto_periodo_cliente_direccion_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente_contacto' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_cliente_contacto_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_prod_presupuesto_periodo_cliente_contacto_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_prod_presupuesto_periodo_cliente_contacto_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente_giro' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_cliente_giro_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_prod_presupuesto_periodo_cliente_giro_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_prod_presupuesto_periodo_cliente_giro_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente_email' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_cliente_email_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_prod_presupuesto_periodo_cliente_email_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_prod_presupuesto_periodo_cliente_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente_rut' + iSeqRow).bind('blur', function() { sc_form_prod_presupuesto_periodo_cliente_rut_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_prod_presupuesto_periodo_cliente_rut_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_prod_presupuesto_periodo_cliente_rut_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_form_prod_presupuesto_periodo_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_id_proyecto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_id_item_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_monto_uf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_vigente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_orden_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_avance_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_facturado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_valor_uf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_factura_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_tipo_moneda_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_reajuste_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_dias_desde_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_dias_hasta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_factor_produccion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_dias_periodo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_avance_periodo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_avance_periodo_siguiente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_avance_informado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_avance_periodo_anterior_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_produccion_total_final_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_total_facturado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_total_facturado_ur_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_avance_informado_con_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_produccion_ep_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_reajuste_con_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_retencion_con_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_produccion_neto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_reajuste_acumulado_neto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_reajuste_acumulado_con_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_monto_real_facturacion_onblur(oThis, iSeqRow) {
  do_ajax_form_prod_presupuesto_periodo_validate_monto_real_facturacion();
  scCssBlur(oThis);
}

function sc_form_prod_presupuesto_periodo_monto_real_facturacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_monto_real_facturacion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_prod_presupuesto_periodo_afecta_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_incluye_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_modificacion_contrato_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_monto_contrato_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_monto_disponible_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_observaciones_solicitud_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_porcentaje_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_retencion_acumulada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_existe_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_presupuesto_periodo_cliente_direccion_onblur(oThis, iSeqRow) {
  do_ajax_form_prod_presupuesto_periodo_validate_cliente_direccion();
  scCssBlur(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_direccion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_cliente_direccion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_contacto_onblur(oThis, iSeqRow) {
  do_ajax_form_prod_presupuesto_periodo_validate_cliente_contacto();
  scCssBlur(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_cliente_contacto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_giro_onblur(oThis, iSeqRow) {
  do_ajax_form_prod_presupuesto_periodo_validate_cliente_giro();
  scCssBlur(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_giro_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_cliente_giro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_email_onblur(oThis, iSeqRow) {
  do_ajax_form_prod_presupuesto_periodo_validate_cliente_email();
  scCssBlur(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_cliente_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_rut_onblur(oThis, iSeqRow) {
  do_ajax_form_prod_presupuesto_periodo_validate_cliente_rut();
  scCssBlur(oThis);
}

function sc_form_prod_presupuesto_periodo_cliente_rut_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_prod_presupuesto_periodo_cliente_rut_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_4(status) {
	...
	displayChange_field("cliente_rut", "", status);
	displayChange_field("cliente_giro", "", status);
	displayChange_field("cliente_direccion", "", status);
	displayChange_field("cliente_contacto", "", status);
	displayChange_field("cliente_email", "", status);
}

function displayChange_block_5(status) {
	displayChange_field("monto_real_facturacion", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_cliente_rut(row, status);
	displayChange_field_cliente_giro(row, status);
	displayChange_field_cliente_direccion(row, status);
	displayChange_field_cliente_contacto(row, status);
	displayChange_field_cliente_email(row, status);
	displayChange_field_monto_real_facturacion(row, status);
...
function displayChange_field(field, row, status) {
	...
	if ("cliente_rut" == field) {
		displayChange_field_cliente_rut(row, status);
	}
	if ("cliente_giro" == field) {
		displayChange_field_cliente_giro(row, status);
	}
	if ("cliente_direccion" == field) {
		displayChange_field_cliente_direccion(row, status);
	}
	if ("cliente_contacto" == field) {
		displayChange_field_cliente_contacto(row, status);
	}
	if ("cliente_email" == field) {
		displayChange_field_cliente_email(row, status);
	}
	if ("monto_real_facturacion" == field) {
		displayChange_field_monto_real_facturacion(row, status);
	}
	if ("monto_uf" == field) {
		displayChange_field_monto_uf(row, status);
...
function displayChange_field_cliente_rut(row, status) {
    var fieldId;
}

function displayChange_field_cliente_giro(row, status) {
    var fieldId;
}

function displayChange_field_cliente_direccion(row, status) {
    var fieldId;
}

function displayChange_field_cliente_contacto(row, status) {
    var fieldId;
}

function displayChange_field_cliente_email(row, status) {
    var fieldId;
}

function displayChange_field_monto_real_facturacion(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_form_prod_presupuesto_periodo_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_desde" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  $("#id_sc_field_fecha_hasta" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  $("#id_sc_field_fecha_desde_factura" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_prod_presupuesto_periodo_validate_fecha_desde_factura(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  $("#id_sc_field_fecha_hasta_factura" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_prod_presupuesto_periodo_validate_fecha_hasta_factura(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_prod_presupuesto_periodo_validate_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_factura" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_prod_presupuesto_periodo_ul_save.php",
    dropZone: $("#hidden_field_data_factura" + iSeqRow),
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_prod_presupuesto_periodo')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
