...
?>
  ...
  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_rut()
  {
    var nomeCampo_cliente_rut = "cliente_rut";
    var var_cliente_rut = scAjaxGetFieldSelect(nomeCampo_cliente_rut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_rut(var_cliente_rut, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_rut_cb);
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_rut

  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_rut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_rut_cb

  // ---------- Validate cliente_giro
  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_giro()
  {
    var nomeCampo_cliente_giro = "cliente_giro";
    var var_cliente_giro = scAjaxGetFieldSelect(nomeCampo_cliente_giro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_giro(var_cliente_giro, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_giro_cb);
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_giro

  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_giro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_giro_cb

  // ---------- Validate cliente_direccion
  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_direccion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_direccion(var_cliente_direccion, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_direccion_cb);
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_direccion

  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_direccion_cb

  // ---------- Validate cliente_contacto
  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_contacto()
  {
    var nomeCampo_cliente_contacto = "cliente_contacto";
    var var_cliente_contacto = scAjaxGetFieldSelect(nomeCampo_cliente_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_contacto(var_cliente_contacto, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_contacto_cb);
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_contacto

  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_contacto_cb

  // ---------- Validate cliente_email
  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_email()
  {
    var nomeCampo_cliente_email = "cliente_email";
    var var_cliente_email = scAjaxGetFieldSelect(nomeCampo_cliente_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_email(var_cliente_email, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_email_cb);
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_email

  function do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_cliente_email_cb

  // ---------- Validate monto_real_facturacion
  function do_ajax_form_prod_presupuesto_periodo_mob_validate_monto_real_facturacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_presupuesto_periodo_mob_validate_monto_real_facturacion(var_monto_real_facturacion, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_validate_monto_real_facturacion_cb);
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_monto_real_facturacion

  function do_ajax_form_prod_presupuesto_periodo_mob_validate_monto_real_facturacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_presupuesto_periodo_mob_validate_monto_real_facturacion_cb
  ...
  function do_ajax_form_prod_presupuesto_periodo_mob_event_fecha_hasta_factura_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_mob_event_fecha_hasta_factura_onchange(var_produccion_neto, var_reajuste_acumulado_neto, var_incluye_retencion, var_existe_retencion, var_afecta_iva, var_retencion_acumulada, var_fecha_desde_factura, var_fecha_hasta_factura, var_fecha_desde, var_id_proyecto, var_avance_informado_con_iva, var_multa, var_retencion, var_retencion_con_iva, var_iva, var_monto_real_facturacion, var_monto_uf, var_total_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_event_fecha_hasta_factura_onchange_cb);
  ...
  function do_ajax_form_prod_presupuesto_periodo_mob_event_multa_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_mob_event_multa_onchange(var_produccion_neto, var_reajuste_acumulado_neto, var_fecha_desde_factura, var_fecha_hasta_factura, var_fecha_desde, var_id_proyecto, var_avance_informado_con_iva, var_multa, var_retencion_con_iva, var_retencion, var_incluye_retencion, var_iva, var_monto_uf, var_total_facturado, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_event_multa_onchange_cb);
  ...
  function do_ajax_form_prod_presupuesto_periodo_mob_event_retencion_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prod_presupuesto_periodo_mob_event_retencion_onchange(var_monto_real_facturacion, var_retencion, var_monto_uf, var_iva, var_retencion_con_iva, var_script_case_init, do_ajax_form_prod_presupuesto_periodo_mob_event_retencion_onchange_cb);
