...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_proyectos/form_proyectos_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_proyectos_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_proyectos_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_proyectos']['error_buffer']) && '' != $_SESSION['scriptcase']['form_proyectos']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_proyectos']['error_buffer'];
}
...
<?php
 include_once("form_proyectos_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_proyectos_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_proyectos_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_proyectos_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-7';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script type="text/javascript">
var pag_ativa = "form_proyectos_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_proyectos_mob_form0' => array(
            'title' => "Datos Proyecto",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_proyectos_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_proyectos_mob_form1' => array(
            'title' => "Usuarios Asociados",
            'class' => $nmgp_num_form == "form_proyectos_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
        'form_proyectos_mob_form2' => array(
            'title' => "Itemización Producción",
            'class' => $nmgp_num_form == "form_proyectos_mob_form2" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('Datos Proyecto' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_proyectos_mob_form0']['class'] = 'scTabInactive';
            }
            if ('Usuarios Asociados' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_proyectos_mob_form1']['class'] = 'scTabInactive';
            }
            if ('Itemización Producción' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_proyectos_mob_form2']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_proyectos_mob_form0"]['class'];
?>
   <li id="id_form_proyectos_mob_form0" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="form_proyectos_mob_form0">
     Datos Proyecto
   </li>
<?php
    $css_celula = $this->tabCssClass["form_proyectos_mob_form1"]['class'];
?>
   <li id="id_form_proyectos_mob_form1" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="form_proyectos_mob_form1">
     Usuarios Asociados
   </li>
<?php
    $css_celula = $this->tabCssClass["form_proyectos_mob_form2"]['class'];
?>
   <li id="id_form_proyectos_mob_form2" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="form_proyectos_mob_form2">
...
<div id="form_proyectos_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nombre_proyecto_line" id="hidden_field_data_nombre_proyecto" style="<?php echo $sStyleHidden_nombre_proyecto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombre_proyecto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nombre_proyecto_label" style=""><span id="id_label_nombre_proyecto"><?php echo $this->nm_new_label['nombre_proyecto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['nombre_proyecto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['nombre_proyecto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_cliente_line" id="hidden_field_data_id_cliente" style="<?php echo $sStyleHidden_id_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_cliente_label" style=""><span id="id_label_id_cliente"><?php echo $this->nm_new_label['id_cliente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_cliente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_prod_clientes_proyectos"]) && $this->Ini->sc_lig_md5["form_prod_clientes_proyectos"] == "S") {
       $Parms_Lig  = "SC_glo_par_id_cl*scinid_cl*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_proyectos_mob_lkpedt_refresh_id_cliente*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_proyectos_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_id_cl*scinid_cl*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_proyectos_mob_lkpedt_refresh_id_cliente*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
   }
 ?><?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_id_cliente", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_prod_clientes_proyectos_edit . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_proyectos_mob&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_inicio_line" id="hidden_field_data_fecha_inicio" style="<?php echo $sStyleHidden_fecha_inicio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_inicio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_inicio_label" style=""><span id="id_label_fecha_inicio"><?php echo $this->nm_new_label['fecha_inicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['fecha_inicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['fecha_inicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_termino_line" id="hidden_field_data_fecha_termino" style="<?php echo $sStyleHidden_fecha_termino; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_termino_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_termino_label" style=""><span id="id_label_fecha_termino"><?php echo $this->nm_new_label['fecha_termino']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['fecha_termino']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['fecha_termino'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_duracion_line" id="hidden_field_data_duracion" style="<?php echo $sStyleHidden_duracion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_duracion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_duracion_label" style=""><span id="id_label_duracion"><?php echo $this->nm_new_label['duracion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['duracion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['duracion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_presupuesto_line" id="hidden_field_data_presupuesto" style="<?php echo $sStyleHidden_presupuesto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_presupuesto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_presupuesto_label" style=""><span id="id_label_presupuesto"><?php echo $this->nm_new_label['presupuesto']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_estado_line" id="hidden_field_data_id_estado" style="<?php echo $sStyleHidden_id_estado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_estado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_estado_label" style=""><span id="id_label_id_estado"><?php echo $this->nm_new_label['id_estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_portafolio_line" id="hidden_field_data_id_portafolio" style="<?php echo $sStyleHidden_id_portafolio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_portafolio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_portafolio_label" style=""><span id="id_label_id_portafolio"><?php echo $this->nm_new_label['id_portafolio']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_fase_line" id="hidden_field_data_id_fase" style="<?php echo $sStyleHidden_id_fase; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_fase_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_fase_label" style=""><span id="id_label_id_fase"><?php echo $this->nm_new_label['id_fase']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_fase']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_fase'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_habilitado_line" id="hidden_field_data_habilitado" style="<?php echo $sStyleHidden_habilitado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_habilitado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_habilitado_label" style=""><span id="id_label_habilitado"><?php echo $this->nm_new_label['habilitado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['habilitado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['habilitado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_habilitado'][] = ''; ?>
 <option value=""></option>
 <option  value="1" <?php  if ($this->habilitado == "1") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_habilitado'][] = '1'; ?>
 <option  value="0" <?php  if ($this->habilitado == "0") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_habilitado'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_direccion_line" id="hidden_field_data_id_direccion" style="<?php echo $sStyleHidden_id_direccion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_direccion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_direccion_label" style=""><span id="id_label_id_direccion"><?php echo $this->nm_new_label['id_direccion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_direccion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_jefe_proyecto_line" id="hidden_field_data_id_jefe_proyecto" style="<?php echo $sStyleHidden_id_jefe_proyecto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_jefe_proyecto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_jefe_proyecto_label" style=""><span id="id_label_id_jefe_proyecto"><?php echo $this->nm_new_label['id_jefe_proyecto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_jefe_proyecto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['php_cmp_required']['id_jefe_proyecto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_afecta_iva'][] = ''; ?>
 <option value=""></option>
 <option  value="1" <?php  if ($this->afecta_iva == "1") { echo " selected" ;} ?><?php  if (empty($this->afecta_iva)) { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_afecta_iva'][] = '1'; ?>
 <option  value="0" <?php  if ($this->afecta_iva == "0") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_afecta_iva'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_existe_retencion'][] = ''; ?>
 <option value=""></option>
 <option  value="1" <?php  if ($this->existe_retencion == "1") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_existe_retencion'][] = '1'; ?>
 <option  value="0" <?php  if ($this->existe_retencion == "0") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_existe_retencion'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_incluye_retencion'][] = ''; ?>
 <option value=""></option>
 <option  value="1" <?php  if ($this->incluye_retencion == "1") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_incluye_retencion'][] = '1'; ?>
 <option  value="0" <?php  if ($this->incluye_retencion == "0") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_proyectos_mob']['Lookup_incluye_retencion'][] = '0'; ?>
 </select></span>
</span><?php  }?>
