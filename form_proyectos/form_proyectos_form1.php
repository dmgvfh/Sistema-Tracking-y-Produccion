<div id="form_proyectos_form1" style='<?php echo ($this->tabCssClass["form_proyectos_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php  $this->proyecto_usuarios_1 = explode("@?@", $this->proyecto_usuarios) ; ?>
    <TD class="scFormLabelOdd scUiLabelWidthFix css_proyecto_usuarios_label" id="hidden_field_label_proyecto_usuarios" style="<?php echo $sStyleHidden_proyecto_usuarios; ?>"><span id="id_label_proyecto_usuarios"><?php echo $this->nm_new_label['proyecto_usuarios']; ?></span></TD>
    <TD class="scFormDataOdd css_proyecto_usuarios_line" id="hidden_field_data_proyecto_usuarios" style="<?php echo $sStyleHidden_proyecto_usuarios; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_proyecto_usuarios_line" style="vertical-align: top;padding: 0px"> 
<?php  
$nmgp_def_dados = "" ; 
