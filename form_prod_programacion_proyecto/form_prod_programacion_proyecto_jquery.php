...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_id_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_prod_programacion_proyecto_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_proyecto' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_id_proyecto_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_prod_programacion_proyecto_id_proyecto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_fecha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_prod_programacion_proyecto_fecha_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_modificacion_contrato' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_modificacion_contrato_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_prod_programacion_proyecto_modificacion_contrato_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_avance' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_avance_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_prod_programacion_proyecto_avance_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_facturacion' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_facturacion_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_prod_programacion_proyecto_facturacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_costos' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_costos_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_prod_programacion_proyecto_costos_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_saldo_ur' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_saldo_ur_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_prod_programacion_proyecto_saldo_ur_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_backlog_p' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_backlog_p_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_prod_programacion_proyecto_backlog_p_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_backlog_f' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_backlog_f_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_prod_programacion_proyecto_backlog_f_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ur_real' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_ur_real_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_prod_programacion_proyecto_ur_real_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_correlativo_mes' + iSeqRow).bind('blur', function() { sc_form_prod_programacion_proyecto_correlativo_mes_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_prod_programacion_proyecto_correlativo_mes_onchange(this, iSeqRow) })
...
function sc_form_prod_programacion_proyecto_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_id_proyecto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_modificacion_contrato_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_avance_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_facturacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_costos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_saldo_ur_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_backlog_p_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_backlog_f_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_ur_real_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_prod_programacion_proyecto_correlativo_mes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_prod_programacion_proyecto_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_prod_programacion_proyecto_validate_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_prod_programacion_proyecto')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
