  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_programacion_proyecto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_programacion_proyecto_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_prod_programacion_proyecto_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_id(var_id, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_id_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_id

  function do_ajax_form_prod_programacion_proyecto_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_id_cb

  // ---------- Validate id_proyecto
  function do_ajax_form_prod_programacion_proyecto_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_id_proyecto_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_id_proyecto

  function do_ajax_form_prod_programacion_proyecto_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_id_proyecto_cb

  // ---------- Validate fecha
  function do_ajax_form_prod_programacion_proyecto_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_fecha_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_fecha

  function do_ajax_form_prod_programacion_proyecto_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_fecha_cb

  // ---------- Validate modificacion_contrato
  function do_ajax_form_prod_programacion_proyecto_validate_modificacion_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_modificacion_contrato(var_modificacion_contrato, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_modificacion_contrato_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_modificacion_contrato

  function do_ajax_form_prod_programacion_proyecto_validate_modificacion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_modificacion_contrato_cb

  // ---------- Validate avance
  function do_ajax_form_prod_programacion_proyecto_validate_avance()
  {
    var nomeCampo_avance = "avance";
    var var_avance = scAjaxGetFieldText(nomeCampo_avance);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_avance(var_avance, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_avance_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_avance

  function do_ajax_form_prod_programacion_proyecto_validate_avance_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avance";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_avance_cb

  // ---------- Validate facturacion
  function do_ajax_form_prod_programacion_proyecto_validate_facturacion()
  {
    var nomeCampo_facturacion = "facturacion";
    var var_facturacion = scAjaxGetFieldText(nomeCampo_facturacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_facturacion(var_facturacion, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_facturacion_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_facturacion

  function do_ajax_form_prod_programacion_proyecto_validate_facturacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_facturacion_cb

  // ---------- Validate costos
  function do_ajax_form_prod_programacion_proyecto_validate_costos()
  {
    var nomeCampo_costos = "costos";
    var var_costos = scAjaxGetFieldText(nomeCampo_costos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_costos(var_costos, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_costos_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_costos

  function do_ajax_form_prod_programacion_proyecto_validate_costos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "costos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_costos_cb

  // ---------- Validate saldo_ur
  function do_ajax_form_prod_programacion_proyecto_validate_saldo_ur()
  {
    var nomeCampo_saldo_ur = "saldo_ur";
    var var_saldo_ur = scAjaxGetFieldText(nomeCampo_saldo_ur);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_saldo_ur(var_saldo_ur, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_saldo_ur_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_saldo_ur

  function do_ajax_form_prod_programacion_proyecto_validate_saldo_ur_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo_ur";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_saldo_ur_cb

  // ---------- Validate backlog_p
  function do_ajax_form_prod_programacion_proyecto_validate_backlog_p()
  {
    var nomeCampo_backlog_p = "backlog_p";
    var var_backlog_p = scAjaxGetFieldText(nomeCampo_backlog_p);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_backlog_p(var_backlog_p, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_backlog_p_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_backlog_p

  function do_ajax_form_prod_programacion_proyecto_validate_backlog_p_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_backlog_p_cb

  // ---------- Validate backlog_f
  function do_ajax_form_prod_programacion_proyecto_validate_backlog_f()
  {
    var nomeCampo_backlog_f = "backlog_f";
    var var_backlog_f = scAjaxGetFieldText(nomeCampo_backlog_f);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_backlog_f(var_backlog_f, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_backlog_f_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_backlog_f

  function do_ajax_form_prod_programacion_proyecto_validate_backlog_f_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_backlog_f_cb

  // ---------- Validate ur_real
  function do_ajax_form_prod_programacion_proyecto_validate_ur_real()
  {
    var nomeCampo_ur_real = "ur_real";
    var var_ur_real = scAjaxGetFieldText(nomeCampo_ur_real);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_ur_real(var_ur_real, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_ur_real_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_ur_real

  function do_ajax_form_prod_programacion_proyecto_validate_ur_real_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ur_real";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_ur_real_cb

  // ---------- Validate correlativo_mes
  function do_ajax_form_prod_programacion_proyecto_validate_correlativo_mes()
  {
    var nomeCampo_correlativo_mes = "correlativo_mes";
    var var_correlativo_mes = scAjaxGetFieldText(nomeCampo_correlativo_mes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_programacion_proyecto_validate_correlativo_mes(var_correlativo_mes, var_script_case_init, do_ajax_form_prod_programacion_proyecto_validate_correlativo_mes_cb);
  } // do_ajax_form_prod_programacion_proyecto_validate_correlativo_mes

  function do_ajax_form_prod_programacion_proyecto_validate_correlativo_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_programacion_proyecto_validate_correlativo_mes_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_programacion_proyecto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_programacion_proyecto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_avance = scAjaxGetFieldText("avance");
    var var_facturacion = scAjaxGetFieldText("facturacion");
    var var_costos = scAjaxGetFieldText("costos");
    var var_saldo_ur = scAjaxGetFieldText("saldo_ur");
    var var_backlog_p = scAjaxGetFieldText("backlog_p");
    var var_backlog_f = scAjaxGetFieldText("backlog_f");
    var var_ur_real = scAjaxGetFieldText("ur_real");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_programacion_proyecto_submit_form(var_id, var_id_proyecto, var_fecha, var_modificacion_contrato, var_avance, var_facturacion, var_costos, var_saldo_ur, var_backlog_p, var_backlog_f, var_ur_real, var_correlativo_mes, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_programacion_proyecto_submit_form_cb);
  } // do_ajax_form_prod_programacion_proyecto_submit_form

  function do_ajax_form_prod_programacion_proyecto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_programacion_proyecto_submit_form_cb_after_alert);
  } // do_ajax_form_prod_programacion_proyecto_submit_form_cb
  function do_ajax_form_prod_programacion_proyecto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_programacion_proyecto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_programacion_proyecto_navigate_form()
  {
    perform_ajax_form_prod_programacion_proyecto_navigate_form();
  }

  function perform_ajax_form_prod_programacion_proyecto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_programacion_proyecto_navigate_form(var_id_proyecto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_programacion_proyecto_navigate_form_cb);
  } // do_ajax_form_prod_programacion_proyecto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_programacion_proyecto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_programacion_proyecto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_programacion_proyecto_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_programacion_proyecto_navigate_form_cb
  function do_ajax_form_prod_programacion_proyecto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_programacion_proyecto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_programacion_proyecto_navigate_form_cb_after_alert

  function sc_hide_form_prod_programacion_proyecto_form()
  {
  ...
  ajax_field_list[2] = "fecha";
  ajax_field_list[3] = "modificacion_contrato";
  ajax_field_list[4] = "avance";
  ajax_field_list[5] = "facturacion";
  ajax_field_list[6] = "costos";
  ajax_field_list[7] = "saldo_ur";
  ajax_field_list[8] = "backlog_p";
  ajax_field_list[9] = "backlog_f";
  ajax_field_list[10] = "ur_real";
  ajax_field_list[11] = "correlativo_mes";
  ...
  var ajax_error_list = {
    ...
    "fecha": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "modificacion_contrato": {"label": "Modificacion Contrato", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "avance": {"label": "Avance", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "facturacion": {"label": "Facturacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "costos": {"label": "Costos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "saldo_ur": {"label": "Saldo Ur", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "backlog_p": {"label": "Backlog P", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "backlog_f": {"label": "Backlog F", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ur_real": {"label": "Ur Real", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_id = {
    ...
    "saldo_ur": new Array("hidden_field_label_saldo_ur", "hidden_field_data_saldo_ur"),
    ...
    "ur_real": new Array("hidden_field_label_ur_real", "hidden_field_data_ur_real"),
