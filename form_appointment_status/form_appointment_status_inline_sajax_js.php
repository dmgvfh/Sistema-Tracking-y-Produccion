  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointment_status_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointment_status_inline_form();
	}
...
?>
  ...
  function do_ajax_form_appointment_status_inline_validate_appointment_status_descr_()
  {
    var nomeCampo_appointment_status_descr_ = "appointment_status_descr_";
    var var_appointment_status_descr_ = scAjaxGetFieldText(nomeCampo_appointment_status_descr_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_status_inline_validate_appointment_status_descr_(var_appointment_status_descr_, var_script_case_init, do_ajax_form_appointment_status_inline_validate_appointment_status_descr__cb);
  } // do_ajax_form_appointment_status_inline_validate_appointment_status_descr_

  function do_ajax_form_appointment_status_inline_validate_appointment_status_descr__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_status_inline_validate_appointment_status_descr__cb

  // ---------- Validate color_
  function do_ajax_form_appointment_status_inline_validate_color_()
  {
    var nomeCampo_color_ = "color_";
    var var_color_ = scAjaxGetFieldText(nomeCampo_color_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_status_inline_validate_color_(var_color_, var_script_case_init, do_ajax_form_appointment_status_inline_validate_color__cb);
  } // do_ajax_form_appointment_status_inline_validate_color_

  function do_ajax_form_appointment_status_inline_validate_color__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_status_inline_validate_color__cb

  // ---------- Validate appointment_status_id_
  function do_ajax_form_appointment_status_inline_validate_appointment_status_id_()
  {
    var nomeCampo_appointment_status_id_ = "appointment_status_id_";
    var var_appointment_status_id_ = scAjaxGetFieldText(nomeCampo_appointment_status_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_status_inline_validate_appointment_status_id_(var_appointment_status_id_, var_script_case_init, do_ajax_form_appointment_status_inline_validate_appointment_status_id__cb);
  } // do_ajax_form_appointment_status_inline_validate_appointment_status_id_

  function do_ajax_form_appointment_status_inline_validate_appointment_status_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_status_inline_validate_appointment_status_id__cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_appointment_status_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_appointment_status_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_appointment_status_descr_ = scAjaxGetFieldText("appointment_status_descr_");
    var var_color_ = scAjaxGetFieldText("color_");
    var var_appointment_status_id_ = scAjaxGetFieldText("appointment_status_id_");
    ...
    scAjaxProcOn();
    x_ajax_form_appointment_status_inline_submit_form(var_appointment_status_descr_, var_color_, var_appointment_status_id_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointment_status_inline_submit_form_cb);
  } // do_ajax_form_appointment_status_inline_submit_form

  function do_ajax_form_appointment_status_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("appointment_status_descr_");
      scAjaxHideErrorDisplay("color_");
      scAjaxHideErrorDisplay("appointment_status_id_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_appointment_status_inline_submit_form_cb_after_alert);
  } // do_ajax_form_appointment_status_inline_submit_form_cb
  function do_ajax_form_appointment_status_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointment_status_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointment_status_inline_navigate_form()
  {
    perform_ajax_form_appointment_status_inline_navigate_form();
  }

  function perform_ajax_form_appointment_status_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_appointment_status_inline_navigate_form(var_appointment_status_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointment_status_inline_navigate_form_cb);
  } // do_ajax_form_appointment_status_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointment_status_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointment_status_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointment_status_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_appointment_status_inline_navigate_form_cb
  function do_ajax_form_appointment_status_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_appointment_status_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_appointment_status_inline_navigate_form_cb_after_alert

  function sc_hide_form_appointment_status_inline_form()
  {
  ...
  ajax_field_list[0] = "appointment_status_descr_";
  ajax_field_list[1] = "color_";
  ajax_field_list[2] = "appointment_status_id_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "appointment_status_descr_": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointment_status_fld_appointment_status_descr'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "color_": {"label": "Color", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_status_id_": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointment_status_fld_appointment_status_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["appointment_status_descr_"][1] = "appointment_status_descr_";
  ajax_field_mult["color_"][1] = "color_";
  ajax_field_mult["appointment_status_id_"][1] = "appointment_status_id_";

  var ajax_field_id = {
    "appointment_status_descr_": new Array("hidden_field_label_appointment_status_descr_", "hidden_field_data_appointment_status_descr_"),
    "color_": new Array("hidden_field_label_color_", "hidden_field_data_color_")
  };

  var ajax_read_only = {
    "appointment_status_descr_": "off",
    "color_": "off",
    "appointment_status_id_": "on"
  };
