  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointment_status" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointment_status_form();
	}
...
?>
  ...
  // ---------- Validate appointment_status_descr_
  function do_ajax_form_appointment_status_validate_appointment_status_descr_(iNumLinha)
  {
    var nomeCampo_appointment_status_descr_ = "appointment_status_descr_" + iNumLinha;
    var var_appointment_status_descr_ = scAjaxGetFieldText(nomeCampo_appointment_status_descr_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_status_validate_appointment_status_descr_(var_appointment_status_descr_, iNumLinha, var_script_case_init, do_ajax_form_appointment_status_validate_appointment_status_descr__cb);
  } // do_ajax_form_appointment_status_validate_appointment_status_descr_

  function do_ajax_form_appointment_status_validate_appointment_status_descr__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "appointment_status_descr_" + iLineNumber;
    }
    else
    {
      sFieldValid = "appointment_status_descr_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "appointment_status_descr_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "appointment_status_descr_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_status_validate_appointment_status_descr__cb

  // ---------- Validate color_
  function do_ajax_form_appointment_status_validate_color_(iNumLinha)
  {
    var nomeCampo_color_ = "color_" + iNumLinha;
    var var_color_ = scAjaxGetFieldText(nomeCampo_color_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_status_validate_color_(var_color_, iNumLinha, var_script_case_init, do_ajax_form_appointment_status_validate_color__cb);
  } // do_ajax_form_appointment_status_validate_color_

  function do_ajax_form_appointment_status_validate_color__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "color_" + iLineNumber;
    }
    else
    {
      sFieldValid = "color_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "color_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "color_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_status_validate_color__cb

  // ---------- Validate appointment_status_id_
  function do_ajax_form_appointment_status_validate_appointment_status_id_(iNumLinha)
  {
    var nomeCampo_appointment_status_id_ = "appointment_status_id_" + iNumLinha;
    var var_appointment_status_id_ = scAjaxGetFieldHidden(nomeCampo_appointment_status_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_status_validate_appointment_status_id_(var_appointment_status_id_, iNumLinha, var_script_case_init, do_ajax_form_appointment_status_validate_appointment_status_id__cb);
  } // do_ajax_form_appointment_status_validate_appointment_status_id_

  function do_ajax_form_appointment_status_validate_appointment_status_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "appointment_status_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "appointment_status_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "appointment_status_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "appointment_status_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_status_validate_appointment_status_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_appointment_status_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_appointment_status_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointment_status_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_appointment_status_add_new_line_cb);
  } // do_ajax_form_appointment_status_add_new_line

  function do_ajax_form_appointment_status_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_appointment_status_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_appointment_status_backup_line(iNumLinha)
  {
    var var_appointment_status_id_ = scAjaxGetFieldHidden("appointment_status_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_status_backup_line(var_appointment_status_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_appointment_status_backup_line_cb);
  } // do_ajax_form_appointment_status_backup_line

  function do_ajax_form_appointment_status_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_appointment_status_backup_line_cb

  function do_ajax_form_appointment_status_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_appointment_status_cancel_insert

  function do_ajax_form_appointment_status_cancel_update(iSeqVert)
  {
    do_ajax_form_appointment_status_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_appointment_status_cancel_update

  function do_ajax_form_appointment_status_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_appointment_status_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_appointment_status_table_refresh()
  {
    var var_appointment_status_id_ = document.F2.appointment_status_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_appointment_status_table_refresh(var_appointment_status_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointment_status_table_refresh_cb);
  } //  do_ajax_form_appointment_status_table_refresh

  function do_ajax_form_appointment_status_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.appointment_status_id_.value = scAjaxGetKeyValue("appointment_status_id_");
    ...
    scAjaxAlert(do_ajax_form_appointment_status_table_refresh_cb_after_alert);
  } // do_ajax_form_appointment_status_table_refresh_cb
  function do_ajax_form_appointment_status_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_appointment_status_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_appointment_status_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_appointment_status_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_appointment_status_descr_ = scAjaxGetFieldText("appointment_status_descr_" + iNumLinha);
    var var_color_ = scAjaxGetFieldText("color_" + iNumLinha);
    var var_appointment_status_id_ = scAjaxGetFieldHidden("appointment_status_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_appointment_status_submit_form(var_appointment_status_descr_, var_color_, var_appointment_status_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointment_status_submit_form_cb);
  } // do_ajax_form_appointment_status_submit_form

  function do_ajax_form_appointment_status_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("appointment_status_descr_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("color_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("appointment_status_id_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointment_status_submit_form_cb_after_alert);
  } // do_ajax_form_appointment_status_submit_form_cb
  function do_ajax_form_appointment_status_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointment_status_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointment_status_navigate_form()
  {
    perform_ajax_form_appointment_status_navigate_form();
  }

  function perform_ajax_form_appointment_status_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_appointment_status_cancel_insert(sc_form_appointment_status_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("appointment_status_descr_" + iNavForm);
      scAjaxHideErrorDisplay("color_" + iNavForm);
      scAjaxHideErrorDisplay("appointment_status_id_" + iNavForm);
    }
    var var_appointment_status_id_ = document.F2.appointment_status_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_appointment_status_navigate_form(var_appointment_status_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointment_status_navigate_form_cb);
  } // do_ajax_form_appointment_status_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointment_status']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointment_status_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.appointment_status_id_.value = scAjaxGetKeyValue("appointment_status_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointment_status_navigate_form_cb_after_alert);
  } // do_ajax_form_appointment_status_navigate_form_cb
  function do_ajax_form_appointment_status_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_appointment_status_navigate_form_cb_after_alert

    function sc_form_appointment_status_get_last_line_number()
    {
    ...
    } //sc_form_appointment_status_get_last_line_number

  function sc_hide_form_appointment_status_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "appointment_status_descr_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "color_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "appointment_status_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["appointment_status_descr_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointment_status_fld_appointment_status_descr'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["color_" + iNumLinha] = {"label": "Color<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["appointment_status_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointment_status_fld_appointment_status_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["appointment_status_descr_"][iNumLinha] = "appointment_status_descr_" + iNumLinha;
    ajax_field_mult["color_"][iNumLinha] = "color_" + iNumLinha;
    ajax_field_mult["appointment_status_id_"][iNumLinha] = "appointment_status_id_" + iNumLinha;
    ajax_field_id["appointment_status_descr_" + iNumLinha] = new Array("hidden_field_label_appointment_status_descr_", "hidden_field_data_appointment_status_descr_" + iNumLinha);
    ajax_field_id["color_" + iNumLinha] = new Array("hidden_field_label_color_", "hidden_field_data_color_" + iNumLinha);
    ajax_error_count["appointment_status_descr_" + iNumLinha] = "off";
    ajax_error_count["color_" + iNumLinha] = "off";
    ajax_error_count["appointment_status_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["appointment_status_descr_" + iNumLinha] = "off";
    ajax_read_only["color_" + iNumLinha] = "off";
    ajax_read_only["appointment_status_id_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["appointment_status_descr_" + iNumLinha] = "on";
    ajax_read_only["color_" + iNumLinha] = "on";
    ajax_read_only["appointment_status_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["appointment_status_descr_" + iNumLinha] = null;
    ajax_error_list["color_" + iNumLinha] = null;
    ajax_error_list["appointment_status_id_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "appointment_status_descr_": new Array(),
    "color_": new Array(),
    "appointment_status_id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["appointment_status_descr_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["appointment_status_descr_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["appointment_status_descr_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["appointment_status_descr_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["appointment_status_descr_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["color_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["color_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["color_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["color_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["color_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["appointment_status_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["appointment_status_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["appointment_status_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["appointment_status_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["appointment_status_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['appointment_status_descr_'])) ? $this->nmgp_cmp_readonly['appointment_status_descr_'] : 'off';
?>
    scAjaxFieldRead("appointment_status_descr_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['color_'])) ? $this->nmgp_cmp_readonly['color_'] : 'off';
?>
    scAjaxFieldRead("color_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['appointment_status_id_'])) ? $this->nmgp_cmp_readonly['appointment_status_id_'] : 'on';
?>
    scAjaxFieldRead("appointment_status_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("appointment_status_descr_" + iSeq, "on");
    scAjaxFieldRead("color_" + iSeq, "on");
    scAjaxFieldRead("appointment_status_id_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["appointment_status_descr_" + iRow] || "on" == ajax_error_count["color_" + iRow] || "on" == ajax_error_count["appointment_status_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_appointment_status_descr_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_color_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_appointment_status_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["appointment_status_descr_" + iRow] && "off" == ajax_error_count["color_" + iRow] && "off" == ajax_error_count["appointment_status_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["appointment_status_descr_" + iRow] = "off";
        ajax_error_count["color_" + iRow] = "off";
        ajax_error_count["appointment_status_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_appointment_status_descr_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_color_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_appointment_status_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("appointment_status_descr_" == sIndex)
    {
    ...
    if ("appointment_status_id_" == sIndex)
    {
