  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_unidad_organizativa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_unidad_organizativa_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_compania
  function do_ajax_form_unidad_organizativa_mob_validate_id_compania()
  {
    var nomeCampo_id_compania = "id_compania";
    var var_id_compania = scAjaxGetFieldSelect(nomeCampo_id_compania);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_organizativa_mob_validate_id_compania(var_id_compania, var_script_case_init, do_ajax_form_unidad_organizativa_mob_validate_id_compania_cb);
  } // do_ajax_form_unidad_organizativa_mob_validate_id_compania

  function do_ajax_form_unidad_organizativa_mob_validate_id_compania_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_compania";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unidad_organizativa_mob_validate_id_compania_cb

  // ---------- Validate nombre_unidad
  function do_ajax_form_unidad_organizativa_mob_validate_nombre_unidad()
  {
    var nomeCampo_nombre_unidad = "nombre_unidad";
    var var_nombre_unidad = scAjaxGetFieldText(nomeCampo_nombre_unidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_organizativa_mob_validate_nombre_unidad(var_nombre_unidad, var_script_case_init, do_ajax_form_unidad_organizativa_mob_validate_nombre_unidad_cb);
  } // do_ajax_form_unidad_organizativa_mob_validate_nombre_unidad

  function do_ajax_form_unidad_organizativa_mob_validate_nombre_unidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_unidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unidad_organizativa_mob_validate_nombre_unidad_cb

  // ---------- Validate usuarios_unidad
  function do_ajax_form_unidad_organizativa_mob_validate_usuarios_unidad()
  {
    var nomeCampo_usuarios_unidad = "usuarios_unidad";
    nm_pack(nomeCampo_usuarios_unidad + '_dest', nomeCampo_usuarios_unidad);
    var var_usuarios_unidad = scAjaxGetFieldText(nomeCampo_usuarios_unidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_organizativa_mob_validate_usuarios_unidad(var_usuarios_unidad, var_script_case_init, do_ajax_form_unidad_organizativa_mob_validate_usuarios_unidad_cb);
  } // do_ajax_form_unidad_organizativa_mob_validate_usuarios_unidad

  function do_ajax_form_unidad_organizativa_mob_validate_usuarios_unidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuarios_unidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unidad_organizativa_mob_validate_usuarios_unidad_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_unidad_organizativa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_unidad_organizativa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_compania = scAjaxGetFieldSelect("id_compania");
    var var_nombre_unidad = scAjaxGetFieldText("nombre_unidad");
    nm_pack("usuarios_unidad_dest", "usuarios_unidad");
    var var_usuarios_unidad = scAjaxGetFieldText("usuarios_unidad", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_form_unidad_organizativa_mob_submit_form(var_id_compania, var_nombre_unidad, var_usuarios_unidad, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_unidad_organizativa_mob_submit_form_cb);
  } // do_ajax_form_unidad_organizativa_mob_submit_form

  function do_ajax_form_unidad_organizativa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_compania");
      scAjaxHideErrorDisplay("nombre_unidad");
      scAjaxHideErrorDisplay("usuarios_unidad");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_unidad_organizativa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_unidad_organizativa_mob_submit_form_cb
  function do_ajax_form_unidad_organizativa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_unidad_organizativa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_unidad_organizativa_mob_navigate_form()
  {
    perform_ajax_form_unidad_organizativa_mob_navigate_form();
  }

  function perform_ajax_form_unidad_organizativa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_unidad_organizativa_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_unidad_organizativa_mob_navigate_form_cb);
  } // do_ajax_form_unidad_organizativa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_unidad_organizativa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_unidad_organizativa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_unidad_organizativa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_unidad_organizativa_mob_navigate_form_cb
  function do_ajax_form_unidad_organizativa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_unidad_organizativa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_unidad_organizativa_mob_navigate_form_cb_after_alert

  function sc_hide_form_unidad_organizativa_mob_form()
  {
  ...
  ajax_field_list[0] = "id_compania";
  ajax_field_list[1] = "nombre_unidad";
  ajax_field_list[2] = "usuarios_unidad";
  ...
  var ajax_error_list = {
    "id_compania": {"label": "Compania", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nombre_unidad": {"label": "Nombre Unidad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "usuarios_unidad": {"label": "Usuarios", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id_compania": new Array(),
    "nombre_unidad": new Array(),
    "usuarios_unidad": new Array()
  };
  ajax_field_mult["id_compania"][1] = "id_compania";
  ajax_field_mult["nombre_unidad"][1] = "nombre_unidad";
  ajax_field_mult["usuarios_unidad"][1] = "usuarios_unidad";

  var ajax_field_id = {
    "id_compania": new Array("hidden_field_label_id_compania", "hidden_field_data_id_compania"),
    "nombre_unidad": new Array("hidden_field_label_nombre_unidad", "hidden_field_data_nombre_unidad"),
    "usuarios_unidad": new Array("hidden_field_label_usuarios_unidad", "hidden_field_data_usuarios_unidad")
  };
