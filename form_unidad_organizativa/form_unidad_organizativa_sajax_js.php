  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_unidad_organizativa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_unidad_organizativa_form();
	}
...
?>
  ...
  function do_ajax_form_unidad_organizativa_validate_id_compania()
  {
    var nomeCampo_id_compania = "id_compania";
    var var_id_compania = scAjaxGetFieldSelect(nomeCampo_id_compania);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_organizativa_validate_id_compania(var_id_compania, var_script_case_init, do_ajax_form_unidad_organizativa_validate_id_compania_cb);
  } // do_ajax_form_unidad_organizativa_validate_id_compania

  function do_ajax_form_unidad_organizativa_validate_id_compania_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unidad_organizativa_validate_id_compania_cb

  // ---------- Validate nombre_unidad
  function do_ajax_form_unidad_organizativa_validate_nombre_unidad()
  {
    var nomeCampo_nombre_unidad = "nombre_unidad";
    var var_nombre_unidad = scAjaxGetFieldText(nomeCampo_nombre_unidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_organizativa_validate_nombre_unidad(var_nombre_unidad, var_script_case_init, do_ajax_form_unidad_organizativa_validate_nombre_unidad_cb);
  } // do_ajax_form_unidad_organizativa_validate_nombre_unidad

  function do_ajax_form_unidad_organizativa_validate_nombre_unidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unidad_organizativa_validate_nombre_unidad_cb

  // ---------- Validate usuarios_unidad
  function do_ajax_form_unidad_organizativa_validate_usuarios_unidad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unidad_organizativa_validate_usuarios_unidad(var_usuarios_unidad, var_script_case_init, do_ajax_form_unidad_organizativa_validate_usuarios_unidad_cb);
  } // do_ajax_form_unidad_organizativa_validate_usuarios_unidad

  function do_ajax_form_unidad_organizativa_validate_usuarios_unidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unidad_organizativa_validate_usuarios_unidad_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_unidad_organizativa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_unidad_organizativa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_unidad_organizativa_submit_form(var_id_compania, var_nombre_unidad, var_usuarios_unidad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_unidad_organizativa_submit_form_cb);
  } // do_ajax_form_unidad_organizativa_submit_form

  function do_ajax_form_unidad_organizativa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_unidad_organizativa_submit_form_cb_after_alert);
  } // do_ajax_form_unidad_organizativa_submit_form_cb
  function do_ajax_form_unidad_organizativa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_unidad_organizativa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_unidad_organizativa_navigate_form()
  {
    perform_ajax_form_unidad_organizativa_navigate_form();
  }

  function perform_ajax_form_unidad_organizativa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_unidad_organizativa_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_unidad_organizativa_navigate_form_cb);
  } // do_ajax_form_unidad_organizativa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_unidad_organizativa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_unidad_organizativa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_unidad_organizativa_navigate_form_cb_after_alert);
  } // do_ajax_form_unidad_organizativa_navigate_form_cb
  function do_ajax_form_unidad_organizativa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_unidad_organizativa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_unidad_organizativa_navigate_form_cb_after_alert

  function sc_hide_form_unidad_organizativa_form()
  {
