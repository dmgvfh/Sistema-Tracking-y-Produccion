...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_count_new_appointments"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_count_new_appointments"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_count_new_appointments']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_count_new_appointments']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_count_new_appointments']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_count_new_appointments']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_count_new_appointments']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_count_new_appointments</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_count_new_appointments']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_count_new_appointments']['embutida_filho'] as $ind => $sc_init)
          {
