<?php
@session_start() ;
$_SESSION['scriptcase']['grid_count_new_appointments']['sc_process_barr'] = true;
require_once('../grid_count_new_appointments/index.php');
unset($_SESSION['scriptcase']['grid_count_new_appointments']['sc_process_barr']);
$ExportCtrl = new grid_count_new_appointments_export_control;
$ExportCtrl->Export_barr();

class grid_count_new_appointments_export_control
{
