...
?>
  ...
  // ---------- Validate id_empresa
  function do_ajax_app_form_edit_users_mob_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldSelect(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_mob_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_app_form_edit_users_mob_validate_id_empresa_cb);
  } // do_ajax_app_form_edit_users_mob_validate_id_empresa

  function do_ajax_app_form_edit_users_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_mob_validate_id_empresa_cb
  ...
  // ---------- Validate is_active
  function do_ajax_app_form_edit_users_mob_validate_is_active()
  {
    var nomeCampo_is_active = "is_active";
    var var_is_active = scAjaxGetFieldRadio(nomeCampo_is_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_mob_validate_is_active(var_is_active, var_script_case_init, do_ajax_app_form_edit_users_mob_validate_is_active_cb);
  } // do_ajax_app_form_edit_users_mob_validate_is_active

  function do_ajax_app_form_edit_users_mob_validate_is_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "is_active";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_mob_validate_is_active_cb

  // ---------- Validate usuario_proyectos
  function do_ajax_app_form_edit_users_mob_validate_usuario_proyectos()
  {
    var nomeCampo_usuario_proyectos = "usuario_proyectos";
    nm_pack(nomeCampo_usuario_proyectos + '_dest', nomeCampo_usuario_proyectos);
    var var_usuario_proyectos = scAjaxGetFieldText(nomeCampo_usuario_proyectos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_mob_validate_usuario_proyectos(var_usuario_proyectos, var_script_case_init, do_ajax_app_form_edit_users_mob_validate_usuario_proyectos_cb);
  } // do_ajax_app_form_edit_users_mob_validate_usuario_proyectos

  function do_ajax_app_form_edit_users_mob_validate_usuario_proyectos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_proyectos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_mob_validate_usuario_proyectos_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_form_edit_users_mob_submit_form()
  {
    ...
    var var_is_active = scAjaxGetFieldRadio("is_active");
    nm_pack("usuario_proyectos_dest", "usuario_proyectos");
    var var_usuario_proyectos = scAjaxGetFieldText("usuario_proyectos", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_mob_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_id_empresa, var_groups, var_is_active, var_usuario_proyectos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_mob_submit_form_cb);
  ...
  function do_ajax_app_form_edit_users_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("is_active");
      scAjaxHideErrorDisplay("usuario_proyectos");
      scLigEditLookupCall();
<?php
...
?>
  ...
  ajax_field_list[5] = "id_empresa";
  ajax_field_list[6] = "groups";
  ajax_field_list[7] = "is_active";
  ajax_field_list[8] = "usuario_proyectos";
  ...
  var ajax_error_list = {
    ...
    "confirm_pswd": {"label": "Confirmar Password", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "name": {"label": "Nombre Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "Dirección de email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_empresa": {"label": "Empresa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "groups": {"label": "Perfil", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "is_active": {"label": "Activo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_proyectos": {"label": "Proyectos Asignados", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["is_active"][1] = "is_active";
  ajax_field_mult["usuario_proyectos"][1] = "usuario_proyectos";
  ...
  var ajax_field_id = {
    ...
    "is_active": new Array("hidden_field_label_is_active", "hidden_field_data_is_active"),
    "usuario_proyectos": new Array("hidden_field_label_usuario_proyectos", "hidden_field_data_usuario_proyectos")
  };
