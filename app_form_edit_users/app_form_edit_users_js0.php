...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_app_form_edit_users_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinY*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutnmgp_opcao*scinnovo*scout', '', 'modal', height, width);
}
...
function scForm_packMultiSelect_multi() {
	...
	for (var Nm_x = 1; Nm_x < NM_count_mult; Nm_x++) {
		nm_pack('usuario_proyectos' + Nm_x + '_dest', 'usuario_proyectos' + Nm_x);
	}
...
{
    document.getElementById('app_form_edit_users_form0').style.width='1px';
    document.getElementById('app_form_edit_users_form0').style.height='0px';
    document.getElementById('app_form_edit_users_form0').style.display='none';
    document.getElementById('app_form_edit_users_form0').style.overflow='scroll';
    document.getElementById('app_form_edit_users_form1').style.width='1px';
    document.getElementById('app_form_edit_users_form1').style.height='0px';
    document.getElementById('app_form_edit_users_form1').style.display='none';
    document.getElementById('app_form_edit_users_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['pdf_view']) {
?>
