   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']['label'] = "Actualizar Información De Usuario";
...
//---------------------------------------------------------
    ...
    function ValidateField_pswd(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['pswd'] == "on")) 
      { 
          if ($this->pswd == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_confirm_pswd(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['confirm_pswd'] == "on")) 
      { 
    ...
    function ValidateField_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['name'] == "on")) 
      { 
          if ($this->name == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_id_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->id_empresa == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['id_empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['id_empresa'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->id_empresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_id_empresa']) && !in_array($this->id_empresa, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_id_empresa']))
          {
              $hasError = true;
    ...
    function ValidateField_is_active(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['is_active']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['is_active'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Activo" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_is_active']) && !in_array($this->is_active, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_is_active']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['is_active']))
      ...
      if ($this->usuario_proyectos != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_usuario_proyectos']) && !in_array($dados_usuario_proyectos_1, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_usuario_proyectos']))
                       {
                           $hasError = true;
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_id_empresa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_id_empresa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_id_empresa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_id_empresa'] = array(); 
}
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('') => str_replace('<', '&lt;',app_form_edit_users_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_id_empresa'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_id_empresa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_empresa']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_edit_users_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . "")));
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('N') => str_replace('<', '&lt;',app_form_edit_users_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_no'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_is_active'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_is_active'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['is_active']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_usuario_proyectos']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_usuario_proyectos'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_usuario_proyectos']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_usuario_proyectos'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_usuario_proyectos'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
        ...
        include_once("app_form_edit_users_mob_form1.php");
        $this->hideFormPages();
 }
