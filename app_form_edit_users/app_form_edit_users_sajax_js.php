...
?>
  ...
  // ---------- Validate id_empresa
  function do_ajax_app_form_edit_users_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldSelect(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_app_form_edit_users_validate_id_empresa_cb);
  } // do_ajax_app_form_edit_users_validate_id_empresa

  function do_ajax_app_form_edit_users_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_id_empresa_cb
  ...
  // ---------- Validate is_active
  function do_ajax_app_form_edit_users_validate_is_active()
  {
    var nomeCampo_is_active = "is_active";
    var var_is_active = scAjaxGetFieldRadio(nomeCampo_is_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_is_active(var_is_active, var_script_case_init, do_ajax_app_form_edit_users_validate_is_active_cb);
  } // do_ajax_app_form_edit_users_validate_is_active

  function do_ajax_app_form_edit_users_validate_is_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_is_active_cb

  // ---------- Validate usuario_proyectos
  function do_ajax_app_form_edit_users_validate_usuario_proyectos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_usuario_proyectos(var_usuario_proyectos, var_script_case_init, do_ajax_app_form_edit_users_validate_usuario_proyectos_cb);
  } // do_ajax_app_form_edit_users_validate_usuario_proyectos

  function do_ajax_app_form_edit_users_validate_usuario_proyectos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_usuario_proyectos_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_id_empresa, var_groups, var_is_active, var_usuario_proyectos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_submit_form_cb);
