...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Agregar Usuario"); } else { echo strip_tags("Actualizar Información De Usuario"); } ?></TITLE>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app_form_edit_users/app_form_edit_users_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['last'] : 'off'); ?>";
...
else
{
    ...
    $remove_margin = '';
    $remove_border = '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['link_info']['remove_border']) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['btn_label']['exit'];
        }
?>
...
<script type="text/javascript">
var pag_ativa = "app_form_edit_users_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'app_form_edit_users_mob_form0' => array(
            'title' => "Datos Usuario",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "app_form_edit_users_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'app_form_edit_users_mob_form1' => array(
            'title' => "Proyectos Asociados",
            'class' => $nmgp_num_form == "app_form_edit_users_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('Datos Usuario' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['app_form_edit_users_mob_form0']['class'] = 'scTabInactive';
            }
            if ('Proyectos Asociados' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['app_form_edit_users_mob_form1']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["app_form_edit_users_mob_form0"]['class'];
?>
   <li id="id_app_form_edit_users_mob_form0" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="app_form_edit_users_mob_form0">
     Datos Usuario
   </li>
<?php
    $css_celula = $this->tabCssClass["app_form_edit_users_mob_form1"]['class'];
?>
   <li id="id_app_form_edit_users_mob_form1" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="app_form_edit_users_mob_form1">
     Proyectos Asociados
   </li>
</ul>
...
<div id="app_form_edit_users_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['email'] = "Dirección de email";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_is_active_line" id="hidden_field_data_is_active" style="<?php echo $sStyleHidden_is_active; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_is_active_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_is_active_label" style=""><span id="id_label_is_active"><?php echo $this->nm_new_label['is_active']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['is_active']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['is_active'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_is_active'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_is_active'][] = 'N'; ?>
