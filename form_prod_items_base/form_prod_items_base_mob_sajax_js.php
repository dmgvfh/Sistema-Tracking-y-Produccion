  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prod_items_base_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prod_items_base_mob_form();
	}
...
?>
  ...
  // ---------- Validate sc_field_0
  function do_ajax_form_prod_items_base_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_base_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_prod_items_base_mob_validate_sc_field_0_cb);
  } // do_ajax_form_prod_items_base_mob_validate_sc_field_0

  function do_ajax_form_prod_items_base_mob_validate_sc_field_0_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_base_mob_validate_sc_field_0_cb

  // ---------- Validate agrupador1
  function do_ajax_form_prod_items_base_mob_validate_agrupador1()
  {
    var nomeCampo_agrupador1 = "agrupador1";
    var var_agrupador1 = scAjaxGetFieldSelect(nomeCampo_agrupador1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_base_mob_validate_agrupador1(var_agrupador1, var_script_case_init, do_ajax_form_prod_items_base_mob_validate_agrupador1_cb);
  } // do_ajax_form_prod_items_base_mob_validate_agrupador1

  function do_ajax_form_prod_items_base_mob_validate_agrupador1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_base_mob_validate_agrupador1_cb

  // ---------- Validate items_tipo_proyecto
  function do_ajax_form_prod_items_base_mob_validate_items_tipo_proyecto()
  {
    var nomeCampo_items_tipo_proyecto = "items_tipo_proyecto";
    nm_pack(nomeCampo_items_tipo_proyecto + '_dest', nomeCampo_items_tipo_proyecto);
    var var_items_tipo_proyecto = scAjaxGetFieldText(nomeCampo_items_tipo_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prod_items_base_mob_validate_items_tipo_proyecto(var_items_tipo_proyecto, var_script_case_init, do_ajax_form_prod_items_base_mob_validate_items_tipo_proyecto_cb);
  } // do_ajax_form_prod_items_base_mob_validate_items_tipo_proyecto

  function do_ajax_form_prod_items_base_mob_validate_items_tipo_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "items_tipo_proyecto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prod_items_base_mob_validate_items_tipo_proyecto_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_prod_items_base_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_prod_items_base_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sc_field_0 = scAjaxGetFieldText("sc_field_0");
    var var_agrupador1 = scAjaxGetFieldSelect("agrupador1");
    nm_pack("items_tipo_proyecto_dest", "items_tipo_proyecto");
    var var_items_tipo_proyecto = scAjaxGetFieldText("items_tipo_proyecto", "@?@");
    var var_id_item = scAjaxGetFieldText("id_item");
    ...
    scAjaxProcOn();
    x_ajax_form_prod_items_base_mob_submit_form(var_sc_field_0, var_agrupador1, var_items_tipo_proyecto, var_id_item, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prod_items_base_mob_submit_form_cb);
  } // do_ajax_form_prod_items_base_mob_submit_form

  function do_ajax_form_prod_items_base_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_prod_items_base_mob_submit_form_cb_after_alert);
  } // do_ajax_form_prod_items_base_mob_submit_form_cb
  function do_ajax_form_prod_items_base_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prod_items_base_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prod_items_base_mob_navigate_form()
  {
    perform_ajax_form_prod_items_base_mob_navigate_form();
  }

  function perform_ajax_form_prod_items_base_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_item = document.F2.id_item.value;
    ...
    scAjaxProcOn();
    x_ajax_form_prod_items_base_mob_navigate_form(var_id_item, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prod_items_base_mob_navigate_form_cb);
  } // do_ajax_form_prod_items_base_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prod_items_base_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prod_items_base_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_item.value = scAjaxGetKeyValue("id_item");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prod_items_base_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_prod_items_base_mob_navigate_form_cb
  function do_ajax_form_prod_items_base_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_prod_items_base_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_prod_items_base_mob_navigate_form_cb_after_alert

  function sc_hide_form_prod_items_base_mob_form()
  {
  ...
  ajax_field_list[1] = "agrupador1";
  ajax_field_list[2] = "items_tipo_proyecto";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "sc_field_0": {"label": "Nombre Ítem", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "agrupador1": {"label": "Agrupador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "items_tipo_proyecto": {"label": "Tipos de Proyectos Asociados", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "items_tipo_proyecto": new Array()
  };
  ajax_field_mult["sc_field_0"][1] = "sc_field_0";
  ajax_field_mult["agrupador1"][1] = "agrupador1";
  ajax_field_mult["items_tipo_proyecto"][1] = "items_tipo_proyecto";
  ...
  var ajax_field_id = {
    ...
    "items_tipo_proyecto": new Array("hidden_field_label_items_tipo_proyecto", "hidden_field_data_items_tipo_proyecto")
  };

  var ajax_read_only = {
    "sc_field_0": "off",
    "agrupador1": "off",
    "items_tipo_proyecto": "off"
  };
