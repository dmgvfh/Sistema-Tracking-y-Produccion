<?php
@session_start() ;
$_SESSION['scriptcase']['grid_prod_hitos_tipo']['sc_process_barr'] = true;
require_once('../grid_prod_hitos_tipo/index.php');
unset($_SESSION['scriptcase']['grid_prod_hitos_tipo']['sc_process_barr']);
$ExportCtrl = new grid_prod_hitos_tipo_export_control;
$ExportCtrl->Export_barr();

class grid_prod_hitos_tipo_export_control
{
