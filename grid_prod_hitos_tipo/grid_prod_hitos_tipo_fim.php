...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_hitos_tipo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_hitos_tipo"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_prod_hitos_tipo'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_hitos_tipo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_hitos_tipo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_hitos_tipo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_hitos_tipo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_prod_hitos_tipo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_prod_hitos_tipo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_prod_hitos_tipo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_prod_hitos_tipo']['embutida_filho'] as $ind => $sc_init)
          {
