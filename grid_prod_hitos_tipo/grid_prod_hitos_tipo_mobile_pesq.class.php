...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "tipo_hito";$Nm_numeric[] = "id";$Nm_numeric[] = "tipo_hito";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tipo_hito_cond" name="tipo_hito_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo_hito'), this, 'tipo_hito')">
      ...
      <br><span id="id_hide_tipo_hito"  <?php echo $str_hide_tipo_hito?>><INPUT  type="text" id="SC_tipo_hito" name="tipo_hito" value="<?php echo NM_encode_input($tipo_hito) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
