...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_appointments_history"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_appointments_history"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_appointments_history</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['embutida_filho'] as $ind => $sc_init)
          {
