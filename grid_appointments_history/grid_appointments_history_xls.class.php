...
class grid_appointments_history_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_appointments_history" . $this->Xls_tp;
          $this->Tit_doc    = "grid_appointments_history" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_appointments_history_total.class.php"); 
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'])
      { 
   ...
   function NM_export_appointments_history_date()
   {
         ...
         $this->appointments_history_date = substr($this->appointments_history_date, 0, 10);
         if (empty($this->appointments_history_date) || $this->appointments_history_date == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->appointments_history_date, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->appointments_history_date, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->appointments_history_date);
   ...
   function NM_export_appointments_history_descr()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->appointments_history_descr, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->appointments_history_descr, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_appointment_status_id()
   {
         ...
         if (is_numeric($this->look_appointment_status_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_appointment_status_id);
         $this->Xls_col++;
   }
   //----- sec_users_login
   function NM_export_sec_users_login()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             ...
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sec_users_login, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_appointments_history_id()
   {
         ...
         if (is_numeric($this->appointments_history_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->appointments_history_id);
         $this->Xls_col++;
   }
   //----- appointments_id
   ...
   //----- appointments_history_date
   function NM_sub_cons_appointments_history_date()
   {
         $this->appointments_history_date = substr($this->appointments_history_date, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->appointments_history_date;
   ...
   //----- appointments_history_descr
   function NM_sub_cons_appointments_history_descr()
   {
         $this->appointments_history_descr = html_entity_decode($this->appointments_history_descr, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->appointments_history_descr = strip_tags($this->appointments_history_descr);
         $this->appointments_history_descr = NM_charset_to_utf8($this->appointments_history_descr);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->appointments_history_descr;
   ...
   //----- appointment_status_id
   function NM_sub_cons_appointment_status_id()
   {
         $this->look_appointment_status_id = NM_charset_to_utf8($this->look_appointment_status_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_appointment_status_id;
   ...
   //----- sec_users_login
   function NM_sub_cons_sec_users_login()
   {
         $this->sec_users_login = html_entity_decode($this->sec_users_login, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sec_users_login = strip_tags($this->sec_users_login);
         $this->sec_users_login = NM_charset_to_utf8($this->sec_users_login);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sec_users_login;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- appointments_history_id
   function NM_sub_cons_appointments_history_id()
   {
         $this->appointments_history_id = NM_charset_to_utf8($this->appointments_history_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->appointments_history_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['nolabel'])
       {
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_history'] ?> :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
