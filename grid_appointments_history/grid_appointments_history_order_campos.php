...
<?php
   ...
   $Ord_Cmp = new grid_appointments_history_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointments_history_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['appointments_history_date'] = "appointments_history_date";
   $tab_labels["appointments_history_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["appointments_history_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["appointments_history_date"] : "" . $this->Nm_lang['lang_appointments_history_fld_appointments_history_date'] . "";
   $tab_ger_campos['appointments_history_descr'] = "on";
   $tab_def_campos['appointments_history_descr'] = "appointments_history_descr";
   $tab_labels["appointments_history_descr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["appointments_history_descr"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["appointments_history_descr"] : "Observaciones";
   $tab_ger_campos['appointment_status_id'] = "on";
   $tab_def_campos['appointment_status_id'] = "appointment_status_id";
   $tab_labels["appointment_status_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["appointment_status_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["appointment_status_id"] : "" . $this->Nm_lang['lang_appointments_history_fld_appointment_status_id'] . "";
   $tab_ger_campos['sec_users_login'] = "on";
   $tab_def_campos['sec_users_login'] = "sec_users_login";
   $tab_labels["sec_users_login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["sec_users_login"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["sec_users_login"] : "" . $this->Nm_lang['lang_appointments_history_fld_sec_users_login'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointments_history_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
