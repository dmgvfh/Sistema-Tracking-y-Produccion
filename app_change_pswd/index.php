...
//
   ...
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_perfil']          = "conn_example";
...
';
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['app_change_pswd']['iframe_menu'])) {
          $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['iframe_menu'] = "";
      }
      if (!isset($_SESSION['sc_session'][$script_case_init]['app_change_pswd']['run_iframe'])) {
          $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['run_iframe'] = "";
      }
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_change_pswd']['link_info']['remove_border'] = true;
        }
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'carga_horas', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_imag_temp'] . "/sc_apl_default_carga_horas.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_carga_horas'])) {
                $_SESSION['scriptcase']['app_change_pswd']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_carga_horas'];
            }
        }
    }
    ...
    else
    {
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['app_change_pswd']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['run_iframe'] != "R")
        {
            ...
            $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['volta_dep'] = (isset($nm_apl_dependente)) ? $nm_apl_dependente : "";
        ...
        $nm_url_saida      = (isset($_SESSION['sc_session'][$script_case_init]['app_change_pswd']['volta_php'])) ? $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['volta_php'] : "";
        $nm_apl_dependente = (isset($_SESSION['sc_session'][$script_case_init]['app_change_pswd']['volta_dep'])) ? $_SESSION['sc_session'][$script_case_init]['app_change_pswd']['volta_dep'] : "";
        $nm_saida_global   = $nm_url_saida;
    ...
    if (isset($_POST['wizard_action']) && 'change_step' == $_POST['wizard_action']) {
        $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['param']['buffer_output'] = true;
        ob_start();
    }
...
//
   ...
   function app_change_pswd_pack_ajax_response()
   {
      ...
      if (isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['wizard']))
      {
          $aResp['wizard'] = $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['wizard'];
      }
...
//-----
      {
         ...
         if (isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['btnDisabled']) && '' != $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['btnDisabled'])
         {
            app_change_pswd_pack_btn_disabled($aResp);
         }
         if (isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['btnLabel']) && '' != $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['btnLabel'])
         {
            app_change_pswd_pack_btn_label($aResp);
         }
         ...
         {
/* mantis 0021191 */            $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['buttonDisplay'] = $inicial_app_change_pswd->contr_app_change_pswd->nmgp_botoes;
   ...
   function app_change_pswd_pack_btn_disabled(&$aResp)
   {
      global $inicial_app_change_pswd;
      $aResp['btnDisabled'] = array();
      foreach ($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['btnDisabled'] as $btnName => $btnStatus) {
        $aResp['btnDisabled'][$btnName] = $btnStatus;
      }
   } // app_change_pswd_pack_ajax_alert

   function app_change_pswd_pack_btn_label(&$aResp)
   {
      global $inicial_app_change_pswd;
      $aResp['btnLabel'] = array();
      foreach ($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['btnLabel'] as $btnName => $btnLabel) {
   ...
   function app_change_pswd_pack_ajax_alert(&$aResp)
   {
      global $inicial_app_change_pswd;
// PHP 8.0
      if (!isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxAlert']['message'])) {
          $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxAlert']['message'] = '';
      }
      if (!isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxAlert']['params'])) {
          $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxAlert']['params'] = '';
      }
//---
   ...
   function app_change_pswd_pack_ajax_message(&$aResp)
   {
      global $inicial_app_change_pswd;
// PHP 8.0
      if (!isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['message'])) {
          $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['message'] = '';
      }
      if (!isset($inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['title'])) {
          $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['ajaxMessage']['title'] = '';
      }
//---
