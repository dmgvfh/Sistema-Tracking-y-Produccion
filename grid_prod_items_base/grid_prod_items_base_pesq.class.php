...
class grid_prod_items_base_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_prod_items_base_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_prod_items_base_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_prod_items_base_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_item')
      {
          $item = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_item($item);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_item($item)
   {
      $item = substr($this->Db->qstr($item), 1, -1);
            $item_look = (is_string($item) ? substr($this->Db->qstr($item), 1, -1) : $item); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct item from " . $this->Ini->nm_tabela . " where  item like '%" . $item . "%' order by item"; 
      unset($cmp1,$cmp2);
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Listado de Ítems base de proyectos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_prod_items_base/grid_prod_items_base_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_prod_items_base_ajax_search.js"></script>
 <script type="text/javascript" src="grid_prod_items_base_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_prod_items_base_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_item_cond#NMF#' + search_get_sel_txt('SC_item_cond') + '@NMF@';
  str_out += 'SC_item#NMF#' + search_get_text('SC_item') + '@NMF@';
  str_out += 'id_ac_item#NMF#' + search_get_text('id_ac_item') + '@NMF@';
  str_out += 'SC_agrupador1_cond#NMF#' + search_get_sel_txt('SC_agrupador1_cond') + '@NMF@';
  str_out += 'SC_agrupador1#NMF#' + search_get_text('SC_agrupador1') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_item").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_item").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_item",
          max_itens: "10",
          cod_desc: "N",
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    ...
    <div class="scFilterHeaderFont" style="float: right;">Listado de Ítems base de proyectos</div>
</div>  </TD>
 </TR>
<?php
   }
   ...
   {
      global 
             $item_cond, $item, $item_autocomp,
             $agrupador1_cond, $agrupador1,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $item = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['item']; 
          $item_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['item_cond']; 
          $agrupador1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['agrupador1']; 
          $agrupador1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['agrupador1_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['NM_operador']; 
          if (strtoupper($agrupador1_cond) != "II" && strtoupper($agrupador1_cond) != "QP" && strtoupper($agrupador1_cond) != "NP" && strtoupper($agrupador1_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($agrupador1, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_item = (in_array($item_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_agrupador1 = (in_array($agrupador1_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($item)) ? strpos($item, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $item = substr($item, 0, $tmp_pos);
         }
      }
      if (!isset($agrupador1) || $agrupador1 == "")
      {
          $agrupador1 = "";
      }
      if (isset($agrupador1) && !empty($agrupador1))
      {
         $tmp_pos = (is_string($agrupador1)) ? strpos($agrupador1, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $agrupador1 = substr($agrupador1, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_item_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['item'])) ? $this->New_label['item'] : "Nombre ïtem"; ?></TD>
      
      <INPUT type="hidden" id="SC_item_cond" name="item_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_item" <?php echo $str_hide_item?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['item'])) ? $this->New_label['item'] : "Nombre ïtem";
 $nmgp_tab_label .= "item?#?" . $SC_Label . "?@?";
...
<?php
      ...
      $item_look = (is_string($item) ? substr($this->Db->qstr($item), 1, -1) : $item); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct item from " . $this->Ini->nm_tabela . " where item = '$item_look' order by item"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$item]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$item];
      }
      else
      {
          $sAutocompValue = $item;
...
?>
<INPUT  type="text" id="SC_item" name="item" value="<?php echo NM_encode_input($item) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_item" name="item_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_agrupador1_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['agrupador1'])) ? $this->New_label['agrupador1'] : "Agrupador"; ?></TD>
      
      <INPUT type="hidden" id="SC_agrupador1_cond" name="agrupador1_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_agrupador1" <?php echo $str_hide_agrupador1?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['agrupador1'])) ? $this->New_label['agrupador1'] : "Agrupador";
 $nmgp_tab_label .= "agrupador1?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_agrupador1" name="agrupador1" value="<?php echo NM_encode_input($agrupador1) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("grid_prod_items_base_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_prod_items_base']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_prod_items_base']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_item'), document.F1.item_cond, 'item');
   document.F1.item.value = "";
   document.F1.item_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_agrupador1'), document.F1.agrupador1_cond, 'agrupador1');
   document.F1.agrupador1.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "carga_horas/grid_prod_items_base";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_item_cond'] = 'cond';
      $tp_fields['SC_item'] = 'text_aut';
      $tp_fields['id_ac_item'] = 'text_aut';
      $tp_fields['SC_agrupador1_cond'] = 'cond';
      $tp_fields['SC_agrupador1'] = 'text';
   ...
   {
      global $item_cond, $item, $item_autocomp,
             $agrupador1_cond, $agrupador1, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($item_autocomp) && empty($item))
      {
          $item = $item_autocomp;
      }
      $item_cond_salva = $item_cond; 
      if (!isset($item_input_2) || $item_input_2 == "")
      {
          $item_input_2 = $item;
      }
      $agrupador1_cond_salva = $agrupador1_cond; 
      if (!isset($agrupador1_input_2) || $agrupador1_input_2 == "")
      {
          $agrupador1_input_2 = $agrupador1;
      }
      if ($agrupador1_cond != "in")
      {
          nm_limpa_numero($agrupador1, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['item'] = $item; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['item_cond'] = $item_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['agrupador1'] = $agrupador1; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['agrupador1_cond'] = $agrupador1_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($item != '') {
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['item'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['item'] = $item;
      }
      $Conteudo = $agrupador1;
      if (strtoupper($agrupador1_cond) != "II" && strtoupper($agrupador1_cond) != "QP" && strtoupper($agrupador1_cond) != "NP" && strtoupper($agrupador1_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['agrupador1'] = $Conteudo;

      //----- $item
      $this->Date_part = false;
      if (isset($item) || $item_cond == "nu" || $item_cond == "nn" || $item_cond == "ep" || $item_cond == "ne")
      {
         $this->monta_condicao("item", $item_cond, $item, "", "item", "VARCHAR", false);
      }

      //----- $agrupador1
      $this->Date_part = false;
      if (isset($agrupador1) || $agrupador1_cond == "nu" || $agrupador1_cond == "nn" || $agrupador1_cond == "ep" || $agrupador1_cond == "ne")
      {
         $this->monta_condicao("agrupador1", $agrupador1_cond, $agrupador1, "", "agrupador1", "INT", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prod_items_base']['cond_pesq'] .= $this->NM_operador;
