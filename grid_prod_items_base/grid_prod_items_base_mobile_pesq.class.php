...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_item";$Nm_numeric[] = "agrupador1";$Nm_numeric[] = "id_item";$Nm_numeric[] = "agrupador1";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_item"  <?php echo $str_hide_item?>><?php
      if ($item != "")
      {
      $item_look = (is_string($item) ? substr($this->Db->qstr($item), 1, -1) : $item); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_agrupador1"  <?php echo $str_hide_agrupador1?>><INPUT  type="text" id="SC_agrupador1" name="agrupador1" value="<?php echo NM_encode_input($agrupador1) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
