...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_items_base"]))
   {
      unset($_SESSION['session_sec_aplicacao']["carga_horas_____grid_prod_items_base"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_prod_items_base'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_items_base']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_items_base']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_prod_items_base']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_prod_items_base']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_prod_items_base']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_prod_items_base</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_prod_items_base']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_prod_items_base']['embutida_filho'] as $ind => $sc_init)
          {
